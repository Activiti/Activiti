 ...
 */
public class CycleServiceFileXStreamImpl implements CycleService {
  ...
  public CycleServiceFileXStreamImpl(String processEngineName) {
  ...
  public CycleServiceFileXStreamImpl(File baseDir) {
