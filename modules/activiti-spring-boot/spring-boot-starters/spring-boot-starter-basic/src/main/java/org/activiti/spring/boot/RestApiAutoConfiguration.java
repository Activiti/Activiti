...
/*
    ...
    @Configuration
    @ConditionalOnClass({UserDetailsService.class, ActivitiRestServicesApplication.class,
            ServletRegistrationBean.class, ServerServlet.class})
    public static class SecureRestServiceAutoConfiguration {

        @Autowired
        private ActivitiProperties activitiProperties;

        @Bean
        @ConditionalOnMissingBean(name = "activitiRestRegistration")
        public ServletRegistrationBean activitiRestRegistration() {
            ServerServlet servlet = new ServerServlet();
            ServletRegistrationBean registration = new ServletRegistrationBean(servlet,
                    this.activitiProperties.getRestApiMapping());
