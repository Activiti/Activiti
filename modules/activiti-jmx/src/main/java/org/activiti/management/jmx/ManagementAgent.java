...
public interface ManagementAgent {
     ...
     *            if set to <tt>true</tt>, then object will be registered
     *            despite existing object is already registered with the name.
     * @throws JMException
     *             is thrown if the registration failed
     */
     ...
     * <p/>
     * <b>Notice:</b> If the JMXEnabled configuration is not set to
     * <tt>true</tt>, this method will return <tt>null</tt>.
     * 
