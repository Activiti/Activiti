...
public class ArtifactPost extends ActivitiCycleWebScript {
  ...
  protected void execute(ActivitiRequest req, Status status, Cache cache, Map<String, Object> model) {
    ...
    String containingFolderId = req.getMandatoryString(obj, "containingFolderId");
    ...
    try {
      this.cycleService.createArtifact(connectorId, containingFolderId, artifactName, artifactType, artifactContent);
