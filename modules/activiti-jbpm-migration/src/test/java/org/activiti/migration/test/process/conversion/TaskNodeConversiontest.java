...
public class TaskNodeConversiontest extends MigrationTestCase {
  ...
  protected void setUp() throws Exception {
    ...
    try {
      ProcessDefinition processDefinition = ProcessDefinition
        .parseXmlResource("org/activiti/migration/test/process/conversion/tasknode/actor-id/processdefinition.xml");
      jbpmContext.deployProcessDefinition(processDefinition);
      jbpmContext.newProcessInstance("actorIdProcess");
    } finally {
      jbpmContext.close();
    }
  }
  ...
  public void testActorIdToAssigneeConversion() {
    String migratedBpmn20Xml = migrateProcess("actorIdProcess");
    String deployId = repositoryService.createDeployment()
      .addString("actorIdProcess.bpmn20.xml", migratedBpmn20Xml)
      .deploy()
      .getId();
