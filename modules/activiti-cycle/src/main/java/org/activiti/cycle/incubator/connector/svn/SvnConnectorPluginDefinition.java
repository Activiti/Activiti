...
import org.activiti.cycle.incubator.connector.svn.provider.SvnBinaryContentProvider;
import org.activiti.cycle.incubator.connector.svn.provider.SvnTextFileContentProvider;
import org.activiti.cycle.incubator.connector.svn.provider.SvnXmlFileContentProvider;

/**
 * Configuration of the svnconnector plugin
 * 
 * @author daniel.meyer@camunda.com
 *
 */
@ActivitiCyclePlugin
public class SvnConnectorPluginDefinition implements ActivitiCyclePluginDefinition {
	...
	public void addArtifactTypes(List<ArtifactType> types) {
		...
		artifactTypeDefault.addDefaultContentRepresentation(new ContentRepresentationImpl(CONTENT_REPRESENTATION_ID_TEXT,
				CycleDefaultMimeType.TEXT, RenderInfo.TEXT_PLAIN), new SvnTextFileContentProvider());
		...
		artifactType3.addDefaultContentRepresentation(new ContentRepresentationImpl(CONTENT_REPRESENTATION_ID_TEXT,
				CycleDefaultMimeType.TEXT, RenderInfo.TEXT_PLAIN), new SvnTextFileContentProvider());
		...
		artifactType1.addDefaultContentRepresentation(new ContentRepresentationImpl(CONTENT_REPRESENTATION_ID_XML,
				CycleDefaultMimeType.XML, RenderInfo.CODE), new SvnXmlFileContentProvider());
		...
		artifactType2.addDefaultContentRepresentation(new ContentRepresentationImpl(CONTENT_REPRESENTATION_ID_XML,
				CycleDefaultMimeType.XML, RenderInfo.CODE), new SvnXmlFileContentProvider());
		...
		artifactTypeXml.addDefaultContentRepresentation(new ContentRepresentationImpl(CONTENT_REPRESENTATION_ID_XML,
				CycleDefaultMimeType.XML, RenderInfo.CODE), new SvnTextFileContentProvider());
		...
		artifactType4.addDefaultContentRepresentation(new ContentRepresentationImpl(CONTENT_REPRESENTATION_ID_BINARY,
				CycleDefaultMimeType.MS_WORD, RenderInfo.BINARY), new SvnBinaryContentProvider());
		...
		artifactType5.addDefaultContentRepresentation(new ContentRepresentationImpl(CONTENT_REPRESENTATION_ID_BINARY,
				CycleDefaultMimeType.MS_POWERPOINT, RenderInfo.BINARY), new SvnBinaryContentProvider());
		...
		artifactType6.addDefaultContentRepresentation(new ContentRepresentationImpl(CONTENT_REPRESENTATION_ID_BINARY,
				CycleDefaultMimeType.PDF, RenderInfo.BINARY), new SvnTextFileContentProvider());
		...
		artifactTypeHtml.addDefaultContentRepresentation(new ContentRepresentationImpl(CONTENT_REPRESENTATION_ID_HTML,
				CycleDefaultMimeType.HTML, RenderInfo.HTML), new SvnTextFileContentProvider());
		artifactTypeHtml.addDownloadContentAction(CONTENT_REPRESENTATION_ID_HTML);
		artifactTypeHtml.addContentRepresentation(new ContentRepresentationImpl(CONTENT_REPRESENTATION_ID_HTML_SOURCE,
				CycleDefaultMimeType.HTML, RenderInfo.CODE), new SvnTextFileContentProvider());
		types.add(artifactTypeHtml);
	}

	public Class<? extends RepositoryConnectorConfiguration> getRepositoryConnectorConfigurationType() {
		return SvnConnectorConfiguration.class;
	}
