 ...
 * variables from Camel into Activiti.
 * 
...
public class ExchangeUtils {
     ...
     * 
     * This method will copy the Camel body to the "camelBody" variable. It will
     * copy the Camel body to individual variables within Activiti if it is of
     * type Map&lt;String, Object&gt; or it will copy the Object as it comes.
     * <ul>
     * <li>If the copyVariablesFromProperties parameter is set on the endpoint,
     * the properties are copied instead</li>
     * <li>If the copyCamelBodyToBodyAsString parameter is set on the endpoint,
     * the camelBody is converted to java.lang.String and added as a camelBody
     * variable, unless it is a Map&lt;String, Object&gt;</li>
     * <li>If the copyVariablesFromHeader parameter is set on the endpoint, each
     * Camel Header will be copied to an individual variable within Activiti.</li>
     * </ul>
     * 
     * @param exchange
     ...
     * @return A Map&lt;String, Object&gt; containing all of the variables to be
     *         used in Activiti
     */
    ...
    /**
     * Gets the value of the Camel header that contains the userId to be set as
     * the process initiator. Returns null if no header name was specified on
     * the Camel route.
     * 
     * @param exchange
     *            The Camel Exchange object
