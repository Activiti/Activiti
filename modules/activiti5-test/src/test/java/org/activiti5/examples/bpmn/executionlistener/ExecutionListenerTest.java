...
public class ExecutionListenerTest extends PluggableActivitiTestCase {
  ...
  @Deployment(resources = {"org/activiti5/examples/bpmn/executionlistener/ExecutionListenersProcess.bpmn20.xml"})
  ...
  @Deployment(resources = {"org/activiti5/examples/bpmn/executionlistener/ExecutionListenersStartEndEvent.bpmn20.xml"})
  ...
  @Deployment(resources = {"org/activiti5/examples/bpmn/executionlistener/ExecutionListenersFieldInjectionProcess.bpmn20.xml"})
  ...
  @Deployment(resources = {"org/activiti5/examples/bpmn/executionlistener/ExecutionListenersCurrentActivity.bpmn20.xml"})
