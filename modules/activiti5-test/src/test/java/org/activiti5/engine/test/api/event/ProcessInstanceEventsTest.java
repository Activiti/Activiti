...
public class ProcessInstanceEventsTest extends PluggableActivitiTestCase {
   ...
   */
  @Deployment(resources = {"org/activiti5/engine/test/bpmn/event/signal/SignalEventTest.testSignalWithGlobalScope.bpmn20.xml"})
   ...
   */
  @Deployment(resources = {"org/activiti5/engine/test/api/event/ProcessInstanceEventsTest.noneTaskProcess.bpmn20.xml"})
   ...
   */
  @Deployment(resources = {"org/activiti5/engine/test/api/event/ProcessInstanceEventsTest.noEndProcess.bpmn20.xml"})
   ...
   */
  @Deployment(resources = {"org/activiti5/engine/test/api/event/ProcessInstanceEventsTest.parallelGatewayNoEndProcess.bpmn20.xml"})
   ...
   * process on PROCESS_COMPLETED event
   */
  @Deployment(resources = {"org/activiti5/engine/test/api/event/ProcessInstanceEventsTest.parallelGatewayTwoEndsProcess.bpmn20.xml"})
  ...
  @Deployment(resources="org/activiti5/engine/test/bpmn/event/end/TerminateEndEventTest.testProcessTerminate.bpmn")
  ...
  @Deployment(resources = {
      "org/activiti5/engine/test/bpmn/multiinstance/MultiInstanceTest.testParallelCallActivity.bpmn20.xml",
  ...
  public void testDeleteMultiInstanceCallActivityProcessInstance() {
    ...
    assertThat("Task cancelled event has to be fired.", listener.getEventsReceived().get(0).getType(), is(ActivitiEventType.ACTIVITY_CANCELLED));
    assertThat("SubProcess cancelled event has to be fired.", listener.getEventsReceived().get(2).getType(), is(ActivitiEventType.PROCESS_CANCELLED));
