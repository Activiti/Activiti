...
public class DeploymentQueryTest extends PluggableActivitiTestCase {
  ...
  public void testQueryByName() {
    DeploymentQuery query = repositoryService.createDeploymentQuery().deploymentName("org/activiti5/engine/test/repository/two.bpmn20.xml");
    assertNotNull(query.singleResult());
    assertEquals(1, query.list().size());
    assertEquals(1, query.count());
  }
  ...
  public void testVerifyDeploymentProperties() {
    ...
    assertEquals("org/activiti5/engine/test/repository/one.bpmn20.xml", deploymentOne.getName());
    assertEquals(deploymentOneId, deploymentOne.getId());

    Deployment deploymentTwo = deployments.get(1);
    assertEquals("org/activiti5/engine/test/repository/two.bpmn20.xml", deploymentTwo.getName());
    ...
    assertEquals("org/activiti5/engine/test/repository/one.bpmn20.xml", deployments.get(0).getName());
