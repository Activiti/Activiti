...
public class InclusiveGatewayTest extends PluggableActivitiTestCase {
  ...
  @Deployment(resources = { "org/activiti5/engine/test/bpmn/gateway/InclusiveGatewayTest.testDivergingInclusiveGateway.bpmn20.xml" })
  ...
  @Deployment(resources={"org/activiti5/engine/test/bpmn/gateway/InclusiveGatewayTest.testJoinAfterCall.bpmn20.xml",
		                 "org/activiti5/engine/test/bpmn/gateway/InclusiveGatewayTest.testJoinAfterCallSubProcess.bpmn20.xml"})	
...
//  
//  @Deployment(resources={"org/activiti5/engine/test/bpmn/gateway/InclusiveGatewayTest.testWithSignalBoundaryEvent.bpmn20.xml"})	
