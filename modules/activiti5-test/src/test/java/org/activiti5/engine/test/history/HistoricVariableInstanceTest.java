...
public class HistoricVariableInstanceTest extends PluggableActivitiTestCase {
  ...
  @Deployment(resources={
          "org/activiti5/engine/test/history/HistoricVariableInstanceTest.testCallSimpleSubProcess.bpmn20.xml",
          "org/activiti5/engine/test/history/simpleSubProcess.bpmn20.xml"
  })
  ...
  @Deployment(resources={
     "org/activiti5/engine/test/history/oneTaskProcess.bpmn20.xml"
   })
