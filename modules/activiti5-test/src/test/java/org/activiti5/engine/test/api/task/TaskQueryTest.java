...
public class TaskQueryTest extends PluggableActivitiTestCase {
  ...
  @Deployment(resources="org/activiti5/engine/test/api/task/taskDefinitionProcess.bpmn20.xml")
  ...
  @Deployment(resources= {"org/activiti5/engine/test/api/task/TaskQueryTest.testTaskVariableValueEquals.bpmn20.xml"})
  ...
  @Deployment(resources= {"org/activiti5/engine/test/api/task/TaskQueryTest.testProcessVariableValueEquals.bpmn20.xml"})
