...
public class MockSupportWithActivitiTestCaseTest extends ActivitiTestCase { 
	...
	protected void setUp() throws Exception {
	  ...
	  mockSupport().mockServiceTaskWithClassDelegate("com.yourcompany.anotherDelegate", "org.activiti5.standalone.testing.helpers.ServiceTaskTestMock");
	}
	...
	@MockServiceTask(originalClassName="com.yourcompany.delegate", 
	                 mockedClassName="org.activiti5.standalone.testing.helpers.ServiceTaskTestMock")
	...
	@Deployment(resources = {"org/activiti5/standalone/testing/MockSupportWithActivitiTestCaseTest.testMockedServiceTaskAnnotation.bpmn20.xml"})
	@MockServiceTask(id = "serviceTask", mockedClassName="org.activiti5.standalone.testing.helpers.ServiceTaskTestMock")
	...
	@Deployment
	@MockServiceTasks({
			@MockServiceTask(originalClassName="com.yourcompany.delegate1", mockedClassName="org.activiti5.standalone.testing.helpers.ServiceTaskTestMock"),
			@MockServiceTask(originalClassName="com.yourcompany.delegate2", mockedClassName="org.activiti5.standalone.testing.helpers.ServiceTaskTestMock")
	})
	...
	@Deployment(resources = {"org/activiti5/standalone/testing/MockSupportWithActivitiTestCaseTest.testNoOpServiceTasksAnnotation.bpmn20.xml"})
	@NoOpServiceTasks(
