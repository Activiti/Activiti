...
public class FullHistoryTest extends ResourceActivitiTestCase {
  ...
  public FullHistoryTest() {
    super("org/activiti5/standalone/history/fullhistory.activiti.cfg.xml");
  }
 ...
 // Variable status when process is finished
  ...
  @Deployment(
    resources={"org/activiti5/engine/test/history/oneTaskProcess.bpmn20.xml"})
  ...
  @Deployment(resources={"org/activiti5/standalone/history/FullHistoryTest.testHistoricProcessInstanceVariableValueEquals.bpmn20.xml"})
...
//    assertEquals(0, historyService.createHistoricProcessInstanceQuery().variableValueLessThanOrEqual("longVar", 12344L).count());
  ...
  @Deployment(resources={"org/activiti5/standalone/history/FullHistoryTest.testVariableUpdatesAreLinkedToActivity.bpmn20.xml"})
