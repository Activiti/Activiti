...
public class MockSupportWithActivitiRuleTest {
	...
	public ActivitiRule activitiRule = new ActivitiRule() {
		...
		protected void configureProcessEngine() {
			...
			activitiRule.mockSupport().mockServiceTaskWithClassDelegate("com.yourcompany.anotherDelegate",
			    "org.activiti5.standalone.testing.helpers.ServiceTaskTestMock");
		}
	...
	@Test
	@Deployment(resources = {"org/activiti5/standalone/testing/MockSupportWithActivitiRuleTest.testMockedServiceTaskAnnotation.bpmn20.xml"})
	...
	@Test
	@Deployment(resources = {"org/activiti5/standalone/testing/MockSupportWithActivitiRuleTest.testNoOpServiceTasksAnnotation.bpmn20.xml"})
	@NoOpServiceTasks(
