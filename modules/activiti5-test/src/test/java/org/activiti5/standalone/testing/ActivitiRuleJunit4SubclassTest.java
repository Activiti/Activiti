 ...
 * {@link org.activiti5.engine.impl.test.TestHelper} needs to be able to find the
 * test method even when it's not declared on the test class itself.
 *
 * Specifically, {@link org.activiti5.engine.impl.test.TestHelper} needs to call getMethod()
