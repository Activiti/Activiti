 ...
 * 
 * <p>
 * Each implementation declares a "precedence". The precedence controls the order in which the resolved implementations will be invoked. (See: getPrecedence().) Implementations with a higher
 * precedence will we invoked first.
 * </p>
 * 
 * 
 * @author Daniel Meyer
