...
public class ActHiTaskinst  implements java.io.Serializable {
    ...
    public ActHiTaskinst(String id, String procDefId, String taskDefKey, String procInstId, String executionId, String name, String parentTaskId, String description, String owner, String assignee, Date startTime, Date claimTime, Date endTime, Long duration, String deleteReason, Integer priority, Date dueDate, String formKey, String category, String tenantId) {
       this.id = id;
