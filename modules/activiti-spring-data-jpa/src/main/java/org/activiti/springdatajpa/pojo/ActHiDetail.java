...
public class ActHiDetail  implements java.io.Serializable {
    ...
    public ActHiDetail(String id, String type, String procInstId, String executionId, String taskId, String actInstId, String name, String varType, Integer rev, Date time, String bytearrayId, Double double_, Long long_, String text, String text2) {
       this.id = id;
       this.type = type;
