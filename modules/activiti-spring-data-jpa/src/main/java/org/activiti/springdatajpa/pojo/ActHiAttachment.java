...
public class ActHiAttachment  implements java.io.Serializable {
    ...
    public ActHiAttachment(String id, Integer rev, String userId, String name, String description, String type, String taskId, String procInstId, String url, String contentId, Date time) {
       this.id = id;
       this.rev = rev;
       this.userId = userId;
       this.name = name;
