...
public abstract class AbstractTablePage extends AbstractPage {
  ...
  /**
   * Concrete pages must implement this. The table that is returned will be used for the list on the left side.
   */
  protected abstract Table createList();

  /**
   * Refresh the list on the left side and selects the next element in the table. (useful when element of the list is deleted)
   */
