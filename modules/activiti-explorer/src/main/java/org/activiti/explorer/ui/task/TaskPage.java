...
/**
 * Abstract super class for all task pages (inbox, queued, archived, etc.), Builds up the default UI: task list on the left, central panel and events on the right.
 * 
 * @author Joram Barrez
 */
