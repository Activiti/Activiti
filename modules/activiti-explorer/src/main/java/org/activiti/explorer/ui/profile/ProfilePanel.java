...
public class ProfilePanel extends Panel {
    ...
    protected void initUi() {
        ...
        // Profile page is a horizontal layout: left we have a panel with the
        // picture,
        // and one the right there is another panel the about, contact, etc
        // information
    ...
    protected InMemoryUploadReceiver initPictureReceiver(Upload upload) {
        InMemoryUploadReceiver receiver = new InMemoryUploadReceiver(upload, 102400L); // 100
                                                                                       // kb
                                                                                       // limit
    ...
    protected void initInformationPanel() {
        ...
        profilePanelLayout.setExpandRatio(infoPanel, 1.0f); // info panel should
                                                            // take all the
                                                            // remaining width
                                                            // available

        // All the information sections are put under each other in a vertical
        // layout
    ...
    protected void initContactSection() {
        ...
        if (!editable && isDefined(skypeId)) {
            // The skype entry shows the name + skype icon, laid out in a small
            // grid
