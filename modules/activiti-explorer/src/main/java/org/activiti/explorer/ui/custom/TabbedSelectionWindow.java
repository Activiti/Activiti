...
/**
 * Generic component for a popup window that allows to display multiple selection tabs on the left, and displays configured components matching those the selection on the right.
 * 
 * Note: For best visual results, the components on the right should be of fixed size, since the window width and heigh is calculated based on these components
 * 
...
public class TabbedSelectionWindow extends PopupWindow {
  ...
  /**
   * @param icon
   *          The 16x16 icon that will be displayed on the left in the selection table.
   * @param name
   *          The name that will be shown in the selection table
   * @param component
   *          The component that is selected when the item in the selection table is clicked.
   * @param clickListener
   *          The listener that will be attached to the OK button displayed beneath the component.
   */
