...
/**
 * Form that renders form-properties and allows posting the filled in value.
 * Performs validation as well. Exposes {@link FormPropertiesEvent}s which allow
 * listening for submission and cancellation of the form.
 * 
