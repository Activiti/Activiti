...
public class TaskTable extends Table implements TaskFormModelListener {
    ...
    public void addTaskRow(HumanStepDefinition humanStepDefinition) {
        Object taskItemId = addTaskRow(null, humanStepDefinition.getName(), humanStepDefinition.getAssignee(), getCommaSeperated(humanStepDefinition.getCandidateGroups()),
                humanStepDefinition.getDescription(), humanStepDefinition.isStartsWithPrevious());
