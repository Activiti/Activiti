...
public class ReportDetailPanel extends DetailPanel {
  ...
  public ReportDetailPanel(String processDefinitionId, AbstractPage parentPage) {
    ...
    this.processDefinition = ProcessEngines.getDefaultProcessEngine().getRepositoryService().createProcessDefinitionQuery().processDefinitionId(processDefinitionId).singleResult();
    ...
    if (startFormData != null && ((startFormData.getFormProperties() != null && !startFormData.getFormProperties().isEmpty()) || startFormData.getFormKey() != null)) {
      ...
      processDefinitionStartForm.addListener(new FormPropertiesEventListener() {
        ...
        protected void handleFormSubmit(FormPropertiesEvent event) {
          ...
          // Report is generated by running a process and storing the
          // dataset in the history tablkes
  ...
  protected void generateReport(ProcessInstance processInstance) {
    ...
    HistoricVariableInstance historicVariableInstance = ProcessEngines.getDefaultProcessEngine().getHistoryService().createHistoricVariableInstanceQuery().processInstanceId(processInstance.getId())
