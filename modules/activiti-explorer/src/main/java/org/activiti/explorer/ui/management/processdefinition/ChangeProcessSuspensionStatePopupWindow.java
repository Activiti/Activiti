...
public class ChangeProcessSuspensionStatePopupWindow extends PopupWindow {
  ...
  protected void addIncludeProcessInstancesSection(boolean suspend) {
    ...
    includeProcessInstancesCheckBox = new CheckBox(suspend ? i18nManager.getMessage(Messages.PROCESS_SUSPEND_POPUP_INCLUDE_PROCESS_INSTANCES_DESCRIPTION)
  ...
  protected void addOkButton(final boolean suspend) {
    ...
    okButton.addListener(new ClickListener() {
      ...
      public void buttonClick(ClickEvent event) {
        ...
        close();
        parentPage.refreshSelectNext(); // select next item in list on
                                        // the left
      }
