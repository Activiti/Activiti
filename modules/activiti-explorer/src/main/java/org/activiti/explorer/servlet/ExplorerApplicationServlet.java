...
public class ExplorerApplicationServlet extends AbstractApplicationServlet {
  ...
  protected void writeAjaxPageHtmlVaadinScripts(Window window, String themeName, Application application, BufferedWriter page, String appUrl, String themeUri, String appId, HttpServletRequest request)
    ...
    String browserDependentCss = "<script type=\"text/javascript\">//<![CDATA[" + "var mobi = ['opera', 'iemobile', 'webos', 'android', 'blackberry', 'ipad', 'safari'];"
        ...
        + "             document.write('<link rel=\"stylesheet\" href=\""
        + themeUri
        + "' + mobi[i] + '6.0.css\" type=\"text/css\"/>');"
        + "           }"
        + "           else {"
        + "             document.write('<link rel=\"stylesheet\" href=\""
        + themeUri
        + "' + mobi[i] + '.css\" type=\"text/css\"/>');"
        + "           }"
        + "          break;"
        + "         }"
        + "       }"
