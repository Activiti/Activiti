...
/**
 * Inspired on the LazyQueryContainer add-on for Vaadin (https://github.com/tlaukkan/vaadin-lazyquerycontainer)
 * 
 * @author Joram Barrez
 */
public class LazyLoadingContainer implements Container.Indexed, Container.Sortable {
  ...
  // binary search using the real id of the object, and map it to an index in
  // the container
