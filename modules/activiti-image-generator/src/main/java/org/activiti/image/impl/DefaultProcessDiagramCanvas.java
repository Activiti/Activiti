...
public class DefaultProcessDiagramCanvas {
     ...
     * Everything beneath these minimum values will be cropped. It's also
     * possible to pass a specific font name and a class loader for the icon
     * images.
     * 
     */
     ...
     * 
     * @param minX
     *            Hint that will be used when generating the image. Parts that
     ...
     * 
     * @param shape
     *            Bounds of this shape used to calculate parameters of inscribed
     *            into this bounds ellipse.
     * @param line
