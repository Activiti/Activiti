...
public final class RestUrls {
    ...
    /**
     * URL template for a single deployment:
     * <i>repository/deployments/{0:deploymentId}</i>
     */
    public static final String[] URL_DEPLOYMENT = { SEGMENT_REPOSITORY_RESOURCES, SEGMENT_DEPLOYMENT_RESOURCE, "{0}" };

    /**
     * URL template listing deployment resources:
     * <i>repository/deployments/{0:deploymentId}/resources</i>
     */
    ...
    /**
     * URL template for a single deployment resource:
     * <i>repository/deployments/{0:deploymentId}/resources/{1}:resourceId</i>
     */
    ...
    /**
     * URL template for a single deployment resource content:
     * <i>repository/deployments
    ...
    /**
     * URL template for the process definition collection:
     * <i>repository/process-definitions</i>
     */
    ...
    /**
     * URL template for a single process definition:
     * <i>repository/process-definitions/{0:processDefinitionId}</i>
     */
    public static final String[] URL_PROCESS_DEFINITION = { SEGMENT_REPOSITORY_RESOURCES, SEGMENT_PROCESS_DEFINITION_RESOURCE, "{0}" };

    /**
     * URL template for the resource of a single process definition:
     * <i>repository
    ...
    /**
     * URL template for a process definition's identity links:
     * <i>repository/process
     * -definitions/{0:processDefinitionId}/identitylinks</i>
     */
    ...
    /**
     * URL template for an identitylink on a process definition:
     * <i>repository/process
     * -definitions/{0:processDefinitionId}/identitylinks/{1
     * :family}/{2:identityId}</i>
     */
    ...
    /**
     * URL template for the model of a process definition:
     * <i>repository/process-definitions/{0:processDefinitionId}/model</i>
     */
    ...
    /**
     * URL template for the image of a process definition:
     * <i>repository/process-definitions/{0:processDefinitionId}/image</i>
     */
    ...
    /**
     * URL template for the editor source of a model
     * <i>repository/models/{0:modelId}/source</i>
     */
    public static final String[] URL_MODEL_SOURCE = { SEGMENT_REPOSITORY_RESOURCES, SEGMENT_MODEL_RESOURCE, "{0}", SEGMENT_SOURCE };

    /**
     * URL template for the extra editor source of a model
     * <i>repository/models/{0:modelId}/source-extra</i>
     */
    ...
    /**
     * URL template for a task's sub tasks:
     * <i>runtime/tasks/{0:taskId}/subtasks</i>
     */
    ...
    /**
     * URL template for a task's variables:
     * <i>runtime/tasks/{0:taskId}/variables</i>
     */
    ...
    /**
     * URL template for a single task variable:
     * <i>runtime/tasks/{0:taskId}/variables/{1:variableName}</i>
     */
    public static final String[] URL_TASK_VARIABLE = { SEGMENT_RUNTIME_RESOURCES, SEGMENT_TASK_RESOURCE, "{0}", SEGMENT_VARIABLES, "{1}" };

    /**
     * URL template for a single task variable content:
     * <i>runtime/tasks/{0:taskId}/variables/{1:variableName}/data</i>
     */
    ...
    /**
     * URL template for a task's identity links:
     * <i>runtime/tasks/{0:taskId}/identitylinks</i>
     */
    ...
    /**
     * URL template for an identitylink on a task:
     * <i>runtime/tasks/{0:taskId}/identitylinks
    ...
    /**
     * URL template for a task's identity links:
     * <i>runtime/tasks/{0:taskId}/comments</i>
     */
    ...
    /**
     * URL template for a comment on a task:
     * <i>runtime/tasks/{0:taskId}/comments/{1:commentId}</i>
     */
    ...
    /**
     * URL template for an event on a task:
     * <i>runtime/tasks/{0:taskId}/events/{1:eventId}</i>
     */
    public static final String[] URL_TASK_EVENT = { SEGMENT_RUNTIME_RESOURCES, SEGMENT_TASK_RESOURCE, "{0}", SEGMENT_EVENTS, "{1}" };

    /**
     * URL template for an task's attachments:
     * <i>runtime/tasks/{0:taskId}/attachments</i>
     */
    ...
    /**
     * URL template for an attachment on a task:
     * <i>runtime/tasks/{0:taskId}/attachments/{1:attachmentId}</i>
     */
    public static final String[] URL_TASK_ATTACHMENT = { SEGMENT_RUNTIME_RESOURCES, SEGMENT_TASK_RESOURCE, "{0}", SEGMENT_ATTACHMENTS, "{1}" };

    /**
     * URL template for the content for an attachment on a task:
     * <i>runtime/tasks/{0:taskId}/attachments/{1:attachmentId}/content</i>
     */
    ...
    /**
     * URL template for execution collection:
     * <i>runtime/executions/{0:executionId}</i>
     */
    public static final String[] URL_EXECUTION_COLLECTION = { SEGMENT_RUNTIME_RESOURCES, SEGMENT_EXECUTION_RESOURCE };

    /**
     * URL template for a single execution:
     * <i>runtime/executions/{0:executionId}</i>
     */
    public static final String[] URL_EXECUTION = { SEGMENT_RUNTIME_RESOURCES, SEGMENT_EXECUTION_RESOURCE, "{0}" };

    /**
     * URL template for the variables for an execution:
     * <i>runtime/executions/{0:executionId}/variables</i>
     */
    ...
    /**
     * URL template for a single variables for an execution:
     * <i>runtime/executions/{0:executionId}/variables/{1:variableName}</i>
     */
    ...
    /**
     * URL template for a single variables for an execution:
     * <i>runtime/executions/{0:executionId}/variables/{1:variableName}/data</i>
     */
    ...
    /**
     * URL template for all active activities on an execution:
     * <i>runtime/executions/{0:executionId}/activities</i>
     */
    ...
    /**
     * URL template for process instance collection:
     * <i>runtime/process-instances</i>
     */
    ...
    /**
     * URL template for a single process instance:
     * <i>runtime/process-instances/{0:processInstanceId}</i>
     */
    public static final String[] URL_PROCESS_INSTANCE = { SEGMENT_RUNTIME_RESOURCES, SEGMENT_PROCESS_INSTANCE_RESOURCE, "{0}" };

    /**
     * URL template for the diagram for a single process instance:
     * <i>runtime/process-instances/{0:processInstanceId}/diagram</i>
     */
    ...
    /**
     * URL template for process instance variable collection:
     * <i>runtime/process-instances/{0:processInstanceId}/variables</i>
     */
    ...
    /**
     * URL template for a single process instance variable:
     * <i>runtime/process-instances
    ...
    /**
     * URL template for a single process instance variable data:
     * <i>runtime/process
     * -instances/{0:processInstanceId}/variables/{1:variableName}/data</i>
     */
    ...
    /**
     * URL template for a comment on a process instance:
     * <i>history/historic-process
     * -instances/{0:processInstanceId}/comments/{1:commentId}</i>
     */
    ...
    /**
     * URL template for comments on a process instance:
     * <i>history/historic-process-instances/{0:processInstanceId}/comments</i>
     */
    ...
    /**
     * URL template for a process instance's identity links:
     * <i>runtime/process-instances/{0:processInstanceId}/identitylinks</i>
     */
    ...
    /**
     * URL template for an identitylink on a process instance:
     * <i>runtime/process
     * -instances/{0:processInstanceId}/identitylinks/users/{1:
     * identityId}/{2:type}</i>
     */
    ...
    /**
     * URL template for a single historic process instance:
     * <i>history/historic-process-instances/{0:processInstanceId}</i>
     */
    ...
    /**
     * URL template for historic process instance query:
     * <i>history/historic-process-instances</i>
     */
    ...
    /**
     * URL template for historic process instance identity links:
     * <i>history/historic
     * -process-instances/{0:processInstanceId}/identitylinks</i>
     */
    ...
    /**
     * URL template for a single historic task instance:
     * <i>history/historic-process
     * -instances/{0:processInstanceId}/variables/{1:variableName}</i>
     */
    ...
    /**
     * URL template for a single historic task instance:
     * <i>history/historic-task-instances/{0:taskId}</i>
     */
    ...
    /**
     * URL template for historic task instance query:
     * <i>history/historic-task-instances</i>
     */
    public static final String[] URL_HISTORIC_TASK_INSTANCES = { SEGMENT_HISTORY_RESOURCES, SEGMENT_HISTORIC_TASK_INSTANCE_RESOURCE };

    /**
     * URL template for historic task instance identity links:
     * <i>history/historic-task-instances/{0:taskId}/identitylinks</i>
     */
    ...
    /**
     * URL template for a single historic task instance:
     * <i>history/historic-task
     * -instances/{0:taskId}/variables/{1:variableName}</i>
     */
    public static final String[] URL_HISTORIC_TASK_INSTANCE_VARIABLE_DATA = { SEGMENT_HISTORY_RESOURCES, SEGMENT_HISTORIC_TASK_INSTANCE_RESOURCE, "{0}", SEGMENT_VARIABLES, "{1}",
            SEGMENT_VARIABLE_DATA };

    /**
     * URL template for historic activity instance query:
     * <i>history/historic-activity-instances</i>
     */
    ...
    /**
     * URL template for historic variable instance query:
     * <i>history/historic-variable-instances</i>
     */
    ...
    /**
     * URL template for a single historic variable instance data:
     * <i>history/historic-variable-instances/{0:varInstanceId}/data</i>
     */
    ...
    /**
     * URL template for a single historic detail variable data:
     * <i>history/historic-detail/{0:detailId}/data</i>
     */
    ...
    /**
     * URL template for historic process instance query:
     * <i>query/historic-process-instances</i>
     */
    ...
    /**
     * URL template for historic process instance query:
     * <i>query/historic-task-instances</i>
     */
    ...
    /**
     * URL template for historic activity instance query:
     * <i>query/historic-activity-instances</i>
     */
    ...
    /**
     * URL template for historic variable instance query:
     * <i>query/historic-variable-instances</i>
     */
    ...
    /**
     * URL template for column-metadata for a single table:
     * <i>management/tables/{0:tableName}/columns</i>
     */
    public static final String[] URL_TABLE_COLUMNS = { SEGMENT_MANAGEMENT_RESOURCES, SEGMENT_TABLES, "{0}", SEGMENT_COLUMNS };

    /**
     * URL template for actual table row data:
     * <i>management/tables/{0:tableName}/data</i>
     */
    ...
    /**
     * URL template for the stacktrace of a single job:
     * <i>management/jobs/{0:jobId}/exception-stacktrace</i>
     */
    ...
    /**
     * URL template for the collection of properties:
     * <i>management/properties</i>
     */
    ...
    /**
     * URL template for the picture for a single user:
     * <i>identity/users/{0:userId}/picture</i>
     */
    public static final String[] URL_USER_PICTURE = { SEGMENT_IDENTITY_RESOURCES, SEGMENT_USERS, "{0}", SEGMENT_PICTURE };

    /**
     * URL template for an info entry for a single user:
     * <i>identity/users/{0:userId}/info/{1:key}</i>
     */
    public static final String[] URL_USER_INFO = { SEGMENT_IDENTITY_RESOURCES, SEGMENT_USERS, "{0}", SEGMENT_INFO, "{1}" };

    /**
     * URL template for the info collection for a single user:
     * <i>identity/users/{0:userId}/info</i>
     */
    ...
    /**
     * URL template for the membership-collection of a group:
     * <i>identity/groups/{0:groupId}/members</i>
     */
    public static final String[] URL_GROUP_MEMBERSHIP_COLLECTION = { SEGMENT_IDENTITY_RESOURCES, SEGMENT_GROUPS, "{0}", SEGMENT_MEMBERS };

    /**
     * URL template for the membership-collection of a single group membership:
     * <i>identity/groups/{0:groupId}/members/{1:userId}</i>
     */
    ...
    /**
     * Creates an url based on the passed fragments and replaces any
     * placeholders with the given arguments. The placeholders are folowing the
     * {@link MessageFormat} convention (eg. {0} is replaced by first argument
     * value).
     */
