 ...
 * 
 * An instance can be created by using {@link #fromRequest(HttpServletRequest)}
 * and {@link #fromCurrentRequest()} which extracts the base URL from the
 * request or by specifying the base URL through {@link #usingBaseUrl(String)}
 * 
 * {@link #buildUrl(String[], Object...)} can be called several times to build
 * URLs based on the base URL
 * 
