...
public class HistoricProcessInstanceCommentResourceTest extends BaseSpringRestTestCase {
    ...
    /**
     * Test getting all comments for a historic process instance. GET
    ...
    /**
     * Test creating a comment for a process instance. POST
     * history/historic-process-instances/{processInstanceId}/comments
     */
    @Deployment(resources = { "org/activiti/rest/service/api/repository/oneTaskProcess.bpmn20.xml" })
    ...
    /**
     * Test getting a comment for a historic process instance. GET
     * history/historic
    ...
    public void testGetComment() throws Exception {
        ...
        try {
            ...
            CloseableHttpResponse response = executeRequest(
                    new HttpGet(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_HISTORIC_PROCESS_INSTANCE_COMMENT, pi.getId(), comment.getId())), 200);
    ...
    /**
     * Test deleting a comment for a task. DELETE
