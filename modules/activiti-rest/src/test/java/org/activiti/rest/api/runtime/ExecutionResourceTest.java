...
public class ExecutionResourceTest extends BaseRestTestCase {
   ...
   */
  @Deployment(resources = {"org/activiti/rest/api/runtime/ExecutionResourceTest.process-with-subprocess.bpmn20.xml"})
   ...
   */
  @Deployment(resources = {"org/activiti/rest/api/runtime/ExecutionResourceTest.process-with-signal.bpmn20.xml"})
   ...
   * Test signalling a single execution, without signal name.
   */
  @Deployment(resources = {"org/activiti/rest/api/runtime/ExecutionResourceTest.process-with-signal-event.bpmn20.xml"})
   ...
   */
  @Deployment(resources = {"org/activiti/rest/api/runtime/ExecutionResourceTest.process-with-message-event.bpmn20.xml"})
