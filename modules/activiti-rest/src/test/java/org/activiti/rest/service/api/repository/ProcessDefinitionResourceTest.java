...
public class ProcessDefinitionResourceTest extends BaseSpringRestTestCase {
    ...
    /**
     * Test getting a single process definition. GET
     * repository/process-definitions/{processDefinitionResource}
     */
    ...
    /**
     * Test getting a single process definition with a graphical notation
     * defined. GET repository/process-definitions/{processDefinitionResource}
     */
    @Deployment
    ...
    /**
     * Test getting an unexisting process-definition. GET
    ...
    /**
     * Test suspending a process definition. POST
     * repository/process-definitions/{processDefinitionId}
     */
    @Deployment(resources = { "org/activiti/rest/service/api/repository/oneTaskProcess.bpmn20.xml" })
    ...
    /**
     * Test suspending a process definition on a certain date. POST
     * repository/process-definitions/{processDefinitionId}
     */
    @Deployment(resources = { "org/activiti/rest/service/api/repository/oneTaskProcess.bpmn20.xml" })
    ...
    /**
     * Test suspending already suspended process definition. POST
     * repository/process-definitions/{processDefinitionId}
     */
    @Deployment(resources = { "org/activiti/rest/service/api/repository/oneTaskProcess.bpmn20.xml" })
    ...
    /**
     * Test activating a suspended process definition. POST
     * repository/process-definitions/{processDefinitionId}
     */
    @Deployment(resources = { "org/activiti/rest/service/api/repository/oneTaskProcess.bpmn20.xml" })
    ...
    /**
     * Test activating a suspended process definition delayed. POST
     * repository/process-definitions/{processDefinitionId}
     */
    @Deployment(resources = { "org/activiti/rest/service/api/repository/oneTaskProcess.bpmn20.xml" })
    ...
    /**
     * Test activating already active process definition. POST
     * repository/process-definitions/{processDefinitionId}
     */
    @Deployment(resources = { "org/activiti/rest/service/api/repository/oneTaskProcess.bpmn20.xml" })
