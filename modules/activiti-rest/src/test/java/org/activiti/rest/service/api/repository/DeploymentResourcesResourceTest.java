...
/**
 * Test for all REST-operations related to listing the resources that are part
 * of a deployment.
 * 
...
public class DeploymentResourcesResourceTest extends BaseSpringRestTestCase {
    ...
    /**
     * Test getting all resources for a single deployment. GET
     * repository/deployments/{deploymentId}/resources
     */
    public void testGetDeploymentResources() throws Exception {

        try {
            Deployment deployment = repositoryService.createDeployment().name("Deployment 1").addClasspathResource("org/activiti/rest/service/api/repository/oneTaskProcess.bpmn20.xml")
    ...
    /**
     * Test getting all resources for a single unexisting deployment. GET
     * repository/deployments/{deploymentId}/resources
     */
