  ...
  public void testGetProcessDefinitions() throws Exception {
    ...
    try {
      ...
      Deployment secondDeployment = repositoryService.createDeployment().name("Deployment 2")
              .addClasspathResource("org/activiti/rest/api/repository/oneTaskProcess.bpmn20.xml")
              .addClasspathResource("org/activiti/rest/api/repository/twoTaskProcess.bpmn20.xml")
              .deploy();
      ...
      url = baseUrl + "?resourceName=org/activiti/rest/api/repository/twoTaskProcess.bpmn20.xml";
      assertResultsPresentInDataResponse(url, twoTaskprocess.getId());
