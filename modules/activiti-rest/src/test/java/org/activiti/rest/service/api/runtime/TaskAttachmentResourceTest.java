...
public class TaskAttachmentResourceTest extends BaseSpringRestTestCase {
    ...
    /**
     * Test getting all attachments for a task. GET
    ...
    public void testGetAttachments() throws Exception {
        try {
            ...
            CloseableHttpResponse response = executeRequest(new HttpGet(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_ATTACHMENT_COLLECTION, task.getId())),
                    HttpStatus.SC_OK);
    ...
    /**
     * Test getting a single attachments for a task. GET
    ...
    /**
     * Test getting a single attachments for a task, using unexisting task and
     * unexisting attachment. GET
     * runtime/tasks/{taskId}/attachments/{attachmentId}
     */
    public void testGetAttachmentUnexistingTaskAndAttachment() throws Exception {
        try {
            ...
            closeResponse(executeRequest(new HttpGet(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_ATTACHMENT, "unexistingtask", urlAttachment.getId())),
                    HttpStatus.SC_NOT_FOUND));

            // Get attachment for task attachment
            closeResponse(executeRequest(new HttpGet(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_ATTACHMENT, task.getId(), "unexistingattachment")),
                    HttpStatus.SC_NOT_FOUND));
    ...
    /**
     * Test getting the content for a single attachments for a task. GET
    ...
    public void testGetAttachmentContent() throws Exception {
        try {
            ...
            CloseableHttpResponse response = executeRequest(
                    new HttpGet(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_ATTACHMENT_DATA, task.getId(), binaryAttachment.getId())), HttpStatus.SC_OK);
    ...
    /**
     * Test getting the content for a single attachments for a task, with a
     * mime-type set. GET
     * runtime/tasks/{taskId}/attachments/{attachmentId}/content
     */
    ...
    /**
     * Test getting the content for a single attachments for a task, for an
     * attachment without content. GET
     * runtime/tasks/{taskId}/attachments/{attachmentId}/content
     */
    public void testGetAttachmentContentWithoutContent() throws Exception {
        try {
            ...
            closeResponse(executeRequest(new HttpGet(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_ATTACHMENT_DATA, task.getId(), urlAttachment.getId())),
                    HttpStatus.SC_NOT_FOUND));
    ...
    /**
     * Test creating a single attachments for a task POST
     * runtime/tasks/{taskId}/attachments/{attachmentId}
     */
    ...
    /**
     * Test creating a single attachments for a task, using multipart-request to
     * supply content POST runtime/tasks/{taskId}/attachments/{attachmentId}
     */
    ...
    /**
     * Test creating a single attachments for a task, without a name POST
     * runtime/tasks/{taskId}/attachments/{attachmentId}
     */
    ...
    /**
     * Test deleting a single attachments for a task DELETE
     * runtime/tasks/{taskId}/attachments/{attachmentId}
     */
