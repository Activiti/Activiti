...
public class TaskVariablesCollectionResourceTest extends BaseSpringRestTestCase {
    ...
    /**
     * Test creating a single task variable. POST
    ...
    /**
     * Test creating a single task variable using a binary stream. POST
     * runtime/tasks/{taskId}/variables
     */
    ...
    /**
     * Test creating a single task variable, testing edge case exceptions. POST
     * runtime/tasks/{taskId}/variables
     */
    ...
    /**
     * Test creating a multipe task variable in a single call. POST
     * runtime/tasks/{taskId}/variables
     */
    ...
    /**
     * Test deleting all local task variables. DELETE
     * runtime/tasks/{taskId}/variables
     */
    @Deployment
