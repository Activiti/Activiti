...
public class TaskVariableResourceTest extends BaseSpringRestTestCase {
    ...
    public void testGetTaskVariable() throws Exception {
        try {
            ...
            // Unexisting variable
            closeResponse(executeRequest(new HttpGet(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_VARIABLE, processTask.getId(), "unexistingVariable")),
    ...
    public void testGetTaskVariableDataForIllegalVariables() throws Exception {
        try {
            ...
            closeResponse(executeRequest(new HttpGet(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_VARIABLE_DATA, task.getId(), "localTaskVariable")),
                    HttpStatus.SC_NOT_FOUND));

            // Try getting data for unexisting property
            closeResponse(executeRequest(new HttpGet(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_TASK_VARIABLE_DATA, task.getId(), "unexistingVariable")),
                    HttpStatus.SC_NOT_FOUND));
    ...
    /**
     * Test deleting a single task variable in all scopes, including "not found"
     * check.
     * 
    ...
    /**
     * Test updating a single task variable in all scopes, including "not found"
     * check.
     * 
