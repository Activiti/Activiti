...
public class TaskResourceTest extends BaseSpringRestTestCase {
    ...
    /**
     * Test getting a single task, spawned by a process. GET
    ...
    /**
     * Test getting a single task, created using the API. GET
     * runtime/tasks/{taskId}
     */
    ...
    /**
     * Test updating a single task without passing in any value, no values
     * should be altered. PUT runtime/tasks/{taskId}
     */
    ...
    /**
     * Test updating a task that is part of a process. PUT
     * runtime/tasks/{taskId}
     */
    @Deployment
    ...
    /**
     * Test claiming a single task and all exceptional cases related to
     * claiming. POST runtime/tasks/{taskId}
     */
    ...
    /**
     * Test delegating a single task and all exceptional cases related to
     * delegation. POST runtime/tasks/{taskId}
     */
    ...
    /**
     * Test resolving a single task and all exceptional cases related to
     * resolution. POST runtime/tasks/{taskId}
     */
    ...
    /**
     * Test executing an invalid action on a single task. POST
     * runtime/tasks/{taskId}
     */
