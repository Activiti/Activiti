...
/**
 * Test for all REST-operations related to a resources that is part of a
 * deployment.
 * 
...
public class DeploymentResourceResourceTest extends BaseSpringRestTestCase {
    ...
    /**
     * Test getting a single resource, deployed in a deployment. GET
    ...
    /**
     * Test getting a single resource for an unexisting deployment. GET
     * repository/deployments/{deploymentId}/resources/{resourceId}
     */
    ...
    /**
     * Test getting an unexisting resource for an existing deployment. GET
     * repository/deployments/{deploymentId}/resources/{resourceId}
     */
    ...
    /**
     * Test getting a deployment resource content. GET
     * repository/deployments/{deploymentId}/resources/{resourceId}
     */
