...
public class ProcessDefinitionCollectionResourceTest extends BaseSpringRestTestCase {
    ...
    public void testGetProcessDefinitions() throws Exception {
        ...
        try {
            ...
            Deployment thirdDeployment = repositoryService.createDeployment().name("Deployment 3").addClasspathResource("org/activiti/rest/service/api/repository/oneTaskProcessWithDi.bpmn20.xml")
                    .deploy();
