...
public class ProcessInstanceVariablesCollectionResourceTest extends BaseSpringRestTestCase {
    ...
    /**
     * Test getting all process variables. GET
    ...
    public void testGetProcessVariables() throws Exception {
        ...
        CloseableHttpResponse response = executeRequest(
                new HttpGet(SERVER_URL_PREFIX + RestUrls.createRelativeResourceUrl(RestUrls.URL_PROCESS_INSTANCE_VARIABLE_COLLECTION, processInstance.getId())), HttpStatus.SC_OK);
    ...
    /**
     * Test creating a single process variable. POST
     * runtime/process-instance/{processInstanceId}/variables
     */
    @Deployment(resources = { "org/activiti/rest/service/api/runtime/ProcessInstanceVariablesCollectionResourceTest.testProcess.bpmn20.xml" })
    ...
    /**
     * Test creating a single process variable using a binary stream. POST
     * runtime/process-instances/{processInstanceId}/variables
     */
    @Deployment(resources = { "org/activiti/rest/service/api/runtime/ProcessInstanceVariablesCollectionResourceTest.testProcess.bpmn20.xml" })
    ...
    /**
     * Test creating a single process variable using a binary stream containing
     * a serializable. POST
     * runtime/process-instances/{processInstanceId}/variables
     */
    @Deployment(resources = { "org/activiti/rest/service/api/runtime/ProcessInstanceVariablesCollectionResourceTest.testProcess.bpmn20.xml" })
    ...
    /**
     * Test creating a single process variable, testing default types when
     * omitted. POST runtime/process-instances/{processInstanceId}/variables
     */
    @Deployment(resources = { "org/activiti/rest/service/api/runtime/ProcessInstanceVariablesCollectionResourceTest.testProcess.bpmn20.xml" })
    ...
    /**
     * Test creating multiple process variables in a single call. POST
     * runtime/process-instance/{processInstanceId}/variables
     */
    @Deployment(resources = { "org/activiti/rest/service/api/runtime/ProcessInstanceVariablesCollectionResourceTest.testProcess.bpmn20.xml" })
    ...
    /**
     * Test creating multiple process variables in a single call. POST
     * runtime/process-instance/{processInstanceId}/variables?override=true
     */
    @Deployment(resources = { "org/activiti/rest/service/api/runtime/ProcessInstanceVariablesCollectionResourceTest.testProcess.bpmn20.xml" })
    ...
    /**
     * Test deleting all process variables. DELETE
     * runtime/process-instance/{processInstanceId}/variables
     */
    @Deployment(resources = { "org/activiti/rest/service/api/runtime/ProcessInstanceVariablesCollectionResourceTest.testProcess.bpmn20.xml" })
