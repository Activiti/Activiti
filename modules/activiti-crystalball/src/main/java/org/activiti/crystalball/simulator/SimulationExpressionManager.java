...
/**
 * {@link org.activiti.engine.impl.el.ExpressionManager} that exposes the full application-context or a limited set
...
public class SimulationExpressionManager extends ExpressionManager {
   ...
   */
  public SimulationExpressionManager(ApplicationContext applicationContext, Map<Object, Object> beans) {
    super(beans);
