...
CREATE TABLE ACT_ID_INFO (ID_ VARCHAR(64) NOT NULL, REV_ integer, USER_ID_ VARCHAR(64), TYPE_ VARCHAR(64), KEY_ VARCHAR(255), VALUE_ VARCHAR(255), PASSWORD_ BYTEA, PARENT_ID_ VARCHAR(255), CONSTRAINT PK_ACT_ID_INFO PRIMARY KEY (ID_));
