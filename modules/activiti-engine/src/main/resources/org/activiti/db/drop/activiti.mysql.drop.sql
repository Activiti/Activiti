...
alter table ACT_GE_BYTEARRAY 
    drop FOREIGN KEY FK_ACT_BYTEARR_DEPL;

alter table ACT_RU_EXECUTION
    drop FOREIGN KEY FK_ACT_EXE_PROCINST;

alter table ACT_RU_EXECUTION 
    drop FOREIGN KEY FK_ACT_EXE_PARENT;

alter table ACT_RU_EXECUTION 
    drop FOREIGN KEY FK_ACT_EXE_SUPER;
    
alter table ACT_ID_MEMBERSHIP 
    drop FOREIGN KEY FK_ACT_MEMB_GROUP;
    
alter table ACT_ID_MEMBERSHIP 
    drop FOREIGN KEY FK_ACT_MEMB_USER;
    
alter table ACT_RU_IDENTITYLINK
    drop FOREIGN KEY FK_ACT_TSKASS_TASK;

alter table ACT_RU_TASK
	drop FOREIGN KEY FK_ACT_TASK_EXE;

alter table ACT_RU_TASK
	drop FOREIGN KEY FK_ACT_TASK_PROCINST;
	
alter table ACT_RU_TASK
	drop FOREIGN KEY FK_ACT_TASK_PROCDEF;
    
alter table ACT_RU_VARIABLE
    drop FOREIGN KEY FK_ACT_VAR_EXE;
    
alter table ACT_RU_VARIABLE
	drop FOREIGN KEY FK_ACT_VAR_PROCINST;    

alter table ACT_RU_VARIABLE
    drop FOREIGN KEY FK_ACT_VAR_BYTEARRAY;

alter table ACT_RU_JOB
    drop FOREIGN KEY FK_ACT_JOB_EXCEPTION;
