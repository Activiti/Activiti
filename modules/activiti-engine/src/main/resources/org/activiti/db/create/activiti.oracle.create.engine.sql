...
CREATE TABLE ACT_GE_PROPERTY (NAME_ NVARCHAR2(64) NOT NULL, VALUE_ NVARCHAR2(300), REV_ NUMBER(10), CONSTRAINT PK_ACT_GE_PROPERTY PRIMARY KEY (NAME_));
...
CREATE TABLE ACT_GE_BYTEARRAY (ID_ NVARCHAR2(64) NOT NULL, REV_ NUMBER(10), NAME_ NVARCHAR2(255), DEPLOYMENT_ID_ NVARCHAR2(64), BYTES_ BLOB, CONSTRAINT PK_ACT_GE_BYTEARRAY PRIMARY KEY (ID_));


-- Changeset liquibase/activiti-engine-5.7.xml::3 ACT_RE_DEPLOYMENT::trademakers::(Checksum: 3:c020dd7872af2758628adbbee6e7614e)
CREATE TABLE ACT_RE_DEPLOYMENT (ID_ NVARCHAR2(64) NOT NULL, NAME_ NVARCHAR2(255), DEPLOY_TIME_ TIMESTAMP(6), CONSTRAINT PK_ACT_RE_DEPLOYMENT PRIMARY KEY (ID_));


-- Changeset liquibase/activiti-engine-5.7.xml::4 ACT_RU_EXECUTION::trademakers::(Checksum: 3:3b7208c3652b5badc6306505212e4be3)
CREATE TABLE ACT_RU_EXECUTION (ID_ NVARCHAR2(64) NOT NULL, REV_ NUMBER(10), PROC_INST_ID_ NVARCHAR2(64), BUSINESS_KEY_ NVARCHAR2(255), PARENT_ID_ NVARCHAR2(64), PROC_DEF_ID_ NVARCHAR2(64), SUPER_EXEC_ NVARCHAR2(64), ACT_ID_ NVARCHAR2(255), IS_ACTIVE_ NUMBER(1,0), IS_CONCURRENT_ NUMBER(1,0), IS_SCOPE_ NUMBER(1,0), CONSTRAINT PK_ACT_RU_EXECUTION PRIMARY KEY (ID_));
...
-- Changeset liquibase/activiti-engine-5.7.xml::4.1.3 ACT_UNIQ_RU_BUS_KEY Oracle::trademakers::(Checksum: 3:f394dd138f0af0bdf3bdc1bc59db9f68)
...
CREATE TABLE ACT_RU_JOB (ID_ NVARCHAR2(64) NOT NULL, REV_ NUMBER(10), TYPE_ NVARCHAR2(255) NOT NULL, LOCK_EXP_TIME_ TIMESTAMP(6), LOCK_OWNER_ NVARCHAR2(255), EXCLUSIVE_ NUMBER(1,0), EXECUTION_ID_ NVARCHAR2(64), PROCESS_INSTANCE_ID_ NVARCHAR2(64), RETRIES_ NUMBER(10), EXCEPTION_STACK_ID_ NVARCHAR2(64), EXCEPTION_MSG_ NVARCHAR2(2000), DUEDATE_ TIMESTAMP(6), REPEAT_ NVARCHAR2(255), HANDLER_TYPE_ NVARCHAR2(255), HANDLER_CFG_ NVARCHAR2(2000), CONSTRAINT PK_ACT_RU_JOB PRIMARY KEY (ID_));


-- Changeset liquibase/activiti-engine-5.7.xml::9 ACT_RE_PROCDEF::trademakers::(Checksum: 3:bfb18fac10e7be4a526c2c60e3e9d5ce)
CREATE TABLE ACT_RE_PROCDEF (ID_ NVARCHAR2(64) NOT NULL, CATEGORY_ NVARCHAR2(255), NAME_ NVARCHAR2(255), KEY_ NVARCHAR2(255), VERSION_ NUMBER(10), DEPLOYMENT_ID_ NVARCHAR2(64), RESOURCE_NAME_ NVARCHAR2(2000), DGRM_RESOURCE_NAME_ NVARCHAR2(2000), HAS_START_FORM_KEY_ NUMBER(1,0), CONSTRAINT PK_ACT_RE_PROCDEF PRIMARY KEY (ID_));


-- Changeset liquibase/activiti-engine-5.7.xml::10 ACT_RU_TASK::trademakers::(Checksum: 3:e3259896b8b1742627cfac858bfe3f27)
CREATE TABLE ACT_RU_TASK (ID_ NVARCHAR2(64) NOT NULL, REV_ NUMBER(10), EXECUTION_ID_ NVARCHAR2(64), PROC_INST_ID_ NVARCHAR2(64), PROC_DEF_ID_ NVARCHAR2(64), NAME_ NVARCHAR2(255), DESCRIPTION_ NVARCHAR2(2000), TASK_DEF_KEY_ NVARCHAR2(255), ASSIGNEE_ NVARCHAR2(64), PRIORITY_ NUMBER(10), CREATE_TIME_ TIMESTAMP(6), OWNER_ NVARCHAR2(64), DELEGATION_ NVARCHAR2(64), DUE_DATE_ TIMESTAMP(6), PARENT_TASK_ID_ NVARCHAR2(64), CONSTRAINT PK_ACT_RU_TASK PRIMARY KEY (ID_));
...
CREATE TABLE ACT_RU_IDENTITYLINK (ID_ NVARCHAR2(64) NOT NULL, REV_ NUMBER(10), GROUP_ID_ NVARCHAR2(64), TYPE_ NVARCHAR2(255), USER_ID_ NVARCHAR2(64), TASK_ID_ NVARCHAR2(64), CONSTRAINT PK_ACT_RU_IDENTITYLINK PRIMARY KEY (ID_));


-- Changeset liquibase/activiti-engine-5.7.xml::12 ACT_RU_VARIABLE::trademakers::(Checksum: 3:d199f15a8bc8201ae0291e648b7092c1)
CREATE TABLE ACT_RU_VARIABLE (ID_ NVARCHAR2(64) NOT NULL, REV_ NUMBER(10), TYPE_ NVARCHAR2(255) NOT NULL, NAME_ NVARCHAR2(255) NOT NULL, EXECUTION_ID_ NVARCHAR2(64), PROC_INST_ID_ NVARCHAR2(64), TASK_ID_ NVARCHAR2(64), BYTEARRAY_ID_ NVARCHAR2(64), DOUBLE_ BINARY_DOUBLE, LONG_ NUMBER(19), TEXT_ NVARCHAR2(2000), TEXT2_ NVARCHAR2(2000), CONSTRAINT PK_ACT_RU_VARIABLE PRIMARY KEY (ID_));
...
ALTER TABLE ACT_GE_BYTEARRAY ADD GENERATED_ NUMBER(1,0);
...
ALTER TABLE ACT_RU_EXECUTION ADD IS_EVENT_SCOPE_ NUMBER(1,0);

ALTER TABLE ACT_RU_EXECUTION ADD SUSPENSION_STATE_ NUMBER(10);
...
ALTER TABLE ACT_RE_PROCDEF ADD REV_ NUMBER(10);

ALTER TABLE ACT_RE_PROCDEF ADD SUSPENSION_STATE_ NUMBER(10);
...
CREATE TABLE ACT_RU_EVENT_SUBSCR (ID_ NVARCHAR2(64) NOT NULL, REV_ NUMBER(10), EVENT_TYPE_ NVARCHAR2(255) NOT NULL, EVENT_NAME_ NVARCHAR2(255), EXECUTION_ID_ NVARCHAR2(64), PROC_INST_ID_ NVARCHAR2(64), ACTIVITY_ID_ NVARCHAR2(64), CONFIGURATION_ NVARCHAR2(255), CREATED_ TIMESTAMP(6) NOT NULL, CONSTRAINT PK_ACT_RU_EVENT_SUBSCR PRIMARY KEY (ID_));
...
ALTER TABLE ACT_RU_EXECUTION ADD CACHED_ENT_STATE_ NUMBER(10);
...
ALTER TABLE ACT_RU_IDENTITYLINK ADD PROC_DEF_ID_ NVARCHAR2(64);
...
ALTER TABLE ACT_RE_PROCDEF MODIFY KEY_ NOT NULL;
...
ALTER TABLE ACT_RE_DEPLOYMENT ADD CATEGORY_ NVARCHAR2(255);
...
CREATE TABLE ACT_RE_MODEL (ID_ NVARCHAR2(64) NOT NULL, REV_ NUMBER(10), NAME_ NVARCHAR2(255), KEY_ NVARCHAR2(255), CATEGORY_ NVARCHAR2(255), CREATE_TIME_ TIMESTAMP(6), LAST_UPDATE_TIME_ TIMESTAMP(6), VERSION_ NUMBER(10), META_INFO_ NVARCHAR2(2000), DEPLOYMENT_ID_ NVARCHAR2(64), EDITOR_SOURCE_VALUE_ID_ NVARCHAR2(64), EDITOR_SOURCE_EXTRA_VALUE_ID_ NVARCHAR2(64), CONSTRAINT PK_ACT_RE_MODEL PRIMARY KEY (ID_));
...
ALTER TABLE ACT_RU_JOB ADD PROC_DEF_ID_ NVARCHAR2(64);
...
ALTER TABLE ACT_RE_PROCDEF ADD DESCRIPTION_ NVARCHAR2(2000);

ALTER TABLE ACT_RE_PROCDEF MODIFY VERSION_ NOT NULL;
...
ALTER TABLE ACT_RU_TASK ADD SUSPENSION_STATE_ NUMBER(10);

UPDATE ACT_RU_TASK SET SUSPENSION_STATE_ = '1';

ALTER TABLE ACT_RU_TASK MODIFY OWNER_ NVARCHAR2(255);

ALTER TABLE ACT_RU_TASK MODIFY ASSIGNEE_ NVARCHAR2(255);
...
ALTER TABLE ACT_RU_IDENTITYLINK MODIFY GROUP_ID_ NVARCHAR2(255);

ALTER TABLE ACT_RU_IDENTITYLINK MODIFY USER_ID_ NVARCHAR2(255);
