...
drop index ACT_IDX_JOB_PROCESS_INSTANCE_ID;
drop index ACT_IDX_JOB_PROC_DEF_ID;
drop index ACT_IDX_JOB_EXCEPTION;
drop index ACT_IDX_TIMER_JOB_EXECUTION_ID;
drop index ACT_IDX_TIMER_JOB_PROCESS_INSTANCE_ID;
drop index ACT_IDX_TIMER_JOB_PROC_DEF_ID;
drop index ACT_IDX_TIMER_JOB_EXCEPTION;    
drop index ACT_IDX_SUSPENDED_JOB_EXECUTION_ID;    
drop index ACT_IDX_SUSPENDED_JOB_PROCESS_INSTANCE_ID;    
drop index ACT_IDX_SUSPENDED_JOB_PROC_DEF_ID;    
drop index ACT_IDX_SUSPENDED_JOB_EXCEPTION;    
drop index ACT_IDX_DEADLETTER_JOB_EXECUTION_ID;      
drop index ACT_IDX_DEADLETTER_JOB_PROCESS_INSTANCE_ID;        
drop index ACT_IDX_DEADLETTER_JOB_PROC_DEF_ID;    
drop index ACT_IDX_DEADLETTER_JOB_EXCEPTION;
