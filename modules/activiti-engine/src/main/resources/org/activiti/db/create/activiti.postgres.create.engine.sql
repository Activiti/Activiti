...
CREATE TABLE ACT_GE_BYTEARRAY (ID_ VARCHAR(64) NOT NULL, REV_ integer, NAME_ VARCHAR(255), DEPLOYMENT_ID_ VARCHAR(64), BYTES_ BYTEA, CONSTRAINT PK_ACT_GE_BYTEARRAY PRIMARY KEY (ID_));
...
CREATE TABLE ACT_RU_JOB (ID_ VARCHAR(64) NOT NULL, REV_ integer, TYPE_ VARCHAR(255) NOT NULL, LOCK_EXP_TIME_ TIMESTAMP, LOCK_OWNER_ VARCHAR(255), EXCLUSIVE_ BOOLEAN, EXECUTION_ID_ VARCHAR(64), PROCESS_INSTANCE_ID_ VARCHAR(64), RETRIES_ integer, EXCEPTION_STACK_ID_ VARCHAR(64), EXCEPTION_MSG_ VARCHAR(4000), DUEDATE_ TIMESTAMP, REPEAT_ VARCHAR(255), HANDLER_TYPE_ VARCHAR(255), HANDLER_CFG_ VARCHAR(4000), CONSTRAINT PK_ACT_RU_JOB PRIMARY KEY (ID_));


-- Changeset liquibase/activiti-engine-5.7.xml::9 ACT_RE_PROCDEF::trademakers::(Checksum: 3:bfb18fac10e7be4a526c2c60e3e9d5ce)
CREATE TABLE ACT_RE_PROCDEF (ID_ VARCHAR(64) NOT NULL, CATEGORY_ VARCHAR(255), NAME_ VARCHAR(255), KEY_ VARCHAR(255), VERSION_ integer, DEPLOYMENT_ID_ VARCHAR(64), RESOURCE_NAME_ VARCHAR(4000), DGRM_RESOURCE_NAME_ VARCHAR(4000), HAS_START_FORM_KEY_ BOOLEAN, CONSTRAINT PK_ACT_RE_PROCDEF PRIMARY KEY (ID_));
...
ALTER TABLE ACT_GE_BYTEARRAY ADD GENERATED_ BOOLEAN;
...
ALTER TABLE ACT_RU_EXECUTION ADD IS_EVENT_SCOPE_ BOOLEAN;
...
ALTER TABLE ACT_RE_PROCDEF ALTER COLUMN  KEY_ SET NOT NULL;
...
ALTER TABLE ACT_RE_PROCDEF ALTER COLUMN  VERSION_ SET NOT NULL;
