...
public abstract class CmdVoid implements Cmd<Void> {
  ...
  protected PersistenceSession getPersistenceSession(TransactionContext transactionContext) {
    return transactionContext.getTransactionalObject(PersistenceSession.class);
  }
