...
/**
 * Defines property resolution behavior on arrays. This resolver handles base
 * objects that are Java language arrays. It accepts any object as a property
 * and coerces that object into an integer index into the array. The resulting
 * value is the value in the array at that index. This resolver can be
...
public class ArrayELResolver extends ELResolver {
    ...
    /**
     * Creates a new ArrayELResolver whose read-only status is determined by the
     * given parameter.
     * 
     * @param readOnly
     ...
     * type that this resolver accepts for the property argument. Otherwise,
     * returns null. Assuming the base is an array, this method will always
     * return Integer.class. This is because arrays accept integers for their
     * index.
     * 
     * @param context
     *            The context of this evaluation.
     * @param base
     *            The array to analyze. Only bases that are a Java language
     *            array are handled by this resolver.
     * @return null if base is not a Java language array; otherwise
     *         Integer.class.
     */
    @Override
     ...
     * of all integers. The getCommonPropertyType(ELContext, Object)8 method
     * returns sufficient information about what properties this resolver
     * accepts.
     * 
     * @param context
     *            The context of this evaluation.
     ...
     * for a value in this array. If the base is a array, the propertyResolved
     ...
     * called, the caller should ignore the return value. Assuming the base is
     * an array, this method will always return
     * base.getClass().getComponentType(), which is the most general type of
     * component that can be stored at any given index in the array.
     * 
     * @param context
     *            The context of this evaluation.
     * @param base
     ...
     * given index. The index is specified by the property argument, and coerced
     * into an integer. If the coercion could not be performed, an
     * IllegalArgumentException is thrown. If the index is out of bounds, null
     * is returned. If the base is a Java language array, the propertyResolved
     * property of the ELContext object must be set to true by this resolver,
     * before returning. If this property is not true after this method is
     ...
     * the base is a Java language array, the propertyResolved property of the
     ...
     * should ignore the return value. If this resolver was constructed in
     * read-only mode, this method will always return true. Otherwise, it
     * returns false.
     * 
     * @param context
     *            The context of this evaluation.
    ...
    /**
     * If the base object is a Java language array, attempts to set the value at
     * the given index with the given value. The index is specified by the
     * property argument, and coerced into an integer. If the coercion could not
     * be performed, an IllegalArgumentException is thrown. If the index is out
     * of bounds, a PropertyNotFoundException is thrown. If the base is a Java
     * language array, the propertyResolved property of the ELContext object
     * must be set to true by this resolver, before returning. If this property
     * is not true after this method is called, the caller can safely assume no
     * value was set. If this resolver was constructed in read-only mode, this
     * method will always throw PropertyNotWritableException.
     * 
     * @param context
     *            The context of this evaluation.
     * @param base
     ...
     *             if the property could not be coerced into an integer, or if
     *             some aspect of the specified element prevents it from being
     *             added to this array.
     ...
     * @throws IllegalArgumentException
     *             if base property cannot be coerced to an integer or base is
     *             not an array.
     * @throws PropertyNotFoundException
