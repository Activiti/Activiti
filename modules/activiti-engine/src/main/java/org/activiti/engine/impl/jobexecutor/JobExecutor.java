...
public abstract class JobExecutor {
    ...
    /**
     * To avoid deadlocks, the default for this is one. This way, in a clustered
     * setup, multiple job executors can acquire jobs without creating a
     * deadlock due to fetching multiple jobs at once and trying to lock them
     * all at once.
     * 
    ...
    /**
     * Possibility to ensure everything is nicely initialized before starting
     * the threads
     */
    ...
    /**
     * Called when a new job was added by the process engine to which this job
     * executor belongs. This is a hint, that for example the acquiring needs to
     * start again when it would be sleeping.
     */
