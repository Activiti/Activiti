...
/**
 * Defines property resolution behavior on instances of java.util.List. This
 * resolver handles base objects of type java.util.List. It accepts any object
 * as a property and coerces that object into an integer index into the list.
 * The resulting value is the value in the list at that index. This resolver can
 * be constructed in read-only mode, which means that isReadOnly will always
 * return true and {@link #setValue(ELContext, Object, Object, Object)} will
 * always throw PropertyNotWritableException. ELResolvers are combined together
 * using {@link CompositeELResolver} s, to define rich semantics for evaluating
...
public class ListELResolver extends ELResolver {
    ...
    /**
     * Creates a new ListELResolver whose read-only status is determined by the
     * given parameter.
     * 
     * @param readOnly
     ...
     * Assuming the base is a List, this method will always return
     * Integer.class. This is because Lists accept integers as their index.
     * 
     * @param context
     *            The context of this evaluation.
     * @param base
     *            The list to analyze. Only bases of type List are handled by
     *            this resolver.
    ...
    /**
     * Always returns null, since there is no reason to iterate through set set
     * of all integers.
     * 
     * @param context
     *            The context of this evaluation.
     ...
     * for a value in this list. If the base is a List, the propertyResolved
     ...
     * called, the caller should ignore the return value. Assuming the base is a
     * List, this method will always return Object.class. This is because Lists
     ...
     *            this resolver.
     * @param property
     *            The index of the element in the list to return the acceptable
    ...
    /**
     * If the base object is a list, returns the value at the given index. The
     * index is specified by the property argument, and coerced into an integer.
     * If the coercion could not be performed, an IllegalArgumentException is
     * thrown. If the index is out of bounds, null is returned. If the base is a
     * List, the propertyResolved property of the ELContext object must be set
     * to true by this resolver, before returning. If this property is not true
     ...
     *            ignored by this resolver.
     * @return If the propertyResolved property of ELContext was set to true,
     *         then the value at the given index or null if the index was out of
     ...
     * the base is a List, the propertyResolved property of the ELContext object
     ...
     * method will always return true. If a List was created using
     * java.util.Collections.unmodifiableList(List), this method must return
     * true. Unfortunately, there is no Collections API method to detect this.
     * However, an implementation can create a prototype unmodifiable List and
    ...
    /**
     * If the base object is a list, attempts to set the value at the given
     * index with the given value. The index is specified by the property
     * argument, and coerced into an integer. If the coercion could not be
     * performed, an IllegalArgumentException is thrown. If the index is out of
     * bounds, a PropertyNotFoundException is thrown. If the base is a List, the
     ...
     * method is called, the caller can safely assume no value was set. If this
     ...
     * unmodifiable List and query its runtime type to see if it matches the
     ...
     *             set operation is not supported by the underlying list.
     * @throws IllegalArgumentException
     *             if the property could not be coerced into an integer.
     * @throws NullPointerException
     *             if context is null
     ...
     * @throws PropertyNotFoundException
     *             if base is not null and the computed index is out of bounds
     *             for base.
     */
