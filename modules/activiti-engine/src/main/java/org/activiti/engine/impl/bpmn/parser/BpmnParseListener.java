...
public interface BpmnParseListener {
  ...
  void parseMultiInstanceLoopCharacteristics(Element activityElement, Element multiInstanceLoopCharacteristicsElement, ActivityImpl activity, ActivityImpl nestedActivity);
