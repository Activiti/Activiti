...
//			        (IntermediateCatchEvent) bpmnParse.getCurrentFlowElement()) != null) {
...
//			}
	    	...
	    	boundaryEvent.setBehavior(bpmnParse.getActivityBehaviorFactory()
	    			.createBoundaryTimerEventActivityBehavior(boundaryEvent, timerEventDefinition, boundaryEvent.isCancelActivity()));
