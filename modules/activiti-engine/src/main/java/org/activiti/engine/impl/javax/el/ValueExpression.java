...
public abstract class ValueExpression extends Expression {
   ...
   * @param context
   *          the context of this evaluation
   * @return the <code>ValueReference</code> for this <code>ValueExpression</code>, or <code>null</code> if this <code>ValueExpression</code> is not a reference to a base (null or non-null) and a
   *         property. If the base is null, and the property is a EL variable, return the <code>ValueReference</code> for the <code>ValueExpression</code> associated with this EL variable.
   * 
   * @since 2.2
   */
