...
public final class TreeMethodExpression extends org.activiti.engine.impl.javax.el.MethodExpression {
    ...
    /**
     * Create a new method expression. The expression must be an lvalue
     * expression or literal text. The expected return type may be
     * <code>null</code>, meaning "don't care". If it is an lvalue expression,
     * the parameter types must not be <code>null</code>. If it is literal text,
     * the expected return type must not be <code>void</code>.
     * 
     * @param store
     ...
     * @param returnType
     *            the expected return type (may be <code>null</code>)
     * @param paramTypes
     *            the expected parameter types (must not be <code>null</code>
     *            for lvalues)
     */
     ...
     *            <code>base[property]</code>)
     * @param paramValues
     * @return method result or <code>null</code> if this is a literal text
     *         expression
     * @throws ELException
     *             if evaluation fails (e.g. suitable method not found)
     */
    ...
    /**
     * Answer <code>true</code> if this is a deferred expression (starting with
     * <code>#{</code>)
     */
