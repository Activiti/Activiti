  ...
  */
  ...
  protected void initSessionFactories() {
    if (sessionFactories == null) {
      ...
      addSessionFactory(new GenericManagerFactory(ModelEntityManagerImpl.class));
      addSessionFactory(new GenericManagerFactory(ExecutionEntityManagerImpl.class));
      addSessionFactory(new GenericManagerFactory(HistoricActivityInstanceEntityManagerImpl.class));
      addSessionFactory(new GenericManagerFactory(HistoricDetailEntityManagerImpl.class));
      addSessionFactory(new GenericManagerFactory(HistoricProcessInstanceEntityManagerImpl.class));
      addSessionFactory(new GenericManagerFactory(HistoricVariableInstanceEntityManagerImpl.class));
      addSessionFactory(new GenericManagerFactory(HistoricTaskInstanceEntityManagerImpl.class));
      addSessionFactory(new GenericManagerFactory(HistoricIdentityLinkEntityManagerImpl.class));
      addSessionFactory(new GenericManagerFactory(IdentityInfoEntityManagerImpl.class));
      addSessionFactory(new GenericManagerFactory(IdentityLinkEntityManagerImpl.class));
      addSessionFactory(new GenericManagerFactory(JobEntityManagerImpl.class));
      addSessionFactory(new GenericManagerFactory(ProcessDefinitionEntityManagerImpl.class));
      addSessionFactory(new GenericManagerFactory(PropertyEntityManagerImpl.class));
      addSessionFactory(new GenericManagerFactory(ResourceEntityManagerImpl.class));
