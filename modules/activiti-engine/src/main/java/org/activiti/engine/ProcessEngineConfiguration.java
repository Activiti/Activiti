...
public abstract class ProcessEngineConfiguration implements EngineServices {
  ...
  /**
   * In case the defined databaseTablePrefix is a schema-name, instead of an actual table name
   * prefix. This is relevant for checking if Activiti-tables exists - since the schema is taken into account
   * already, adding a prefix for the table-check will result in wrong table-names.
   * 
   *  @since 5.15
   */
