...
/**
 * Defines property resolution behavior on instances of java.util.Map. This
 * resolver handles base objects of type java.util.Map. It accepts any object as
 * a property and uses that object as a key in the map. The resulting value is
 * the value in the map that is associated with that key. This resolver can be
...
public class MapELResolver extends ELResolver {
     ...
     * This is because Maps accept any object as a key.
     * 
     * @param context
    ...
    /**
     * If the base object is a map, returns an Iterator containing the set of
     * keys available in the Map. Otherwise, returns null. The Iterator returned
     * must contain zero or more instances of java.beans.FeatureDescriptor. Each
     * info object contains information about a key in the Map, and is
     * initialized as follows:
     * <ul>
     * <li>displayName - The return value of calling the toString method on this
     * key, or "null" if the key is null</li>
     ...
     *         FeatureDescriptor objects, each representing a key in this map,
