...
public class FullHistoryTest extends ResourceActivitiTestCase {
    ...
    public void testVariableUpdatesLinkedToActivity() throws Exception {
        ...
        /*
         * This is OK! The variable is set on the root execution, on a execution
         * never run through the activity, where the process instances stands
         * when calling the set Variable. But the ActivityId of this flow node
         * is used. So the execution id's doesn't have to be equal.
         * 
