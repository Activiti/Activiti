...
public class AdvancedCycleBusinessCalendarTest extends PvmTestCase {
  ...
  public void testDaylightSavingFallIso() throws Exception {
    ...
    ClockUtil.setCurrentCalendar(parseCalendar("20131103-04:00:00", TimeZone.getTimeZone("UTC")));
  ...
  public void testDaylightSavingSpringIso() throws Exception {
    ...
    ClockUtil.setCurrentCalendar(parseCalendar("20140309-05:00:00", TimeZone.getTimeZone("UTC")));
  ...
  public void testIsoString() throws Exception {
    ...
    ClockUtil.setCurrentCalendar(parseCalendar("20140310-04:00:00", TimeZone.getTimeZone("UTC")));
    
    assertEquals(parseCalendar("20140311-04:00:00", TimeZone.getTimeZone("UTC")).getTime(), businessCalendar.resolveDuedate("R2/2014-03-10T00:00:00/P1D DSTZONE:US/Eastern"));
  }

  public void testLegacyIsoString() throws Exception {
    AdvancedCycleBusinessCalendar businessCalendar = new AdvancedCycleBusinessCalendar();

    ClockUtil.setCurrentCalendar(parseCalendar("20140310-04:00:00", TimeZone.getDefault()));
