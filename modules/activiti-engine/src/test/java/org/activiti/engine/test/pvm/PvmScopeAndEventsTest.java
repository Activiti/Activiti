...
public class PvmScopeAndEventsTest extends PvmTestCase {
     ...
     * ------------------------------------------+ | | | outerScope (scope) | |
     * | | +----------------------------------+
     * +-----------------------------------+ | | | | | firstInnerScope (scope) |
     * | secondInnerScope (scope) | | | | | | +------------------------------+ |
     * | +-------------------------------+ | | | | | | |
     * firstMostInnerNestedActivity | | | | secondMostInnerNestedActivity | | |
     * | | | | | +-------+ +-------------+ | | | | +--------------+ +-----+ | |
     * | | | | | | | start |-->| waitInFirst |--------->| waitInSecond |--> |
     * end | | | | | | | | | +-------+ +-------------+ | | | | +--------------+
     * +-----+ | | | | | | | +------------------------------+ | |
     * +-------------------------------+ | | | | |
     * +----------------------------------+
    ...
    public void testStartEndWithScopesAndNestedActivities() {
        ...
        PvmProcessDefinition processDefinition = new ProcessDefinitionBuilder("scopes and events").executionListener(org.activiti.engine.impl.pvm.PvmEvent.EVENTNAME_START, eventCollector)
                .executionListener(org.activiti.engine.impl.pvm.PvmEvent.EVENTNAME_END, eventCollector).createActivity("mostOuterNestedActivity")
                ...
                .createActivity("outerScope").executionListener(org.activiti.engine.impl.pvm.PvmEvent.EVENTNAME_START, eventCollector)
                .executionListener(org.activiti.engine.impl.pvm.PvmEvent.EVENTNAME_END, eventCollector).createActivity("firstInnerScope")
                .executionListener(org.activiti.engine.impl.pvm.PvmEvent.EVENTNAME_START, eventCollector).executionListener(org.activiti.engine.impl.pvm.PvmEvent.EVENTNAME_END, eventCollector)
                .createActivity("firstMostInnerNestedActivity").executionListener(org.activiti.engine.impl.pvm.PvmEvent.EVENTNAME_START, eventCollector)
                ...
                .executionListener(org.activiti.engine.impl.pvm.PvmEvent.EVENTNAME_START, eventCollector).executionListener(org.activiti.engine.impl.pvm.PvmEvent.EVENTNAME_END, eventCollector)
                .transition("waitInFirst").endActivity().createActivity("waitInFirst").behavior(new WaitState())
                .executionListener(org.activiti.engine.impl.pvm.PvmEvent.EVENTNAME_START, eventCollector).executionListener(org.activiti.engine.impl.pvm.PvmEvent.EVENTNAME_END, eventCollector)
                .transition("waitInSecond").endActivity().endActivity().endActivity().createActivity("secondInnerScope")
                .executionListener(org.activiti.engine.impl.pvm.PvmEvent.EVENTNAME_START, eventCollector).executionListener(org.activiti.engine.impl.pvm.PvmEvent.EVENTNAME_END, eventCollector)
                .createActivity("secondMostInnerNestedActivity").executionListener(org.activiti.engine.impl.pvm.PvmEvent.EVENTNAME_START, eventCollector)
                .executionListener(org.activiti.engine.impl.pvm.PvmEvent.EVENTNAME_END, eventCollector).createActivity("waitInSecond").behavior(new WaitState())
                .executionListener(org.activiti.engine.impl.pvm.PvmEvent.EVENTNAME_START, eventCollector).executionListener(org.activiti.engine.impl.pvm.PvmEvent.EVENTNAME_END, eventCollector)
                ...
                .executionListener(org.activiti.engine.impl.pvm.PvmEvent.EVENTNAME_END, eventCollector).endActivity().endActivity().endActivity().endActivity().endActivity().buildProcessDefinition();
     ...
     * 
     */
    // this test does not start the process at the initial (the activity with id
    // 'start'), but at
    // 'waitInFirst'
