...
/**
 * Test case for all {@link ActivitiEventListener}s that throws a signal BPMN
 * event when an {@link ActivitiEvent} has been dispatched.
 * 
...
public class SignalThrowingEventListenerTest extends PluggableActivitiTestCase {
    ...
    /**
     * Test signal throwing when a job failed and the retries are decremented,
     * affectively starting a new transaction.
     */
    @Deployment
    ...
    /**
     * Test signal throwing when a job failed, signaling will happen in the
     * rolled back transaction, not doing anything in the end...
     */
    ...
    /**
     * Test if an engine-wide signal is thrown as response to a dispatched
     * event.
     */
