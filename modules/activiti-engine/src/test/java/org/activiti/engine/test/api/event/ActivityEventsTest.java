...
public class ActivityEventsTest extends PluggableActivitiTestCase {
    ...
    /**
     * Test starting and completed events for activity. Since these events are
     * dispatched in the core of the PVM, not all individual activity-type is
     * tested. Rather, we test the main types (tasks, gateways, events,
     * subprocesses).
     */
    @Deployment
    ...
    /**
     * Test events related to message events, called from the API, targeting an
     * event-subprocess.
     */
    @Deployment
    ...
    /**
     * Test events related to error-events, thrown from within process-execution
     * (eg. service-task).
     */
    @Deployment
