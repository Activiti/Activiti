 ...
 * {@link ProcessDiagramLayout}, the files can be regenerated by running the
...
//              new File("src/test/resources/org/activiti/engine/test/api/repository/diagram/" + imageFileName + ".actual.png"));
   ...
   * {@link ProcessDiagramLayout#getProcessDiagramLayout(InputStream, InputStream)}.
   */
  @Test
  ...
  private void assertLayoutCorrect(Map<String, Bounds> processDiagramLayout) throws IOException {
  ...
  private static String generateHtmlCode(String imageUrl, Map<String, Bounds> mapOfBoundsForImage, String highlightedActivityId) {
    ...
    for (Entry<String, Bounds> entry : mapOfBoundsForImage.entrySet()) {
      String bpmnElementId = entry.getKey();
      Bounds bounds = entry.getValue();
      html.append("      <div");
      html.append(" class=\"BPMNElement\"");
      html.append(" id=\"" + bpmnElementId + "\"");
      html.append(" style=\"");
      html.append(" left: " + (int) (bounds.getX() - 2) + "px;");
      html.append(" top: " + (int) (bounds.getY() - 2) + "px;");
      html.append(" width: " + bounds.getWidth().intValue() + "px;");
      html.append(" height: " + bounds.getHeight().intValue() + "px;\"></div>\n");
    }
    html.append("    </div>\n");
    html.append("  </body>\n");
    html.append("</html>");
