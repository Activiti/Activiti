...
public class ProcessInstanceQueryTest extends PluggableActivitiTestCase {
    ...
    /**
     * Setup starts 4 process instances of oneTaskProcess and 1 instance of
     * oneTaskProcess2
     */
    ...
    public void testOrQueryByProcessDefinitionName() {
        assertEquals(PROCESS_DEFINITION_KEY_DEPLOY_COUNT, runtimeService.createProcessInstanceQuery().or().processDefinitionName(PROCESS_DEFINITION_NAME).processDefinitionId("undefined").endOr()
                .count());
    ...
    public void testQueryNullVariable() throws Exception {
        ...
        for (HistoricVariableInstance historicVariableInstance : variables) {
            System.out.println("historicVariableInstance " + historicVariableInstance.getProcessInstanceId() + " " + historicVariableInstance.getVariableName() + " "
        ...
        // When a byte-array refrence is present, the variable is not considered
        // null
