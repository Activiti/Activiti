...
public class DuplicateVariableInsertTest extends PluggableActivitiTestCase {
    ...
    /**
     * Test for ACT-1887: Inserting the same new variable at the same time, from
     * 2 different threads, using 2 modified commands that use a barrier for
     * starting and a barrier for completing the command, so they each insert a
     * new variable guaranteed.
     */
    ...
    /**
     * Command wrapping a SetExecutionVariablesCmd, waiting in to start and end
     * on the barriers passed in.
     * 
    ...
    /**
     * Command wrapping a SetTaskVariablesCmd, waiting in to start and end on
     * the barriers passed in.
     * 
     * @author Frederik Heremans
     * 
     */
