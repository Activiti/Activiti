...
public class HistoryServiceTest extends PluggableActivitiTestCase {
    ...
    /**
     * Only do one second type, as the logic is same as in
     * {@link ProcessInstanceQueryTest} and I do not want to duplicate all test
     * case logic here. Basically copied from {@link ProcessInstanceQueryTest}
     */
    @Deployment(resources = { "org/activiti/engine/test/api/oneTaskProcess.bpmn20.xml" })
