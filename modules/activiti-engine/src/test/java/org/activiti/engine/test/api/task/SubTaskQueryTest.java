...
public class SubTaskQueryTest extends PluggableActivitiTestCase {
  ...
  private List<String> generateTestSubTasks() throws Exception {
    ...
    Context.getProcessEngineConfiguration().getClock().setCurrentTime(sdf.parse("01/01/2008 01:01:01.000"));
    ...
    Context.getProcessEngineConfiguration().getClock().setCurrentTime(sdf.parse("01/01/2009 01:01:01.000"));
    for (int i = 1; i <= 2; i++) {
    ...
    Context.getProcessEngineConfiguration().getClock().setCurrentTime(sdf.parse("01/02/2008 02:02:02.000"));
    ...
    Context.getProcessEngineConfiguration().getClock().setCurrentTime(sdf.parse("05/02/2008 02:02:02.000"));
    ...
    Context.getProcessEngineConfiguration().getClock().setCurrentTime(sdf.parse("02/01/2009 01:01:01.000"));
    for (int i = 1; i <= 2; i++) {
      Task subtask = taskService.newTask();
