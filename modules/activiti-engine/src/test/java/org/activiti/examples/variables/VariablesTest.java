...
public class VariablesTest extends PluggableActivitiTestCase {
  ...
  public String getDataObjectId(String executionId, String name) {
  ...
  public void testChangeVariableType() {
    ...
    if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.AUDIT)) {
      String oldSerializableVarId = getDataObjectId(processInstance.getId(), "serializableVar");
      String oldLongVar = getDataObjectId(processInstance.getId(), "longVar");
      ...
      String newSerializableVarId = getDataObjectId(processInstance.getId(), "serializableVar");
      ...
      String newLongVar = getDataObjectId(processInstance.getId(), "longVar");
