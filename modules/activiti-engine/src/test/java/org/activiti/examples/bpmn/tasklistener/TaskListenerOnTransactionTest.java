...
public class TaskListenerOnTransactionTest extends PluggableActivitiTestCase {
  ...
  @Deployment
  public void testOnCompleteWithRollback() {
    ...
    ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("taskListenersOnCompleteRollback", variables);
    ...
    assertEquals("serviceTask1", currentTasks.get(0).getTaskId());
    assertEquals("Service Task 1", currentTasks.get(0).getTaskName());
