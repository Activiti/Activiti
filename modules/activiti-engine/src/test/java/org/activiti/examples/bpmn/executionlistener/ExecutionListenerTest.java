...
public class ExecutionListenerTest extends PluggableActivitiTestCase {
  ...
  @Deployment(resources = {"org/activiti/examples/bpmn/executionlistener/ExecutionListenersOnDelete.bpmn20.xml.bpmn20.xml"})
  public void testExecutionListenersOnDelete() {
    RecorderExecutionListener.clear();
    
    ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("executionListenersOnCreate");
    assertProcessEnded(processInstance.getId());
