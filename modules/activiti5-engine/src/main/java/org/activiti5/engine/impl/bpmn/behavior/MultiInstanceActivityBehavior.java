...
public abstract class MultiInstanceActivityBehavior extends FlowNodeActivityBehavior  
  ...
  protected boolean isExtraScopeNeeded() {
    ...
    return innerActivityBehavior instanceof org.activiti5.engine.impl.bpmn.behavior.SubProcessActivityBehavior;  
  }
  ...
  protected void callActivityEndListeners(ActivityExecution execution) {
    List<ExecutionListener> listeners = activity.getExecutionListeners(org.activiti5.engine.impl.pvm.PvmEvent.EVENTNAME_END);
