...
@ContextConfiguration("classpath:org/activiti5/spring/test/components/ScopingTests-context.xml")
@Ignore
...
public class XmlNamespaceProcessScopeTest {
  ...
  public void before() throws Throwable {
    this.processEngine.getRepositoryService().createDeployment().addClasspathResource("org/activiti5/spring/test/components/spring-component-waiter.bpmn20.xml").deploy();
