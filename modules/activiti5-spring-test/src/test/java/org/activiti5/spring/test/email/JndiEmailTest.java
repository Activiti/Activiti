package org.activiti5.spring.test.email;
...
@ContextConfiguration("classpath:org/activiti5/spring/test/email/jndiEmailConfiguaration-context.xml")
public class JndiEmailTest extends SpringActivitiTestCase {
  ...
  @Deployment(resources = {"org/activiti5/spring/test/email/EmailTaskUsingJndi.bpmn20.xml"})
