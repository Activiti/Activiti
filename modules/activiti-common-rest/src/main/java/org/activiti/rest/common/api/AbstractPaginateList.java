...
public abstract class AbstractPaginateList {
    ...
    /**
     * uses the pagination parameters form the request and makes sure to order
     * the result and set all pagination attributes for the response to render
     * 
     * @param req
     ...
     * @param defaultSort
     *            THe default sort column (the rest attribute) that later will
     *            be mapped to an internal engine name
     */
    ...
    /**
     * uses the pagination parameters from the request and makes sure to order
     * the result and set all pagination attributes for the response to render
     * 
     * @param req
     *            The request containing the pagination parameters
