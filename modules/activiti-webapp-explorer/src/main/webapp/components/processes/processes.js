...
(function()
{
  ...
  YAHOO.extend(Activiti.component.Processes, Activiti.component.Base,
  {
    ...
    {
      var url = Activiti.service.REST_PROXY_URI_RELATIVE + '/deployment/' + encodeURIComponent($html(data.deploymentId)) + '/resource/' + encodeURIComponent($html(data.diagramResourceName));
