...
public class ActivitiEventBuilder {
     ...
     * @param type
     *            type of event
     * @return an {@link ActivitiEvent} that doesn't have it's execution
     *         context-fields filled, as the event is a global event,
     *         independant of any running execution.
     */
     ...
     * @return an {@link ActivitiEntityEvent}. In case an
     *         {@link ExecutionContext} is active, the execution related event
     *         fields will be populated. If not, execution details will be
     ...
     * @return an {@link ActivitiEntityEvent} that is also instance of
     *         {@link ActivitiExceptionEvent}. In case an
     *         {@link ExecutionContext} is active, the execution related event
