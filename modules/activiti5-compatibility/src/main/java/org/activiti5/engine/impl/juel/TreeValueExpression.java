 ...
 * {@link #getType(ELContext)}, {@link #getValue(ELContext)},
 * {@link #isReadOnly(ELContext)} or {@link #setValue(ELContext, Object)}.
 * 
 * Instances of this class are usually created using an
 * {@link ExpressionFactoryImpl}.
 * 
...
public final class TreeValueExpression extends org.activiti5.engine.impl.javax.el.ValueExpression {
     ...
     *            <code>base[property]</code>) and to determine the result from
     *            the last base/property pair
     * @return lvalue evaluation type or <code>null</code> for rvalue
     *         expressions
     * @throws ELException
     *             if evaluation fails (e.g. property not found, type conversion
     *             failed, ...)
     */
    @Override
     ...
     *            <code>base[property]</code>) and to determine the result from
     *            the last base/property pair
     * @return <code>true</code> if {@link #setValue(ELContext, Object)} always
     *         fails.
     * @throws ELException
     *             if evaluation fails (e.g. property not found, type conversion
     *             failed, ...)
     ...
     * @param context
     *            used to resolve properties (<code>base.property</code> and
     *            <code>base[property]</code>) and to perform the assignment to
     *            the last base/property pair
     * @throws ELException
     *             if evaluation fails (e.g. property not found, type conversion
    ...
    /**
     * Answer <code>true</code> if this could be used as an lvalue. This is the
     * case for eval expressions consisting of a simple identifier or a
     * nonliteral prefix, followed by a sequence of property operators (
