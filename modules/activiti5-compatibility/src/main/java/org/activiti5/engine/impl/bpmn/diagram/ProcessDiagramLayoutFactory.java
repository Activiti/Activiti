...
package org.activiti5.engine.impl.bpmn.diagram;
...
import org.activiti5.engine.repository.DiagramElement;
import org.activiti5.engine.repository.DiagramLayout;
import org.activiti5.engine.repository.DiagramNode;
...
public class ProcessDiagramLayoutFactory {
     ...
     *            BPMN 2.0 XML file
     * @param imageStream
     *            BPMN 2.0 diagram in PNG format (JPEG and other formats
     *            supported by {@link ImageIO} may also work)
    ...
    /**
     * Provides positions and dimensions of elements in a BPMN process diagram
     * as provided by {@link RepositoryService#getProcessDiagram(String)}.
     * 
     * @param bpmnXmlStream
