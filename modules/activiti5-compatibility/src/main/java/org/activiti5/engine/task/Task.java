...
public interface Task extends TaskInfo {
     ...
     * {@link #getDelegationState() delegationState} to
     * {@link DelegationState#PENDING}. If no owner is set on the task, the
     * owner is set to the current assignee of the task.
     */
