 ...
 * 
 * Currently, only 8-bits are supporten, but can be extended to use all 31 bits
 * in the integer (1st of 32 bits is used for sign).
 * 
...
public class BitMaskUtil {
     ...
     *            integer value
     * @param bitNumber
     *            number of the bit to set to '1' (right first bit starting at
     *            1).
     */
     ...
     *            integer value
     * @param bitNumber
     *            number of the bit to set to '0' (right first bit starting at
     *            1).
     */
     ...
     *            integer value
     * @param bitNumber
     *            number of the bit to set to '0' or '1' (right first bit
     *            starting at 1).
     * @param bitValue
