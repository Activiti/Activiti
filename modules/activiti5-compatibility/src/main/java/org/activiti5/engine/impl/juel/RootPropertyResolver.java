...
/**
 * Simple root property resolver implementation. This resolver handles root
 * properties (i.e.
 * <code>base == null &amp;&amp; property instanceof String</code>), which are
 * stored in a map. The properties can be accessed via the
 * {@link #getProperty(String)}, {@link #setProperty(String, Object)},
 * {@link #isProperty(String)} and {@link #properties()} methods.
 * 
...
public class RootPropertyResolver extends ELResolver {
     ...
     * @param property
     *            property name
     * @return <code>true</code> if the given property is associated with a
     *         value
     */
