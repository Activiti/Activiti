...
import org.activiti5.engine.impl.ProcessEngineInfoImpl;
 ...
 * <code>org.activiti.impl.servlet.listener.ProcessEnginesServletContextListener</code>
 * ). That way, all applications can just use the {@link #getProcessEngines()}
 * to obtain pre-initialized and cached process engines. <br>
 * <br>
...
public abstract class ProcessEngines {
     ...
     * resources <code>activiti.cfg.xml</code> (plain Activiti style
     * configuration) and for resources <code>activiti-context.xml</code>
    ...
    /**
     * Get initialization results. Only info will we available for process
     * engines which were added in the {@link ProcessEngines#init()}. No
     ...
     *            is the name of the process engine or null for the default
     *            process engine.
     */
