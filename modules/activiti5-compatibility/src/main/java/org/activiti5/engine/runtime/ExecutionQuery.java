...
public interface ExecutionQuery extends Query<ExecutionQuery, Execution> {
     ...
     * 
     * Note that only process instances have a business key and as such, child
     * executions will NOT be returned. If you want to return child executions
     * of the process instance with the given business key too, use the
     * {@link #processInstanceBusinessKey(String, boolean)} method with a
     * boolean value of <i>true</i> instead.
     */
    ExecutionQuery processInstanceBusinessKey(String processInstanceBusinessKey);

    /**
     * Only executions with the given business key. Similar to
     * {@link #processInstanceBusinessKey(String)}, but allows to choose whether
     * child executions are returned or not.
     */
    ...
    /**
     * Only select executions which are a direct child-execution of the
     ...
     * The type of variable is determined based on the value, using types
     * configured in {@link ProcessEngineConfiguration#getVariableTypes()}.
     * Byte-arrays and {@link Serializable} objects (which are not primitive
    ...
    /**
     * Only select executions which have a local string variable with the given
    ...
    /**
     * Only select executions which have at least one local variable with the
     * given value. The type of variable is determined based on the value, using
     * types configured in {@link ProcessEngineConfiguration#getVariableTypes()}
     * . Byte-arrays and {@link Serializable} objects (which are not primitive
     * type wrappers) are not supported.
     */
    ...
    /**
     * Only select executions which have a local string variable which is not
    ...
    /**
     * Only select executions which have a local variable value greater than the
     * passed value. Booleans, Byte-arrays and {@link Serializable} objects
    ...
    /**
     * Only select executions which have a local variable value greater than or
     * equal to the passed value. Booleans, Byte-arrays and {@link Serializable}
    ...
    /**
     * Only select executions which have a local variable value less than the
     * passed value. Booleans, Byte-arrays and {@link Serializable} objects
     * (which are not primitive type wrappers) are not supported.
     * 
     * @param name
    ...
    /**
     * Only select executions which have a local variable value less than or
     * equal to the passed value. Booleans, Byte-arrays and {@link Serializable}
     * objects (which are not primitive type wrappers) are not supported.
     * 
     * @param name
    ...
    /**
     * Only select executions which have a local variable value like the given
     * value. This be used on string variables only.
     * 
     * @param name
     *            variable name, cannot be null.
     * @param value
     ...
     * with the given name set to the given value. Byte-arrays and
     * {@link Serializable} objects (which are not primitive type wrappers) are
     * not supported.
     */
    ...
    /**
     * Only select executions which are part of a process that have at least one
     * variable with the given value. Byte-arrays and {@link Serializable}
     * objects (which are not primitive type wrappers) are not supported.
     */
    ...
    /**
     * Only select executions which are part of a process that have a local
     * string variable with the given value, case insensitive.
     * <p>
     * This method only works if your database has encoding/collation that
     * supports case-sensitive queries. For example, use "collate UTF-8" on
     * MySQL and for MSSQL, select one of the case-sensitive Collations
    ...
    /**
     * Only select executions which are part of a process that have a local
     * string variable which is not the given value, case insensitive.
     * <p>
     * This method only works if your database has encoding/collation that
     * supports case-sensitive queries. For example, use "collate UTF-8" on
     * MySQL and for MSSQL, select one of the case-sensitive Collations
    ...
    /**
     * Only select executions which have a signal event subscription for the
     * given signal name.
     * 
     * (The signalName is specified using the 'name' attribute of the signal
     * element in the BPMN 2.0 XML.)
     * 
     * @param signalName
    ...
    /**
     * Only select executions which have a message event subscription for the
     * given messageName.
     * 
     * (The messageName is specified using the 'name' attribute of the message
     * element in the BPMN 2.0 XML.)
     * 
     * @param messageName
    ...
    /**
     * Order by process definition key (needs to be followed by {@link #asc()}
     * or {@link #desc()}).
     */
