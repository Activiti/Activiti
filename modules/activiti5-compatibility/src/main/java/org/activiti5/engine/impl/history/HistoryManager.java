...
public interface HistoryManager extends Session {
    ...
    /**
     * @return true, if the configured history-level is equal to OR set to a
     *         higher value than the given level.
     */
    ...
    /**
     * Record a process-instance ended. Updates the historic process instance if
     * activity history is enabled.
     */
    public abstract void recordProcessInstanceEnd(String processInstanceId, String deleteReason, String activityId);

    /**
     * Record a process-instance started and record start-event if activity
     * history is enabled.
     */
    public abstract void recordProcessInstanceStart(ExecutionEntity processInstance);

    /**
     * Record a process-instance name change.
     */
    public abstract void recordProcessInstanceNameChange(String processInstanceId, String newName);

    /**
     * Record a sub-process-instance started and alters the
     ...
     */
    public abstract void recordStartEventEnded(String executionId, String activityId);
    ...
    /**
     * Replaces any open historic activityInstances' execution-id's to the id of
     * the replaced execution, if activity history is enabled.
     */
    public abstract void recordExecutionReplacedBy(ExecutionEntity execution, InterpretableExecution replacedBy);

    /**
     * Record a change of the process-definition id of a process instance, if
     * activity history is enabled.
     */
    public abstract void recordProcessDefinitionChange(String processInstanceId, String processDefinitionId);

    /**
     * Record the creation of a task, if audit history is enabled.
     */
    public abstract void recordTaskCreated(TaskEntity task, ExecutionEntity execution);
    ...
    /**
     * Record the id of a the task associated with a historic activity, if
     * activity history is enabled.
     */
     ...
     */
    public abstract void recordTaskDescriptionChange(String taskId, String description);
     ...
     * Record a variable has been created, if audit history is enabled.
     */
    public abstract void recordHistoricDetailVariableCreate(VariableInstanceEntity variable, ExecutionEntity sourceActivityExecution, boolean useActivityId);
    ...
    /**
     * Creates a new comment to indicate a new {@link IdentityLink} has been
     * created or deleted, if history is enabled.
     */
    public abstract void createIdentityLinkComment(String taskId, String userId, String groupId, String type, boolean create);
     ...
     * created or deleted, if history is enabled.
     */
    public abstract void createProcessInstanceIdentityLinkComment(String processInstanceId, String userId, String groupId, String type, boolean create);

    /**
     * Creates a new comment to indicate a new {@link IdentityLink} has been
     * created or deleted, if history is enabled.
     */
    public abstract void createProcessInstanceIdentityLinkComment(String processInstanceId, String userId, String groupId, String type, boolean create, boolean forceNullUserId);

    /**
     * Creates a new comment to indicate a new attachment has been created or
     * deleted, if history is enabled.
     */
    public abstract void createAttachmentComment(String taskId, String processInstanceId, String attachmentName, boolean create);
    ...
    /**
     * Record the creation of a new {@link IdentityLink}, if audit history is
     * enabled.
     */
    public abstract void recordIdentityLinkCreated(IdentityLinkEntity identityLink);

    public abstract void deleteHistoricIdentityLink(String id);

    public abstract void updateProcessBusinessKeyInHistory(ExecutionEntity processInstance);
