...
import org.activiti5.engine.impl.event.logger.handler.ActivityErrorReceivedEventHandler;
import org.activiti5.engine.impl.event.logger.handler.ActivityMessageEventHandler;
import org.activiti5.engine.impl.event.logger.handler.ActivitySignaledEventHandler;
import org.activiti5.engine.impl.event.logger.handler.ActivityStartedEventHandler;
import org.activiti5.engine.impl.event.logger.handler.EventLoggerEventHandler;
import org.activiti5.engine.impl.event.logger.handler.ProcessInstanceEndedEventHandler;
import org.activiti5.engine.impl.event.logger.handler.ProcessInstanceStartedEventHandler;
import org.activiti5.engine.impl.event.logger.handler.SequenceFlowTakenEventHandler;
import org.activiti5.engine.impl.event.logger.handler.TaskAssignedEventHandler;
import org.activiti5.engine.impl.event.logger.handler.TaskCompletedEventHandler;
import org.activiti5.engine.impl.event.logger.handler.TaskCreatedEventHandler;
import org.activiti5.engine.impl.event.logger.handler.VariableCreatedEventHandler;
import org.activiti5.engine.impl.event.logger.handler.VariableDeletedEventHandler;
import org.activiti5.engine.impl.event.logger.handler.VariableUpdatedEventHandler;
...
public class EventLogger implements ActivitiEventListener {
    ...
    /**
     * Subclasses that want something else than the database flusher should
