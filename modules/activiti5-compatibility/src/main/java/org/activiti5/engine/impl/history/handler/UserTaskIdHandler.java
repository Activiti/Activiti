...
/**
 * Called when a task is created for a user-task activity. Allows recoring task-id in historic activity.
 * 
...
public class UserTaskIdHandler implements TaskListener {
  ...
  public void notify(DelegateTask task) {
    Context.getCommandContext().getHistoryManager().recordTaskId((TaskEntity) task);
  }
