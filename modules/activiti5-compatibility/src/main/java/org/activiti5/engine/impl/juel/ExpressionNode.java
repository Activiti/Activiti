...
public interface ExpressionNode extends Node {
  ...
  /**
   * @return <code>true</code> if the subtree rooted at this node could be used as an lvalue expression (identifier or property sequence with non-literal prefix).
   */
  ...
  /**
   * Determine whether {@link #setValue(Bindings, ELContext, Object)} will throw a {@link org.activiti5.engine.impl.javax.el.PropertyNotWritableException}.
   * 
   * @param bindings
   *          bindings containing variables and functions
   * @param context
