...
public interface DelegateTask extends VariableScope {
    ...
    /**
     * indication of how important/urgent this task is with a number between 0
     * and 100 where higher values mean a higher priority and lower values mean
     * lower priority: [0..19] lowest, [20..39] low, [40..59] normal, [60..79]
     * high [80..100] highest
     */
    int getPriority();
    ...
    /**
     * The current {@link org.activiti5.engine.task.DelegationState} for this
     * task.
     */
    ...
    /**
     * Change the category of the task. This is an optional field and allows to
     * 'tag' tasks as belonging to a certain category.
     */
    ...
    /**
     * Involves a group with group task. The type of identityLink is defined by
     * the given identityLink.
     * 
     * @param groupId
    ...
    /**
     * Convenience shorthand for {@link #deleteUserIdentityLink(String, String)}
     * ; with type {@link IdentityLinkType#CANDIDATE}
     * 
     * @param userId
     ...
     * 
     * @return set of {@link IdentityLink}s of type
     *         {@link IdentityLinkType#CANDIDATE}.
     */
