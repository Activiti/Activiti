...
public class Parser {
    ...
    public static abstract class ExtensionHandler {
        ...
        /**
         * @return the extension point specifying where this syntax extension is
         *         active
         */
        ...
        /**
         * Called by the parser if it handles a extended token associated with
         * this handler at the appropriate extension point.
         * 
         * @param children
    ...
    private static final String EXPR_FIRST = IDENTIFIER + "|" + STRING + "|" + FLOAT + "|" + INTEGER + "|" + TRUE + "|" + FALSE + "|" + NULL + "|" + MINUS + "|" + NOT + "|" + EMPTY + "|" + LPAREN;
     ...
     * 
     * @return the consumed token (which was the current token when calling this
     *         method)
     */
    ...
    /**
     * consume current token (get next token); throw exception if the current
     * token doesn't match the expected symbol.
     */
    ...
    /**
     * dynmamic := &lt;START_EVAL_DYNAMIC&gt; expr &lt;END_EVAL&gt; deferred :=
     * &lt;START_EVAL_DEFERRED&gt; expr &lt;END_EVAL&gt;
     */
    ...
    /**
     * cmp := add (&lt;LT&gt; add | &lt;LE&gt; add | &lt;GE&gt; add | &lt;GT&gt;
     * add)*
     */
    ...
    /**
     * unary := &lt;NOT&gt; unary | &lt;MINUS&gt; unary | &lt;EMPTY&gt; unary |
     * value
     */
    ...
    /**
     * value := (nonliteral | literal) (&lt;DOT&gt; &lt;IDENTIFIER&gt; |
     * &lt;LBRACK&gt; expr &lt;RBRACK&gt;)*
     */
    ...
    /**
     * nonliteral := &lt;IDENTIFIER&gt; | function | &lt;LPAREN&gt; expr
     * &lt;RPAREN&gt; function := (&lt;IDENTIFIER&gt; &lt;COLON&gt;)?
     * &lt;IDENTIFIER&gt; &lt;LPAREN&gt; list? &lt;RPAREN&gt;
     */
