...
public interface RuntimeService {
     ...
     * order process, the business key could be an order id. This business key
     * can then be used to easily look up that process instance , see
     * {@link ProcessInstanceQuery#processInstanceBusinessKey(String)}.
    ...
    /**
     * Similar to {@link #startProcessInstanceByKey(String)}, but using a
     * specific tenant identifier.
     */
    ProcessInstance startProcessInstanceByKeyAndTenantId(String processDefinitionKey, String tenantId);

    /**
     * Similar to {@link #startProcessInstanceByKey(String, String)}, but using
     * a specific tenant identifier.
     */
    ProcessInstance startProcessInstanceByKeyAndTenantId(String processDefinitionKey, String businessKey, String tenantId);

    /**
     * Similar to {@link #startProcessInstanceByKey(String, Map)}, but using a
     * specific tenant identifier.
     */
    ...
    /**
     * Similar to {@link #startProcessInstanceByKey(String, String, Map)}, but
     * using a specific tenant identifier.
     */
     ...
     * 
     * @return the {@link ProcessInstance} object representing the started
     *         process instance
     * 
    ...
    /**
     * Similar to {@link RuntimeService#startProcessInstanceByMessage(String)},
     ...
     * </p>
     * 
     * See {@link #startProcessInstanceByMessage(String, Map)}. This method
     * allows specifying a business key.
     * 
     * @param messageName
     *            the 'name' of the message as specified as an attribute on the
     *            bpmn20 {@code <message name="messageName" />} element.
     * @param businessKey
     *            the business key which is added to the started process
     *            instance
     * 
     * @throws ActivitiExeception
     *             if no subscription to a message with the given name exists
    ...
    /**
     * Similar to
     * {@link RuntimeService#startProcessInstanceByMessage(String, String)}, but
     * with tenant context.
     */
     ...
     *            the 'payload' of the message. The variables are added as
     *            processes variables to the started process instance.
     * @return the {@link ProcessInstance} object representing the started
     *         process instance
     * 
     * @throws ActivitiExeception
    ...
    /**
     * Similar to {@link RuntimeService#startProcessInstanceByMessage(String,
     * Map<String, Object>)}, but with tenant context.
     */
     ...
     * </p>
     * 
     * See {@link #startProcessInstanceByMessage(String, Map)}. In addition,
     * this method allows specifying a business key.
     * 
     * @param messageName
     *            the 'name' of the message as specified as an attribute on the
     *            bpmn20 {@code <message name="messageName" />} element.
    ...
    /**
     * Similar to {@link RuntimeService#startProcessInstanceByMessage(String,
     * String, Map<String, Object>)}, but with tenant context.
     */
     ...
     * 
     * @param processInstanceId
     *            id of the process instance to set the business key, cannot be
     *            null
     * @param businessKey
    ...
    /**
     * Involves a group with a process instance. The type of identityLink is
     * defined by the given identityLink.
     * 
     * @param processInstanceId
     *            id of the process instance, cannot be null.
     * @param groupId
     ...
     * @param identityLinkType
     *            type of identity, cannot be null (@see
     *            {@link IdentityLinkType}).
     * @throws ActivitiObjectNotFoundException
     ...
     * {@link #addUserIdentityLink(String, String, String)}; with type
    ...
    /**
     * Convenience shorthand for
     * {@link #addGroupIdentityLink(String, String, String)}; with type
     * {@link IdentityLinkType#CANDIDATE}
     * 
     * @param processInstanceId
     *            id of the process instance, cannot be null.
    ...
    /**
     * Convenience shorthand for
     * {@link #deleteUserIdentityLink(String, String, String)}; with type
     * {@link IdentityLinkType#CANDIDATE}
     * 
     * @param processInstanceId
     *            id of the process instance, cannot be null.
    ...
    /**
     * Convenience shorthand for
     * {@link #deleteGroupIdentityLink(String, String, String)}; with type
     * {@link IdentityLinkType#CANDIDATE}
     * 
     * @param processInstanceId
     *            id of the process instance, cannot be null.
    ...
    /**
     * Removes the association between a user and a process instance for the
    ...
    /**
     * Removes the association between a group and a process instance for the
     * given identityLinkType.
     * 
     * @param processInstanceId
     *            id of the process instance, cannot be null.
    ...
    /**
     * All variable values that are defined in the execution scope, without
     * taking outer scopes into account. If you have many task local variables
     * and you only need a few, consider using
     ...
     * account which are visible from the given execution scope (including
     * parent scopes).
     * 
     * @param executionId
     *            id of execution, cannot be null.
     ...
     * are visible to the given execution (including parent scopes). Returns
     * null when no variable value is found with the given name or when the
     ...
     * are visible to the given execution (including parent scopes). Returns
     * null when no variable value is found with the given name or when the
     * value is set to null. Throws ClassCastException when cannot cast variable
     * to given class
     * 
     * @param executionId
     *            id of execution, cannot be null.
    ...
    /**
     * The variable value for an execution. Returns the value when the variable
     * is set for the execution (and not searching parent scopes). Returns null
    ...
    /**
     * The variable value for an execution. Returns the value casted to given
     * class when the variable is set for the execution (and not searching
     * parent scopes). Returns null when no variable value is found with the
    ...
    /**
     * Check whether or not this execution has a local variable set with the
     * given name.
     */
     ...
     * @param value
     *            value to set. When null is passed, the variable is not
     *            removed, only it's value will be set to null.
     * @throws ActivitiObjectNotFoundException
     *             when no execution is found for the given executionId.
     */
     ...
     * scopes). If the variable is not already existing, it will be created in
     * the given execution.
     * 
     * @param executionId
     *            id of execution to set variable in, cannot be null.
     ...
     * 
     * If a process instance is in state suspended, activiti will not execute
     * jobs (timers, messages) associated with this instance.
     * 
     ...
     * been received. This method delivers the signal to all executions waiting
     * on the signal.
     * <p/>
     * 
    ...
    /**
     * Similar to {@link #signalEventReceived(String)}, but within the context
     * of one tenant.
     */
    ...
    /**
     * Similar to {@link #signalEventReceivedAsync(String)}, but within the
    ...
    /**
     * Similar to {@link #signalEventReceived(String, Map<String, Object>)}, but
     * within the context of one tenant.
     */
    void signalEventReceivedWithTenantId(String signalName, Map<String, Object> processVariables, String tenantId);

    /**
     * Notifies the process engine that a signal event of name 'signalName' has
     * been received. This method delivers the signal to a single execution,
     * being the execution referenced by 'executionId'. The waiting execution is
     ...
     * <p>
     * <li>The scope for an intermediate message event in the main process is
     * that of the process instance</li>
     * <li>The scope for an intermediate message event in a subprocess is that
     * of the subprocess</li>
     * <li>The scope for a boundary message event is that of the execution for
     * the Activity the event is attached to</li>
     * <p>
     * Variables are set according to the algorithm as documented for
     * {@link VariableScope#setVariables(Map)}, applied separately to each
     * variable.
     ...
     * longer be notified, regardless of the type(s) it was registered for in
     * the first place.
     * 
