            ...
            if (execution.isConcurrent() && !execution.isScope()) {
                ...
                if (concurrentRootExecutions.size() == 1) {
                    ...
                    if (lastConcurrent.isScope()) {
                        ...
                        // We can't just merge the data of the lastConcurrent
                        // into the concurrentRoot.
                        // This is because the concurrent root might be in a
                        // takeAll-loop. So the
                        // concurrent execution is the one that will be
                        // receiving the take
