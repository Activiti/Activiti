...
import org.activiti5.engine.impl.cfg.BpmnParseFactory;
 ...
 * {@link Parser} creates {@link BpmnParse} instances that can be used to
 * actually parse the BPMN 2.0 XML process definitions.
 * 
 * @author Tom Baeyens
 * @author Joram Barrez
 */
public class BpmnParser {
    ...
    /**
     * The namespace of the generic OMG DI elements (don't ask me why they didnt
     * use the BPMN_DI_NS ...)
     */
    ...
    /**
     * Creates a new {@link BpmnParse} instance that can be used to parse only
     * one BPMN 2.0 process definition.
     */
