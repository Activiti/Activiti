...
public class CompositeELResolver extends ELResolver {
   ...
   * <li>Otherwise, iteration stops and no more component resolvers are considered. The value returned by getType() is returned by this method.</li>
   * </ol>
   ...
   * <li>If the ELContext's propertyResolved flag is false then iteration continues.</li>
   * <li>Otherwise, iteration stops and no more component resolvers are considered. The value returned by getValue() is returned by this method.</li>
   * </ol>
   * If none of the component resolvers were able to perform this operation, the value null is returned and the propertyResolved flag remains set to false. Any exception thrown by component resolvers
   * during the iteration is propagated to the caller of this method.
   * 
   ...
   * <li>If the ELContext's propertyResolved flag is false then iteration continues.</li>
   * <li>Otherwise, iteration stops and no more component resolvers are considered. The value returned by isReadOnly() is returned by this method.</li>
   * </ol>
   ...
   * <ol>
   * <li>The setValue() method is called, passing in the provided context, base, property and value.</li>
   * <li>If the ELContext's propertyResolved flag is false then iteration continues.</li>
   ...
   * <ol>
   * <li>The <code>invoke()</code> method is called, passing in the provided <code>context</code>, <code>base</code>, <code>method</code>, <code>paramTypes</code>, and <code>params</code>.</li>
   * <li>If the <code>ELContext</code>'s <code>propertyResolved</code> flag is <code>false</code> then iteration continues.</li>
