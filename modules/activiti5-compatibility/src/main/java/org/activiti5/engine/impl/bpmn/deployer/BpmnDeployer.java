...
import org.activiti5.engine.impl.cmd.DeploymentSettings;
        ...
        if (eventDefinition.getEventType().equals("message") && eventDefinition.isStartEvent()) {
          ...
          for (EventSubscriptionEntity eventSubscriptionEntity : subscriptionsForSameMessageName) {
            ...
            if (eventSubscriptionEntity.getProcessInstanceId() == null || eventSubscriptionEntity.getProcessInstanceId().isEmpty()) {
              ...
              throw new ActivitiException("Cannot deploy process definition '" + processDefinition.getResourceName() + "': there already is a message event subscription for the message with name '"
