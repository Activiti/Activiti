...
/**
 * Variable type capable of storing a list of reference to JPA-entities. Only
 * JPA-Entities which are configured by annotations are supported. Use of
 * compound primary keys is not supported. <br>
 * The variable value should be of type {@link List} and can only contain
...
public class JPAEntityListVariableType implements VariableType, CacheableVariable {
    ...
    /**
     * @return a bytearray containing all ID's in the given string serialized as
     *         an array.
     */
