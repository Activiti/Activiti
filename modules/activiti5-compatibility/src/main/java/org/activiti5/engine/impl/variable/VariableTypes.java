...
/**
 * Interface describing a container for all available {@link VariableType}s of
 * variables.
 * 
 * @author dsyer
...
public interface VariableTypes {
    ...
    /**
     * @return the type for the given type name. Returns null if no type was
     *         found with the name.
     */
    public VariableType getVariableType(String typeName);

    /**
     * @return the variable type to be used to store the given value as a
     *         variable.
    ...
    /**
     * Add type at the given index. The index is used when finding a type for an
     * object. When different types can store a specific object value, the one
     * with the smallest index will be used.
     */
