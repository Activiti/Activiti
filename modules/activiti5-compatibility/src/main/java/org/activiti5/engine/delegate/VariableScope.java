...
public interface VariableScope {
     ...
     * used. This applies recursively up the parent scope chain until, if no
     * scope contains a local variable by the provided name, ultimately the root
     * scope is reached and the variable value is set on that scope.</li>
     * <p>
     * In practice for most cases, this algorithm will set variables to the
     * scope of the execution at the process instance’s root level, if there is
     * no execution-local variable by the provided name.
     * 
     * @param variableName
     ...
     * {@link #setVariable(String, Object)}, applied separately to each
     * variable.
     * 
