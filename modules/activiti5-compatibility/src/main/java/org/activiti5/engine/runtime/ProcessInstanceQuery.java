...
public interface ProcessInstanceQuery extends Query<ProcessInstanceQuery, ProcessInstance> {
    ...
    /**
     * Select process instance with the given business key, unique for the given
     * process definition
     */
    ...
    /**
     * Select process instances whose process definition name is
    ...
    /**
     * Select the process instances which are defined by a deployment with the
     * given id.
     */
    ProcessInstanceQuery deploymentId(String deploymentId);

    /**
     * Select the process instances which are defined by one of the given
     * deployment ids
     */
    ProcessInstanceQuery deploymentIdIn(List<String> deploymentIds);

    /**
     * Select the process instances which are a sub process instance of the
     * given super process instance.
     */
    ...
    /**
     * Select the process instances with which the user with the given id is
     * involved.
     */
    ProcessInstanceQuery involvedUser(String userId);

    /**
     * Only select process instances which have a global variable with the given
     * value. The type of variable is determined based on the value, using types
    ...
    /**
     * Only select process instances which have at least one global variable
     * with the given value. The type of variable is determined based on the
     * value, using types configured in
    ...
    /**
     * Only select process instances which have a local string variable with the
    ...
    /**
     * Only select process instances which have a global variable with the given
     * name, but with a different value than the passed value. Byte-arrays and
     * {@link Serializable} objects (which are not primitive type wrappers) are
     * not supported.
     * 
     * @param name
    ...
    /**
     * Only select process instances which have a local string variable which is
     ...
     * the passed value. Booleans, Byte-arrays and {@link Serializable} objects
    ...
    /**
     * Only select process instances which have a global variable value greater
     * than or equal to the passed value. Booleans, Byte-arrays and
     * {@link Serializable} objects (which are not primitive type wrappers) are
     * not supported.
     * 
     * @param name
    ...
    /**
     * Only select process instances which have a global variable value less
     * than the passed value. Booleans, Byte-arrays and {@link Serializable}
    ...
    /**
     * Only select process instances which have a global variable value like the
     * given value. This be used on string variables only.
     * 
     * @param name
     *            variable name, cannot be null.
     * @param value
    ...
    /**
     * Only select process instances which are active, which means that neither
     * the process instance nor the corresponding process definition are
     * suspended.
     */
