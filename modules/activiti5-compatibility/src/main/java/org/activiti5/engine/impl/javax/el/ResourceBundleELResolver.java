 ...
 * java.util.ResourceBundle. This resolver handles base objects of type
 * java.util.ResourceBundle. It accepts any object as a property and coerces it
 * to a java.lang.String for invoking
 * java.util.ResourceBundle.getObject(String). This resolver is read only and
 * will throw a {@link PropertyNotWritableException} if setValue is called.
 * ELResolvers are combined together using {@link CompositeELResolver}s, to
 * define rich semantics for evaluating an expression. See the javadocs for
 * {@link ELResolver} for details.
 */
public class ResourceBundleELResolver extends ELResolver {
    /**
     * If the base object is a ResourceBundle, returns the most general type
     * that this resolver accepts for the property argument. Otherwise, returns
     * null. Assuming the base is a ResourceBundle, this method will always
     * return String.class.
     * 
     * @param context
     *            The context of this evaluation.
     * @param base
     *            The bundle to analyze. Only bases of type ResourceBundle are
    ...
    /**
     * If the base object is a ResourceBundle, returns an Iterator containing
     * the set of keys available in the ResourceBundle. Otherwise, returns null.
     ...
     * a key in the ResourceBundle, and is initialized as follows:
     * <ul>
     ...
     *         FeatureDescriptor objects, each representing a key in this
     *         bundle, or null if the base object is not a ResourceBundle.
     */
    @Override
    ...
    /**
     * If the base object is an instance of ResourceBundle, return null, since
     * the resolver is read only. If the base is ResourceBundle, the
    ...
    /**
     * If the base object is an instance of ResourceBundle, the provided
     * property will first be coerced to a String. The Object returned by
     * getObject on the base ResourceBundle will be returned. If the base is
     * ResourceBundle, the propertyResolved property of the ELContext object
     ...
     *            String.
     * @return If the propertyResolved property of ELContext was set to true,
     *         then null if property is null; otherwise the Object for the given
     *         key (property coerced to String) from the ResourceBundle. If no
     *         object for the given key can be found, then the String "???" +
     *         key + "???".
     * @throws NullPointerException
     *             if context is null.
     * @throws ELException
     ...
     * java.util.ResourceBundle, return true.
     * 
     * @return If the propertyResolved property of ELContext was set to true,
