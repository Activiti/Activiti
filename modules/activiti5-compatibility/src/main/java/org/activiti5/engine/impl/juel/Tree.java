...
/**
 * Parsed expression, usually created by a {@link org.activiti5.engine.impl.juel.TreeBuilder}. The {@link #bind(FunctionMapper, VariableMapper)} method is used to create
 * {@link org.activiti5.engine.impl.juel.Bindings}, which are needed at evaluation time to lookup functions and variables. The tree itself does not contain such information, because it would make the
 * tree depend on the function/variable mapper supplied at parse time.
 * 
