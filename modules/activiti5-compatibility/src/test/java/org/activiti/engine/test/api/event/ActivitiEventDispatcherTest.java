...
public abstract class ActivitiEventDispatcherTest extends PluggableActivitiTestCase {
    ...
    /**
     * Test adding a listener and check if events are sent to it. Also checks
     * that after removal, no events are received.
     */
    ...
    /**
     * Test adding a listener and check if events are sent to it, for the types
     * it was registered for. Also checks that after removal, no events are
     * received.
     */
