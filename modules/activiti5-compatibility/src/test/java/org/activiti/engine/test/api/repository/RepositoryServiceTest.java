...
public class RepositoryServiceTest extends PluggableActivitiTestCase {
    ...
    public void testDeploymentWithDelayedProcessDefinitionActivation() {
        ...
        org.activiti5.engine.repository.Deployment deployment = repositoryService.createDeployment().addClasspathResource("org/activiti/engine/test/api/oneTaskProcess.bpmn20.xml")
    ...
    /**
     * This test was added due to issues with unzip of JDK 7, where the default
     * is changed to UTF8 instead of the platform encoding (which is, in fact,
     * good). However, some platforms do not create UTF8-compatible ZIP files.
     * 
