...
public class PvmScopeAndEventsTest extends PvmTestCase {
    ...
    public void testStartEndWithScopesAndNestedActivities() {
        ...
        PvmProcessDefinition processDefinition = new ProcessDefinitionBuilder("scopes and events").executionListener(org.activiti5.engine.impl.pvm.PvmEvent.EVENTNAME_START, eventCollector)
                ...
                .executionListener(org.activiti5.engine.impl.pvm.PvmEvent.EVENTNAME_START, eventCollector).executionListener(org.activiti5.engine.impl.pvm.PvmEvent.EVENTNAME_END, eventCollector)
                .createActivity("secondMostInnerNestedActivity").executionListener(org.activiti5.engine.impl.pvm.PvmEvent.EVENTNAME_START, eventCollector)
                .executionListener(org.activiti5.engine.impl.pvm.PvmEvent.EVENTNAME_END, eventCollector).createActivity("waitInSecond").behavior(new WaitState())
                .executionListener(org.activiti5.engine.impl.pvm.PvmEvent.EVENTNAME_START, eventCollector).executionListener(org.activiti5.engine.impl.pvm.PvmEvent.EVENTNAME_END, eventCollector)
                ...
                .executionListener(org.activiti5.engine.impl.pvm.PvmEvent.EVENTNAME_END, eventCollector).endActivity().endActivity().endActivity().endActivity().endActivity().buildProcessDefinition();
