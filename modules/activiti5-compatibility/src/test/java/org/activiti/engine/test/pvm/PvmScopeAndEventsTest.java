...
public class PvmScopeAndEventsTest extends PvmTestCase {
   ...
   * | | outerScope (scope) | | | | +----------------------------------+ +-----------------------------------+ | | | | | firstInnerScope (scope) | | secondInnerScope (scope) | | | | | |
  ...
  public void testStartEndWithScopesAndNestedActivities() {
    ...
    PvmProcessDefinition processDefinition = new ProcessDefinitionBuilder("scopes and events").executionListener(org.activiti5.engine.impl.pvm.PvmEvent.EVENTNAME_START, eventCollector)
        .executionListener(org.activiti5.engine.impl.pvm.PvmEvent.EVENTNAME_END, eventCollector).createActivity("mostOuterNestedActivity")
        ...
        .createActivity("outerScope").executionListener(org.activiti5.engine.impl.pvm.PvmEvent.EVENTNAME_START, eventCollector)
        .executionListener(org.activiti5.engine.impl.pvm.PvmEvent.EVENTNAME_END, eventCollector).createActivity("firstInnerScope")
        .executionListener(org.activiti5.engine.impl.pvm.PvmEvent.EVENTNAME_START, eventCollector).executionListener(org.activiti5.engine.impl.pvm.PvmEvent.EVENTNAME_END, eventCollector)
        .createActivity("firstMostInnerNestedActivity").executionListener(org.activiti5.engine.impl.pvm.PvmEvent.EVENTNAME_START, eventCollector)
        ...
        .executionListener(org.activiti5.engine.impl.pvm.PvmEvent.EVENTNAME_START, eventCollector).executionListener(org.activiti5.engine.impl.pvm.PvmEvent.EVENTNAME_END, eventCollector)
        .transition("waitInFirst").endActivity().createActivity("waitInFirst").behavior(new WaitState()).executionListener(org.activiti5.engine.impl.pvm.PvmEvent.EVENTNAME_START, eventCollector)
        .executionListener(org.activiti5.engine.impl.pvm.PvmEvent.EVENTNAME_END, eventCollector).transition("waitInSecond").endActivity().endActivity().endActivity()
        .createActivity("secondInnerScope").executionListener(org.activiti5.engine.impl.pvm.PvmEvent.EVENTNAME_START, eventCollector)
        .executionListener(org.activiti5.engine.impl.pvm.PvmEvent.EVENTNAME_END, eventCollector).createActivity("secondMostInnerNestedActivity")
        .executionListener(org.activiti5.engine.impl.pvm.PvmEvent.EVENTNAME_START, eventCollector).executionListener(org.activiti5.engine.impl.pvm.PvmEvent.EVENTNAME_END, eventCollector)
        .createActivity("waitInSecond").behavior(new WaitState()).executionListener(org.activiti5.engine.impl.pvm.PvmEvent.EVENTNAME_START, eventCollector)
