...
public class StartTimerEventRepeatWithEndExpressionTest extends PluggableActivitiTestCase {
    ...
    public void testCycleDateStartTimerEvent() throws Exception {
        ...
        // deploy the process
        repositoryService.createDeployment().addClasspathResource("org/activiti/engine/test/bpmn/event/timer/StartTimerEventRepeatWithEndExpressionTest.testCycleDateStartTimerEvent.bpmn20.xml")
                .deploy();
        ...
        // After the second startEvent Execution should have 2 process instances
        // started
