...
public class SubTaskQueryTest extends PluggableActivitiTestCase {
    ...
    /**
     * test for task inclusion/exclusion (no other filters, order by task
     * assignee )
     */
    ...
    /**
     * test for task inclusion/exclusion when additional filter is specified
     * (like assignee), no order.
     */
    ...
    /**
     * Generates some test sub-tasks to the tasks generated by
     * {@link #generateTestTasks()}.<br/>
     * - 1 root task where kermit is a candidate with 2 subtasks (both with
     * kermit as candidate) <br/>
     * - 2 root task where gonzo is assignee with 3 + 2 subtasks assigned to
     * gonzo
     */
