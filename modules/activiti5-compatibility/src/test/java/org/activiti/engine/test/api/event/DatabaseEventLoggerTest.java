...
public class DatabaseEventLoggerTest extends PluggableActivitiTestCase {
    ...
    public void testDatabaseEvents() throws IOException {
        ...
        String deploymentId = repositoryService.createDeployment().addClasspathResource("org/activiti/engine/test/api/event/DatabaseEventLoggerProcess.bpmn20.xml").tenantId(testTenant).deploy()
                .getId();
