...
public class ProcessInstanceMigrationTest extends PluggableActivitiTestCase {
    ...
    public void testSetProcessDefinitionVersionPIIsSubExecution() {
        ...
        try {
            ...
            assertTextPresent("A process instance id is required, but the provided id '" + execution.getId() + "' points to a child execution of process instance '" + pi.getId()
                    + "'. Please invoke the " + command.getClass().getSimpleName() + " with a root execution id.", ae.getMessage());
        }
    }
    ...
    public void testSetProcessDefinitionVersionActivityMissing() {
        ...
        org.activiti5.engine.repository.Deployment deployment = repositoryService.createDeployment().addClasspathResource(TEST_PROCESS_ACTIVITY_MISSING).deploy();
    ...
    public void testSetProcessDefinitionVersion() {
        ...
        // deploy new version of the process definition
        org.activiti5.engine.repository.Deployment deployment = repositoryService.createDeployment().addClasspathResource(TEST_PROCESS).deploy();
        assertEquals(2, repositoryService.createProcessDefinitionQuery().count());
    ...
    public void testSetProcessDefinitionVersionSubExecutions() {
        ...
        // deploy new version of the process definition
        org.activiti5.engine.repository.Deployment deployment = repositoryService.createDeployment().addClasspathResource(TEST_PROCESS_WITH_PARALLEL_GATEWAY).deploy();
        assertEquals(2, repositoryService.createProcessDefinitionQuery().count());
    ...
    public void testSetProcessDefinitionVersionWithCallActivity() {
        ...
        // deploy new version of the process definition
        org.activiti5.engine.repository.Deployment deployment = repositoryService.createDeployment().addClasspathResource(TEST_PROCESS_CALL_ACTIVITY).deploy();
    ...
    public void testSetProcessDefinitionVersionWithWithTask() {
        try {
            ...
            // deploy new version of the process definition
            org.activiti5.engine.repository.Deployment deployment = repositoryService.createDeployment().addClasspathResource(TEST_PROCESS_USER_TASK_V2).deploy();
    ...
    public void testSetProcessDefinitionVersionSubExecutionsNested() {
        ...
        // deploy new version of the process definition
        org.activiti5.engine.repository.Deployment deployment = repositoryService.createDeployment().addClasspathResource(TEST_PROCESS_NESTED_SUB_EXECUTIONS).deploy();
        assertEquals(2, repositoryService.createProcessDefinitionQuery().count());
