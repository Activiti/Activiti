...
public class SubProcessTest extends PluggableActivitiTestCase {
    ...
    /**
     * A test case that has a timer attached to the subprocess, where 2
     * concurrent paths are defined when the timer fires.
     */
    @Deployment
    ...
    /**
     * Test case where the simple sub process of previous test cases is nested
     * within another subprocess.
     */
    @Deployment
    ...
    /**
     * Test case where the simple sub process of previous test cases is nested
     * within two other sub processes
     */
    @Deployment
    ...
    public void testSimpleParallelSubProcess() {
        ...
        // Completing both tasks, should destroiy the subprocess and activate
        // the task after the subprocess
    ...
    /**
     * @see <a
     *      href="http://jira.codehaus.org/browse/ACT-1072">http://jira.codehaus.org/browse/ACT-1072</a>
     */
    @Deployment
