...
public abstract class SpringActivitiTestCase extends AbstractActivitiTestCase implements ApplicationContextAware {
    ...
    // to store all the resolved ProcessEngines
    // and map them to something
    private Map<Object, ProcessEngine> cachedProcessEngines = new ConcurrentHashMap<Object, ProcessEngine>();
