...
/**
 * this class records and manages all known {@link  org.activiti.spring.annotations.State State annotation} - responding
 ...
 * @since 1.0
 */
public class StateHandlerRegistry extends ReceiveTaskActivityBehavior implements BeanFactoryAware, BeanNameAware, ActivityBehavior, InitializingBean {
     ...
     *
     * @param registration the {@link StateHandlerRegistration}
     */
    public void registerActivitiStateHandler(StateHandlerRegistration registration) {
     ...
     * on specificity of the {@link StateHandlerRegistration}
     *
     ...
     */
    public Collection<StateHandlerRegistration> findRegistrationsForProcessAndState(
     ...
     * @return an unambiguous {@link StateHandlerRegistry} or null
     */
    public StateHandlerRegistration findRegistrationForProcessAndState(String processName, String stateName) {

        StateHandlerRegistration r = null;

        String key = registrationKey(processName, stateName);

        Collection<StateHandlerRegistration> rs = this.findRegistrationsForProcessAndState(
                processName, stateName);

        for (StateHandlerRegistration sr : rs) {
