 ...
 * to be executed next. This allows us to test dynamically wire in the
 * calledElement in the callActivity task. In an actual implementation there
 * would be business logic here to determine which process to execute in the
 * callActivity task.
 * 
