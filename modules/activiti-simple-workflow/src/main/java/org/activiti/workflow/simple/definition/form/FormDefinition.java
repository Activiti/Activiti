 ...
 * that a user must complete to continue the workflow. Such a form contains
 * {@link FormPropertyDefinition}s and {@link FormPropertyGroup}s or potentially
...
public class FormDefinition implements FormPropertyDefinitionContainer {
    ...
    /**
     * @return All {@link FormPropertyDefinition}s that are not part of any
     *         {@link FormPropertyGroup}.
     */
