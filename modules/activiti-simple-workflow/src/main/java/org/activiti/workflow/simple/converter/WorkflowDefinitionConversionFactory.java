 ...
 * objects.
 * 
 * It is necessary for a correct conversion to set (or inject)
 * {@link StepDefinition} converters (instances of
 * {@link StepDefinitionConverter}) and conversion life cycle listeners
...
public class WorkflowDefinitionConversionFactory {
    ...
    /**
     * Returns all {@link WorkflowDefinitionConversionListener} instances, both
     * the injected and the default ones.
     */
    ...
    /**
     * @param definition
     *            {@link StepDefinition} to get converter for. First, the
     *            injected list of {@link StepDefinitionConverter} is checked,
     *            before falling back to the default list of
