...
/**
 * A converter capable of converting {@link WorkflowDefinition}s from and to a JSON representation. <br>
 * <p>
    ...
    if (objectMapper == null) {
      ...
      synchronized (this) {
        if (objectMapper == null) {
          ...
          // sub-types
          objectMapper.registerSubtypes(ListPropertyDefinition.class, TextPropertyDefinition.class, ReferencePropertyDefinition.class, DatePropertyDefinition.class, NumberPropertyDefinition.class,
