 ...
 * <p>
 * Instances of this class <b>are thread-safe</b>.
 * </p>
 * 
...
public class SimpleWorkflowJsonConverter {
     ...
     * @return The workflow definition instance, read from the given
     *         input-stream.
     * @throws SimpleWorkflowException
     *             when an error occurs while reading or parsing the definition.
     */
    ...
    /**
     * @param bytes
     *            array representing the definition JSON.
     * @return The workflow definition instance, parsed from the given array.
     * @throws SimpleWorkflowException
     *             when an error occurs while parsing the definition.
     */
     ...
     * @param e
     *            exception to wrap
     * @return an {@link SimpleWorkflowException} to throw, wrapping the given
     *         exception.
     */
        ...
        if (objectMapper == null) {
            ...
            synchronized (this) {
                if (objectMapper == null) {
                    ...
                    // Register all property-definition model classes as
                    // sub-types
                    objectMapper.registerSubtypes(ListPropertyDefinition.class, TextPropertyDefinition.class, ReferencePropertyDefinition.class, DatePropertyDefinition.class,
                            NumberPropertyDefinition.class, BooleanPropertyDefinition.class);

                    // Register all step-types
                    objectMapper.registerSubtypes(HumanStepDefinition.class, FeedbackStepDefinition.class, ParallelStepsDefinition.class, ChoiceStepsDefinition.class, ListStepDefinition.class,
                            ListConditionStepDefinition.class, ScriptStepDefinition.class, DelayStepDefinition.class);
                    // Register additional sub-types to allow custom model
                    // entities to be
