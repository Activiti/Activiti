 ...
 * 
 * The feedback initiator has the possibility to stop to the collection of the
 * feedback, even if not all selected users have provided feedback.
 * 
 * There are a few options when it comes to selecting which people will need to
 * provide feedback:
 * <ul>
 ...
 * <b>must</b> must match the default one, see
 * {@link FeedbackStepDefinitionConverter}.</li>
 * </ul>
 * 
 * @author Joram Barrez
 */
