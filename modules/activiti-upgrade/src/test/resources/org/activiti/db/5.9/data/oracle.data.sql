insert into ACT_RE_DEPLOYMENT(ID_, NAME_, DEPLOY_TIME_)
    values('1', 'simpleTaskProcess', to_timestamp('2012-11-21 10:41:48.121', 'YYYY-MM-DD HH:MI:SS.FF'));
...
insert into ACT_HI_PROCINST (
        ...
        null,
        'simpleTaskProcess:1:3',
        to_timestamp('2012-11-21 10:41:49.108', 'YYYY-MM-DD HH:MI:SS.FF'),
        null,
        null,
        null,
        'start',
...
insert into ACT_HI_ACTINST (
        ...
        'startEvent',
        null,
        to_timestamp('2012-11-21 10:41:49.109', 'YYYY-MM-DD HH:MI:SS.FF'),
        to_timestamp('2012-11-21 10:41:49.115', 'YYYY-MM-DD HH:MI:SS.FF'),
        6
      );
...
insert into ACT_HI_ACTINST (
        ...
        'userTask',
        'kermit',
        to_timestamp('2012-11-21 10:41:49.116', 'YYYY-MM-DD HH:MI:SS.FF'),
        null,
        null
      );
...
insert into ACT_HI_ACTINST (
        ...
        'userTask',
        'swedishchef',
        to_timestamp('2012-11-21 10:41:49.669', 'YYYY-MM-DD HH:MI:SS.FF'),
        null,
        null
      );
...
update ACT_HI_ACTINST set
      EXECUTION_ID_ = '4',
      ASSIGNEE_ = 'kermit',
      END_TIME_ = to_timestamp('2012-11-21 10:41:49.669', 'YYYY-MM-DD HH:MI:SS.FF'),
      DURATION_ = 553
    where ID_ = '6';
...
update ACT_HI_TASKINST set
      ...
      OWNER_ = null,
      ASSIGNEE_ = 'kermit',
      END_TIME_ = to_timestamp('2012-11-21 10:41:49.606', 'YYYY-MM-DD HH:MI:SS.FF'),
      DURATION_ = 490,
...
insert into ACT_RE_DEPLOYMENT(ID_, NAME_, DEPLOY_TIME_)
    values('10', 'simpleTaskProcess', to_timestamp('2012-11-21 10:41:49.903', 'YYYY-MM-DD HH:MI:SS.FF'));
...
insert into ACT_HI_PROCINST (
        ...
        null,
        'taskWithExecutionVariablesProcess:1:12',
        to_timestamp('2012-11-21 10:41:50.189', 'YYYY-MM-DD HH:MI:SS.FF'),
        null,
        null,
        null,
        'start',
...
insert into ACT_HI_ACTINST (
        ...
        null,
        to_timestamp('2012-11-21 10:41:50.189', 'YYYY-MM-DD HH:MI:SS.FF'),
        to_timestamp('2012-11-21 10:41:50.215', 'YYYY-MM-DD HH:MI:SS.FF'),
        26
      );
