insert into ACT_RE_DEPLOYMENT(ID_, NAME_, DEPLOY_TIME_)
    values('1', 'simpleTaskProcess', to_timestamp('2012-11-21 10:42:43.572', 'YYYY-MM-DD HH:MI:SS.FF'));
...
insert into ACT_HI_PROCINST (
        ...
        null,
        'simpleTaskProcess:1:3',
        to_timestamp('2012-11-21 10:42:44.441', 'YYYY-MM-DD HH:MI:SS.FF'),
        null,
        null,
        null,
        'start',
...
insert into ACT_HI_ACTINST (
        ...
        null,
        to_timestamp('2012-11-21 10:42:44.441', 'YYYY-MM-DD HH:MI:SS.FF'),
        to_timestamp('2012-11-21 10:42:44.448', 'YYYY-MM-DD HH:MI:SS.FF'),
        7
      );
...
insert into ACT_HI_ACTINST (
        ...
        'userTask',
        'kermit',
        to_timestamp('2012-11-21 10:42:44.449', 'YYYY-MM-DD HH:MI:SS.FF'),
        null,
        null
      );
...
insert into ACT_HI_ACTINST (
        ...
        'userTask',
        'swedishchef',
        to_timestamp('2012-11-21 10:42:45.16', 'YYYY-MM-DD HH:MI:SS.FF'),
        null,
        null
      );
...
update ACT_HI_ACTINST set
      EXECUTION_ID_ = '4',
      ASSIGNEE_ = 'kermit',
      END_TIME_ = to_timestamp('2012-11-21 10:42:45.16', 'YYYY-MM-DD HH:MI:SS.FF'),
      DURATION_ = 567
    where ID_ = '6';
...
update ACT_HI_TASKINST set
      ...
      OWNER_ = null,
      ASSIGNEE_ = 'kermit',
      END_TIME_ = to_timestamp('2012-11-21 10:42:44.944', 'YYYY-MM-DD HH:MI:SS.FF'),
      DURATION_ = 495,
...
insert into ACT_RE_DEPLOYMENT(ID_, NAME_, DEPLOY_TIME_)
    values('10', 'simpleTaskProcess', to_timestamp('2012-11-21 10:42:45.267', 'YYYY-MM-DD HH:MI:SS.FF'));
...
insert into ACT_HI_PROCINST (
        ...
        null,
        'taskWithExecutionVariablesProcess:1:12',
        to_timestamp('2012-11-21 10:42:45.535', 'YYYY-MM-DD HH:MI:SS.FF'),
        null,
        null,
        null,
        'start',
...
insert into ACT_HI_ACTINST (
        ...
        null,
        to_timestamp('2012-11-21 10:42:45.535', 'YYYY-MM-DD HH:MI:SS.FF'),
        to_timestamp('2012-11-21 10:42:45.559', 'YYYY-MM-DD HH:MI:SS.FF'),
        24
      );
