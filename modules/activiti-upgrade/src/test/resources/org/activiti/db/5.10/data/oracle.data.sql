insert into ACT_RE_DEPLOYMENT(ID_, NAME_, DEPLOY_TIME_)
    values('1', 'simpleTaskProcess', to_timestamp('2012-11-21 09:18:53.566', 'YYYY-MM-DD HH:MI:SS.FF'));
...
insert into ACT_HI_PROCINST (
        ...
        null,
        'simpleTaskProcess:1:3',
        to_timestamp('2012-11-21 09:18:54.136', 'YYYY-MM-DD HH:MI:SS.FF'),
        null,
        null,
        null,
        'start',
...
insert into ACT_HI_ACTINST (
        ...
        'startEvent',
        null,
        to_timestamp('2012-11-21 09:18:54.137', 'YYYY-MM-DD HH:MI:SS.FF'),
        to_timestamp('2012-11-21 09:18:54.143', 'YYYY-MM-DD HH:MI:SS.FF'),
        6
      );
...
insert into ACT_HI_ACTINST (
        ...
        'userTask',
        'kermit',
        to_timestamp('2012-11-21 09:18:54.144', 'YYYY-MM-DD HH:MI:SS.FF'),
        null,
        null
      );
...
insert into ACT_HI_ACTINST (
        ...
        'userTask',
        'swedishchef',
        to_timestamp('2012-11-21 09:18:54.689', 'YYYY-MM-DD HH:MI:SS.FF'),
        null,
        null
      );
...
update ACT_HI_ACTINST set
      EXECUTION_ID_ = '4',
      ASSIGNEE_ = 'kermit',
      END_TIME_ = to_timestamp('2012-11-21 09:18:54.689', 'YYYY-MM-DD HH:MI:SS.FF'),
      DURATION_ = 545
    where ID_ = '6';
...
update ACT_HI_TASKINST set
      ...
      OWNER_ = null,
      ASSIGNEE_ = 'kermit',
      END_TIME_ = to_timestamp('2012-11-21 09:18:54.596', 'YYYY-MM-DD HH:MI:SS.FF'),
      DURATION_ = 452,
...
insert into ACT_RE_DEPLOYMENT(ID_, NAME_, DEPLOY_TIME_)
    values('10', 'simpleTaskProcess', to_timestamp('2012-11-21 09:18:54.892', 'YYYY-MM-DD HH:MI:SS.FF'));
...
insert into ACT_HI_PROCINST (
        ...
        null,
        'taskWithExecutionVariablesProcess:1:12',
        to_timestamp('2012-11-21 09:18:55.198', 'YYYY-MM-DD HH:MI:SS.FF'),
        null,
        null,
        null,
        'start',
...
insert into ACT_RU_TASK (ID_, REV_, NAME_, PARENT_TASK_ID_, DESCRIPTION_, PRIORITY_, CREATE_TIME_, OWNER_,
    ...
    values ('20',
            ...
            null,
            50,
            to_timestamp('2012-11-21 09:18:55.199', 'YYYY-MM-DD HH:MI:SS.FF'),
            null,
            null,
            null,
            '13',
