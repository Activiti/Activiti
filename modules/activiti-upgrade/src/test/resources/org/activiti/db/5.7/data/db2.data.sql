insert into ACT_RE_DEPLOYMENT(ID_, NAME_, DEPLOY_TIME_)
    values('1', 'simpleTaskProcess', TIMESTAMP (''2012-11-21 17:29:46''));
...
update ACT_HI_ACTINST set
      EXECUTION_ID_ = '4',
      ASSIGNEE_ = 'kermit',
      END_TIME_ = TIMESTAMP (''2012-11-21 17:29:47''),
      DURATION_ = 548
    where ID_ = '6';
...
insert into ACT_RE_DEPLOYMENT(ID_, NAME_, DEPLOY_TIME_)
    values('10', 'simpleTaskProcess', TIMESTAMP (''2012-11-21 17:29:47''));
