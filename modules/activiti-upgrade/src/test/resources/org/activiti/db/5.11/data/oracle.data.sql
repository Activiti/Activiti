insert into ACT_RE_DEPLOYMENT(ID_, NAME_, DEPLOY_TIME_)
    values('1', 'simpleTaskProcess', to_timestamp('2012-11-21 09:07:04.612', 'YYYY-MM-DD HH:MI:SS.FFF'));
...
insert into ACT_HI_PROCINST (
        ...
        null,
        'simpleTaskProcess:1:3',
        to_timestamp('2012-11-21 09:07:05.287', 'YYYY-MM-DD HH:MI:SS.FFF'),
        null,
        null,
        null,
        'start',
...
insert into ACT_HI_ACTINST (
        ...
        'startEvent',
        null,
        to_timestamp('2012-11-21 09:07:05.288', 'YYYY-MM-DD HH:MI:SS.FFF'),
        to_timestamp('2012-11-21 09:07:05.294', 'YYYY-MM-DD HH:MI:SS.FFF'),
        6
      );
...
insert into ACT_HI_ACTINST (
        ...
        'userTask',
        'kermit',
        to_timestamp('2012-11-21 09:07:05.295', 'YYYY-MM-DD HH:MI:SS.FFF'),
        null,
        null
      );
...
insert into ACT_HI_ACTINST (
        ...
        'userTask',
        'swedishchef',
        to_timestamp('2012-11-21 09:07:06.192', 'YYYY-MM-DD HH:MI:SS.FFF'),
        null,
        null
      );
...
insert into ACT_RU_TASK (ID_, REV_, NAME_, PARENT_TASK_ID_, DESCRIPTION_, PRIORITY_, CREATE_TIME_, OWNER_,
    ...
    values ('9',
            ...
            'spicy sauce',
            50,
            to_timestamp('2012-11-21 09:07:06.193', 'YYYY-MM-DD HH:MI:SS.FFF'),
            null,
            'swedishchef',
            null,
            '4',
...
update ACT_HI_ACTINST set
      EXECUTION_ID_ = '4',
      ASSIGNEE_ = 'kermit',
      END_TIME_ = to_timestamp('2012-11-21 09:07:06.192', 'YYYY-MM-DD HH:MI:SS.FFF'),
      DURATION_ = 897
    where ID_ = '6';
...
update ACT_HI_TASKINST set
      ...
      OWNER_ = null,
      ASSIGNEE_ = 'kermit',
      END_TIME_ = to_timestamp('2012-11-21 09:07:06.090', 'YYYY-MM-DD HH:MI:SS.FFF'),
      DURATION_ = 795,
...
insert into ACT_RE_DEPLOYMENT(ID_, NAME_, DEPLOY_TIME_)
    values('10', 'simpleTaskProcess', to_timestamp('2012-11-21 09:07:06.796', 'YYYY-MM-DD HH:MI:SS.FFF'));
...
insert into ACT_HI_PROCINST (
        ...
        null,
        'taskWithExecutionVariablesProcess:1:12',
        to_timestamp('2012-11-21 09:07:07.065', 'YYYY-MM-DD HH:MI:SS.FFF'),
        null,
        null,
        null,
        'start',
...
insert into ACT_HI_ACTINST (
        ...
        null,
        to_timestamp('2012-11-21 09:07:07.065', 'YYYY-MM-DD HH:MI:SS.FFF'),
        to_timestamp('2012-11-21 09:07:07.066', 'YYYY-MM-DD HH:MI:SS.FFF'),
        1
      );
