insert into ACT_RE_DEPLOYMENT(ID_, NAME_, DEPLOY_TIME_)
    values('1', 'simpleTaskProcess', to_timestamp('2012-11-21 14:06:53.308', 'YYYY-MM-DD HH:MI:SS.FF'));
...
insert into ACT_HI_PROCINST (
        ...
        null,
        'simpleTaskProcess:1:3',
        to_timestamp('2012-11-21 14:06:53.534', 'YYYY-MM-DD HH:MI:SS.FF'),
        null,
        null,
        null,
        'start',
...
insert into ACT_HI_ACTINST (
        ...
        null,
        to_timestamp('2012-11-21 14:06:53.534', 'YYYY-MM-DD HH:MI:SS.FF'),
        to_timestamp('2012-11-21 14:06:53.541', 'YYYY-MM-DD HH:MI:SS.FF'),
        7
      );
...
insert into ACT_RU_TASK (ID_, REV_, NAME_, PARENT_TASK_ID_, DESCRIPTION_, PRIORITY_, CREATE_TIME_, OWNER_,
    ...
    values ('7',
            ...
            null,
            50,
            to_timestamp('2012-11-21 14:06:53.542', 'YYYY-MM-DD HH:MI:SS.FF'),
            null,
            'kermit',
            null,
            '4',
...
insert into ACT_HI_ACTINST (
        ...
        'userTask',
        'swedishchef',
        to_timestamp('2012-11-21 14:06:53.629', 'YYYY-MM-DD HH:MI:SS.FF'),
        null,
        null
      );
...
update ACT_HI_TASKINST set
      ...
      OWNER_ = null,
      ASSIGNEE_ = 'kermit',
      END_TIME_ = to_timestamp('2012-11-21 14:06:53.621', 'YYYY-MM-DD HH:MI:SS.FF'),
      DURATION_ = 79,
...
update ACT_HI_ACTINST set
      EXECUTION_ID_ = '4',
      ASSIGNEE_ = 'kermit',
      END_TIME_ = to_timestamp('2012-11-21 14:06:53.629', 'YYYY-MM-DD HH:MI:SS.FF'),
      DURATION_ = 88
    where ID_ = '6';
...
insert into ACT_RE_DEPLOYMENT(ID_, NAME_, DEPLOY_TIME_)
    values('10', 'simpleTaskProcess', to_timestamp('2012-11-21 14:06:53.658', 'YYYY-MM-DD HH:MI:SS.FF'));
...
insert into ACT_HI_PROCINST (
        ...
        null,
        'taskWithExecutionVariablesProcess:1:12',
        to_timestamp('2012-11-21 14:06:53.745', 'YYYY-MM-DD HH:MI:SS.FF'),
        null,
        null,
        null,
        'start',
...
insert into ACT_HI_ACTINST (
        ...
        null,
        to_timestamp('2012-11-21 14:06:53.745', 'YYYY-MM-DD HH:MI:SS.FF'),
        to_timestamp('2012-11-21 14:06:53.747', 'YYYY-MM-DD HH:MI:SS.FF'),
        2
      );
