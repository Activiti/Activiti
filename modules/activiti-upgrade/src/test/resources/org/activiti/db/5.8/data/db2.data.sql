insert into ACT_RE_DEPLOYMENT(ID_, NAME_, DEPLOY_TIME_)
    values('1', 'simpleTaskProcess', TIMESTAMP (''2012-11-21 17:29:05''));
...
update ACT_HI_ACTINST set
      EXECUTION_ID_ = '4',
      ASSIGNEE_ = 'kermit',
      END_TIME_ = TIMESTAMP (''2012-11-21 17:29:07''),
      DURATION_ = 528
    where ID_ = '6';
...
update ACT_HI_TASKINST set
      ...
      OWNER_ = null,
      ASSIGNEE_ = 'kermit',
      END_TIME_ = TIMESTAMP (''2012-11-21 17:29:06''),
      DURATION_ = 468,
...
insert into ACT_RE_DEPLOYMENT(ID_, NAME_, DEPLOY_TIME_)
    values('10', 'simpleTaskProcess', TIMESTAMP (''2012-11-21 17:29:07''));
