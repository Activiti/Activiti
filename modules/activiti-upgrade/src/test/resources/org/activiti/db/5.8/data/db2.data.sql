insert into ACT_RE_DEPLOYMENT(ID_, NAME_, DEPLOY_TIME_)
    values('1', 'simpleTaskProcess', TIMESTAMP ('2012-11-22 15:43:40'));
...
update ACT_HI_TASKINST set
      ...
      OWNER_ = null,
      ASSIGNEE_ = 'kermit',
      END_TIME_ = TIMESTAMP ('2012-11-22 15:43:41'),
      DURATION_ = 471,
...
insert into ACT_RE_DEPLOYMENT(ID_, NAME_, DEPLOY_TIME_)
    values('10', 'simpleTaskProcess', TIMESTAMP ('2012-11-22 15:43:41'));
