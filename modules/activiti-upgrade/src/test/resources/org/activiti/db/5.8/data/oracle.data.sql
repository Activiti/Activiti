insert into ACT_RE_DEPLOYMENT(ID_, NAME_, DEPLOY_TIME_)
    values('1', 'simpleTaskProcess', to_timestamp('2012-11-21 10:42:15.592', 'YYYY-MM-DD HH:MI:SS.FF'));
...
insert into ACT_HI_PROCINST (
        ...
        null,
        'simpleTaskProcess:1:3',
        to_timestamp('2012-11-21 10:42:16.460', 'YYYY-MM-DD HH:MI:SS.FF'),
        null,
        null,
        null,
        'start',
...
insert into ACT_HI_ACTINST (
        ...
        null,
        to_timestamp('2012-11-21 10:42:16.460', 'YYYY-MM-DD HH:MI:SS.FF'),
        to_timestamp('2012-11-21 10:42:16.468', 'YYYY-MM-DD HH:MI:SS.FF'),
        8
      );
...
insert into ACT_HI_TASKINST (
        ...
        null,
        'kermit',
        to_timestamp('2012-11-21 10:42:16.469', 'YYYY-MM-DD HH:MI:SS.FF'),
        null,
        null,
        null,
        'simpleTask1',
...
insert into ACT_HI_ACTINST (
        ...
        'userTask',
        'swedishchef',
        to_timestamp('2012-11-21 10:42:17.07', 'YYYY-MM-DD HH:MI:SS.FF'),
        null,
        null
      );
...
insert into ACT_RU_TASK (ID_, REV_, NAME_, PARENT_TASK_ID_, DESCRIPTION_, PRIORITY_, CREATE_TIME_, OWNER_,
    ...
    values ('9',
            ...
            'spicy sauce',
            50,
            to_timestamp('2012-11-21 10:42:17.08', 'YYYY-MM-DD HH:MI:SS.FF'),
            null,
            'swedishchef',
            null,
            '4',
...
update ACT_HI_TASKINST set
      ...
      OWNER_ = null,
      ASSIGNEE_ = 'kermit',
      END_TIME_ = to_timestamp('2012-11-21 10:42:16.946', 'YYYY-MM-DD HH:MI:SS.FF'),
      DURATION_ = 477,
...
update ACT_HI_ACTINST set
      EXECUTION_ID_ = '4',
      ASSIGNEE_ = 'kermit',
      END_TIME_ = to_timestamp('2012-11-21 10:42:17.07', 'YYYY-MM-DD HH:MI:SS.FF'),
      DURATION_ = 539
    where ID_ = '6';
...
insert into ACT_RE_DEPLOYMENT(ID_, NAME_, DEPLOY_TIME_)
    values('10', 'simpleTaskProcess', to_timestamp('2012-11-21 10:42:17.238', 'YYYY-MM-DD HH:MI:SS.FF'));
...
insert into ACT_HI_PROCINST (
        ...
        null,
        'taskWithExecutionVariablesProcess:1:12',
        to_timestamp('2012-11-21 10:42:17.497', 'YYYY-MM-DD HH:MI:SS.FF'),
        null,
        null,
        null,
        'start',
...
insert into ACT_HI_ACTINST (
        ...
        null,
        to_timestamp('2012-11-21 10:42:17.497', 'YYYY-MM-DD HH:MI:SS.FF'),
        to_timestamp('2012-11-21 10:42:17.522', 'YYYY-MM-DD HH:MI:SS.FF'),
        25
      );
...
insert into ACT_HI_DETAIL (ID_, TYPE_, PROC_INST_ID_, EXECUTION_ID_, ACT_INST_ID_, TASK_ID_, NAME_, REV_, VAR_TYPE_, TIME_, BYTEARRAY_ID_, DOUBLE_, LONG_ , TEXT_, TEXT2_)
    values (
      ...
      0,
      'string',
      to_timestamp('2012-11-21 10:42:17.521', 'YYYY-MM-DD HH:MI:SS.FF'),
      null,
      null,
      null,
      'gonzo',
