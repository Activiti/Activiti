...
import org.activiti.services.core.sort.ProcessDefinitionSortApplier;
...
public class PageableRepositoryService {
    ...
    @Autowired
    public PageableRepositoryService(RepositoryService repositoryService, PageRetriever pageRetriever, ProcessDefinitionConverter processDefinitionConverter, ProcessDefinitionSortApplier sortApplier) {
