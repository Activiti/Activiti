...
import org.activiti.services.core.sort.ProcessInstanceSortApplier;
...
public class PageableProcessInstanceService {
    ...
    @Autowired
    public PageableProcessInstanceService(PageRetriever pageRetriever, RuntimeService runtimeService, ProcessInstanceSortApplier sortApplier, ProcessInstanceConverter processInstanceConverter) {
