...
public class VariableSpecification extends BaseSpecification<Variable> implements Specification<Variable> {

    public VariableSpecification(SpecSearchCriteria criteria) {
        super(criteria);
    }
}
