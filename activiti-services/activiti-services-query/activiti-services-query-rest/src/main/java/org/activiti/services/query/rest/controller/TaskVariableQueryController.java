...
public class TaskVariableQueryController {
	...
	public PagedResources<VariableQueryResource> findAll(@PathVariable String taskId, Pageable pageable,
			PagedResourcesAssembler<VariableES> pagedResourcesAssembler) {

		return pagedResourcesAssembler.toResource(variableRepository.findAll(taskId, pageable), resourceAssembler);
	}
}