...
@JsonSubTypes({ @JsonSubTypes.Type(value = ProcessStartedEvent.class, name = "ProcessStartedEvent"),
...
public abstract class AbstractProcessEngineEvent implements ProcessEngineEvent {
	...
	public AbstractProcessEngineEvent(Long timestamp, String eventType, String executionId, String processDefinitionId,
