 ...
 */
@Component
public class TaskConverter implements ModelConverter<Task, org.activiti.services.model.Task> {
    ...
    @Override
    public org.activiti.services.model.Task from(Task task) {
        org.activiti.services.model.Task clientTask = new org.activiti.services.model.Task();
    ...
    @Override
    public List<org.activiti.services.model.Task> from(List<Task> tasks) {
