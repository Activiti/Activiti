...
public class ApplicationUpgradeContextServiceIT {
    ...
    public void should_retrieveManifest() throws IOException {
        ...
        assertThat(projectModel.getCreationDate())
            .isEqualTo("2019-08-16T15:58:46.056+0000");
        assertThat(projectModel.getDescription()).isEqualTo("");
        assertThat(projectModel.getId())
            .isEqualTo("c519a458-539f-4385-a937-2edfb4045eb9");
        assertThat(projectModel.getLastModifiedBy()).isEqualTo("qa-modeler-1");
        assertThat(projectModel.getLastModifiedDate())
            .isEqualTo("2019-08-16T16:03:41.941+0000");
    ...
    public void should_haveEnforcedAppVersionSet() {
        assertThat(applicationUpgradeContextService.hasEnforcedAppVersion())
            .isTrue();
        assertThat(applicationUpgradeContextService.getEnforcedAppVersion())
            .isEqualTo(1);
    }
}
