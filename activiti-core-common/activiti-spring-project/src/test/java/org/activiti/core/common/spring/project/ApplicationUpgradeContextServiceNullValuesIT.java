...
public class ApplicationUpgradeContextServiceNullValuesIT {
    ...
    @Autowired private ApplicationUpgradeContextService applicationUpgradeContextService;
    ...
    public void should_throwException_when_noManifestPresent() {
        ...
        Throwable thrown =
                catchThrowable(() -> applicationUpgradeContextService.loadProjectManifest());
        assertThat(thrown)
