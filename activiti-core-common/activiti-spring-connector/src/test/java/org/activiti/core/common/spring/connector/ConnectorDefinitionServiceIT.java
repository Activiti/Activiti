...
public class ConnectorDefinitionServiceIT {
  ...
  public void connectorDefinition() throws IOException {
    ...
    assertThat(connectorDefinitions.get(0).getActions().get("actionId1").getName())
        .isEqualTo("actionName1");
    assertThat(
            connectorDefinitions.get(0).getActions().get("actionId1").getInputs().get(0).getName())
        .isEqualTo("input-variable-name-1");
    assertThat(
            connectorDefinitions.get(0).getActions().get("actionId1").getOutputs().get(0).getName())
