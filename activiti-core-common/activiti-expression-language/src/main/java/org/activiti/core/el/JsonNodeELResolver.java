...
public class JsonNodeELResolver extends ELResolver {
     ...
     *     resolution. The thrown exception must be included as the cause property of this
    ...
    /**
     * Returns the {@link ObjectMapper} used internally to convert {@link List} properties.
     * Subclasses may override this method to provide a specific one
     */
     ...
     *     stored in this map.
     * @throws PropertyNotWritableException if this resolver was constructed in read-only mode, or
     *     if the put operation is not supported by the underlying map.
     * @throws ELException if an exception was thrown while performing the property or variable
     *     resolution. The thrown exception must be included as the cause property of this
     *     exception, if available.
     */
