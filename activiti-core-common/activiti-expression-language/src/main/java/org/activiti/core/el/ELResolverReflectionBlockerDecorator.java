...
public class ELResolverReflectionBlockerDecorator extends ELResolverDecorator {
    ...
    private static final Predicate<Method> IS_FINAL =
            method -> Modifier.isFinal(method.getModifiers());
    private static final Predicate<Method> IS_NATIVE =
            method -> Modifier.isNative(method.getModifiers());
    private static final Set<String> NATIVE_METHODS =
