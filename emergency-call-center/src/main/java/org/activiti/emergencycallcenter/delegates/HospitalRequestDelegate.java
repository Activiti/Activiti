...
public class HospitalRequestDelegate implements JavaDelegate {
  ...
  public void execute(DelegateExecution execution) {
    ...
    parameters.put(RestUtil.PROCESS_DEFINITION_KEY, properties.getProperty(EmergencyCallCenterProperties.HOSPITAL_ACTIVITI_DEFINITION_KEY));
	...
	RestUtil.sendResourceRequest(
      properties.getProperty(EmergencyCallCenterProperties.HOSPITAL_ACTIVITI_BASE_URL) + properties.getProperty(EmergencyCallCenterProperties.HOSPITAL_ACTIVITI_PROCESS_START_ENDPOINT), 
      properties.getProperty(EmergencyCallCenterProperties.HOSPITAL_ACTIVITI_USER), 
      properties.getProperty(EmergencyCallCenterProperties.HOSPITAL_ACTIVITI_PASSWORD), 
      parameters);
