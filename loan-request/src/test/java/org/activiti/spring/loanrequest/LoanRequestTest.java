 ...
 */
@ContextConfiguration(locations = "LoanRequest-context.xml")
public class LoanRequestTest extends SpringActivitiTestCase {
  ...
  protected void before() {
    String[] defs = {"org/activiti/spring/loanrequest/LoanRequest.bpmn20.xml"};
    for (String pd : defs)
...
/*
 * //Below illustrates non-xml configuration
 *
 * @Configuration
 * 
 ...
 * LocalContainerEntityManagerFactoryBean(); emf.setPersistenceXmlLocation( "classpath:/org/activiti/spring/loanrequest/custom-persistence.xml"); emf.setJpaVendorAdapter(openJpaVendorAdapter);
