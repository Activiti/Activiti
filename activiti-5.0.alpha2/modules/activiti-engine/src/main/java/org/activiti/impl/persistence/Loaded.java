...
public class Loaded {
  ...
  static {
    updateStatementIds.put(DbExecutionImpl.class, "org.activiti.persistence.updateExecution");
    ...
    updateStatementIds.put(VariableInstance.class, "org.activiti.persistence.updateVariableInstance");
    updateStatementIds.put(ByteArrayImpl.class, "org.activiti.persistence.updateByteArray");
  }
