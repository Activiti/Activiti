...
The Activiti Explorer webapp allows uploading bar files (and single +bpmn20.xml+ or +.bpmn+ files) through the webapp user interface. Choose the _Management tab_ and click on __Deployment__:
