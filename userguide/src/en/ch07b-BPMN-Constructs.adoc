...
An Event Sub-Process is represented using XML in the same way as a an <<bpmnSubProcessXMLRepresentation,embedded subprocess>>. In addition the attribute +triggeredByEvent+ must have the value ++true++:
