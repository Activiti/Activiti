 ...
 * {@link Configuration} instance and is a costly operation which should be
...
public interface ProcessEngine {
  ...
  public static String VERSION = "5.0.alpha1";

  /** the name as specified in the 'name' attribute in the 
   * root element of an activiti.cfg.xml configuration file */
  String getName();
