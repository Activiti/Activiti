 ...
 * @author Tom Baeyens
 */
public class GetNextDbidBlockCmd implements Cmd<DbidBlock> {

  public DbidBlock execute(TransactionContext transactionContext) {
    PersistenceSession persistenceSession = transactionContext.getTransactionalObject(PersistenceSession.class);
    return persistenceSession.getNextDbidBlock();
  }
}
