...
public class StateManager {
  ...
  public StateManager(Object target, String stateFieldName, ClientProcessDefinition processDefinition) {
    this(target, stateFieldName, processDefinition, false);
  }

  public StateManager(Object target, String stateFieldName, ClientProcessDefinition processDefinition, boolean initialize) {
    this.target = target;
