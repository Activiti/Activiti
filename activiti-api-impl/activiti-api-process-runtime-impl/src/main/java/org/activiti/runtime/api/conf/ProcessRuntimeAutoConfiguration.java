...
import org.activiti.runtime.api.event.internal.MessageCancelledListenerDelegate;
...
public class ProcessRuntimeAutoConfiguration {
    ...
    @Bean
    @ConditionalOnMissingBean(name = "registerMessageCancelledListenerDelegate")
    public InitializingBean registerMessageCancelledListenerDelegate(RuntimeService runtimeService,
                                                                     @Autowired(required = false) List<BPMNElementEventListener<BPMNMessageCancelledEvent>> eventListeners,
                                                                     BPMNMessageConverter bpmnMessageConverter) {
        return () -> runtimeService.addEventListener(new MessageCancelledListenerDelegate(getInitializedListeners(eventListeners),
                        new ToMessageCancelledConverter(bpmnMessageConverter)),
