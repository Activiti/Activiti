...
import org.activiti.api.runtime.event.impl.BPMNTimerCanceledEventImpl;
import org.activiti.api.runtime.model.impl.BPMNTimerImpl;
import org.activiti.engine.delegate.event.ActivitiEntityEvent;
import org.activiti.engine.impl.persistence.entity.TimerJobEntityImpl;

public class ToTimerCanceledConverter implements EventConverter<BPMNTimerCanceledEvent, ActivitiEntityEvent> {

    public ToTimerCanceledConverter() {
    }

    @Override
    public Optional<BPMNTimerCanceledEvent> from(ActivitiEntityEvent internalEvent) {
        ...
        BPMNTimerCanceledEventImpl event = new BPMNTimerCanceledEventImpl(timer);
