...
import org.activiti.api.runtime.event.impl.BPMNTimerExecutionFailureEventImpl;
import org.activiti.api.runtime.model.impl.BPMNTimerImpl;
import org.activiti.engine.delegate.event.ActivitiEntityEvent;
import org.activiti.engine.impl.persistence.entity.JobEntityImpl;

public class ToTimerExecutionFailureConverter implements EventConverter<BPMNTimerExecutionFailureEvent, ActivitiEntityEvent> {

    public ToTimerExecutionFailureConverter() {
    }

    @Override
    public Optional<BPMNTimerExecutionFailureEvent> from(ActivitiEntityEvent internalEvent) {
        ...
        BPMNTimerExecutionFailureEventImpl event = new BPMNTimerExecutionFailureEventImpl(timer);
