...
public class ProcessModelAutoConfiguration {
    ...
    public Module customizeProcessModelObjectMapper(
        ...
        resolver.addMapping(
            StartMessageSubscription.class,
        ...
        resolver.addMapping(
            StartMessageDeploymentDefinition.class,
            StartMessageDeploymentDefinitionImpl.class
        );
        resolver.addMapping(
            ProcessCandidateStarterUser.class,
            ProcessCandidateStarterUserImpl.class
        );
        resolver.addMapping(
            ProcessCandidateStarterGroup.class,
        ...
        module.registerSubtypes(
            new NamedType(
                SuspendProcessPayload.class,
                SuspendProcessPayload.class.getSimpleName()
            )
        );
        module.registerSubtypes(
            new NamedType(
                ResumeProcessPayload.class,
        ...
        module.registerSubtypes(
            new NamedType(
                StartMessagePayload.class,
                StartMessagePayload.class.getSimpleName()
            )
        );
        module.registerSubtypes(
            new NamedType(
                ReceiveMessagePayload.class,
                ReceiveMessagePayload.class.getSimpleName()
            )
        );
        module.registerSubtypes(
            new NamedType(
                MessageEventPayload.class,
                MessageEventPayload.class.getSimpleName()
            )
        );
        module.setAbstractTypes(resolver);

        ConversionService conversionService = conversionServiceProvider.getIfUnique(
            this::conversionService
        );

        module.addSerializer(
            new ProcessVariablesMapSerializer(conversionService)
        );
    ...
    @Bean
    public MapToStringConverter mapToStringConverter(
        @Lazy ObjectMapper objectMapper
    ) {
    ...
    @Bean
    public StringToJsonNodeConverter stringToJsonNodeConverter(
        @Lazy ObjectMapper objectMapper
    ) {
    ...
    @Bean
    public JsonNodeToStringConverter jsonNodeToStringConverter(
        @Lazy ObjectMapper objectMapper
    ) {
    ...
    @Bean
    public StringToListConverter sringToListConverter(
        @Lazy ObjectMapper objectMapper
    ) {
    ...
    @Bean
    public StringToSetConverter stringToSetConverter(
        @Lazy ObjectMapper objectMapper
    ) {
    ...
    @Bean
    public SetToStringConverter setToStringConverter(
        @Lazy ObjectMapper objectMapper
    ) {
