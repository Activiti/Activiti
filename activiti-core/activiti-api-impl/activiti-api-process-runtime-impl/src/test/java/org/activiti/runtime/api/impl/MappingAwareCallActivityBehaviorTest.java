...
public class MappingAwareCallActivityBehaviorTest {
  ...
  @InjectMocks private MappingAwareCallActivityBehavior behavior;

  @Mock private ExtensionsVariablesMappingProvider mappingProvider;

  @Mock private ProcessVariablesInitiator processVariablesInitiator;
  ...
  @Test
  public void
      calculateInboundVariablesShouldTakeIntoAccountMappingProviderAndProcessVariablesInitiator() {
    // given
    ...
    given(
            processVariablesInitiator.calculateVariablesFromExtensionFile(
                processDefinition, providerVariables))
        .willReturn(initiatorVariables);

    // when
    Map<String, Object> inboundVariables =
        behavior.calculateInboundVariables(execution, processDefinition);
    // then
