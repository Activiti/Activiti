...
public class IntegrationContextBuilderTest {
    ...
    @InjectMocks private IntegrationContextBuilder builder;

    @Mock private ExtensionsVariablesMappingProvider inboundVariablesProvider;
    ...
    public void setUp() {
        ...
        given(deploymentManager.findDeployedProcessDefinitionById(PROCESS_DEFINITION_ID))
