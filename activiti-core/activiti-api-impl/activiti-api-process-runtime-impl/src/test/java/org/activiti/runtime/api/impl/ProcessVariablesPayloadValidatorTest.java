...
public class ProcessVariablesPayloadValidatorTest {
    ...
    @Test
    public void
            should_throwIllegalStateException_when_payloadVariableWithExpressionInStringVariable() {
        Throwable throwable =
                catchThrowable(
                        () ->
                                processVariablesValidator.checkPayloadVariables(
    ...
    @Test
    public void
            should_throwIllegalStateException_when_payloadVariableWithExpressionInObjectVariable()
                    throws IOException {
        Throwable throwable =
                catchThrowable(
                        () ->
