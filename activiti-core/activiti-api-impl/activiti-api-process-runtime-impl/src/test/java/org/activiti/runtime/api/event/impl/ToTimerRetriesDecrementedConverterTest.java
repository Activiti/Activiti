...
public class ToTimerRetriesDecrementedConverterTest {
    ...
    @InjectMocks private ToTimerRetriesDecrementedConverter toTimerConverter;
    ...
    public void shouldReturnConvertedEventsWhenInternalEvenIsRelatedToTimers() {
        ...
        // when
        BPMNTimerRetriesDecrementedEvent timerEvent =
                toTimerConverter.from(internalEvent).orElse(null);
    ...
    public void shouldReturnEmptyOptionalWhenInternalEventIsNotRelatedToTimers() {
        ...
        // when
        Optional<BPMNTimerRetriesDecrementedEvent> optional =
                toTimerConverter.from(mock(ActivitiEntityEvent.class));
