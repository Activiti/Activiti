...
public class TimerRetriesDecrementedListenerDelegateTest {
  ...
  @Mock private BPMNElementEventListener<BPMNTimerRetriesDecrementedEvent> listener;

  @Mock private ToTimerRetriesDecrementedConverter converter;

  @BeforeEach
  public void setUp() {
    initMocks(this);
    listenerDelegate =
        new TimerRetriesDecrementedListenerDelegate(singletonList(listener), converter);
  }
  ...
  public void shouldCallRegisteredListenersWhenConvertedEventIsNotEmpty() {
    ...
    BPMNTimerRetriesDecrementedEventImpl convertedEvent =
