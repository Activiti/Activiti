...
@SpringBootTest
@TestPropertySource(properties = {"activiti.enable.jsonpatch.path.variables=true"})
public class ExtensionsVariablesMappingProviderTest_withJsonPatchPathVariablesEnabled {
