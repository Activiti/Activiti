...
public class ExtensionsVariablesMappingProviderTest {
    ...
    public void calculateOutputVariablesShouldDoMappingWhenThereIsMappingSet() throws Exception {
        ...
        Map<String, Object> entityVariables =
                singletonMap("task_output_variable_name_1", "var-one");
    ...
    private DelegateExecution initExpressionResolverTest(
            String fileName, String processDefinitionKey) throws IOException {
        ObjectMapper objectMapper = new ObjectMapper();
        ProcessExtensionModel extensions =
                objectMapper.readValue(
        ...
        DelegateExecution execution =
                buildExecution(extensions.getExtensions(processDefinitionKey));
        ExpressionResolver expressionResolver =
    ...
    public void should_substituteExpressions_when_expressionIsInProperties() throws Exception {
        DelegateExecution execution =
                initExpressionResolverTest(
                        "expression-in-properties.json", "Process_expressionProperty");
