...
public class ExtensionsVariablesMappingProviderTest {
  ...
  @InjectMocks private ExtensionsVariablesMappingProvider variablesMappingProvider;

  @Mock private ProcessExtensionService processExtensionService;
  ...
  public void calculateInputVariablesShouldDoMappingWhenThereIsMappingSet() throws Exception {
    ...
    ExpressionResolver expressionResolver =
        ExpressionResolverHelper.initContext(execution, processExtensions);

    ReflectionTestUtils.setField(
        variablesMappingProvider, "expressionResolver", expressionResolver);

    // when
    Map<String, Object> inputVariables =
        variablesMappingProvider.calculateInputVariables(execution);
    ...
    assertThat(inputVariables)
        .doesNotContainKeys("task_input_variable_mapped_with_null_process_variable");
  }
  ...
  public void calculateInputVariablesShouldNotPassAnyVariablesWhenTheMappingIsEmpty()
    ...
    DelegateExecution execution =
        buildExecution(extensions.getExtensions("Process_taskVariableEmptyMapping"));
  ...
  public void calculateInputVariablesShouldPassOnlyConstantsWhenTheMappingIsEmpty()
    ...
    DelegateExecution execution =
        buildExecution(extensions.getExtensions("Process_taskVariableEmptyMappingWithContants"));
  ...
  public void calculateOutputVariablesShouldDoMappingWhenThereIsMappingSet() throws Exception {
    ...
    Map<String, Object> outPutVariables =
        variablesMappingProvider.calculateOutPutVariables(
            buildMappingExecutionContext(execution), entityVariables);
  ...
  public void calculateOutputVariablesShouldPassAllVariablesWhenThereIsNoMapping()
    ...
    DelegateExecution execution =
        buildExecution(extensions.getExtensions("Process_taskVariableNoMapping"));
    ...
    Map<String, Object> outPutVariables =
        variablesMappingProvider.calculateOutPutVariables(
            buildMappingExecutionContext(execution), taskVariables);
  ...
  private DelegateExecution initExpressionResolverTest(String fileName, String processDefinitionKey)
    ...
    ProcessExtensionModel extensions =
        objectMapper.readValue(
            new File("src/test/resources/expressions/" + fileName), ProcessExtensionModel.class);

    DelegateExecution execution = buildExecution(extensions.getExtensions(processDefinitionKey));
    ExpressionResolver expressionResolver =
        ExpressionResolverHelper.initContext(
            execution, extensions.getExtensions(processDefinitionKey));
  ...
  public void should_notSubstituteExpressions_when_thereAreNoExpressions() throws Exception {
    DelegateExecution execution =
        initExpressionResolverTest("no-expression.json", "Process_NoExpression");
  ...
  public void should_notSubstituteExpressions_when_expressionIsInConstants() throws Exception {
    DelegateExecution execution =
        initExpressionResolverTest(
            "expression-in-constants.json", "Process_expression-in-constants");
  ...
  public void should_substituteExpressions_when_expressionIsInInputMappingValue() throws Exception {
    DelegateExecution execution =
        initExpressionResolverTest(
            "expression-in-mapping-input-value.json", "Process_expressionMappingInputValue");
  ...
  public void should_notSubstituteExpressions_when_expressionIsInInputMappingVariable()
    ...
    DelegateExecution execution =
        initExpressionResolverTest(
            "expression-in-mapping-input-variable.json", "Process_expressionMappingInputVariable");
  ...
  public void should_substituteExpressions_when_expressionIsInOutputMappingValue()
    ...
    DelegateExecution execution =
        initExpressionResolverTest(
            "expression-in-mapping-output-value.json", "Process_expressionMappingOutputValue");
  ...
  public void should_substituteExpressions_when_expressionIsInProperties() throws Exception {
    DelegateExecution execution =
        initExpressionResolverTest("expression-in-properties.json", "Process_expressionProperty");
  ...
  public void should_returnEmptyOutputMapping_when_thereIsNoAvaliableVariableInTask()
    ...
    Map<String, Object> outputMapping =
        variablesMappingProvider.calculateOutPutVariables(
            buildMappingExecutionContext(execution), null);
  ...
  public void should_returnEmptyOutputMapping_when_thereIsAnEmptyValueInOutputMappingVariable()
    ...
    DelegateExecution execution =
        initExpressionResolverTest(
            "no-value-in-output-mapping-variable.json", "Process_noValueOutputMappingVariable");
