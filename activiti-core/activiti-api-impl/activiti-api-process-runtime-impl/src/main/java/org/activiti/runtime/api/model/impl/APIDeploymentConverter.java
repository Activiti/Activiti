...
public class APIDeploymentConverter
    ...
    implements
        ModelConverter<org.activiti.engine.repository.Deployment, Deployment> {

    @Override
    public Deployment from(
        org.activiti.engine.repository.Deployment internalDeployment
    ) {
        ...
        deployment.setProjectReleaseVersion(
            internalDeployment.getProjectReleaseVersion()
        );
