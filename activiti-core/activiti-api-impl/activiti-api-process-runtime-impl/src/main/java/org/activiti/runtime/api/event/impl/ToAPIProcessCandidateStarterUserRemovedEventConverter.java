...
public class ToAPIProcessCandidateStarterUserRemovedEventConverter
    implements
        EventConverter<ProcessCandidateStarterUserRemovedEvent, ActivitiEntityEvent> {
    ...
    public ToAPIProcessCandidateStarterUserRemovedEventConverter(
        APIProcessCandidateStarterUserConverter converter
    ) {
        this.converter = converter;
    }

    @Override
    public Optional<ProcessCandidateStarterUserRemovedEvent> from(
        ...
        if (internalEvent.getEntity() instanceof IdentityLink) {
            ...
            if (
                ...
                event =
                    new ProcessCandidateStarterUserRemovedEventImpl(
