...
public class ToActivityCompletedConverter
        implements EventConverter<BPMNActivityCompletedEvent, ActivitiActivityEvent> {
    ...
    public Optional<BPMNActivityCompletedEvent> from(ActivitiActivityEvent internalEvent) {
        return Optional.of(
                new BPMNActivityCompletedEventImpl(toActivityConverter.from(internalEvent)));
    }
}
