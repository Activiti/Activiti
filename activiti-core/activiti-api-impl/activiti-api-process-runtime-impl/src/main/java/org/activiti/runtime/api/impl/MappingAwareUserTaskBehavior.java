...
public class MappingAwareUserTaskBehavior extends UserTaskActivityBehavior {
    ...
    public MappingAwareUserTaskBehavior(
            UserTask userTask, VariablesCalculator variablesCalculator) {
        super(userTask);
    ...
    protected Map<String, Object> calculateOutBoundVariables(
            DelegateExecution execution, Map<String, Object> taskCompleteVariables) {
        return variablesCalculator.calculateOutPutVariables(
                buildMappingExecutionContext(execution), taskCompleteVariables);
    }
}
