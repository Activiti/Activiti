...
public class TimerRetriesDecrementedListenerDelegate implements ActivitiEventListener {
    ...
    private List<BPMNElementEventListener<BPMNTimerRetriesDecrementedEvent>>
    ...
    public TimerRetriesDecrementedListenerDelegate(
            List<BPMNElementEventListener<BPMNTimerRetriesDecrementedEvent>>
                    processRuntimeEventListeners,
    ...
    public void onEvent(ActivitiEvent event) {
        converter
                ...
                .ifPresent(
                        convertedEvent -> {
                            for (BPMNElementEventListener<BPMNTimerRetriesDecrementedEvent>
                                    listener : processRuntimeEventListeners) {
