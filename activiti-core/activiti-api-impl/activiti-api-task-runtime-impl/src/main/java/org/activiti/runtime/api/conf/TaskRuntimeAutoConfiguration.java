...
public class TaskRuntimeAutoConfiguration {
  ...
  public TaskAdminRuntime taskAdminRuntime(
    ...
    return new TaskAdminRuntimeImpl(
        taskService, taskConverter, variableInstanceConverter, taskRuntimeHelper, securityManager);
  }
  ...
  public TaskRuntimeHelper taskRuntimeHelper(
    ...
    return new TaskRuntimeHelper(
        taskService, taskConverter, securityManager, taskVariablesValidator);
  }
  ...
  public TaskVariablesPayloadValidator taskVariablesValidator(
      DateFormatterProvider dateFormatterProvider, VariableNameValidator variableNameValidator) {
    ...
    return () ->
        runtimeService.addEventListener(
            new TaskCreatedListenerDelegate(
                getInitializedTaskRuntimeEventListeners(listeners), taskCreatedEventConverter),
    ...
    return () ->
        runtimeService.addEventListener(
            new TaskAssignedListenerDelegate(
                getInitializedTaskRuntimeEventListeners(listeners), taskAssignedEventConverter),
