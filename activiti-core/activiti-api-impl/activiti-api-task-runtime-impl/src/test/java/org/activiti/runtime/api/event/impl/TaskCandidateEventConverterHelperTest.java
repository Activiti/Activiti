...
public class TaskCandidateEventConverterHelperTest {
    ...
    public void isTaskCandidateUserLink_when_taskId_userId_and_typeCandidate() {
        IdentityLink identityLink = createUserIdentityLink(
            "aTaskId",
            "aUserId",
    ...
    public void isTaskCandidateGroupLink_when_taskId_groupId_and_typeCandidate() {
        IdentityLink identityLink = createGroupIdentityLink(
            "aTaskId",
            "aGroupId",
            IdentityLinkType.CANDIDATE
        );
    ...
    private IdentityLinkEntityImpl createUserIdentityLink(
        String taskId,
        String userId,
        String type
    ) {
    ...
    private IdentityLinkEntityImpl createGroupIdentityLink(
        String taskId,
        String groupId,
        String type
    ) {
