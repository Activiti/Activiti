...
public class ProcessVariablesTest {
    ...
    private void startProcess() {
        processInstanceId = processRuntime
            .start(
    ...
    private void setVariables() {
        ...
        processRuntime.setVariables(
            new SetVariablesPayloadBuilder()
                .withVariables(variablesMap)
                .withProcessInstanceId(processInstanceId)
                .build()
        );

        variableInstanceList = processRuntime.variables(
            new GetVariablesPayloadBuilder().withProcessInstanceId(processInstanceId).build()
        );
    }
