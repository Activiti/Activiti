...
public class BaseElementTest {
    ...
    public void testGetAttributeValue() {
        // Given
        ExtensionAttribute extensionAttributeOne =
                createExtensionAttribute("attrOne", "attrValueOne");

        ExtensionAttribute extensionAttributeTwo =
                createExtensionAttribute("attrTwo", "attrValueTwo");
        extensionAttributeTwo.setNamespace(null);

        ExtensionAttribute extensionAttributeThree =
                createExtensionAttribute("attrThree", "attrValueTwo");
    ...
    public void testSetValues() {
        ...
        List<ExtensionElement> extensionElements =
                baseElement.getExtensionElements().get("elementOne");
        ...
        List<ExtensionAttribute> nestedAttributesInElementOne =
                extensionElementOne.getAttributes().get("attrOneElementOne");
    ...
    private BaseElement createOtherBaseElement() {
        ...
        ExtensionElement extensionElementOne =
                createExtensionElement("elementOne", singletonList(extensionAttributeElementOne));

        ExtensionAttribute extensionAttributeOne =
                createExtensionAttribute("attrOne", "prefix", "attrValueOne");
    ...
    private ExtensionElement createExtensionElement(
            String name, List<ExtensionAttribute> extensionAttributes) {
