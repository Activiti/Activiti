...
public class InclusiveGatewayTest extends PluggableActivitiTestCase {
    ...
    public void testMergingInclusiveGateway() {
        ProcessInstance pi =
                runtimeService.startProcessInstanceByKey(
                        "inclusiveGwMerging", singletonMap("input", 2));
    ...
    public void testDecideBasedOnListOrArrayOfBeans() {
        ...
        assertThatExceptionOfType(ActivitiException.class)
                .isThrownBy(
                        () ->
                                runtimeService.startProcessInstanceByKey(
                                        "inclusiveDecisionBasedOnListOrArrayOfBeans",
    ...
    public void testLoop() {
        ProcessInstance pi =
                runtimeService.startProcessInstanceByKey(
                        "inclusiveTestLoop", singletonMap("counter", 1));
    ...
    public void testMultipleProcessInstancesMergedBug() {
        ...
        // Verify there is an inactive execution in the inclusive gateway before the task complete
        // of
        // process instance 1
        ...
        // Before bugfix: in BOTH process instances the inactive execution was removed (result was
        // 0)
