...
public class SerializePOJOJsonTest extends ResourceActivitiTestCase {
  ...
  public void testJsonVarInExpression() throws Exception {
    ...
    ProcessInstance processInstance =
        runtimeService.startProcessInstanceByKey("testJsonVarInExpression", vars);
    String taskId =
        taskService
            .createTaskQuery()
  ...
  public void testCollectionJsonVarInExpression() throws Exception {
    ...
    vars.put("userCollection", list);
    ProcessInstance processInstance =
        runtimeService.startProcessInstanceByKey("testCollectionJsonVarInExpression", vars);
    String taskId =
        taskService
            .createTaskQuery()
            .processInstanceId(processInstance.getId())
  ...
  public void testCollectionInJsonVarInExpression() throws Exception {
    ...
    vars.put("userMap", map);
    ProcessInstance processInstance =
        runtimeService.startProcessInstanceByKey("testCollectionInJsonVarInExpression", vars);
    String taskId =
        taskService
            .createTaskQuery()
            .processInstanceId(processInstance.getId())
    ...
    List<SomeSerializable> beanList =
        asList(
  ...
  public void testPOJOCollectionInJsonVarInExpression() throws Exception {
    ...
    vars.put("userMap", map);
    ProcessInstance processInstance =
        runtimeService.startProcessInstanceByKey("testPOJOCollectionInJsonVarInExpression", vars);
    String taskId =
        taskService
            .createTaskQuery()
            .processInstanceId(processInstance.getId())
