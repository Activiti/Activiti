...
public class HistoryServiceTest extends PluggableActivitiTestCase {
  ...
  public void testExcludeSubprocesses() {
    ...
    List<HistoricProcessInstance> instanceList =
        historyService.createHistoricProcessInstanceQuery().excludeSubprocesses(false).list();
  ...
  public void testHistoricProcessInstanceQueryByProcessDefinitionKey() {
    ...
    HistoricProcessInstance historicProcessInstance =
        historyService
            ...
            .singleResult();
    assertThat(historicProcessInstance).isNotNull();
    assertThat(historicProcessInstance.getProcessDefinitionKey().equals(processDefinitionKey))
        .isTrue();
    assertThat(historicProcessInstance.getStartActivityId()).isEqualTo("theStart");

    // now complete the task to end the process instance
    Task task =
        taskService.createTaskQuery().processDefinitionKey("checkCreditProcess").singleResult();
    ...
    HistoricProcessInstance historicProcessInstanceSub =
        historyService
            .createHistoricProcessInstanceQuery()
            .processDefinitionKey("checkCreditProcess")
            .singleResult();
    HistoricProcessInstance historicProcessInstanceSuper =
        historyService
            .createHistoricProcessInstanceQuery()
  ...
  public void testHistoricProcessInstanceQueryByDeploymentId() {
    ...
    HistoricProcessInstanceQuery processInstanceQuery =
        historyService.createHistoricProcessInstanceQuery().deploymentId(deployment.getId());
    assertThat(processInstanceQuery.count()).isEqualTo(5);
    ...
    processInstanceQuery =
        historyService.createHistoricProcessInstanceQuery().deploymentId("invalid");
    assertThat(processInstanceQuery.count()).isEqualTo(0);
  }
  ...
  public void testHistoricProcessInstanceQueryByDeploymentIdIn() {
    ...
    HistoricProcessInstanceQuery processInstanceQuery =
        historyService.createHistoricProcessInstanceQuery().deploymentIdIn(deploymentIds);
    assertThat(processInstanceQuery.count()).isEqualTo(5);
  ...
  public void testHistoricTaskInstanceQueryByDeploymentId() {
    ...
    HistoricTaskInstanceQuery taskInstanceQuery =
        historyService.createHistoricTaskInstanceQuery().deploymentId(deployment.getId());
  ...
  public void testHistoricTaskInstanceQueryByDeploymentIdIn() {
    ...
    deploymentIds.add(deployment.getId());
    HistoricTaskInstanceQuery taskInstanceQuery =
        historyService.createHistoricTaskInstanceQuery().deploymentIdIn(deploymentIds);
    assertThat(taskInstanceQuery.count()).isEqualTo(5);
  ...
  public void testHistoricTaskInstanceOrQueryByDeploymentId() {
    ...
    taskInstanceQuery =
        historyService.createHistoricTaskInstanceQuery().or().deploymentId("invalid").endOr();
    assertThat(taskInstanceQuery.count()).isEqualTo(0);
  ...
  public void testLocalizeTasks() throws Exception {
    ...
    ObjectNode infoNode =
        dynamicBpmnService.changeLocalizationName("en-GB", "theTask", "My localized name");
    dynamicBpmnService.changeLocalizationDescription(
        "en-GB".toString(), "theTask", "My localized description", infoNode);
  ...
  public void testHistoricVariableInstancesOnParallelExecution() {
    ProcessInstance pi =
        runtimeService.startProcessInstanceByKey("concurrent", singletonMap("rootValue", "test"));
  ...
  public void testQueryStringVariable() {
    ...
    processInstances =
        historyService.createHistoricProcessInstanceQuery().variableValueEquals("abcdef").list();
    assertThat(processInstances).hasSize(2);
    expectedIds = asList(processInstance1.getId(), processInstance2.getId());
    ids =
        new ArrayList<String>(
  ...
  public void testQueryDateVariable() throws Exception {
    ...
    ProcessInstance processInstance1 =
        runtimeService.startProcessInstanceByKey("oneTaskProcess", singletonMap("dateVar", date1));
    taskService.complete(
        taskService
            .createTaskQuery()
            .processInstanceId(processInstance1.getId())
    ...
    HistoricProcessInstanceQuery query =
        historyService.createHistoricProcessInstanceQuery().variableValueEquals("dateVar", date1);
    List<HistoricProcessInstance> processInstances = query.list();
    assertThat(processInstances).isNotNull();
    assertThat(processInstances).hasSize(2);
    ...
    processInstances =
        historyService.createHistoricProcessInstanceQuery().variableValueEquals(date1).list();
    assertThat(processInstances).hasSize(2);
    expectedIds = asList(processInstance1.getId(), processInstance2.getId());
    ids =
        new ArrayList<String>(
