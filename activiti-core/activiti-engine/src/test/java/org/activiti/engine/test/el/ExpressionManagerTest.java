...
public class ExpressionManagerTest extends PluggableActivitiTestCase {
    ...
    public void testMethodExpressions() {
        ...
        assertThat(
            runtimeService.createProcessInstanceQuery().processDefinitionKey("methodExpressionProcess").count()
        ).isEqualTo(0);
    }
    ...
    public void testAuthenticatedUserIdAvailable() {
        try {
            ...
            ProcessInstance processInstance = runtimeService.startProcessInstanceByKey(
                "testAuthenticatedUserIdAvailableProcess"
            );
