...
public class TransactionSubProcessTest extends PluggableActivitiTestCase {
    ...
    public void testSimpleCaseTxSuccessful() {
        ...
        ProcessInstance processInstance =
                runtimeService.startProcessInstanceByKey("transactionProcess");
        ...
        Execution eventScopeExecution =
                runtimeService
                        .createExecutionQuery()
                        .executionId(eventSubscriptionEntity.getConfiguration())
                        .singleResult();
        assertThat(eventScopeExecution).isNotNull();

        // we still have compensate event subscriptions for the compensation handlers, only now they
        // are
        // part of the event scope
        assertThat(
                        createEventSubscriptionQuery()
                                .eventType("compensate")
                                .activityId("undoBookHotel")
    ...
    public void testSimpleCaseTxCancelled() {
        ...
        assertThat(runtimeService.getVariable(processInstance.getId(), "undoBookHotel"))
                .isEqualTo(1);
        assertThat(runtimeService.getVariable(processInstance.getId(), "undoBookFlight"))
                .isEqualTo(1);
        assertThat(runtimeService.getVariable(processInstance.getId(), "undoChargeCard"))
                .isEqualTo(1);
    ...
    public void testCancelEndConcurrent() {
        ...
        // if we have history, we check that the invocation of the compensation handlers is recorded
        // in
        // history.
        if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.ACTIVITY)) {
            assertThat(
    ...
    public void testNestedCancelInner() {
        ...
        Task taskInner =
                taskService
                        .createTaskQuery()
                        .taskDefinitionKey("innerTxaskCustomer")
                        .singleResult();
        Task taskOuter =
                taskService.createTaskQuery().taskDefinitionKey("bookFlight").singleResult();
        ...
        // assert that the compensation handlers have been invoked:
        assertThat(runtimeService.getVariable(processInstance.getId(), "innerTxundoBookHotel"))
                .isEqualTo(5);
        assertThat(runtimeService.getVariable(processInstance.getId(), "innerTxundoBookFlight"))
                .isEqualTo(1);
        ...
        runtimeService.trigger(
                runtimeService
                        .createExecutionQuery()
                        .activityId("afterInnerCancellation")
                        .singleResult()
                        .getId());
    ...
    public void testNestedCancelOuter() {
        ...
        runtimeService.trigger(
                runtimeService
                        .createExecutionQuery()
                        .activityId("afterOuterCancellation")
                        .singleResult()
                        .getId());
    ...
    public void testMultiInstanceTx() {
        ...
        List<EventSubscriptionEntity> eventSubscriptionEntities =
                createEventSubscriptionQuery().eventType("compensate").list();
    ...
    public void testMultiInstanceTxSuccessful() {
        ...
        List<EventSubscriptionEntity> EventSubscriptionEntitys =
                createEventSubscriptionQuery().eventType("compensate").list();
        ...
        List<Execution> executions =
                runtimeService.createExecutionQuery().activityId("receive").list();
    ...
    public void testMultipleCancelBoundaryFails() {
        assertThatExceptionOfType(ActivitiException.class)
                ...
                .withMessageContaining(
                        "multiple boundary events with cancelEventDefinition not supported on same"
                                + " transaction");
    }
                ...
                .isThrownBy(
                        () ->
                                repositoryService
                                        ...
                                        .deploy())
                .withMessageContaining(
                        "boundary event with cancelEventDefinition only supported on transaction"
                                + " subprocesses");
    }
                ...
                .isThrownBy(
                        () ->
                                repositoryService
                                        ...
                                        .deploy())
                .withMessageContaining(
                        "end event with cancelEventDefinition only supported inside transaction"
                                + " subprocess");
    }
    ...
    public void testParseWithDI() {
        ...
        ProcessInstance processInstance =
                runtimeService.startProcessInstanceByKey("TransactionSubProcessTest");
