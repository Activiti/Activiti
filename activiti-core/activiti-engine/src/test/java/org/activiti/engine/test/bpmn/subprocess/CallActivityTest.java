...
public class CallActivityTest extends ResourceActivitiTestCase {
    ...
    public void testInstantiateSuspendedProcessByMessage() throws Exception {
        ...
        Deployment messageTriggeredBpmnDeployment = processEngine.getRepositoryService()
            .createDeployment().name("messageTriggeredProcessDeployment")
            .addBpmnModel("messageTriggered.bpmn20.xml",
                messageTriggeredBpmnModel).deploy();
    ...
    public void testInstantiateChildProcess() throws Exception {
        ...
        processEngine.getRepositoryService().createDeployment().name("childProcessDeployment")
    ...
    public void testInstantiateSuspendedChildProcess() throws Exception {
        ...
        Deployment childDeployment = processEngine.getRepositoryService().createDeployment()
            .name("childProcessDeployment").addBpmnModel("childProcess.bpmn20.xml",
                childBpmnModel).deploy();
    ...
    public void testInstantiateSubprocess() throws Exception {
        ...
        processEngine.getRepositoryService().createDeployment().name("masterProcessDeployment")
            .addBpmnModel("masterProcess.bpmn20.xml",
    ...
    public void testInheritVariablesSubprocess() throws Exception {
        ...
        List<HistoricVariableInstance> variableInstances = variableInstanceQuery.processInstanceId(
            calledInstanceId).list();
    ...
    private void suspendProcessDefinitions(Deployment childDeployment) {
        List<ProcessDefinition> childProcessDefinitionList = repositoryService.createProcessDefinitionQuery()
            .deploymentId(childDeployment.getId()).list();
