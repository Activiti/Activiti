...
public class BoundaryTimerNonInterruptingEventTest extends PluggableActivitiTestCase {
    ...
    public void testMultipleTimersOnUserTask() {
        ...
        TimerJobQuery jobQuery =
                managementService.createTimerJobQuery().processInstanceId(pi.getId());
    ...
    public void testTimerOnConcurrentTasks() {
        ...
        Task task =
                taskService.createTaskQuery().taskDefinitionKey("timerFiredTask").singleResult();
    ...
    public void testTimerWithCycle() throws Exception {
        ...
        // a new job must be prepared because there are indefinite number of repeats 1 hour
        // interval");
        assertThat(
                        managementService
                                .createTimerJobQuery()
    ...
    public void testReceiveTaskWithBoundaryTimer() {
        ...
        List<Execution> executions =
                runtimeService.createExecutionQuery().activityId("task").list();
        assertThat(executions).hasSize(1);
        List<String> activeActivityIds =
                runtimeService.getActiveActivityIds(executions.get(0).getId());
    ...
    @Deployment(
            resources =
                    "org/activiti/engine/test/bpmn/event/timer/BoundaryTimerNonInterruptingEventTest.testTimerOnConcurrentSubprocess.bpmn20.xml")
