...
public class BoundaryTimerNonInterruptingEventTest extends PluggableActivitiTestCase {
    ...
    public void testTimerOnConcurrentTasks() {
        ...
        Task task = taskService.createTaskQuery().taskDefinitionKey("timerFiredTask")
            .singleResult();
    ...
    public void testTimerWithCycle() throws Exception {
        String processInstanceId = runtimeService.startProcessInstanceByKey("nonInterruptingCycle")
            .getId();
        ...
        assertThat(managementService.createTimerJobQuery().processInstanceId(processInstanceId)
            .count()).isEqualTo(1);
    ...
    public void testTimerOnEmbeddedSubprocess() {
        String id = runtimeService.startProcessInstanceByKey(
            "nonInterruptingTimerOnEmbeddedSubprocess").getId();
    ...
    public void testReceiveTaskWithBoundaryTimer() {
        ...
        ProcessInstance pi = runtimeService.startProcessInstanceByKey("nonInterruptingCycle",
            variables);
        ...
        List<Execution> executions = runtimeService.createExecutionQuery().activityId("task")
            .list();
    ...
    public void testTimerOnConcurrentSubprocess() {
        String procId = runtimeService.startProcessInstanceByKey("testTimerOnConcurrentSubprocess")
            .getId();
