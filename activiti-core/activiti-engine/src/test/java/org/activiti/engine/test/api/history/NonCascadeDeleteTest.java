...
public class NonCascadeDeleteTest extends PluggableActivitiTestCase {
    ...
    public void testHistoricProcessInstanceQuery() {
        ...
        processInstanceId = runtimeService.startProcessInstanceByKey(PROCESS_DEFINITION_KEY)
            .getId();
        ...
        if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.ACTIVITY)) {
            ...
            HistoricProcessInstance processInstanceAfterDelete = historyService.createHistoricProcessInstanceQuery()
                .processInstanceId(processInstanceId).singleResult();
