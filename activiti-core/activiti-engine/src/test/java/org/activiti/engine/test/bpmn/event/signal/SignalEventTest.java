...
public class SignalEventTest extends PluggableActivitiTestCase {
    ...
    public void testUseSignalForExceptionsBetweenParallelPaths() {
        ...
        taskService.complete(
                task.getId(),
                singletonMap(
                        "developers", asList("developerOne", "developerTwo", "developerThree")));
    ...
    public void testSignalStartEventFromProcess() {
        ...
        assertThat(taskService.createTaskQuery().taskName("Task in process D").count())
                .isEqualTo(1);
        ...
        assertThat(taskService.createTaskQuery().taskName("Task after signal").count())
                .isEqualTo(1);
