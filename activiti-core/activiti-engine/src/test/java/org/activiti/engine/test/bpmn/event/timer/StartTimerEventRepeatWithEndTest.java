  ...
  public void testCycleDateStartTimerEvent() throws Exception {
    ...
    repositoryService
        ...
        .addClasspathResource(
            "org/activiti/engine/test/bpmn/event/timer/StartTimerEventRepeatWithEndTest.testCycleDateStartTimerEvent.bpmn20.xml")
        .deploy();
    ...
    // ADVANCE THE CLOCK
    // advance the clock to 11 dec -> the system will execute the pending job and will create a new
    // one
    moveByMinutes(60 * 25);
