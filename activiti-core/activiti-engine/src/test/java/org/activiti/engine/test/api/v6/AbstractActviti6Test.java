 ...
 * <p>
 * When using H2 and the default schema name, it will also boot the H2 webapp (reachable with
...
public class AbstractActviti6Test {
    ...
    public void initProcessEngine() {
        if (cachedProcessEngine == null) {
            ...
            if (cachedProcessEngine instanceof ProcessEngineImpl) {
                if (((ProcessEngineImpl) cachedProcessEngine).getProcessEngineConfiguration()
                    .getJdbcUrl().equals(H2_TEST_JDBC_URL)) {
    ...
    public void logCommandInvokerDebugInfo() {
        ...
        List<ProcessEngineConfigurator> configurators = ((ProcessEngineImpl) cachedProcessEngine).getProcessEngineConfiguration()
            .getConfigurators();
