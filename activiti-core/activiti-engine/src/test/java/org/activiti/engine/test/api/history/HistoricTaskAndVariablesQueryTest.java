 ...
 */
public class HistoricTaskAndVariablesQueryTest
    ...
    public void testQuery() {
        if (
            ...
            task =
                historyService
                    .createHistoricTaskInstanceQuery()
                    .taskVariableValueLike("testVar", "someVaria%")
                    .singleResult();
            ...
            task =
                historyService
                    .createHistoricTaskInstanceQuery()
                    .taskVariableValueLikeIgnoreCase("testVar", "somevaria%")
                    .singleResult();
            assertThat(task).isNotNull();
            assertThat(task.getName()).isEqualTo("gonzoTask");
            ...
            task =
                historyService
                    .createHistoricTaskInstanceQuery()
                    .taskVariableValueLikeIgnoreCase("testVar", "somevaria2%")
                    .singleResult();
    ...
    public void testOrQuery() {
        if (
            ...
            assertThat(task.getProcessVariables()).hasSize(0);
            assertThat(task.getTaskLocalVariables().get("testVar"))
                .isEqualTo("someVariable");
            assertThat(task.getTaskLocalVariables().get("testVar2"))
                .isEqualTo(123);
    ...
    public void testOrQueryMultipleVariableValues() {
        if (
            ...
            HistoricTaskInstanceQuery query0 = historyService
                .createHistoricTaskInstanceQuery()
                .includeProcessVariables()
                .or();
            for (int i = 0; i < 20; i++) {
                query0 =
                    query0.processVariableValueEquals("anotherProcessVar", i);
            }
            query0 = query0.endOr();
            ...
            for (int i = 0; i < 20; i++) {
                query1 =
                    query1.processVariableValueEquals("anotherProcessVar", i);
            }
            query1 = query1.endOr();
        ...
        if (
            ...
            tasks =
                historyService
                    .createHistoricTaskInstanceQuery()
                    .taskCandidateUser(KERMIT, KERMITSGROUPS)
                    .taskCandidateGroupIn(asList("management"))
                    .list();
            assertThat(tasks).hasSize(3);
            ...
            tasks =
                historyService
                    .createHistoricTaskInstanceQuery()
                    .taskCandidateUser(GONZO, GONZOSGROUPS)
                    .taskCandidateGroupIn(asList("invalid"))
                    .list();
            assertThat(tasks).hasSize(0);
