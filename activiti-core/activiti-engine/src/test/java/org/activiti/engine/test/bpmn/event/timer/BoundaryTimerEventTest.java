...
public class BoundaryTimerEventTest extends PluggableActivitiTestCase {
    ...
    public void testNullExpressionOnTimer() {
        ...
        // After process start, there should be a timer created
        ProcessInstance pi = runtimeService.startProcessInstanceByKey("testNullExpressionOnTimer",
            variables);
    ...
    public void testInfiniteRepeatingTimer() throws Exception {
        ...
        for (int i = 0; i < 30; i++) {
            ...
            if (previousDueDate != null) {
                assertThat(job.getDuedate().getTime() - previousDueDate.getTime()
                    >= twentyFourHours).isTrue();
            }
