...
public class BoundaryTimerEventTest extends PluggableActivitiTestCase {
    ...
    public void testInfiniteRepeatingTimer() throws Exception {
        ...
        for (int i = 0; i < 30; i++) {
            ...
            if (previousDueDate != null) {
                assertThat(
                                job.getDuedate().getTime() - previousDueDate.getTime()
                                        >= twentyFourHours)
                        .isTrue();
            }
    ...
    public void testBoundaryTimerEvent() throws Exception {
        ...
        try {
            ...
            // expected exception because the boundary timer event created a timer job to be
            // executed
            // after 10 minutes
        }
        ...
        // after another 8 minutes (the timer will have to execute because it wasa set to be
        // executed @
        ...
        // there should be only one userTask and it should be the one triggered by the boundary
        // timer
        // event.
