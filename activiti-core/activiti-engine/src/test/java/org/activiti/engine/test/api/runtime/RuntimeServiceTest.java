...
public class RuntimeServiceTest extends PluggableActivitiTestCase {
    ...
    public void testStartProcessInstanceByIdNullVariables() {
        ...
        assertThat(runtimeService.createProcessInstanceQuery().processDefinitionKey("oneTaskProcess").count())
            .isEqualTo(1);
    }
    ...
    public void testStartProcessInstanceWithBusinessKey() {
        ...
        processInstance =
            runtimeService.startProcessInstanceByKey("oneTaskProcess", "456", singletonMap("var", "value"));
        assertThat(processInstance).isNotNull();
        assertThat(runtimeService.createProcessInstanceQuery().processDefinitionKey("oneTaskProcess").count())
            .isEqualTo(2);
        ...
        processInstance =
            runtimeService.startProcessInstanceById(processDefinition.getId(), "101123", singletonMap("var", "value2"));
        assertThat(processInstance).isNotNull();
        assertThat(runtimeService.createProcessInstanceQuery().processDefinitionKey("oneTaskProcess").count())
            .isEqualTo(4);
    ...
    public void testStartProcessInstanceByProcessInstanceBuilder() {
        ...
        // by id
        processInstance =
            processInstanceBuilder.processDefinitionId(processDefinition.getId()).businessKey("789").start();
        assertThat(processInstance).isNotNull();
        assertThat(runtimeService.createProcessInstanceQuery().processDefinitionKey("oneTaskProcess").count())
            .isEqualTo(3);
    ...
    public void testMessageEventReceived() {
        ...
        for (int executions = 3; executions > 0; executions--) {
            ...
            assertThat(runtimeService.createExecutionQuery().messageEventSubscriptionName("alert").count())
                .isEqualTo(executions - 1);
        }
        ...
        for (int executions = 3; executions > 0; executions--) {
            ...
            assertThat(runtimeService.createExecutionQuery().messageEventSubscriptionName("panic").count())
                .isEqualTo(executions - 1);
        }
    }
