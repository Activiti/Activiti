...
public class RuntimeServiceTest extends PluggableActivitiTestCase {
    ...
    public void testStartProcessInstanceWithLongStringVariable() {
        ...
        Task task = taskService
            ...
            .singleResult();
        assertThat(task.getProcessVariables()).isNotNull();
        assertThat(task.getProcessVariables().get("longString"))
            .isEqualTo(longString.toString());
    }
    ...
    public void testStartProcessInstanceWithBusinessKey() {
        ...
        assertThat(
            ...
            .isEqualTo(2);
        assertThat(runtimeService.getVariable(processInstance.getId(), "var"))
            .isEqualTo("value");
    ...
    public void testFindActiveActivityIdsUnexistingExecututionId() {
        assertThatExceptionOfType(ActivitiObjectNotFoundException.class)
            ...
            .withMessageContaining(
                "execution unexistingExecutionId doesn't exist"
            )
            .satisfies(ae ->
    ...
    public void testGetVariableUnexistingVariableName() {
        ...
        Object variableValue = runtimeService.getVariable(
            processInstance.getId(),
            "unexistingVariable"
        );
    ...
    public void testSetVariables() {
        ...
        runtimeService.setVariables(
            processInstance.getId(),
            map("variable1", "value1", "variable2", "value2")
        );

        assertThat(
            runtimeService.getVariable(processInstance.getId(), "variable1")
        )
            .isEqualTo("value1");
        assertThat(
    ...
    public void testSetVariablesUnexistingExecutionId() {
        assertThatExceptionOfType(ActivitiObjectNotFoundException.class)
            ...
            .withMessageContaining(
                "execution unexistingexecution doesn't exist"
            )
            .satisfies(ae ->
                assertThat(ae.getObjectClass()).isEqualTo(Execution.class)
            );
    ...
    @Deployment(
        resources = { "org/activiti/engine/test/api/oneSubProcess.bpmn20.xml" }
    )
    ...
    public void testRemoveVariableLocalWithParentScope() {
        ...
        checkHistoricVariableUpdateEntity(
            "localVariable",
            processInstance.getId()
        );
    }
    ...
    public void testRemoveVariables() {
        ...
        assertThat(
            runtimeService.getVariable(processInstance.getId(), "variable3")
        )
            .isEqualTo("value3");
        assertThat(
            runtimeService.getVariableLocal(
    ...
    public void testSetProcessInstanceName() {
        ...
        assertThatExceptionOfType(ActivitiException.class)
            .isThrownBy(() ->
                runtimeService.setProcessInstanceName(processInstanceId, null)
            )
            .withMessage(
                "process instance " +
                processInstanceId +
    ...
    public void testGetVariableUnexistingVariableNameWithCast() {
        ...
        String variableValue = runtimeService.getVariable(
            processInstance.getId(),
            "unexistingVariable",
            String.class
        );
    ...
    public void testGetVariableExistingVariableNameWithCast() {
        ...
        Boolean variableValue = runtimeService.getVariable(
            processInstance.getId(),
            "var1",
            Boolean.class
        );
    ...
    public void testGetVariableLocalUnexistingVariableNameWithCast() {
        ...
        String variableValue = runtimeService.getVariableLocal(
            processInstance.getId(),
            "var1",
            String.class
        );
    ...
    public void testGetVariableLocalExistingVariableNameWithCast() {
        ...
        Boolean variableValue = runtimeService.getVariableLocal(
            processInstance.getId(),
            "var1",
            Boolean.class
        );
    ...
    public void testHistoricVariableRemovedWhenRuntimeVariableIsRemoved() {
        if (
            ...
            assertThat(
                ...
                .hasSize(3);
            assertThat(
                runtimeService.getVariable(processInstance.getId(), "var2")
            )
                .isNotNull();
    ...
    public void testAuthenticatedStartUserProcessInstance() {
        ...
        assertThat(processInstance.getStartUserId())
