...
public class CompensateEventTest extends PluggableActivitiTestCase {
    ...
    public void testCompensateSubprocess() {
        ...
        Execution execution = runtimeService.createExecutionQuery().activityId("beforeEnd")
            .singleResult();
    ...
    public void testCompensateWithSubprocess() {
        ...
        Task compensationTask3 = taskService.createTaskQuery()
            .processInstanceId(processInstance.getId())
    ...
    public void testCompensateNestedSubprocess() {
        ...
        Task task = taskService.createTaskQuery().processInstanceId(processInstance.getId())
            .taskDefinitionKey("afterNestedSubProcess").singleResult();
        assertThat(task).isNotNull();
        taskService.complete(task.getId());

        Task compensationTask = taskService.createTaskQuery()
            .processInstanceId(processInstance.getId()).taskDefinitionKey("undoBookHotel")
            .singleResult();
