...
public class ParsedDeploymentTest extends PluggableActivitiTestCase {
    ...
    public void testCreateAndQuery() throws UnsupportedEncodingException {
        ...
        ProcessDefinitionEntity id1 = getProcessDefinitionEntityFromList(processDefinitions,
            ID1_ID);
        ProcessDefinitionEntity id2 = getProcessDefinitionEntityFromList(processDefinitions,
            ID2_ID);
        ...
        ProcessDefinitionEntity en1 = getProcessDefinitionEntityFromList(processDefinitions,
            EN1_ID);
        ProcessDefinitionEntity en2 = getProcessDefinitionEntityFromList(processDefinitions,
            EN2_ID);
