...
public class DeleteProcessInstanceTest extends PluggableActivitiTestCase {
    ...
    public void testNoEndTimeSet() {
        ...
        if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.ACTIVITY)) {
            ...
            log.info(
                    "End time for the deleted instance of \"Demo Partial Deletion\" that was"
                            + " started with a Task Type of \"user\": "
                            + hInstanceUser.getEndTime()
                            + ".");
            log.info(
                    "Successfully deleted the instance of \"Demo Partial Deletion\" that was"
                            + " started with a Task Type of \"user\".");
        }
