...
public class ProcessDefinitionQueryByLatestTest
    ...
    public void testQueryByLatestAndId() throws Exception {
        // Deploy
        List<String> xmlFileNameList = asList(
        ...
        ProcessDefinitionQuery idQuery2 = repositoryService
            .createProcessDefinitionQuery()
    ...
    public void testQueryByLatestAndName() throws Exception {
        ...
        // name
        ProcessDefinitionQuery nameQuery = repositoryService
            .createProcessDefinitionQuery()
    ...
    public void testQueryByLatestAndDeploymentId() throws Exception {
        ...
        ProcessDefinitionQuery deploymentQuery2 = repositoryService
            .createProcessDefinitionQuery()
