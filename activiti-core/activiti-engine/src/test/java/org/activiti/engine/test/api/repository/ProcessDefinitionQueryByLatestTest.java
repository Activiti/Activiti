...
public class ProcessDefinitionQueryByLatestTest extends PluggableActivitiTestCase {
    ...
    public void testQueryByLatestAndId() throws Exception {
        ...
        ProcessDefinitionQuery idQuery1 =
                repositoryService
                        .createProcessDefinitionQuery()
        ...
        ProcessDefinitionQuery idQuery2 =
                repositoryService
                        .createProcessDefinitionQuery()
                        .processDefinitionId(processDefinitionIdList.get(1))
                        .latestVersion();
        processDefinitions = idQuery2.list();
        assertThat(processDefinitions).hasSize(1);
        assertThat(processDefinitions.get(0).getKey()).isEqualTo("testProcess1");

        ProcessDefinitionQuery idQuery3 =
                repositoryService
                        .createProcessDefinitionQuery()
                        .processDefinitionId(processDefinitionIdList.get(2))
                        .latestVersion();
    ...
    public void testQueryByLatestAndName() throws Exception {
        ...
        // name
        ProcessDefinitionQuery nameQuery =
                repositoryService
                        .createProcessDefinitionQuery()
        ...
        // nameLike
        ProcessDefinitionQuery nameLikeQuery =
                repositoryService
                        .createProcessDefinitionQuery()
                        .processDefinitionName("one")
                        .latestVersion();
    ...
    public void testQueryByLatestAndDeploymentId() throws Exception {
        ...
        // deploymentId
        ProcessDefinitionQuery deploymentQuery1 =
                repositoryService
                        .createProcessDefinitionQuery()
        ...
        ProcessDefinitionQuery deploymentQuery2 =
                repositoryService
                        .createProcessDefinitionQuery()
                        .deploymentId(deploymentIdList.get(1))
                        .latestVersion();
