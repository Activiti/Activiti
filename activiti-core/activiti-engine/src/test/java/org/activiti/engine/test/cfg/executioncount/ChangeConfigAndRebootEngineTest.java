...
public class ChangeConfigAndRebootEngineTest extends ResourceActivitiTestCase {
    ...
    protected void assertConfigProperty(boolean expectedValue) {
        PropertyEntity propertyEntity = managementService.executeCommand(
    ...
    protected void assertExecutions(ProcessInstance processInstance,
        ...
        for (Execution execution : executions) {
            ...
            assertThat(countingExecutionEntity.isCountEnabled()).isEqualTo(
                expectedCountIsEnabledFlag);
