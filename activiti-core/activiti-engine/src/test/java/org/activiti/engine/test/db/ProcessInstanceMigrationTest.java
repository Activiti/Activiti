...
public class ProcessInstanceMigrationTest extends PluggableActivitiTestCase {
    ...
    private static final String TEST_PROCESS_WITH_PARALLEL_GATEWAY =
            "org/activiti/examples/bpmn/gateway/ParallelGatewayTest.testForkJoin.bpmn20.xml";
    private static final String TEST_PROCESS =
            "org/activiti/engine/test/db/ProcessInstanceMigrationTest.testSetProcessDefinitionVersion.bpmn20.xml";
    private static final String TEST_PROCESS_ACTIVITY_MISSING =
            "org/activiti/engine/test/db/ProcessInstanceMigrationTest.testSetProcessDefinitionVersionActivityMissing.bpmn20.xml";

    private static final String TEST_PROCESS_CALL_ACTIVITY =
            "org/activiti/engine/test/db/ProcessInstanceMigrationTest.withCallActivity.bpmn20.xml";
    private static final String TEST_PROCESS_USER_TASK_V1 =
            "org/activiti/engine/test/db/ProcessInstanceMigrationTest.testSetProcessDefinitionVersionWithTask.bpmn20.xml";
    private static final String TEST_PROCESS_USER_TASK_V2 =
            "org/activiti/engine/test/db/ProcessInstanceMigrationTest.testSetProcessDefinitionVersionWithTaskV2.bpmn20.xml";
    private static final String TEST_PROCESS_NESTED_SUB_EXECUTIONS =
            "org/activiti/engine/test/db/ProcessInstanceMigrationTest.testSetProcessDefinitionVersionSubExecutionsNested.bpmn20.xml";
    ...
    public void testSetProcessDefinitionVersionEmptyArguments() {
        ...
        assertThatExceptionOfType(ActivitiIllegalArgumentException.class)
                ...
                .withMessageContaining(
                        "The process definition version is mandatory, but 'null' has been"
                                + " provided.");

        assertThatExceptionOfType(ActivitiIllegalArgumentException.class)
                .isThrownBy(() -> new SetProcessDefinitionVersionCmd("42", -1))
                .withMessageContaining(
                        "The process definition version must be positive, but '-1' has been"
                                + " provided.");
    }
    ...
    public void testSetProcessDefinitionVersionPIIsSubExecution() {
        ...
        SetProcessDefinitionVersionCmd command =
                new SetProcessDefinitionVersionCmd(execution.getId(), 1);
    ...
    public void testSetProcessDefinitionVersionActivityMissing() {
        ...
        Execution execution =
                runtimeService.createExecutionQuery().activityId("waitState1").singleResult();
        ...
        assertThatExceptionOfType(ActivitiException.class)
                ...
                .withMessageContaining(
                        "The new process definition (key = 'receiveTask') does not contain the"
                            + " current activity (id = 'waitState1') of the process instance (id ="
                            + " '");
