...
public class ProcessInstanceMigrationTest extends PluggableActivitiTestCase {
  ...
  public void testSetProcessDefinitionVersionActivityMissing() {
    ...
    assertThatExceptionOfType(ActivitiException.class)
        ...
        .withMessageContaining(
            "The new process definition (key = 'receiveTask') does not contain the current activity"
                + " (id = 'waitState1') of the process instance (id = '");
  ...
  public void testSetProcessDefinitionVersion() {
    ...
    ProcessDefinition newProcessDefinition =
        repositoryService.createProcessDefinitionQuery().processDefinitionVersion(2).singleResult();
