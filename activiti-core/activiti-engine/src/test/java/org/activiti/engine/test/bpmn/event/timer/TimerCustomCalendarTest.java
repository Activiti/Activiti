...
public class TimerCustomCalendarTest extends ResourceActivitiTestCase {
    ...
    public void testCycleTimer() {
        ...
        assertThat(jobs.get(0).getDuedate()).as(
            "Job must be scheduled by custom business calendar to Date(0)").isEqualTo(new Date(0));
    ...
    public void testCustomDurationTimerCalendar() {
        ...
        Execution execution = runtimeService.createExecutionQuery()
            .processInstanceId(processInstance.getId()).activityId("receive").singleResult();
