...
public class CancelCallActivityByMessageTest extends PluggableActivitiTestCase {
    ...
    public void testCancelCallActivityByMessage() throws Exception {
        ...
        CallActivityByMessageEventListener myEventListener =
                new CallActivityByMessageEventListener();
        ...
        // this is external subprocess. Workflow uses the ENTITY_CREATED event to determine when to
        // send
        // our event.
