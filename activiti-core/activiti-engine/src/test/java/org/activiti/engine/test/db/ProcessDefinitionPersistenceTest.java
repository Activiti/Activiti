...
public class ProcessDefinitionPersistenceTest extends PluggableActivitiTestCase {
    ...
    public void testProcessDefinitionPersistence() {
        String deploymentId = repositoryService.createDeployment()
            ...
            .addClasspathResource("org/activiti/engine/test/db/processTwo.bpmn20.xml").deploy()
            .getId();
    ...
    public void testProcessDefinitionIntrospection() {
        String deploymentId = repositoryService.createDeployment()
            .addClasspathResource("org/activiti/engine/test/db/processOne.bpmn20.xml").deploy()
            .getId();
        ...
        assertThat(outgoingFlows.get(0).getDocumentation()).isEqualTo(
            "The only transitions in the process");
    ...
    public void testProcessDefinitionQuery() {
        ...
        assertThat(
            repositoryService.createProcessDefinitionQuery().orderByProcessDefinitionName().asc()
                .count()).isEqualTo(4);
        assertThat(repositoryService.createProcessDefinitionQuery().latestVersion()
            .orderByProcessDefinitionName().asc().count()).isEqualTo(2);
