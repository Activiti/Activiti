...
public class ProcessDefinitionPersistenceTest extends PluggableActivitiTestCase {
    ...
    public void testProcessDefinitionIntrospection() {
        ...
        Process process =
                repositoryService.getBpmnModel(processDefinition.getId()).getMainProcess();
    ...
    public void testProcessDefinitionGraphicalNotationFlag() {
        ...
        ProcessDefinition processWithDi =
                repositoryService
                        .createProcessDefinitionQuery()
        ...
        ProcessDefinition processWithoutDi =
                repositoryService
                        .createProcessDefinitionQuery()
