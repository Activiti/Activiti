...
public class TaskQueryTest extends PluggableActivitiTestCase {
    ...
    private UserGroupManager userGroupManager = Mockito.mock(
    ...
    public void testQueryByCandidateGroup() {
        ...
        TaskQuery querySales = taskService
            .createTaskQuery()
    ...
    public void testQueryByCandidateOrAssignedWithUserGroupProxy() {
        ...
        Mockito
            .when(userGroupManager.getUserGroups(KERMIT))
            .thenReturn(KERMITSGROUPS);
        Mockito
            .when(userGroupManager.getUserGroups(GONZO))
            .thenReturn(GONZOSGROUPS);
        Mockito
            .when(userGroupManager.getUserGroups(FOZZIE))
            .thenReturn(FOZZIESGROUPS);
    ...
    public void testQueryByCandidateOrAssignedWithNoGroups() {
        ...
        Mockito
            .when(userGroupManager.getUserGroups(SCOOTER))
            .thenReturn(SCOOTERSGROUPS);
        ...
        Task assigneeToScooter = taskService
            .createTaskQuery()
            .taskName("assigneeToScooter")
            .singleResult();
    ...
    public void testQueryByCandidateGroupIn() {
        ...
        TaskQuery queryForException = taskService
            .createTaskQuery()
        ...
        TaskQuery query = taskService
            .createTaskQuery()
            .taskCandidateUser(KERMIT, groups);
        assertThat(query.count()).isEqualTo(11);
        assertThat(query.list()).hasSize(11);
        ...
        query =
            taskService
                .createTaskQuery()
                .taskCandidateUser(KERMIT, asList("unexisting"));
        assertThat(query.count()).isEqualTo(6);
        assertThat(query.list()).hasSize(6);
        ...
        query =
            taskService
                .createTaskQuery()
                .taskCandidateUser("unexisting", asList("unexisting"));
        assertThat(query.count()).isEqualTo(0);
        assertThat(query.list()).hasSize(0);
    ...
    @Deployment(
        resources = "org/activiti/engine/test/api/task/taskDefinitionProcess.bpmn20.xml"
    )
    ...
    public void testTaskVariableValueEquals() throws Exception {
        ...
        assertThat(
            ...
            .isEqualTo(1);
        assertThat(
            taskService.createTaskQuery().taskVariableValueEquals(1234).count()
        )
            .isEqualTo(1);
        assertThat(
            taskService
            ...
            .isEqualTo(1);
        assertThat(
            taskService.createTaskQuery().taskVariableValueEquals(true).count()
        )
            .isEqualTo(1);
        assertThat(
            taskService.createTaskQuery().taskVariableValueEquals(date).count()
        )
            .isEqualTo(1);
        assertThat(
            taskService.createTaskQuery().taskVariableValueEquals(null).count()
        )
            .isEqualTo(1);
        ...
        assertThat(
            ...
            .isEqualTo(0);
        assertThat(
            taskService.createTaskQuery().taskVariableValueEquals(9999).count()
        )
            .isEqualTo(0);
        assertThat(
            taskService
            ...
            .isEqualTo(0);
        assertThat(
            taskService.createTaskQuery().taskVariableValueEquals(false).count()
        )
            .isEqualTo(0);
        assertThat(
            taskService
    ...
    @Deployment(
        resources = "org/activiti/engine/test/api/task/TaskQueryTest.testProcessDefinition.bpmn20.xml"
    )
    ...
    public void testProcessVariableValueLike() throws Exception {
        ...
        assertThat(
            taskService
                .createTaskQuery()
                .processVariableValueLike("mixed", "Azer%")
                .count()
        )
            .isEqualTo(1);
        assertThat(
            taskService
                .createTaskQuery()
                .processVariableValueLike("mixed", "A%")
                .count()
        )
            .isEqualTo(1);
        assertThat(
    ...
    public void testProcessVariableValueLessThan() throws Exception {
        ...
        assertThat(
            taskService
                .createTaskQuery()
                .processVariableValueLessThan("number", 12)
                .count()
        )
            .isEqualTo(1);
        assertThat(
            taskService
                .createTaskQuery()
                .processVariableValueLessThan("number", 10)
                .count()
        )
            .isEqualTo(0);
    }
    ...
    public void testProcessDefinitionId() throws Exception {
        ...
        List<Task> tasks = taskService
            ...
            .list();
        assertThat(tasks).hasSize(1);
        assertThat(tasks.get(0).getProcessInstanceId())
    ...
    public void testTaskDueDate() throws Exception {
        ...
        Date dueDate = new SimpleDateFormat("dd/MM/yyyy hh:mm:ss")
        .parse("01/02/2003 01:12:13");
    ...
    public void testQuerySorting() {
        assertThat(taskService.createTaskQuery().orderByTaskId().asc().list())
            .hasSize(12);
        assertThat(taskService.createTaskQuery().orderByTaskName().asc().list())
            .hasSize(12);
        assertThat(
            taskService.createTaskQuery().orderByTaskPriority().asc().list()
        )
            .hasSize(12);
        assertThat(
            taskService.createTaskQuery().orderByTaskAssignee().asc().list()
        )
            .hasSize(12);
        assertThat(
            taskService.createTaskQuery().orderByTaskDescription().asc().list()
        )
            .hasSize(12);
        assertThat(
            taskService
            ...
            .hasSize(12);
        assertThat(
            taskService.createTaskQuery().orderByExecutionId().asc().list()
        )
            .hasSize(12);
        assertThat(
            ...
            .hasSize(12);
        assertThat(
            taskService.createTaskQuery().orderByTaskDueDate().asc().list()
        )
            .hasSize(12);

        assertThat(taskService.createTaskQuery().orderByTaskId().desc().list())
            .hasSize(12);
        assertThat(
            ...
            .hasSize(12);
        assertThat(
            taskService.createTaskQuery().orderByTaskPriority().desc().list()
        )
            .hasSize(12);
        assertThat(
            taskService.createTaskQuery().orderByTaskAssignee().desc().list()
        )
            .hasSize(12);
        assertThat(
            taskService.createTaskQuery().orderByTaskDescription().desc().list()
        )
            .hasSize(12);
        assertThat(
            taskService
            ...
            .hasSize(12);
        assertThat(
            taskService.createTaskQuery().orderByExecutionId().desc().list()
        )
            .hasSize(12);
        assertThat(
            ...
            .hasSize(12);
        assertThat(
            taskService.createTaskQuery().orderByTaskDueDate().desc().list()
        )
            .hasSize(12);
    ...
    public void testNativeQueryPaging() {
        assertThat(managementService.getTableName(Task.class))
            .isEqualTo("ACT_RU_TASK");
        assertThat(managementService.getTableName(TaskEntity.class))
            .isEqualTo("ACT_RU_TASK");
        assertThat(
            taskService
    ...
    public void testQueryByDeploymentId() throws Exception {
        ...
        assertThat(
            ...
            .isEqualTo(1);
        assertThat(
            taskService.createTaskQuery().deploymentId("invalid").singleResult()
        )
            .isNull();
        assertThat(
            taskService.createTaskQuery().deploymentId("invalid").count()
        )
            .isEqualTo(0);
    }
    ...
    public void testQueryByDeploymentIdIn() throws Exception {
        ...
        assertThat(
            ...
            .isNotNull();
        assertThat(
            taskService.createTaskQuery().deploymentIdIn(deploymentIds).count()
        )
            .isEqualTo(1);
    ...
    public void testTaskLocalAndProcessInstanceVariableEqualsInOr() {
        ...
        List<Task> allTasks = taskService
            .createTaskQuery()
            .processDefinitionKey("oneTaskProcess")
            .list();
        ...
        runtimeService.setVariable(
            allTasks.get(2).getProcessInstanceId(),
            "var",
            "theValue"
        );
        runtimeService.setVariable(
            allTasks.get(3).getProcessInstanceId(),
            "var",
            "theValue"
        );
        runtimeService.setVariable(
            allTasks.get(4).getProcessInstanceId(),
            "var",
            "theValue"
        );
    ...
    public void testLocalizeTasks() throws Exception {
        ...
        assertThat(tasks.get(0).getDescription())
            .isEqualTo("My Task Description");
        ...
        assertThat(tasks.get(0).getDescription())
            .isEqualTo("Mi Tarea Descripción");
        ...
        dynamicBpmnService.changeLocalizationName(
            "en",
            "theTask",
            "My 'en' localized name",
            infoNode
        );
        dynamicBpmnService.changeLocalizationDescription(
            "en",
            "theTask",
            "My 'en' localized description",
            infoNode
        );
        dynamicBpmnService.saveProcessDefinitionInfo(
            processInstance.getProcessDefinitionId(),
        ...
        assertThat(tasks.get(0).getName())
            .isEqualTo("My 'en-GB' localized name");
        assertThat(tasks.get(0).getDescription())
            .isEqualTo("My 'en-GB' localized description");
        ...
        assertThat(task.getDescription())
            .isEqualTo("My 'en' localized description");
