...
public class TaskQueryTest extends PluggableActivitiTestCase {
    ...
    public void testQueryByAssigneeIds() {
        ...
        if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.AUDIT)) {
            // History
            assertThat(historyService.createHistoricTaskInstanceQuery().taskAssigneeIds(asList(GONZO, KERMIT)).count())
                .isEqualTo(1);
            assertThat(
                historyService.createHistoricTaskInstanceQuery().taskAssigneeIds(asList(KERMIT, "kermit2")).count()
            )
                .isEqualTo(0);
        }
        ...
        if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.AUDIT)) {
            // History
            assertThat(
                historyService.createHistoricTaskInstanceQuery().taskAssigneeIds(asList(GONZO, "testAssignee")).count()
            )
                .isEqualTo(2);
        }
    ...
    public void testQueryByInvolvedUser() {
        try {
            ...
            assertThat(taskService.createTaskQuery().taskId(adhocTask.getId()).taskInvolvedUser(GONZO).count())
                .isEqualTo(1);
            assertThat(taskService.createTaskQuery().taskId(adhocTask.getId()).taskInvolvedUser(KERMIT).count())
                .isEqualTo(1);
            assertThat(taskService.createTaskQuery().taskId(adhocTask.getId()).taskInvolvedUser(FOZZIE).count())
                .isEqualTo(1);
        } finally {
    ...
    public void testQueryByInvolvedGroup() {
        try {
            ...
            assertThat(taskService.getIdentityLinksForTask(adhocTask.getId())).hasSize(3);
            assertThat(taskService.createTaskQuery().taskId(adhocTask.getId()).taskInvolvedGroupsIn(groups).count())
                .isEqualTo(1);
        } finally {
            List<Task> allTasks = taskService.createTaskQuery().list();
            for (Task task : allTasks) {
    ...
    public void testQueryByCandidateUser() {
        ...
        assertThatExceptionOfType(ActivitiException.class).isThrownBy(() -> queryFozzie.singleResult());
    }
    ...
    public void testQueryByCandidateUserOr() {
        ...
        TaskQuery queryFozzie = taskService
            .createTaskQuery()
            .or()
            .taskId("invalid")
    ...
    public void testQueryByCandidateOrAssignedOr() {
        ...
        Task assigneeToKermit = taskService
            .createTaskQuery()
            .or()
            .taskId("invalid")
            .taskName("assigneeToKermit")
            .singleResult();
        taskService.deleteTask(assigneeToKermit.getId());
        if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.AUDIT)) {
            historyService.deleteHistoricTaskInstance(assigneeToKermit.getId());
    ...
    public void testQueryByCandidateGroupInOr() {
        ...
        query =
            taskService
                .createTaskQuery()
                .or()
                .taskCandidateUser("unexisting", null)
                .taskCandidateGroup("unexisting")
                .endOr();
        assertThat(query.count()).isEqualTo(0);
        assertThat(query.list()).hasSize(0);
    ...
    public void testTaskDefinitionKeyLikeOr() throws Exception {
        ...
        Long count = taskService
            ...
            .or()
            .taskId("invalid")
            .taskDefinitionKeyLike("%unexistingKey%")
            .count();
        assertThat(count.longValue()).isEqualTo(0L);
    }
    ...
    public void testTaskVariableValueEquals() throws Exception {
        ...
        assertThat(taskService.createTaskQuery().taskVariableValueEquals("unexistingVar", "value").count())
            .isEqualTo(0);
        ...
        assertThat(taskService.createTaskQuery().taskVariableValueEquals("stringVar", "stringValue").count())
            .isEqualTo(1);
        ...
        assertThat(taskService.createTaskQuery().taskVariableValueEquals("dateVar", otherDate.getTime()).count())
            .isEqualTo(0);
        ...
        assertThat(taskService.createTaskQuery().taskVariableValueNotEquals("shortVar", (short) 999).count())
            .isEqualTo(1);
        ...
        assertThat(taskService.createTaskQuery().taskVariableValueGreaterThanOrEqual("integerVar", 1000).count())
            .isEqualTo(1);
        assertThat(taskService.createTaskQuery().taskVariableValueGreaterThanOrEqual("integerVar", 1234).count())
            .isEqualTo(1);
        assertThat(taskService.createTaskQuery().taskVariableValueGreaterThanOrEqual("integerVar", 1240).count())
            .isEqualTo(0);
        ...
        assertThat(taskService.createTaskQuery().taskVariableValueLessThanOrEqual("integerVar", 1240).count())
            .isEqualTo(1);
        assertThat(taskService.createTaskQuery().taskVariableValueLessThanOrEqual("integerVar", 1234).count())
            .isEqualTo(1);
        assertThat(taskService.createTaskQuery().taskVariableValueLessThanOrEqual("integerVar", 1000).count())
            .isEqualTo(0);
    }
    ...
    public void testTaskVariableValueEqualsOr() throws Exception {
        ...
        assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .taskVariableValueEquals("unexistingVar", "value")
                .count()
        )
            .isEqualTo(0);
        ...
        // Test query matches
        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").taskVariableValueEquals("longVar", 928374L).count()
        )
            .isEqualTo(1);
        assertThat(
            taskService
            ...
            .isEqualTo(1);
        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").taskVariableValueEquals("integerVar", 1234).count()
        )
            .isEqualTo(1);
        assertThat(
            taskService
            ...
            .isEqualTo(1);
        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").taskVariableValueEquals("booleanVar", true).count()
        )
            .isEqualTo(1);
        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").taskVariableValueEquals("dateVar", date).count()
        )
            .isEqualTo(1);
        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").taskVariableValueEquals("nullVar", null).count()
        )
            .isEqualTo(1);

        // Test query for other values on existing variables
        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").taskVariableValueEquals("longVar", 999L).count()
        )
            .isEqualTo(0);
        assertThat(
            taskService
            ...
            .isEqualTo(0);
        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").taskVariableValueEquals("integerVar", 999).count()
        )
            .isEqualTo(0);
        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").taskVariableValueEquals("stringVar", "999").count()
        )
            .isEqualTo(0);
        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").taskVariableValueEquals("booleanVar", false).count()
        )
            .isEqualTo(0);
        Calendar otherDate = Calendar.getInstance();
        otherDate.add(Calendar.YEAR, 1);
        assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .taskVariableValueEquals("dateVar", otherDate.getTime())
                .count()
        )
            .isEqualTo(0);
        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").taskVariableValueEquals("nullVar", "999").count()
        )
            .isEqualTo(0);

        // Test query for not equals
        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").taskVariableValueNotEquals("longVar", 999L).count()
        )
            .isEqualTo(1);
        assertThat(
            taskService
            ...
            .isEqualTo(1);
        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").taskVariableValueNotEquals("integerVar", 999).count()
        )
            .isEqualTo(1);
        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").taskVariableValueNotEquals("stringVar", "999").count()
        )
            .isEqualTo(1);
        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").taskVariableValueNotEquals("booleanVar", false).count()
        )
            .isEqualTo(1);

        // Test value-only variable equals
        assertThat(taskService.createTaskQuery().or().taskId("invalid").taskVariableValueEquals(928374L).count())
            .isEqualTo(1);
        assertThat(taskService.createTaskQuery().or().taskId("invalid").taskVariableValueEquals((short) 123).count())
            .isEqualTo(1);
        assertThat(taskService.createTaskQuery().or().taskId("invalid").taskVariableValueEquals(1234).count())
            .isEqualTo(1);
        assertThat(taskService.createTaskQuery().or().taskId("invalid").taskVariableValueEquals("stringValue").count())
            .isEqualTo(1);
        assertThat(taskService.createTaskQuery().or().taskId("invalid").taskVariableValueEquals(true).count())
            .isEqualTo(1);
        assertThat(taskService.createTaskQuery().or().taskId("invalid").taskVariableValueEquals(date).count())
            .isEqualTo(1);
        assertThat(taskService.createTaskQuery().or().taskId("invalid").taskVariableValueEquals(null).count())
            .isEqualTo(1);

        assertThat(taskService.createTaskQuery().or().taskId("invalid").taskVariableValueEquals(999999L).count())
            .isEqualTo(0);
        assertThat(taskService.createTaskQuery().or().taskId("invalid").taskVariableValueEquals((short) 999).count())
            .isEqualTo(0);
        assertThat(taskService.createTaskQuery().or().taskId("invalid").taskVariableValueEquals(9999).count())
            .isEqualTo(0);
        assertThat(
            taskService
                .createTaskQuery()
                .or()
                .taskId("invalid")
                .taskVariableValueEquals("unexistingstringvalue")
                .count()
        )
            .isEqualTo(0);
        assertThat(taskService.createTaskQuery().or().taskId("invalid").taskVariableValueEquals(false).count())
            .isEqualTo(0);
        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").taskVariableValueEquals(otherDate.getTime()).count()
        )
            .isEqualTo(0);

        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").taskVariableValueLike("stringVar", "string%").count()
        )
            .isEqualTo(1);
        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").taskVariableValueLike("stringVar", "String%").count()
            ...
            .isEqualTo(0);
        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").taskVariableValueLike("stringVar", "%Value").count()
        )
            .isEqualTo(1);
        ...
        assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .taskVariableValueGreaterThan("integerVar", 1000)
                .count()
        )
            .isEqualTo(1);
        assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .taskVariableValueGreaterThan("integerVar", 1234)
                .count()
        )
            .isEqualTo(0);
        assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .taskVariableValueGreaterThan("integerVar", 1240)
                .count()
        )
            .isEqualTo(0);
        ...
        assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .taskVariableValueGreaterThanOrEqual("integerVar", 1000)
                .count()
        )
            .isEqualTo(1);
        assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .taskVariableValueGreaterThanOrEqual("integerVar", 1234)
                .count()
        )
            .isEqualTo(1);
        assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .taskVariableValueGreaterThanOrEqual("integerVar", 1240)
                .count()
        )
            .isEqualTo(0);

        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").taskVariableValueLessThan("integerVar", 1240).count()
        )
            .isEqualTo(1);
        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").taskVariableValueLessThan("integerVar", 1234).count()
        )
            .isEqualTo(0);
        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").taskVariableValueLessThan("integerVar", 1000).count()
        )
            .isEqualTo(0);
        ...
        assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .taskVariableValueLessThanOrEqual("integerVar", 1240)
                .count()
        )
            .isEqualTo(1);
        assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .taskVariableValueLessThanOrEqual("integerVar", 1234)
                .count()
        )
            .isEqualTo(1);
        assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .taskVariableValueLessThanOrEqual("integerVar", 1000)
                .count()
        )
            .isEqualTo(0);
    }
    ...
    public void testProcessVariableValueEquals() throws Exception {
        ...
        assertThat(taskService.createTaskQuery().processVariableValueEquals("shortVar", (short) 123).count())
            .isEqualTo(1);
        assertThat(taskService.createTaskQuery().processVariableValueEquals("integerVar", 1234).count()).isEqualTo(1);
        assertThat(taskService.createTaskQuery().processVariableValueEquals("stringVar", "stringValue").count())
            .isEqualTo(1);
        ...
        assertThat(taskService.createTaskQuery().processVariableValueEquals("shortVar", (short) 999).count())
            .isEqualTo(0);
        ...
        Calendar otherDate = Calendar.getInstance();
        otherDate.add(Calendar.YEAR, 1);
        assertThat(taskService.createTaskQuery().processVariableValueEquals("dateVar", otherDate.getTime()).count())
            .isEqualTo(0);
        ...
        assertThat(taskService.createTaskQuery().processVariableValueNotEquals("shortVar", (short) 999).count())
            .isEqualTo(1);
        assertThat(taskService.createTaskQuery().processVariableValueNotEquals("integerVar", 999).count()).isEqualTo(1);
        assertThat(taskService.createTaskQuery().processVariableValueNotEquals("stringVar", "999").count())
            .isEqualTo(1);
        assertThat(taskService.createTaskQuery().processVariableValueNotEquals("booleanVar", false).count())
            .isEqualTo(1);

        // and query for the existing variable with NOT should result in nothing
        // found:
        assertThat(taskService.createTaskQuery().processVariableValueNotEquals("longVar", 928374L).count())
            .isEqualTo(0);
        ...
        assertThat(taskService.createTaskQuery().processVariableValueEquals("unexistingstringvalue").count())
            .isEqualTo(0);
        ...
        assertThat(
            taskService.createTaskQuery().processVariableValueEquals(928374L).taskVariableValueEquals(928374L).count()
        )
            .isEqualTo(1);
    }

    @Deployment(
        resources = { "org/activiti/engine/test/api/task/TaskQueryTest.testProcessVariableValueEquals.bpmn20.xml" }
    )
    public void testProcessVariableValueEqualsOn() throws Exception {
        ...
        // Test query matches
        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").processVariableValueEquals("longVar", 928374L).count()
        )
            .isEqualTo(1);
        assertThat(
            taskService
            ...
            .isEqualTo(1);
        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").processVariableValueEquals("integerVar", 1234).count()
        )
            .isEqualTo(1);
        assertThat(
            taskService
            ...
            .isEqualTo(1);
        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").processVariableValueEquals("booleanVar", true).count()
        )
            .isEqualTo(1);
        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").processVariableValueEquals("dateVar", date).count()
        )
            .isEqualTo(1);
        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").processVariableValueEquals("nullVar", null).count()
        )
            .isEqualTo(1);

        // Test query for other values on existing variables
        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").processVariableValueEquals("longVar", 999L).count()
        )
            .isEqualTo(0);
        assertThat(
            taskService
            ...
            .isEqualTo(0);
        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").processVariableValueEquals("integerVar", 999).count()
        )
            .isEqualTo(0);
        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").processVariableValueEquals("stringVar", "999").count()
        )
            .isEqualTo(0);
        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").processVariableValueEquals("booleanVar", false).count()
        )
            .isEqualTo(0);
        Calendar otherDate = Calendar.getInstance();
        otherDate.add(Calendar.YEAR, 1);
        assertThat(
            ...
            .isEqualTo(0);
        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").processVariableValueEquals("nullVar", "999").count()
        )
            .isEqualTo(0);
        ...
        // Test querying for task variables not equals
        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").processVariableValueNotEquals("longVar", 999L).count()
        )
            .isEqualTo(1);
        assertThat(
            taskService
        ...
        assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .processVariableValueNotEquals("integerVar", 999)
                .count()
        )
            .isEqualTo(1);
        assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .processVariableValueNotEquals("stringVar", "999")
                .count()
        )
            .isEqualTo(1);
        assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .processVariableValueNotEquals("booleanVar", false)
                .count()
        )
            .isEqualTo(1);
        ...
        // Test value-only variable equals
        assertThat(taskService.createTaskQuery().or().taskId("invalid").processVariableValueEquals(928374L).count())
            .isEqualTo(1);
        assertThat(taskService.createTaskQuery().or().taskId("invalid").processVariableValueEquals((short) 123).count())
            .isEqualTo(1);
        assertThat(taskService.createTaskQuery().or().taskId("invalid").processVariableValueEquals(1234).count())
            .isEqualTo(1);
        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").processVariableValueEquals("stringValue").count()
        )
            .isEqualTo(1);
        assertThat(taskService.createTaskQuery().or().taskId("invalid").processVariableValueEquals(true).count())
            .isEqualTo(1);
        assertThat(taskService.createTaskQuery().or().taskId("invalid").processVariableValueEquals(date).count())
            .isEqualTo(1);
        assertThat(taskService.createTaskQuery().or().taskId("invalid").processVariableValueEquals(null).count())
            .isEqualTo(1);

        assertThat(taskService.createTaskQuery().or().taskId("invalid").processVariableValueEquals(999999L).count())
            .isEqualTo(0);
        assertThat(taskService.createTaskQuery().or().taskId("invalid").processVariableValueEquals((short) 999).count())
            .isEqualTo(0);
        assertThat(taskService.createTaskQuery().or().taskId("invalid").processVariableValueEquals(9999).count())
            .isEqualTo(0);
        assertThat(
            taskService
                .createTaskQuery()
                .or()
                .taskId("invalid")
                .processVariableValueEquals("unexistingstringvalue")
                .count()
        )
            .isEqualTo(0);
        assertThat(taskService.createTaskQuery().or().taskId("invalid").processVariableValueEquals(false).count())
            .isEqualTo(0);
        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").processVariableValueEquals(otherDate.getTime()).count()
        )
            .isEqualTo(0);
    }
    ...
    public void testVariableValueEqualsIgnoreCase() throws Exception {
        ...
        assertThat(taskService.createTaskQuery().taskVariableValueEqualsIgnoreCase("mixed", "azerTY").count())
            .isEqualTo(1);
        assertThat(taskService.createTaskQuery().taskVariableValueEqualsIgnoreCase("mixed", "azerty").count())
            .isEqualTo(1);
        assertThat(taskService.createTaskQuery().taskVariableValueEqualsIgnoreCase("mixed", "uiop").count())
            .isEqualTo(0);

        assertThat(taskService.createTaskQuery().taskVariableValueEqualsIgnoreCase("upper", "azerTY").count())
            .isEqualTo(1);
        assertThat(taskService.createTaskQuery().taskVariableValueEqualsIgnoreCase("upper", "azerty").count())
            .isEqualTo(1);
        assertThat(taskService.createTaskQuery().taskVariableValueEqualsIgnoreCase("upper", "uiop").count())
            .isEqualTo(0);

        assertThat(taskService.createTaskQuery().taskVariableValueEqualsIgnoreCase("lower", "azerTY").count())
            .isEqualTo(1);
        assertThat(taskService.createTaskQuery().taskVariableValueEqualsIgnoreCase("lower", "azerty").count())
            .isEqualTo(1);
        assertThat(taskService.createTaskQuery().taskVariableValueEqualsIgnoreCase("lower", "uiop").count())
            .isEqualTo(0);

        // Test not-equals
        assertThat(taskService.createTaskQuery().taskVariableValueNotEqualsIgnoreCase("mixed", "azerTY").count())
            .isEqualTo(0);
        assertThat(taskService.createTaskQuery().taskVariableValueNotEqualsIgnoreCase("mixed", "azerty").count())
            .isEqualTo(0);
        assertThat(taskService.createTaskQuery().taskVariableValueNotEqualsIgnoreCase("mixed", "uiop").count())
            .isEqualTo(1);

        assertThat(taskService.createTaskQuery().taskVariableValueNotEqualsIgnoreCase("upper", "azerTY").count())
            .isEqualTo(0);
        assertThat(taskService.createTaskQuery().taskVariableValueNotEqualsIgnoreCase("upper", "azerty").count())
            .isEqualTo(0);
        assertThat(taskService.createTaskQuery().taskVariableValueNotEqualsIgnoreCase("upper", "uiop").count())
            .isEqualTo(1);

        assertThat(taskService.createTaskQuery().taskVariableValueNotEqualsIgnoreCase("lower", "azerTY").count())
            .isEqualTo(0);
        assertThat(taskService.createTaskQuery().taskVariableValueNotEqualsIgnoreCase("lower", "azerty").count())
            .isEqualTo(0);
        assertThat(taskService.createTaskQuery().taskVariableValueNotEqualsIgnoreCase("lower", "uiop").count())
            .isEqualTo(1);
    }
    ...
    public void testProcessVariableValueEqualsIgnoreCase() throws Exception {
        ...
        assertThat(taskService.createTaskQuery().processVariableValueEqualsIgnoreCase("mixed", "azerTY").count())
            .isEqualTo(1);
        assertThat(taskService.createTaskQuery().processVariableValueEqualsIgnoreCase("mixed", "azerty").count())
            .isEqualTo(1);
        assertThat(taskService.createTaskQuery().processVariableValueEqualsIgnoreCase("mixed", "uiop").count())
            .isEqualTo(0);

        assertThat(taskService.createTaskQuery().processVariableValueEqualsIgnoreCase("upper", "azerTY").count())
            .isEqualTo(1);
        assertThat(taskService.createTaskQuery().processVariableValueEqualsIgnoreCase("upper", "azerty").count())
            .isEqualTo(1);
        assertThat(taskService.createTaskQuery().processVariableValueEqualsIgnoreCase("upper", "uiop").count())
            .isEqualTo(0);

        assertThat(taskService.createTaskQuery().processVariableValueEqualsIgnoreCase("lower", "azerTY").count())
            .isEqualTo(1);
        assertThat(taskService.createTaskQuery().processVariableValueEqualsIgnoreCase("lower", "azerty").count())
            .isEqualTo(1);
        assertThat(taskService.createTaskQuery().processVariableValueEqualsIgnoreCase("lower", "uiop").count())
            .isEqualTo(0);
    }
    ...
    public void testProcessVariableValueLikeIgnoreCase() throws Exception {
        ...
        assertThat(taskService.createTaskQuery().processVariableValueLikeIgnoreCase("mixed", "azer%").count())
            .isEqualTo(1);
        assertThat(taskService.createTaskQuery().processVariableValueLikeIgnoreCase("mixed", "a%").count())
            .isEqualTo(1);
        assertThat(taskService.createTaskQuery().processVariableValueLikeIgnoreCase("mixed", "Azz%").count())
            .isEqualTo(0);
    }
    ...
    public void testProcessVariableValueGreaterThanOrEquals() throws Exception {
        ...
        assertThat(taskService.createTaskQuery().processVariableValueGreaterThanOrEqual("number", 5).count())
            .isEqualTo(1);
        assertThat(taskService.createTaskQuery().processVariableValueGreaterThanOrEqual("number", 10).count())
            .isEqualTo(1);
        assertThat(taskService.createTaskQuery().processVariableValueGreaterThanOrEqual("number", 11).count())
            .isEqualTo(0);
    }
    ...
    public void testProcessVariableValueLessThanOrEquals() throws Exception {
        ...
        assertThat(taskService.createTaskQuery().processVariableValueLessThanOrEqual("number", 12).count())
            .isEqualTo(1);
        assertThat(taskService.createTaskQuery().processVariableValueLessThanOrEqual("number", 10).count())
            .isEqualTo(1);
    ...
    public void testProcessDefinitionIdOr() throws Exception {
        ...
        assertThat(taskService.createTaskQuery().or().taskId("invalid").processDefinitionId("unexisting").count())
            .isEqualTo(0);
    }
    ...
    public void testProcessDefinitionKeyOr() throws Exception {
        ...
        assertThat(taskService.createTaskQuery().or().taskId("invalid").processDefinitionKey("unexisting").count())
            .isEqualTo(0);
    ...
    public void testProcessDefinitionKeyInOr() throws Exception {
        ...
        List<String> includeIds = new ArrayList<String>();
        assertThat(taskService.createTaskQuery().or().taskId("invalid").processDefinitionKeyIn(includeIds).count())
            .isEqualTo(0);
    ...
    public void testProcessDefinitionNameOr() throws Exception {
        ...
        assertThat(taskService.createTaskQuery().or().taskId("invalid").processDefinitionName("unexisting").count())
            .isEqualTo(0);
    }
    ...
    public void testProcessCategoryInOr() throws Exception {
        ...
        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").processCategoryIn(singletonList("unexisting")).count()
        )
            .isEqualTo(0);
    }
    ...
    public void testProcessCategoryNotIn() throws Exception {
        ...
        final Task task = taskService
            .createTaskQuery()
            .processCategoryNotIn(singletonList("unexisting"))
            .singleResult();
        assertThat(task).isNotNull();
        assertThat(task.getTaskDefinitionKey()).isEqualTo("theTask");
        assertThat(task.getProcessInstanceId()).isEqualTo(processInstance.getId());
    ...
    public void testProcessCategoryNotInOr() throws Exception {
        ...
        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").processCategoryNotIn(singletonList("Examples")).count()
        )
            .isEqualTo(0);
    }
    ...
    public void testProcessInstanceIdIn() throws Exception {
        ...
        final Task task = taskService
            .createTaskQuery()
            .processInstanceIdIn(singletonList(processInstance.getId()))
            .singleResult();
        assertThat(task).isNotNull();
        assertThat(task.getTaskDefinitionKey()).isEqualTo("theTask");
        assertThat(task.getProcessInstanceId()).isEqualTo(processInstance.getId());
    ...
    public void testProcessInstanceIdInOr() throws Exception {
        ...
        assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .processInstanceIdIn(singletonList("unexisting"))
                .count()
        )
            .isEqualTo(0);
    }
    ...
    public void testProcessInstanceIdInMultiple() throws Exception {
        ...
        assertThat(
            taskService
                .createTaskQuery()
                .processInstanceIdIn(asList(processInstance1.getId(), processInstance2.getId(), "unexisting"))
                .count()
        )
            .isEqualTo(2);

        assertThat(taskService.createTaskQuery().processInstanceIdIn(asList("unexisting1", "unexisting2")).count())
            .isEqualTo(0);
    }
    ...
    public void testProcessInstanceIdInOrMultiple() throws Exception {
        ...
        assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .processInstanceIdIn(asList("unexisting1", "unexisting2"))
                .count()
        )
            .isEqualTo(0);
    }
    ...
    public void testProcessInstanceBusinessKeyOr() throws Exception {
        ...
        assertThat(
            ...
            .hasSize(1);
        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").processInstanceBusinessKey("BUSINESS-KEY-1").list()
        )
            .hasSize(1);
        assertThat(
            taskService.createTaskQuery().or().taskId("invalid").processInstanceBusinessKey("NON-EXISTING").count()
        )
            .isEqualTo(0);
    }
    ...
    public void testTaskDueDate() throws Exception {
        ...
        assertThat(
            taskService.createTaskQuery().processInstanceId(processInstance.getId()).taskDueDate(dueDate).count()
        )
            .isEqualTo(1);
        ...
        assertThat(
            taskService
                .createTaskQuery()
                .processInstanceId(processInstance.getId())
                .taskDueBefore(otherDate.getTime())
                .count()
        )
            .isEqualTo(1);
    }
    ...
    public void testTaskDueBefore() throws Exception {
        ...
        assertThat(
            taskService
                .createTaskQuery()
                .processInstanceId(processInstance.getId())
                .taskDueBefore(oneHourLater.getTime())
                .count()
        )
            .isEqualTo(1);
        assertThat(
            taskService
                .createTaskQuery()
                .processInstanceId(processInstance.getId())
                .taskDueBefore(oneHourAgo.getTime())
                .count()
        )
            .isEqualTo(0);
    ...
    public void testTaskDueAfter() throws Exception {
        ...
        assertThat(
            taskService
                .createTaskQuery()
                .processInstanceId(processInstance.getId())
                .taskDueAfter(oneHourAgo.getTime())
                .count()
        )
            .isEqualTo(1);
        assertThat(
            taskService
                .createTaskQuery()
                .processInstanceId(processInstance.getId())
                .taskDueAfter(oneHourLater.getTime())
                .count()
        )
            .isEqualTo(0);
    ...
    public void testTaskWithoutDueDate() throws Exception {
        ...
        assertThat(
            taskService.createTaskQuery().processInstanceId(processInstance.getId()).withoutTaskDueDate().count()
        )
            .isEqualTo(0);
    ...
    public void testNativeQuery() {
        ...
        assertThat(
            taskService.createNativeTaskQuery().sql("SELECT count(*) FROM ACT_RU_TASK T1, ACT_RU_TASK T2").count()
        )
            .isEqualTo(144);
        ...
        assertThat(taskService.createNativeTaskQuery().sql("SELECT DISTINCT T1.* FROM ACT_RU_TASK T1").list())
            .hasSize(12);
        ...
        assertThat(
            taskService
                .createNativeTaskQuery()
                .sql("SELECT * FROM " + managementService.getTableName(Task.class) + " T WHERE T.NAME_ = 'gonzoTask'")
                .list()
        )
            .hasSize(1);
    ...
    public void testIncludeBinaryVariablesOr() throws Exception {
        ...
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey(
            "oneTaskProcess",
            singletonMap("binaryVariable", (Object) "It is I, le binary".getBytes())
        );
        Task task = taskService
            .createTaskQuery()
            .or()
    ...
    public void testQueryByDeploymentIdOr() throws Exception {
        org.activiti.engine.repository.Deployment deployment = repositoryService.createDeploymentQuery().singleResult();
        runtimeService.startProcessInstanceByKey("oneTaskProcess");
        assertThat(taskService.createTaskQuery().or().taskId("invalid").deploymentId(deployment.getId()).singleResult())
            .isNotNull();
        assertThat(taskService.createTaskQuery().or().taskId("invalid").deploymentId(deployment.getId()).count())
            .isEqualTo(1);
        assertThat(taskService.createTaskQuery().deploymentId("invalid").singleResult()).isNull();
    ...
    public void testQueryByDeploymentIdInOr() throws Exception {
        ...
        List<String> deploymentIds = new ArrayList<String>();
        deploymentIds.add(deployment.getId());
        assertThat(taskService.createTaskQuery().or().taskId("invalid").deploymentIdIn(deploymentIds).singleResult())
            .isNotNull();

        assertThat(taskService.createTaskQuery().or().taskId("invalid").deploymentIdIn(deploymentIds).count())
            .isEqualTo(1);
    ...
    public void testQueryByTaskNameLikeIgnoreCase() {
        ...
        if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.AUDIT)) {
            // History
            assertThat(historyService.createHistoricTaskInstanceQuery().taskNameLikeIgnoreCase("%task%").count())
                .isEqualTo(12);
            assertThat(historyService.createHistoricTaskInstanceQuery().taskNameLikeIgnoreCase("%Task%").count())
                .isEqualTo(12);
            assertThat(historyService.createHistoricTaskInstanceQuery().taskNameLikeIgnoreCase("%TASK%").count())
            ...
            assertThat(historyService.createHistoricTaskInstanceQuery().taskNameLikeIgnoreCase("%TasK%").count())
                .isEqualTo(12);
            assertThat(historyService.createHistoricTaskInstanceQuery().taskNameLikeIgnoreCase("gonzo%").count())
                .isEqualTo(1);
            assertThat(historyService.createHistoricTaskInstanceQuery().taskNameLikeIgnoreCase("%Gonzo%").count())
                .isEqualTo(1);
            assertThat(historyService.createHistoricTaskInstanceQuery().taskNameLikeIgnoreCase("Task%").count())
    ...
    public void testQueryByTaskDescriptionLikeIgnoreCase() {
        ...
        if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.AUDIT)) {
            // History
            assertThat(historyService.createHistoricTaskInstanceQuery().taskDescriptionLikeIgnoreCase("%task%").count())
                .isEqualTo(6);
            assertThat(historyService.createHistoricTaskInstanceQuery().taskDescriptionLikeIgnoreCase("%Task%").count())
                .isEqualTo(6);
            assertThat(historyService.createHistoricTaskInstanceQuery().taskDescriptionLikeIgnoreCase("%TASK%").count())
            ...
            assertThat(historyService.createHistoricTaskInstanceQuery().taskDescriptionLikeIgnoreCase("task%").count())
                .isEqualTo(0);
            assertThat(historyService.createHistoricTaskInstanceQuery().taskDescriptionLikeIgnoreCase("gonzo%").count())
                .isEqualTo(1);
            assertThat(historyService.createHistoricTaskInstanceQuery().taskDescriptionLikeIgnoreCase("Gonzo%").count())
                .isEqualTo(1);
            assertThat(
                historyService.createHistoricTaskInstanceQuery().taskDescriptionLikeIgnoreCase("%manage%").count()
            )
                .isEqualTo(0);
        }
    }
    ...
    public void testQueryByAssigneeLikeIgnoreCase() {
        ...
        if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.AUDIT)) {
            // History
            assertThat(historyService.createHistoricTaskInstanceQuery().taskAssigneeLikeIgnoreCase("%gonzo%").count())
                .isEqualTo(1);
            assertThat(historyService.createHistoricTaskInstanceQuery().taskAssigneeLikeIgnoreCase("%GONZO%").count())
                .isEqualTo(1);
            assertThat(historyService.createHistoricTaskInstanceQuery().taskAssigneeLikeIgnoreCase("%Gon%").count())
                .isEqualTo(1);
            assertThat(historyService.createHistoricTaskInstanceQuery().taskAssigneeLikeIgnoreCase("gon%").count())
                .isEqualTo(1);
            assertThat(historyService.createHistoricTaskInstanceQuery().taskAssigneeLikeIgnoreCase("%nzo%").count())
                .isEqualTo(1);
            assertThat(
                historyService.createHistoricTaskInstanceQuery().taskAssigneeLikeIgnoreCase("%doesnotexist%").count()
            )
                .isEqualTo(0);
        }
    }
    ...
    public void testQueryByOwnerLikeIgnoreCase() {
        ...
        if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.AUDIT)) {
            // History
            assertThat(historyService.createHistoricTaskInstanceQuery().taskOwnerLikeIgnoreCase("%gonzo%").count())
                .isEqualTo(6);
            assertThat(historyService.createHistoricTaskInstanceQuery().taskOwnerLikeIgnoreCase("%GONZO%").count())
                .isEqualTo(6);
            assertThat(historyService.createHistoricTaskInstanceQuery().taskOwnerLikeIgnoreCase("%Gon%").count())
                .isEqualTo(6);
            assertThat(historyService.createHistoricTaskInstanceQuery().taskOwnerLikeIgnoreCase("gon%").count())
                .isEqualTo(6);
            assertThat(historyService.createHistoricTaskInstanceQuery().taskOwnerLikeIgnoreCase("%nzo%").count())
                .isEqualTo(6);
            assertThat(
                historyService.createHistoricTaskInstanceQuery().taskOwnerLikeIgnoreCase("%doesnotexist%").count()
            )
                .isEqualTo(0);
        }
    }
    ...
    public void testQueryByBusinessKeyLikeIgnoreCase() {
        ...
        // Runtime
        assertThat(taskService.createTaskQuery().processInstanceBusinessKeyLikeIgnoreCase("%key%").count())
            .isEqualTo(3);
        assertThat(taskService.createTaskQuery().processInstanceBusinessKeyLikeIgnoreCase("%KEY%").count())
            .isEqualTo(3);
        assertThat(taskService.createTaskQuery().processInstanceBusinessKeyLikeIgnoreCase("%EY%").count()).isEqualTo(3);
        assertThat(taskService.createTaskQuery().processInstanceBusinessKeyLikeIgnoreCase("%business%").count())
            .isEqualTo(2);
        assertThat(taskService.createTaskQuery().processInstanceBusinessKeyLikeIgnoreCase("business%").count())
            .isEqualTo(2);
        assertThat(taskService.createTaskQuery().processInstanceBusinessKeyLikeIgnoreCase("%doesnotexist%").count())
            .isEqualTo(0);
        ...
        if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.AUDIT)) {
            ...
            assertThat(
                historyService
                    .createHistoricTaskInstanceQuery()
                    .processInstanceBusinessKeyLikeIgnoreCase("%key%")
                    .count()
            )
                .isEqualTo(3);
            assertThat(
            ...
            assertThat(
                historyService
                    .createHistoricTaskInstanceQuery()
                    .processInstanceBusinessKeyLikeIgnoreCase("%EY%")
                    .count()
            )
                .isEqualTo(3);
            assertThat(
                historyService
                    .createHistoricTaskInstanceQuery()
                    .processInstanceBusinessKeyLikeIgnoreCase("%business%")
                    .count()
            )
                .isEqualTo(2);
            assertThat(
            ...
            assertThat(
                historyService
                    .createHistoricTaskInstanceQuery()
                    .processInstanceBusinessKeyLikeIgnoreCase("%doesnotexist%")
                    .count()
            )
                .isEqualTo(0);
        }
    ...
    public void testQueryByProcessDefinitionKeyLikeIgnoreCase() {
        ...
        if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.AUDIT)) {
            // History
            assertThat(
                historyService.createHistoricTaskInstanceQuery().processDefinitionKeyLikeIgnoreCase("%one%").count()
            )
                .isEqualTo(4);
            assertThat(
                historyService.createHistoricTaskInstanceQuery().processDefinitionKeyLikeIgnoreCase("%ONE%").count()
                ...
                .isEqualTo(4);
            assertThat(
                historyService.createHistoricTaskInstanceQuery().processDefinitionKeyLikeIgnoreCase("ON%").count()
            )
                .isEqualTo(4);
            assertThat(
                historyService.createHistoricTaskInstanceQuery().processDefinitionKeyLikeIgnoreCase("%fake%").count()
            )
                .isEqualTo(0);
        }
    }
    ...
    public void testLocalizeTasks() throws Exception {
        ...
        dynamicBpmnService.changeLocalizationDescription(
            "en-GB",
            "theTask",
            "My 'en-GB' localized description",
            infoNode
        );
        ...
        tasks =
            taskService.createTaskQuery().processDefinitionId(processInstance.getProcessDefinitionId()).listPage(0, 10);
        assertThat(tasks).hasSize(1);
        assertThat(tasks.get(0).getName()).isEqualTo("my task");
        assertThat(tasks.get(0).getDescription()).isEqualTo("My Task Description");
        ...
        task =
            taskService.createTaskQuery().processDefinitionId(processInstance.getProcessDefinitionId()).singleResult();
        assertThat(task.getName()).isEqualTo("my task");
        assertThat(task.getDescription()).isEqualTo("My Task Description");
    ...
    public void testQueryCandidateOrAssignedUserAndCandidateGroupsIn() {
        ...
        final Task queriedTask = taskService
            .createTaskQuery()
            .taskId(taskId)
