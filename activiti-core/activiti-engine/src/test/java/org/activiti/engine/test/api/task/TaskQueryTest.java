...
public class TaskQueryTest extends PluggableActivitiTestCase {
  ...
  public void testQueryByTaskIdOr() {
    TaskQuery query =
        taskService.createTaskQuery().or().taskId(taskIds.get(0)).taskName("INVALID NAME").endOr();
    assertThat(query.singleResult()).isNotNull();
    assertThat(query.list()).hasSize(1);
    assertThat(query.count()).isEqualTo(1);
  }
  ...
  public void testQueryByNameInIgnoreCaseOr() {
    ...
    TaskQuery query =
        taskService.createTaskQuery().or().taskNameInIgnoreCase(taskNameList).taskId("invalid");
    assertThat(query.list()).hasSize(7);
    assertThat(query.count()).isEqualTo(7);
  ...
  public void testQueryByInvalidDescriptionOr() {
    TaskQuery query =
        taskService.createTaskQuery().or().taskId("invalid").taskDescription("invalid");
    assertThat(query.singleResult()).isNull();
    assertThat(query.list()).hasSize(0);
    assertThat(query.count()).isEqualTo(0);
  ...
  public void testQueryByDescriptionLikeOr() {
    TaskQuery query =
        taskService.createTaskQuery().or().taskId("invalid").taskDescriptionLike("%gonzo%");
    assertThat(query.singleResult()).isNotNull();
    assertThat(query.list()).hasSize(1);
    assertThat(query.count()).isEqualTo(1);
  }
        ...
        .isThrownBy(
            () ->
                taskService
                    ...
                    .or()
                    .taskId("invalid")
                    .taskDescriptionLike(null)
                    .list());
  }

  public void testQueryByInvalidDescriptionLikeOr() {
    TaskQuery query =
        taskService.createTaskQuery().or().taskId("invalid").taskDescriptionLike("invalid");
    assertThat(query.singleResult()).isNull();
    assertThat(query.list()).hasSize(0);
    assertThat(query.count()).isEqualTo(0);
  ...
  public void testQueryByAssigneeIdsOr() {
    TaskQuery query =
        taskService.createTaskQuery().or().taskId("invalid").taskAssigneeIds(asList(GONZO, KERMIT));
    assertThat(query.count()).isEqualTo(1);
    assertThat(query.list()).hasSize(1);
    assertThat(query.singleResult()).isNotNull();
  ...
  public void testQueryByCandidateGroupOr() {
    TaskQuery query =
        taskService.createTaskQuery().or().taskId("invalid").taskCandidateGroup("management");
    assertThat(query.count()).isEqualTo(3);
    assertThat(query.list()).hasSize(3);
    assertThatExceptionOfType(ActivitiException.class).isThrownBy(() -> query.singleResult());

    TaskQuery querySales =
        taskService.createTaskQuery().or().taskId("invalid").taskCandidateGroup("sales");
    assertThat(querySales.count()).isEqualTo(0);
    assertThat(querySales.list()).hasSize(0);
  }
  ...
  public void testQueryByCandidateOrAssigned() {
    ...
    Task assigneeToKermit =
        taskService.createTaskQuery().taskName("assigneeToKermit").singleResult();
  ...
  public void testQueryByCandidateOrAssignedWithUserGroupProxy() {
    // don't specify groups in query calls, instead get them through UserGroupLookupProxy (which
    // could be remote service)
  ...
  public void testQueryByCandidateOrAssignedWithNoGroups() {
    ...
    query =
        taskService.createTaskQuery().or().taskId("dummyidforor").taskCandidateOrAssigned(SCOOTER);
    assertThat(query.count()).isEqualTo(1);
    tasks = query.list();
    assertThat(tasks).hasSize(1);
    ...
    Task assigneeToScooter =
        taskService.createTaskQuery().taskName("assigneeToScooter").singleResult();
  ...
  public void testQueryByCandidateGroupInOr() {
    List<String> groups = asList("management", "accountancy");
    TaskQuery queryForException =
        taskService.createTaskQuery().or().taskId("invalid").taskCandidateGroupIn(groups);
    assertThat(queryForException.count()).isEqualTo(5);
    assertThat(queryForException.list()).hasSize(5);
  ...
  public void testQueryByDelegationStateOr() {
    TaskQuery query =
        taskService.createTaskQuery().or().taskId("invalid").taskDelegationState(null);
    assertThat(query.count()).isEqualTo(12);
    assertThat(query.list()).hasSize(12);
    query =
        taskService
  ...
  public void testQueryCreatedOnOr() throws Exception {
    ...
    TaskQuery query =
        taskService.createTaskQuery().or().taskId("invalid").taskCreatedOn(createTime);
    assertThat(query.count()).isEqualTo(6);
    assertThat(query.list()).hasSize(6);
  }
  ...
  public void testQueryCreatedBeforeOr() throws Exception {
    ...
    TaskQuery query =
        taskService.createTaskQuery().or().taskId("invalid").taskCreatedBefore(before);
    assertThat(query.count()).isEqualTo(7);
    assertThat(query.list()).hasSize(7);
  ...
  public void testTaskDefinitionKeyOr() throws Exception {
    ...
    // 1 task should exist with key "taskKey1"
    List<Task> tasks =
        taskService.createTaskQuery().or().taskId("invalid").taskDefinitionKey("taskKey1").list();
    assertThat(tasks).isNotNull();
    assertThat(tasks).hasSize(1);
  ...
  public void testTaskDefinitionKeyLike() throws Exception {
    ...
    tasks =
        taskService.createTaskQuery().taskDefinitionKeyLike("%123").orderByTaskName().asc().list();
    assertThat(tasks).isNotNull();
    assertThat(tasks).hasSize(1);
  ...
  public void testTaskVariableValueEquals() throws Exception {
    ...
    assertThat(
            taskService.createTaskQuery().taskVariableValueEquals("unexistingVar", "value").count())
        .isEqualTo(0);
    ...
    // Test query matches
    assertThat(taskService.createTaskQuery().taskVariableValueEquals("longVar", 928374L).count())
        .isEqualTo(1);
    assertThat(
            taskService.createTaskQuery().taskVariableValueEquals("shortVar", (short) 123).count())
        .isEqualTo(1);
    assertThat(taskService.createTaskQuery().taskVariableValueEquals("integerVar", 1234).count())
        .isEqualTo(1);
    assertThat(
            taskService
                .createTaskQuery()
                ...
                .count())
        .isEqualTo(1);
    assertThat(taskService.createTaskQuery().taskVariableValueEquals("booleanVar", true).count())
        .isEqualTo(1);
    assertThat(taskService.createTaskQuery().taskVariableValueEquals("dateVar", date).count())
        .isEqualTo(1);
    assertThat(taskService.createTaskQuery().taskVariableValueEquals("nullVar", null).count())
        .isEqualTo(1);

    // Test query for other values on existing variables
    assertThat(taskService.createTaskQuery().taskVariableValueEquals("longVar", 999L).count())
        .isEqualTo(0);
    assertThat(
            taskService.createTaskQuery().taskVariableValueEquals("shortVar", (short) 999).count())
        .isEqualTo(0);
    assertThat(taskService.createTaskQuery().taskVariableValueEquals("integerVar", 999).count())
        .isEqualTo(0);
    assertThat(taskService.createTaskQuery().taskVariableValueEquals("stringVar", "999").count())
        .isEqualTo(0);
    assertThat(taskService.createTaskQuery().taskVariableValueEquals("booleanVar", false).count())
        .isEqualTo(0);
    ...
    assertThat(
            taskService
                ...
                .count())
        .isEqualTo(0);
    assertThat(taskService.createTaskQuery().taskVariableValueEquals("nullVar", "999").count())
        .isEqualTo(0);

    // Test query for not equals
    assertThat(taskService.createTaskQuery().taskVariableValueNotEquals("longVar", 999L).count())
        .isEqualTo(1);
    assertThat(
            taskService
                .createTaskQuery()
                ...
                .count())
        .isEqualTo(1);
    assertThat(taskService.createTaskQuery().taskVariableValueNotEquals("integerVar", 999).count())
        .isEqualTo(1);
    assertThat(taskService.createTaskQuery().taskVariableValueNotEquals("stringVar", "999").count())
        .isEqualTo(1);
    assertThat(
            taskService.createTaskQuery().taskVariableValueNotEquals("booleanVar", false).count())
        .isEqualTo(1);

    // Test value-only variable equals
    assertThat(taskService.createTaskQuery().taskVariableValueEquals(928374L).count()).isEqualTo(1);
    assertThat(taskService.createTaskQuery().taskVariableValueEquals((short) 123).count())
        .isEqualTo(1);
    assertThat(taskService.createTaskQuery().taskVariableValueEquals(1234).count()).isEqualTo(1);
    assertThat(taskService.createTaskQuery().taskVariableValueEquals("stringValue").count())
        .isEqualTo(1);
    ...
    assertThat(taskService.createTaskQuery().taskVariableValueEquals((short) 999).count())
        .isEqualTo(0);
    assertThat(taskService.createTaskQuery().taskVariableValueEquals(9999).count()).isEqualTo(0);
    assertThat(
            taskService.createTaskQuery().taskVariableValueEquals("unexistingstringvalue").count())
        .isEqualTo(0);
    assertThat(taskService.createTaskQuery().taskVariableValueEquals(false).count()).isEqualTo(0);
    assertThat(taskService.createTaskQuery().taskVariableValueEquals(otherDate.getTime()).count())
        .isEqualTo(0);

    assertThat(taskService.createTaskQuery().taskVariableValueLike("stringVar", "string%").count())
        .isEqualTo(1);
    assertThat(taskService.createTaskQuery().taskVariableValueLike("stringVar", "String%").count())
        .isEqualTo(0);
    assertThat(taskService.createTaskQuery().taskVariableValueLike("stringVar", "%Value").count())
        .isEqualTo(1);

    assertThat(
            taskService.createTaskQuery().taskVariableValueGreaterThan("integerVar", 1000).count())
        .isEqualTo(1);
    assertThat(
            taskService.createTaskQuery().taskVariableValueGreaterThan("integerVar", 1234).count())
        .isEqualTo(0);
    assertThat(
            taskService.createTaskQuery().taskVariableValueGreaterThan("integerVar", 1240).count())
        .isEqualTo(0);
    ...
    assertThat(taskService.createTaskQuery().taskVariableValueLessThan("integerVar", 1240).count())
        .isEqualTo(1);
    assertThat(taskService.createTaskQuery().taskVariableValueLessThan("integerVar", 1234).count())
        .isEqualTo(0);
    assertThat(taskService.createTaskQuery().taskVariableValueLessThan("integerVar", 1000).count())
        .isEqualTo(0);
  ...
  public void testTaskVariableValueEqualsOr() throws Exception {
    ...
    assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .taskVariableValueEquals("longVar", 999L)
                .count())
        .isEqualTo(0);
    assertThat(
            taskService
    ...
    assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .taskVariableValueEquals("integerVar", 999)
                .count())
        .isEqualTo(0);
    assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .taskVariableValueEquals("stringVar", "999")
                .count())
        .isEqualTo(0);
    assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .taskVariableValueEquals("booleanVar", false)
                .count())
        .isEqualTo(0);
    Calendar otherDate = Calendar.getInstance();
    otherDate.add(Calendar.YEAR, 1);
    ...
    assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .taskVariableValueEquals("nullVar", "999")
                .count())
        .isEqualTo(0);
    ...
    assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .taskVariableValueNotEquals("longVar", 999L)
                .count())
        .isEqualTo(1);
    assertThat(
            taskService
    ...
    assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .taskVariableValueNotEquals("integerVar", 999)
                .count())
        .isEqualTo(1);
    assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .taskVariableValueNotEquals("stringVar", "999")
                .count())
        .isEqualTo(1);
    assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .taskVariableValueNotEquals("booleanVar", false)
                .count())
        .isEqualTo(1);
    ...
    assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .taskVariableValueEquals("stringValue")
                .count())
        .isEqualTo(1);
    assertThat(
            taskService
    ...
    assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .taskVariableValueEquals(999999L)
                .count())
        .isEqualTo(0);
    assertThat(
            taskService
    ...
    assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .taskVariableValueEquals(otherDate.getTime())
                .count())
        .isEqualTo(0);
    ...
    assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .taskVariableValueLike("stringVar", "string%")
                .count())
        .isEqualTo(1);
    assertThat(
            taskService
    ...
    assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .taskVariableValueLike("stringVar", "%Value")
                .count())
        .isEqualTo(1);
    ...
    assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .taskVariableValueLessThan("integerVar", 1240)
                .count())
        .isEqualTo(1);
    assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .taskVariableValueLessThan("integerVar", 1234)
                .count())
        .isEqualTo(0);
    assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .taskVariableValueLessThan("integerVar", 1000)
                .count())
        .isEqualTo(0);
  ...
  public void testProcessVariableValueEquals() throws Exception {
    ...
    // Test query matches
    assertThat(taskService.createTaskQuery().processVariableValueEquals("longVar", 928374L).count())
        .isEqualTo(1);
    assertThat(
            taskService
                .createTaskQuery()
                ...
                .count())
        .isEqualTo(1);
    assertThat(taskService.createTaskQuery().processVariableValueEquals("integerVar", 1234).count())
        .isEqualTo(1);
    assertThat(
            taskService
                .createTaskQuery()
                ...
                .count())
        .isEqualTo(1);
    assertThat(taskService.createTaskQuery().processVariableValueEquals("booleanVar", true).count())
        .isEqualTo(1);
    assertThat(taskService.createTaskQuery().processVariableValueEquals("dateVar", date).count())
        .isEqualTo(1);
    assertThat(taskService.createTaskQuery().processVariableValueEquals("nullVar", null).count())
        .isEqualTo(1);

    // Test query for other values on existing variables
    assertThat(taskService.createTaskQuery().processVariableValueEquals("longVar", 999L).count())
        .isEqualTo(0);
    assertThat(
            taskService
                .createTaskQuery()
                ...
                .count())
        .isEqualTo(0);
    assertThat(taskService.createTaskQuery().processVariableValueEquals("integerVar", 999).count())
        .isEqualTo(0);
    assertThat(taskService.createTaskQuery().processVariableValueEquals("stringVar", "999").count())
        .isEqualTo(0);
    assertThat(
            taskService.createTaskQuery().processVariableValueEquals("booleanVar", false).count())
        .isEqualTo(0);
    Calendar otherDate = Calendar.getInstance();
    otherDate.add(Calendar.YEAR, 1);
    assertThat(
            taskService
                ...
                .count())
        .isEqualTo(0);
    assertThat(taskService.createTaskQuery().processVariableValueEquals("nullVar", "999").count())
        .isEqualTo(0);
    ...
    assertThat(taskService.createTaskQuery().processVariableValueNotEquals("longVar", 999L).count())
        .isEqualTo(1);
    assertThat(
            taskService
                .createTaskQuery()
        ...
        .isEqualTo(1);
    assertThat(
            taskService.createTaskQuery().processVariableValueNotEquals("integerVar", 999).count())
        .isEqualTo(1);
    assertThat(
            taskService.createTaskQuery().processVariableValueNotEquals("stringVar", "999").count())
        .isEqualTo(1);
    assertThat(
            taskService
                .createTaskQuery()
    ...
    // found:
    assertThat(
            taskService.createTaskQuery().processVariableValueNotEquals("longVar", 928374L).count())
        .isEqualTo(0);

    // Test value-only variable equals
    assertThat(taskService.createTaskQuery().processVariableValueEquals(928374L).count())
        .isEqualTo(1);
    assertThat(taskService.createTaskQuery().processVariableValueEquals((short) 123).count())
        .isEqualTo(1);
    assertThat(taskService.createTaskQuery().processVariableValueEquals(1234).count()).isEqualTo(1);
    assertThat(taskService.createTaskQuery().processVariableValueEquals("stringValue").count())
        .isEqualTo(1);
    ...
    assertThat(taskService.createTaskQuery().processVariableValueEquals(999999L).count())
        .isEqualTo(0);
    assertThat(taskService.createTaskQuery().processVariableValueEquals((short) 999).count())
        .isEqualTo(0);
    ...
    assertThat(
            taskService
                ...
                .count())
        .isEqualTo(0);
    assertThat(taskService.createTaskQuery().processVariableValueEquals(false).count())
        .isEqualTo(0);
    assertThat(
            taskService.createTaskQuery().processVariableValueEquals(otherDate.getTime()).count())
        .isEqualTo(0);
  ...
  public void testProcessVariableValueEqualsOn() throws Exception {
    ...
    assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .processVariableValueEquals("longVar", 999L)
                .count())
        .isEqualTo(0);
    assertThat(
            taskService
    ...
    assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .processVariableValueEquals("integerVar", 999)
                .count())
        .isEqualTo(0);
    assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .processVariableValueEquals("stringVar", "999")
                .count())
        .isEqualTo(0);
    assertThat(
            taskService
    ...
    assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .processVariableValueEquals("nullVar", "999")
                .count())
        .isEqualTo(0);
    ...
    assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .processVariableValueNotEquals("longVar", 999L)
                .count())
        .isEqualTo(1);
    assertThat(
            taskService
    ...
    assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .processVariableValueEquals(1234)
                .count())
        .isEqualTo(1);
    assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .processVariableValueEquals("stringValue")
                .count())
        .isEqualTo(1);
    assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .processVariableValueEquals(true)
                .count())
        .isEqualTo(1);
    assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .processVariableValueEquals(date)
                .count())
        .isEqualTo(1);
    assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .processVariableValueEquals(null)
                .count())
        .isEqualTo(1);
    ...
    assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .processVariableValueEquals(999999L)
                .count())
        .isEqualTo(0);
    assertThat(
            taskService
    ...
    assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .processVariableValueEquals(9999)
                .count())
        .isEqualTo(0);
    assertThat(
            taskService
    ...
    assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .processVariableValueEquals(false)
                .count())
        .isEqualTo(0);
    assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .processVariableValueEquals(otherDate.getTime())
                .count())
        .isEqualTo(0);
  }
  ...
  public void testProcessVariableValueEqualsIgnoreCase() throws Exception {
    ...
    assertThat(
            taskService
                .createTaskQuery()
                .processVariableValueEqualsIgnoreCase("mixed", "azerTY")
                .count())
        .isEqualTo(1);
    assertThat(
            taskService
    ...
    assertThat(
            taskService
                .createTaskQuery()
                .processVariableValueEqualsIgnoreCase("mixed", "uiop")
                .count())
        .isEqualTo(0);
    ...
    assertThat(
            taskService
                .createTaskQuery()
                .processVariableValueEqualsIgnoreCase("upper", "azerTY")
                .count())
        .isEqualTo(1);
    assertThat(
            taskService
    ...
    assertThat(
            taskService
                .createTaskQuery()
                .processVariableValueEqualsIgnoreCase("upper", "uiop")
                .count())
        .isEqualTo(0);
    ...
    assertThat(
            taskService
                .createTaskQuery()
                .processVariableValueEqualsIgnoreCase("lower", "azerTY")
                .count())
        .isEqualTo(1);
    assertThat(
            taskService
    ...
    assertThat(
            taskService
                .createTaskQuery()
                .processVariableValueEqualsIgnoreCase("lower", "uiop")
                .count())
        .isEqualTo(0);
  }
  ...
  public void testProcessVariableValueLike() throws Exception {
    ...
    assertThat(taskService.createTaskQuery().processVariableValueLike("mixed", "Azer%").count())
        .isEqualTo(1);
    assertThat(taskService.createTaskQuery().processVariableValueLike("mixed", "A%").count())
        .isEqualTo(1);
    assertThat(taskService.createTaskQuery().processVariableValueLike("mixed", "a%").count())
        .isEqualTo(0);
  }
  ...
  public void testProcessVariableValueLikeIgnoreCase() throws Exception {
    ...
    assertThat(
            taskService
                .createTaskQuery()
                .processVariableValueLikeIgnoreCase("mixed", "azer%")
                .count())
        .isEqualTo(1);
    assertThat(
            taskService.createTaskQuery().processVariableValueLikeIgnoreCase("mixed", "a%").count())
        .isEqualTo(1);
    assertThat(
            taskService
                .createTaskQuery()
                .processVariableValueLikeIgnoreCase("mixed", "Azz%")
                .count())
        .isEqualTo(0);
  }
  ...
  public void testProcessVariableValueGreaterThan() throws Exception {
    ...
    assertThat(taskService.createTaskQuery().processVariableValueGreaterThan("number", 5).count())
        .isEqualTo(1);
    assertThat(taskService.createTaskQuery().processVariableValueGreaterThan("number", 10).count())
        .isEqualTo(0);
  }
  ...
  public void testProcessVariableValueGreaterThanOrEquals() throws Exception {
    ...
    assertThat(
            taskService
                .createTaskQuery()
                .processVariableValueGreaterThanOrEqual("number", 5)
                .count())
        .isEqualTo(1);
    assertThat(
            taskService
                .createTaskQuery()
                .processVariableValueGreaterThanOrEqual("number", 10)
                .count())
        .isEqualTo(1);
    assertThat(
            taskService
                .createTaskQuery()
                .processVariableValueGreaterThanOrEqual("number", 11)
                .count())
        .isEqualTo(0);
  }
  ...
  public void testProcessVariableValueLessThan() throws Exception {
    ...
    assertThat(taskService.createTaskQuery().processVariableValueLessThan("number", 12).count())
        .isEqualTo(1);
    assertThat(taskService.createTaskQuery().processVariableValueLessThan("number", 10).count())
        .isEqualTo(0);
  }
  ...
  public void testProcessVariableValueLessThanOrEquals() throws Exception {
    ...
    assertThat(
            taskService.createTaskQuery().processVariableValueLessThanOrEqual("number", 12).count())
        .isEqualTo(1);
    assertThat(
            taskService.createTaskQuery().processVariableValueLessThanOrEqual("number", 10).count())
        .isEqualTo(1);
    assertThat(
            taskService.createTaskQuery().processVariableValueLessThanOrEqual("number", 8).count())
        .isEqualTo(0);
  }
  ...
  public void testProcessDefinitionId() throws Exception {
    ...
    assertThat(taskService.createTaskQuery().processDefinitionId("unexisting").count())
        .isEqualTo(0);
  }
  ...
  public void testProcessDefinitionKey() throws Exception {
    ...
    assertThat(taskService.createTaskQuery().processDefinitionKey("unexisting").count())
        .isEqualTo(0);
  }
  ...
  public void testProcessDefinitionKeyIn() throws Exception {
    ...
    assertThat(taskService.createTaskQuery().processDefinitionKeyIn(includeIds).count())
        .isEqualTo(13);
  ...
  public void testProcessDefinitionName() throws Exception {
    ...
    List<Task> tasks =
        taskService.createTaskQuery().processDefinitionName("The One Task Process").list();
    assertThat(tasks).hasSize(1);
    assertThat(tasks.get(0).getProcessInstanceId()).isEqualTo(processInstance.getId());

    assertThat(taskService.createTaskQuery().processDefinitionName("unexisting").count())
        .isEqualTo(0);
  }
  ...
  public void testProcessDefinitionNameOr() throws Exception {
    ...
    assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .processDefinitionName("unexisting")
                .count())
        .isEqualTo(0);
  }
  ...
  public void testProcessCategoryIn() throws Exception {
    ...
    final Task task =
        taskService.createTaskQuery().processCategoryIn(singletonList("Examples")).singleResult();
    assertThat(task).isNotNull();
    ...
    assertThat(taskService.createTaskQuery().processCategoryIn(singletonList("unexisting")).count())
        .isEqualTo(0);
  }
  ...
  public void testProcessCategoryInOr() throws Exception {
    ...
    assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .processCategoryIn(singletonList("unexisting"))
                .count())
        .isEqualTo(0);
  }
  ...
  public void testProcessCategoryNotIn() throws Exception {
    ...
    assertThat(
            taskService.createTaskQuery().processCategoryNotIn(singletonList("Examples")).count())
        .isEqualTo(0);
  }
  ...
  public void testProcessCategoryNotInOr() throws Exception {
    ...
    assertThat(
            taskService
                ...
                .or()
                .taskId("invalid")
                .processCategoryNotIn(singletonList("Examples"))
                .count())
        .isEqualTo(0);
  }
  ...
  public void testProcessInstanceIdIn() throws Exception {
    ...
    assertThat(
            taskService.createTaskQuery().processInstanceIdIn(singletonList("unexisting")).count())
        .isEqualTo(0);
  }
  ...
  public void testProcessInstanceBusinessKey() throws Exception {
    ...
    assertThat(
            taskService
                ...
                .list())
        .hasSize(1);
    assertThat(taskService.createTaskQuery().processInstanceBusinessKey("BUSINESS-KEY-1").list())
        .hasSize(1);
    assertThat(taskService.createTaskQuery().processInstanceBusinessKey("NON-EXISTING").count())
        .isEqualTo(0);
  }
  ...
  public void testQuerySorting() {
    ...
    assertThat(taskService.createTaskQuery().orderByTaskId().taskName("testTask").asc().list())
        .hasSize(6);
    assertThat(taskService.createTaskQuery().orderByTaskId().taskName("testTask").desc().list())
        .hasSize(6);
  }
  ...
  public void testNativeQuery() {
    ...
    assertThat(
            taskService
                .createNativeTaskQuery()
                .sql("SELECT count(*) FROM ACT_RU_TASK T1, ACT_RU_TASK T2")
                .count())
        .isEqualTo(144);
    ...
    assertThat(
            taskService
                .createNativeTaskQuery()
                .sql("SELECT DISTINCT T1.* FROM ACT_RU_TASK T1")
                .list())
        .hasSize(12);
  ...
  public void testIncludeBinaryVariables() throws Exception {
    ...
    ProcessInstance processInstance =
        runtimeService.startProcessInstanceByKey(
            "oneTaskProcess", singletonMap("binaryVariable", "It is I, le binary".getBytes()));
    Task task =
        taskService.createTaskQuery().processInstanceId(processInstance.getId()).singleResult();
    assertThat(task).isNotNull();
    taskService.setVariableLocal(
        task.getId(), "binaryTaskVariable", (Object) "It is I, le binary".getBytes());

    // Query task, including processVariables
    task =
        taskService.createTaskQuery().taskId(task.getId()).includeProcessVariables().singleResult();
    assertThat(task).isNotNull();
  ...
  public void testQueryByDeploymentId() throws Exception {
    ...
    runtimeService.startProcessInstanceByKey("oneTaskProcess");
    assertThat(taskService.createTaskQuery().deploymentId(deployment.getId()).singleResult())
        .isNotNull();
  ...
  public void testQueryByDeploymentIdOr() throws Exception {
    ...
    assertThat(
        ...
        .isEqualTo(1);
    assertThat(taskService.createTaskQuery().deploymentId("invalid").singleResult()).isNull();
    assertThat(taskService.createTaskQuery().or().taskId("invalid").deploymentId("invalid").count())
        .isEqualTo(0);
  }
  ...
  public void testQueryByDeploymentIdIn() throws Exception {
    ...
    assertThat(taskService.createTaskQuery().deploymentIdIn(deploymentIds).singleResult())
        .isNotNull();
  ...
  public void testQueryByTaskNameLikeIgnoreCase() {
    ...
    // Runtime
    assertThat(taskService.createTaskQuery().taskNameLikeIgnoreCase("%task%").count())
        .isEqualTo(12);
    assertThat(taskService.createTaskQuery().taskNameLikeIgnoreCase("%Task%").count())
        .isEqualTo(12);
    assertThat(taskService.createTaskQuery().taskNameLikeIgnoreCase("%TASK%").count())
    ...
    assertThat(taskService.createTaskQuery().taskNameLikeIgnoreCase("%Gonzo%").count())
        .isEqualTo(1);
  ...
  public void testQueryByTaskDescriptionLikeIgnoreCase() {
    ...
    // Runtime
    assertThat(taskService.createTaskQuery().taskDescriptionLikeIgnoreCase("%task%").count())
        .isEqualTo(6);
    assertThat(taskService.createTaskQuery().taskDescriptionLikeIgnoreCase("%Task%").count())
        .isEqualTo(6);
    assertThat(taskService.createTaskQuery().taskDescriptionLikeIgnoreCase("%TASK%").count())
    ...
    assertThat(taskService.createTaskQuery().taskDescriptionLikeIgnoreCase("task%").count())
        .isEqualTo(0);
    assertThat(taskService.createTaskQuery().taskDescriptionLikeIgnoreCase("gonzo%").count())
        .isEqualTo(1);
    assertThat(taskService.createTaskQuery().taskDescriptionLikeIgnoreCase("Gonzo%").count())
        .isEqualTo(1);
    assertThat(taskService.createTaskQuery().taskDescriptionLikeIgnoreCase("%manage%").count())
        .isEqualTo(0);
    ...
    if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.AUDIT)) {
      ...
      assertThat(
              historyService
                  .createHistoricTaskInstanceQuery()
                  .taskDescriptionLikeIgnoreCase("gonzo%")
                  .count())
          .isEqualTo(1);
      assertThat(
              historyService
      ...
      assertThat(
              historyService
                  .createHistoricTaskInstanceQuery()
                  .taskDescriptionLikeIgnoreCase("%manage%")
                  .count())
          .isEqualTo(0);
    }
  }
  ...
  public void testQueryByAssigneeLikeIgnoreCase() {
    ...
    // Runtime
    assertThat(taskService.createTaskQuery().taskAssigneeLikeIgnoreCase("%gonzo%").count())
        .isEqualTo(1);
    assertThat(taskService.createTaskQuery().taskAssigneeLikeIgnoreCase("%GONZO%").count())
        .isEqualTo(1);
    assertThat(taskService.createTaskQuery().taskAssigneeLikeIgnoreCase("%Gon%").count())
        .isEqualTo(1);
    assertThat(taskService.createTaskQuery().taskAssigneeLikeIgnoreCase("gon%").count())
        .isEqualTo(1);
    assertThat(taskService.createTaskQuery().taskAssigneeLikeIgnoreCase("%nzo%").count())
        .isEqualTo(1);
    assertThat(taskService.createTaskQuery().taskAssigneeLikeIgnoreCase("%doesnotexist%").count())
        .isEqualTo(0);
    ...
    if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.AUDIT)) {
      ...
      assertThat(
              historyService
                  .createHistoricTaskInstanceQuery()
                  .taskAssigneeLikeIgnoreCase("%gonzo%")
                  .count())
          .isEqualTo(1);
      assertThat(
              historyService
      ...
      assertThat(
              historyService
                  .createHistoricTaskInstanceQuery()
                  .taskAssigneeLikeIgnoreCase("%Gon%")
                  .count())
          .isEqualTo(1);
      assertThat(
              historyService
      ...
      assertThat(
              historyService
                  .createHistoricTaskInstanceQuery()
                  .taskAssigneeLikeIgnoreCase("%nzo%")
                  .count())
          .isEqualTo(1);
      assertThat(
              historyService
                  .createHistoricTaskInstanceQuery()
                  .taskAssigneeLikeIgnoreCase("%doesnotexist%")
                  .count())
          .isEqualTo(0);
    }
  }
  ...
  public void testQueryByOwnerLikeIgnoreCase() {
    ...
    // Runtime
    assertThat(taskService.createTaskQuery().taskOwnerLikeIgnoreCase("%gonzo%").count())
        .isEqualTo(6);
    assertThat(taskService.createTaskQuery().taskOwnerLikeIgnoreCase("%GONZO%").count())
        .isEqualTo(6);
    ...
    assertThat(taskService.createTaskQuery().taskOwnerLikeIgnoreCase("%doesnotexist%").count())
        .isEqualTo(0);
    ...
    if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.AUDIT)) {
      ...
      assertThat(
              historyService
                  .createHistoricTaskInstanceQuery()
                  .taskOwnerLikeIgnoreCase("%nzo%")
                  .count())
          .isEqualTo(6);
      assertThat(
              historyService
                  .createHistoricTaskInstanceQuery()
                  .taskOwnerLikeIgnoreCase("%doesnotexist%")
                  .count())
          .isEqualTo(0);
    }
  }
  ...
  public void testQueryByBusinessKeyLikeIgnoreCase() {
    ...
    // Runtime
    assertThat(
            taskService.createTaskQuery().processInstanceBusinessKeyLikeIgnoreCase("%key%").count())
        .isEqualTo(3);
    assertThat(
            taskService.createTaskQuery().processInstanceBusinessKeyLikeIgnoreCase("%KEY%").count())
        .isEqualTo(3);
    assertThat(
            taskService.createTaskQuery().processInstanceBusinessKeyLikeIgnoreCase("%EY%").count())
        .isEqualTo(3);
    assertThat(
            taskService
                .createTaskQuery()
  ...
  public void testQueryByProcessDefinitionKeyLikeIgnoreCase() {
    ...
    assertThat(taskService.createTaskQuery().processDefinitionKeyLikeIgnoreCase("%one%").count())
        .isEqualTo(4);
    assertThat(taskService.createTaskQuery().processDefinitionKeyLikeIgnoreCase("%ONE%").count())
        .isEqualTo(4);
    assertThat(taskService.createTaskQuery().processDefinitionKeyLikeIgnoreCase("ON%").count())
        .isEqualTo(4);
    assertThat(taskService.createTaskQuery().processDefinitionKeyLikeIgnoreCase("%fake%").count())
        .isEqualTo(0);
    ...
    if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.AUDIT)) {
      ...
      assertThat(
              historyService
                  .createHistoricTaskInstanceQuery()
                  .processDefinitionKeyLikeIgnoreCase("%one%")
                  .count())
          .isEqualTo(4);
      assertThat(
              historyService
      ...
      assertThat(
              historyService
                  .createHistoricTaskInstanceQuery()
                  .processDefinitionKeyLikeIgnoreCase("ON%")
                  .count())
          .isEqualTo(4);
      assertThat(
              historyService
                  .createHistoricTaskInstanceQuery()
                  .processDefinitionKeyLikeIgnoreCase("%fake%")
                  .count())
          .isEqualTo(0);
    }
  }
  ...
  public void testTaskLocalAndProcessInstanceVariableEqualsInOr() {
    ...
    List<Task> allTasks =
        taskService.createTaskQuery().processDefinitionKey("oneTaskProcess").list();
    ...
    assertThat(
            taskService.createTaskQuery().taskVariableValueEquals("localVar", "someValue").list())
        .hasSize(2);
    assertThat(taskService.createTaskQuery().processVariableValueEquals("var", "theValue").list())
        .hasSize(3);
  ...
  public void testLocalizeTasks() throws Exception {
    ...
    ObjectNode infoNode =
        dynamicBpmnService.getProcessDefinitionInfo(processInstance.getProcessDefinitionId());

    dynamicBpmnService.changeLocalizationName(
        "en-GB", "theTask", "My 'en-GB' localized name", infoNode);
    dynamicBpmnService.changeLocalizationDescription(
        "en-GB", "theTask", "My 'en-GB' localized description", infoNode);
    dynamicBpmnService.saveProcessDefinitionInfo(
        processInstance.getProcessDefinitionId(), infoNode);

    dynamicBpmnService.changeLocalizationName("en", "theTask", "My 'en' localized name", infoNode);
    dynamicBpmnService.changeLocalizationDescription(
        "en", "theTask", "My 'en' localized description", infoNode);
    dynamicBpmnService.saveProcessDefinitionInfo(
        processInstance.getProcessDefinitionId(), infoNode);
