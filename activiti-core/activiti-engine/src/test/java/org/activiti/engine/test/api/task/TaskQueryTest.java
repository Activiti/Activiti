...
public class TaskQueryTest extends PluggableActivitiTestCase {
    ...
    public void setUp() throws Exception {
        ProcessEngineConfigurationImpl engineConfiguration =
                (ProcessEngineConfigurationImpl)
                        cachedProcessEngine.getProcessEngineConfiguration();
    ...
    public void testQueryByNameInOr() {
        ...
        TaskQuery query =
                taskService.createTaskQuery().or().taskNameIn(taskNameList).taskId("invalid");
        assertThat(query.list()).hasSize(7);
        assertThat(query.count()).isEqualTo(7);
    ...
    public void testQueryByNameLikeOr() {
        TaskQuery query =
                taskService.createTaskQuery().or().taskId("invalid").taskNameLike("gonzo%");
        assertThat(query.singleResult()).isNotNull();
        assertThat(query.list()).hasSize(1);
        assertThat(query.count()).isEqualTo(1);
    }
    ...
    public void testQueryByInvolvedGroup() {
        try {
            ...
            taskService.addGroupIdentityLink(
                    adhocTask.getId(), "group1", IdentityLinkType.PARTICIPANT);
    ...
    public void testQueryByCandidateUser() {
        ...
        TaskQuery queryFozzie =
                taskService.createTaskQuery().taskCandidateUser(FOZZIE, FOZZIESGROUPS);
    ...
    public void testQueryByCandidateOrAssigned() {
        TaskQuery query =
                taskService.createTaskQuery().taskCandidateOrAssigned(KERMIT, KERMITSGROUPS);
        assertThat(query.count()).isEqualTo(11);
    ...
    public void testQueryByCandidateGroupIn() {
        ...
        // Unexisting groups or groups that don't have candidate tasks shouldn't influence other
        // results
    ...
    public void testQueryCreatedAfterOr() throws Exception {
        ...
        TaskQuery query =
                taskService.createTaskQuery().or().taskId("invalid").taskCreatedAfter(after);
        assertThat(query.count()).isEqualTo(3);
        assertThat(query.list()).hasSize(3);
    ...
    public void testTaskVariableValueEquals() throws Exception {
        ...
        assertThat(taskService.createTaskQuery().taskVariableValueEquals(928374L).count())
                .isEqualTo(1);
        assertThat(taskService.createTaskQuery().taskVariableValueEquals((short) 123).count())
                .isEqualTo(1);
        assertThat(taskService.createTaskQuery().taskVariableValueEquals(1234).count())
                .isEqualTo(1);
        assertThat(taskService.createTaskQuery().taskVariableValueEquals("stringValue").count())
                .isEqualTo(1);
        assertThat(taskService.createTaskQuery().taskVariableValueEquals(true).count())
                .isEqualTo(1);
        assertThat(taskService.createTaskQuery().taskVariableValueEquals(date).count())
                .isEqualTo(1);
        assertThat(taskService.createTaskQuery().taskVariableValueEquals(null).count())
                .isEqualTo(1);

        assertThat(taskService.createTaskQuery().taskVariableValueEquals(999999L).count())
                .isEqualTo(0);
        assertThat(taskService.createTaskQuery().taskVariableValueEquals((short) 999).count())
                .isEqualTo(0);
        assertThat(taskService.createTaskQuery().taskVariableValueEquals(9999).count())
                .isEqualTo(0);
        assertThat(
                        taskService
                                .createTaskQuery()
                                ...
                                .count())
                .isEqualTo(0);
        assertThat(taskService.createTaskQuery().taskVariableValueEquals(false).count())
                .isEqualTo(0);
        assertThat(
                        taskService
                                .createTaskQuery()
    ...
    public void testProcessVariableValueEquals() throws Exception {
        ...
        assertThat(
                        taskService
                                .createTaskQuery()
                                .processVariableValueNotEquals("longVar", 928374L)
                                .count())
                .isEqualTo(0);
        ...
        assertThat(taskService.createTaskQuery().processVariableValueEquals((short) 123).count())
                .isEqualTo(1);
        assertThat(taskService.createTaskQuery().processVariableValueEquals(1234).count())
                .isEqualTo(1);
        assertThat(taskService.createTaskQuery().processVariableValueEquals("stringValue").count())
                .isEqualTo(1);
        assertThat(taskService.createTaskQuery().processVariableValueEquals(true).count())
                .isEqualTo(1);
        assertThat(taskService.createTaskQuery().processVariableValueEquals(date).count())
                .isEqualTo(1);
        assertThat(taskService.createTaskQuery().processVariableValueEquals(null).count())
                .isEqualTo(1);
        ...
        assertThat(taskService.createTaskQuery().processVariableValueEquals((short) 999).count())
                .isEqualTo(0);
        assertThat(taskService.createTaskQuery().processVariableValueEquals(9999).count())
                .isEqualTo(0);
        assertThat(
                        taskService
                                .createTaskQuery()
    ...
    public void testProcessVariableValueLikeIgnoreCase() throws Exception {
        ...
        assertThat(
                        taskService
                                .createTaskQuery()
                                .processVariableValueLikeIgnoreCase("mixed", "a%")
                                .count())
                .isEqualTo(1);
        assertThat(
                        taskService
    ...
    public void testProcessVariableValueGreaterThan() throws Exception {
        ...
        assertThat(
                        taskService
                                .createTaskQuery()
                                .processVariableValueGreaterThan("number", 5)
                                .count())
                .isEqualTo(1);
        assertThat(
                        taskService
                                .createTaskQuery()
                                .processVariableValueGreaterThan("number", 10)
                                .count())
                .isEqualTo(0);
    }
    ...
    public void testProcessVariableValueLessThanOrEquals() throws Exception {
        ...
        assertThat(
                        taskService
                                .createTaskQuery()
                                .processVariableValueLessThanOrEqual("number", 12)
                                .count())
                .isEqualTo(1);
        assertThat(
                        taskService
                                .createTaskQuery()
                                .processVariableValueLessThanOrEqual("number", 10)
                                .count())
                .isEqualTo(1);
        assertThat(
                        taskService
                                .createTaskQuery()
                                .processVariableValueLessThanOrEqual("number", 8)
                                .count())
                .isEqualTo(0);
    }
    ...
    public void testProcessInstanceIdInMultiple() throws Exception {
        ...
        assertThat(
                        taskService
                                .createTaskQuery()
                                .processInstanceIdIn(
                                        asList(processInstance1.getId(), processInstance2.getId()))
                                .count())
                .isEqualTo(2);
        assertThat(
                        taskService
    ...
    public void testQuerySorting() {
        ...
        assertThat(taskService.createTaskQuery().orderByProcessInstanceId().asc().list())
                .hasSize(12);
        ...
        assertThat(taskService.createTaskQuery().orderByTaskDescription().desc().list())
                .hasSize(12);
        assertThat(taskService.createTaskQuery().orderByProcessInstanceId().desc().list())
                .hasSize(12);
    ...
    public void testQueryByDeploymentId() throws Exception {
        ...
        assertThat(taskService.createTaskQuery().deploymentId(deployment.getId()).singleResult())
                .isNotNull();
        assertThat(taskService.createTaskQuery().deploymentId(deployment.getId()).count())
                .isEqualTo(1);
    ...
    public void testQueryByDeploymentIdIn() throws Exception {
        ...
        assertThat(taskService.createTaskQuery().deploymentIdIn(deploymentIds).singleResult())
                .isNotNull();
        assertThat(taskService.createTaskQuery().deploymentIdIn(deploymentIds).count())
                .isEqualTo(1);
    ...
    public void testQueryByOwnerLikeIgnoreCase() {
        ...
        assertThat(taskService.createTaskQuery().taskOwnerLikeIgnoreCase("%GONZO%").count())
                .isEqualTo(6);
        assertThat(taskService.createTaskQuery().taskOwnerLikeIgnoreCase("%Gon%").count())
                .isEqualTo(6);
        assertThat(taskService.createTaskQuery().taskOwnerLikeIgnoreCase("gon%").count())
                .isEqualTo(6);
        assertThat(taskService.createTaskQuery().taskOwnerLikeIgnoreCase("%nzo%").count())
                .isEqualTo(6);
    ...
    public void testLocalizeTasks() throws Exception {
        ...
        ObjectNode infoNode =
                dynamicBpmnService.getProcessDefinitionInfo(
        ...
        dynamicBpmnService.changeLocalizationName(
                "en", "theTask", "My 'en' localized name", infoNode);
        dynamicBpmnService.changeLocalizationDescription(
