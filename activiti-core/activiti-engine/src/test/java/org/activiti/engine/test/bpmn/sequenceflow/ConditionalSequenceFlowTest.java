...
public class ConditionalSequenceFlowTest extends PluggableActivitiTestCase {
    ...
    public void testUelExpression() {
        ...
        ProcessInstance pi = runtimeService.startProcessInstanceByKey("condSeqFlowUelExpr",
            variables);
    ...
    public void testSkipExpression() {
        ...
        ProcessInstance pi = runtimeService.startProcessInstanceByKey("testSkipExpression",
            variables);
    ...
    public void testDynamicExpression() {
        ...
        ObjectNode infoNode = dynamicBpmnService.changeSequenceFlowCondition("flow1",
            "${input == 'right'}");
