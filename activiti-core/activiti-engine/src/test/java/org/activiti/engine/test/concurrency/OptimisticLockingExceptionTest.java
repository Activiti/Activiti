...
public class OptimisticLockingExceptionTest extends PluggableActivitiTestCase {
  ...
  public void testOptimisticLockExceptionForConcurrentJoin() throws Exception {
    ...
    // But with concurrency, you never know. Hence why this test is repeated 10 time to make sure
    // the chance for
   ...
   * OptimisticLockingTestCommandContextCloseListener} to the current {@link CommandContext} before
   * doing the regular trigger.
   */
  ...
  /**
   * {@link CommandContextCloseListener} that halts the closing of the {@link CommandContext} until
