...
public class OptimisticLockingExceptionTest extends PluggableActivitiTestCase {
    ...
    public void testOptimisticLockExceptionForConcurrentJoin() throws Exception {
        ...
        // But with concurrency, you never know. Hence why this test is repeated 10 time to make
        // sure
        // the chance for
        ...
        for (int i = 0; i < 10; i++) {
            ...
            ProcessInstance processInstance =
                    runtimeService.startProcessInstanceByKey("CompetingJoinsProcess");
            ...
            // Either the transactions just happened to be aligned perfectly and no problem occurred
    ...
    /**
     * Simple extension of the triggerCommand, that adds a {@link
     * OptimisticLockingTestCommandContextCloseListener} to the current {@link CommandContext}
     * before doing the regular trigger.
     */
    ...
    public static class OptimisticLockingTestCommandContextCloseListener
        ...
        public static CyclicBarrier TEST_BARRIER_BEFORE_CLOSE =
                new CyclicBarrier(
