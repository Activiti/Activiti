...
public class ModelQueryTest extends PluggableActivitiTestCase {
    ...
    public void testByDeploymentId() {
        ...
        assertThat(repositoryService.createModelQuery().deploymentId(deployment.getId())
            .count()).isEqualTo(0);
    ...
    public void testVerifyModelProperties() {
        ...
        models = repositoryService.createModelQuery().modelNameLike("%model%").orderByModelName()
            .asc().list();
    ...
    public void testNativeQuery() {
        ...
        assertThat(repositoryService.createNativeProcessDefinitionQuery()
            .sql(baseQuerySql + " where NAME_ = #{name}").parameter("name", "my model")
            .list()).hasSize(1);
