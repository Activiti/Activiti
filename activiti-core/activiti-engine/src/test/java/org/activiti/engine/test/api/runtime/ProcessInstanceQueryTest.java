...
public class ProcessInstanceQueryTest extends PluggableActivitiTestCase {
  ...
  private static final String PROCESS_DEFINITION_CATEGORY =
      "org.activiti.enginge.test.api.runtime.Category";
  private static final String PROCESS_DEFINITION_CATEGORY_2 =
  ...
  public void testQueryByProcessDefinitionKeySingleResult() {
    ProcessInstanceQuery query =
        runtimeService.createProcessInstanceQuery().processDefinitionKey(PROCESS_DEFINITION_KEY_2);
  ...
  public void testQueryByInvalidProcessDefinitionKey() {
    assertThat(
            runtimeService
                ...
                .singleResult())
        .isNull();
    assertThat(runtimeService.createProcessInstanceQuery().processDefinitionKey("invalid").list())
        .hasSize(0);
  }
  ...
  public void testQueryByProcessDefinitionKeys() {
    ...
    ProcessInstanceQuery query =
        runtimeService.createProcessInstanceQuery().processDefinitionKeys(processDefinitionKeySet);
    assertThat(query.count()).isEqualTo(PROCESS_DEPLOY_COUNT);
    assertThat(query.list()).hasSize(PROCESS_DEPLOY_COUNT);
    assertThatExceptionOfType(ActivitiException.class).isThrownBy(() -> query.singleResult());
  }
  ...
  public void testQueryByProcessInstanceName() {
    ...
    assertThat(
            runtimeService
                ...
                .singleResult())
        .isNotNull();
    assertThat(runtimeService.createProcessInstanceQuery().processInstanceName("new name").list())
        .hasSize(1);
  ...
  public void testQueryByProcessInstanceNameLike() {
    ...
    assertThat(
        ...
        .isNotNull();
    assertThat(
            runtimeService.createProcessInstanceQuery().processInstanceNameLike("new name").list())
        .hasSize(1);
  ...
  public void testOrQueryByProcessInstanceNameLikeIgnoreCase() {
    ...
    assertThat(
            runtimeService
                .createProcessInstanceQuery()
                .processInstanceNameLikeIgnoreCase("%NaM%")
                .list())
        .hasSize(2);
    assertThat(
            runtimeService
                .createProcessInstanceQuery()
                .processInstanceNameLikeIgnoreCase("%the%")
                .list())
        .hasSize(1);
    assertThat(
            runtimeService
                .createProcessInstanceQuery()
                .processInstanceNameLikeIgnoreCase("new%")
                .list())
        .hasSize(1);
    assertThat(
            runtimeService
  ...
  public void testQueryByBusinessKeyAndProcessDefinitionKey() {
    assertThat(
            runtimeService
                .createProcessInstanceQuery()
                .processInstanceBusinessKey("0", PROCESS_DEFINITION_KEY)
                .count())
        .isEqualTo(1);
    assertThat(
            runtimeService
                .createProcessInstanceQuery()
                .processInstanceBusinessKey("1", PROCESS_DEFINITION_KEY)
                .count())
        .isEqualTo(1);
    assertThat(
            runtimeService
                .createProcessInstanceQuery()
                .processInstanceBusinessKey("2", PROCESS_DEFINITION_KEY)
                .count())
        .isEqualTo(1);
    assertThat(
            runtimeService
                .createProcessInstanceQuery()
                .processInstanceBusinessKey("3", PROCESS_DEFINITION_KEY)
                .count())
        .isEqualTo(1);
    assertThat(
            runtimeService
  ...
  public void testQueryByBusinessKey() {
    assertThat(runtimeService.createProcessInstanceQuery().processInstanceBusinessKey("0").count())
        .isEqualTo(1);
    assertThat(runtimeService.createProcessInstanceQuery().processInstanceBusinessKey("1").count())
        .isEqualTo(2);
  }
  ...
  public void testQueryByProcessDefinitionId() {
    final ProcessDefinition processDefinition1 =
        repositoryService
            .createProcessDefinitionQuery()
            .processDefinitionKey(PROCESS_DEFINITION_KEY)
            .singleResult();
    ProcessInstanceQuery query1 =
        runtimeService.createProcessInstanceQuery().processDefinitionId(processDefinition1.getId());
    ...
    ProcessInstanceQuery query2 =
        runtimeService.createProcessInstanceQuery().processDefinitionId(processDefinition2.getId());
  ...
  public void testQueryByProcessDefinitionIds() {
    ...
    ProcessInstanceQuery query =
        runtimeService.createProcessInstanceQuery().processDefinitionIds(processDefinitionIdSet);
    assertThat(query.count()).isEqualTo(PROCESS_DEPLOY_COUNT);
    assertThat(query.list()).hasSize(PROCESS_DEPLOY_COUNT);
    assertThatExceptionOfType(ActivitiException.class).isThrownBy(() -> query.singleResult());
  }
  ...
  public void testQueryByInvalidProcessDefinitionName() {
    assertThat(
            runtimeService
                ...
                .singleResult())
        .isNull();
    assertThat(runtimeService.createProcessInstanceQuery().processDefinitionName("invalid").count())
        .isEqualTo(0);
  }

  public void testQueryByDeploymentId() {
    List<ProcessInstance> instances =
        runtimeService.createProcessInstanceQuery().deploymentId(deployment.getId()).list();
  ...
  public void testQueryByDeploymentIdIn() {
    ...
    List<ProcessInstance> instances =
        runtimeService.createProcessInstanceQuery().deploymentIdIn(deploymentIds).list();
    assertThat(instances).hasSize(PROCESS_DEPLOY_COUNT);
  ...
  public void testQueryByInvalidDeploymentId() {
    assertThat(runtimeService.createProcessInstanceQuery().deploymentId("invalid").singleResult())
        .isNull();
    assertThat(runtimeService.createProcessInstanceQuery().deploymentId("invalid").count())
        .isEqualTo(0);
  }
  ...
  public void testQueryByInvalidProcessInstanceId() {
    assertThat(
            runtimeService
                .createProcessInstanceQuery()
                .processInstanceId("I do not exist")
                .singleResult())
        .isNull();
    assertThat(
            runtimeService.createProcessInstanceQuery().processInstanceId("I do not exist").list())
        .hasSize(0);
  }
  ...
  public void testQueryBySuperProcessInstanceId() {
    ProcessInstance superProcessInstance =
        runtimeService.startProcessInstanceByKey("subProcessQueryTest");
  ...
  public void testQueryParentProcessInstanceIdResultMapping() {
    ...
    assertThat(query.list()).hasSize(1);
    assertThat(query.count()).isEqualTo(1);
    assertThat(subProcessInstance.getParentProcessInstanceId())
  ...
  public void testQueryByInvalidSuperProcessInstanceId() {
    assertThat(
            runtimeService
                ...
                .singleResult())
        .isNull();
    assertThat(runtimeService.createProcessInstanceQuery().superProcessInstanceId("invalid").list())
        .hasSize(0);
  }
  ...
  public void testQueryByInvalidSubProcessInstanceId() {
    assertThat(
            runtimeService
                ...
                .singleResult())
        .isNull();
    assertThat(runtimeService.createProcessInstanceQuery().subProcessInstanceId("invalid").list())
        .hasSize(0);
  }
  ...
  public void testQueryBySuperProcessInstanceIdNested() {
    ...
    ProcessInstance nestedSubProcessInstance =
        runtimeService
            .createProcessInstanceQuery()
  ...
  public void testQueryWithExcludeSubprocesses() {
    ...
    List<ProcessInstance> instanceList =
        runtimeService.createProcessInstanceQuery().excludeSubprocesses(true).list();
  ...
  public void testQuerySorting() {
    ...
    assertThat(
            runtimeService.createProcessInstanceQuery().orderByProcessDefinitionId().asc().list())
        .hasSize(PROCESS_DEPLOY_COUNT);
    assertThat(
            runtimeService.createProcessInstanceQuery().orderByProcessDefinitionKey().asc().list())
        .hasSize(PROCESS_DEPLOY_COUNT);

    assertThat(runtimeService.createProcessInstanceQuery().orderByProcessInstanceId().desc().list())
        .hasSize(PROCESS_DEPLOY_COUNT);
    assertThat(
            runtimeService.createProcessInstanceQuery().orderByProcessDefinitionId().desc().list())
        .hasSize(PROCESS_DEPLOY_COUNT);
    assertThat(
            runtimeService.createProcessInstanceQuery().orderByProcessDefinitionKey().desc().list())
        .hasSize(PROCESS_DEPLOY_COUNT);
  ...
  public void testQueryStringVariable() {
    ...
    ProcessInstanceQuery query =
        runtimeService.createProcessInstanceQuery().variableValueEquals("stringVar", "abcdef");
    ...
    List<String> ids =
        new ArrayList(asList(processInstances.get(0).getId(), processInstances.get(1).getId()));
    ...
    resultInstance =
        runtimeService.createProcessInstanceQuery().variableValueEquals("azerty").singleResult();
    assertThat(resultInstance).isNotNull();
    assertThat(resultInstance.getId()).isEqualTo(processInstance3.getId());

    processInstances =
        runtimeService.createProcessInstanceQuery().variableValueEquals("abcdef").list();
    assertThat(processInstances).hasSize(2);
    expecedIds = asList(processInstance1.getId(), processInstance2.getId());
    ids = new ArrayList(asList(processInstances.get(0).getId(), processInstances.get(1).getId()));
    ids.removeAll(expecedIds);
  ...
  public void testQueryLongVariable() {
    ...
    ProcessInstanceQuery query =
        runtimeService.createProcessInstanceQuery().variableValueEquals("longVar", 12345L);
    List<ProcessInstance> processInstances = query.list();
    assertThat(processInstances).isNotNull();
    assertThat(processInstances).hasSize(2);
    ...
    // Test LESS_THAN
    processInstances =
        runtimeService.createProcessInstanceQuery().variableValueLessThan("longVar", 55555L).list();
    assertThat(processInstances).hasSize(2);
    ...
    // Test value-only matching
    resultInstance =
        runtimeService.createProcessInstanceQuery().variableValueEquals(55555L).singleResult();
    assertThat(resultInstance).isNotNull();
    assertThat(resultInstance.getId()).isEqualTo(processInstance3.getId());

    processInstances =
        runtimeService.createProcessInstanceQuery().variableValueEquals(12345L).list();
    assertThat(processInstances).hasSize(2);
    ...
    resultInstance =
        runtimeService.createProcessInstanceQuery().variableValueEquals(999L).singleResult();
    assertThat(resultInstance).isNull();
  ...
  public void testQueryDoubleVariable() {
    ...
    ProcessInstanceQuery query =
        runtimeService.createProcessInstanceQuery().variableValueEquals("doubleVar", 12345.6789);
    List<ProcessInstance> processInstances = query.list();
    assertThat(processInstances).isNotNull();
    assertThat(processInstances).hasSize(2);
    ...
    // Test value-only matching
    resultInstance =
        runtimeService.createProcessInstanceQuery().variableValueEquals(55555.5555).singleResult();
    assertThat(resultInstance).isNotNull();
    assertThat(resultInstance.getId()).isEqualTo(processInstance3.getId());

    processInstances =
        runtimeService.createProcessInstanceQuery().variableValueEquals(12345.6789).list();
    assertThat(processInstances).hasSize(2);
    expectedIds = asList(processInstance1.getId(), processInstance2.getId());
    ids = new ArrayList(asList(processInstances.get(0).getId(), processInstances.get(1).getId()));
    ids.removeAll(expectedIds);
    ...
    resultInstance =
        runtimeService.createProcessInstanceQuery().variableValueEquals(999.999).singleResult();
    assertThat(resultInstance).isNull();
  ...
  public void testQueryIntegerVariable() {
    ...
    ProcessInstanceQuery query =
        runtimeService.createProcessInstanceQuery().variableValueEquals("integerVar", 12345);
    List<ProcessInstance> processInstances = query.list();
    assertThat(processInstances).isNotNull();
    assertThat(processInstances).hasSize(2);
    ...
    // Test value-only matching
    resultInstance =
        runtimeService.createProcessInstanceQuery().variableValueEquals(55555).singleResult();
    assertThat(resultInstance).isNotNull();
    assertThat(resultInstance.getId()).isEqualTo(processInstance3.getId());

    processInstances =
        runtimeService.createProcessInstanceQuery().variableValueEquals(12345).list();
    assertThat(processInstances).hasSize(2);
    expectedIds = asList(processInstance1.getId(), processInstance2.getId());
    ids =
    ...
    resultInstance =
        runtimeService.createProcessInstanceQuery().variableValueEquals(9999).singleResult();
    assertThat(resultInstance).isNull();
  ...
  public void testQueryShortVariable() {
    ...
    ProcessInstanceQuery query =
        runtimeService.createProcessInstanceQuery().variableValueEquals("shortVar", shortVar);
    List<ProcessInstance> processInstances = query.list();
    assertThat(processInstances).isNotNull();
    assertThat(processInstances).hasSize(2);
    ...
    processInstances =
        runtimeService.createProcessInstanceQuery().variableValueEquals((short) 1234).list();
    assertThat(processInstances).hasSize(2);
    expectedIds = asList(processInstance1.getId(), processInstance2.getId());
    ids =
        new ArrayList<String>(
    ...
    resultInstance =
        runtimeService.createProcessInstanceQuery().variableValueEquals((short) 999).singleResult();
    assertThat(resultInstance).isNull();
  ...
  public void testQueryDateVariable() throws Exception {
    ...
    // Query on single short variable, should result in 2 matches
    ProcessInstanceQuery query =
        runtimeService.createProcessInstanceQuery().variableValueEquals("dateVar", date1);
    List<ProcessInstance> processInstances = query.list();
    assertThat(processInstances).isNotNull();
    assertThat(processInstances).hasSize(2);
    ...
    assertThat(
            runtimeService
                .createProcessInstanceQuery()
                .variableValueGreaterThan("dateVar", nextYear.getTime())
                .count())
        .isEqualTo(0);
    assertThat(
            runtimeService
    ...
    processInstances =
        runtimeService.createProcessInstanceQuery().variableValueEquals(date1).list();
    assertThat(processInstances).hasSize(2);
    expectedIds = asList(processInstance1.getId(), processInstance2.getId());
    ids =
        new ArrayList<String>(
  ...
  public void testBooleanVariable() throws Exception {
    ...
    List<ProcessInstance> instances =
        runtimeService.createProcessInstanceQuery().variableValueEquals("booleanVar", true).list();
    ...
    instances =
        runtimeService.createProcessInstanceQuery().variableValueEquals("booleanVar", false).list();
  ...
  public void testQueryNullVariable() throws Exception {
    ...
    ProcessInstance processInstance4 =
        runtimeService.startProcessInstanceByKey("oneTaskProcess", vars);

    vars = new HashMap<String, Object>();
    vars.put("nullVarByte", "testbytes".getBytes());
    ProcessInstance processInstance5 =
        runtimeService.startProcessInstanceByKey("oneTaskProcess", vars);

    // Query on null value, should return one value
    ProcessInstanceQuery query =
        runtimeService.createProcessInstanceQuery().variableValueEquals("nullVar", null);
    List<ProcessInstance> processInstances = query.list();
    assertThat(processInstances).isNotNull();
    ...
    // Test value-only
    assertThat(runtimeService.createProcessInstanceQuery().variableValueEquals(null).count())
        .isEqualTo(1);
    ...
    assertThatExceptionOfType(ActivitiIllegalArgumentException.class)
        .isThrownBy(
            () ->
                runtimeService
                    .createProcessInstanceQuery()
                    .variableValueEqualsIgnoreCase("upper", null)
                    .singleResult())
  ...
  public void testClashingValues() throws Exception {
    ...
    ProcessInstance processInstance2 =
        runtimeService.startProcessInstanceByKey("oneTaskProcess", vars2);

    List<ProcessInstance> foundInstances =
        runtimeService
            .createProcessInstanceQuery()
            .processDefinitionKey("oneTaskProcess")
  ...
  public void testNativeQuery() {
    ...
    assertThat(
            runtimeService
                .createNativeProcessInstanceQuery()
                .sql(
                    "SELECT count(*) FROM " + managementService.getTableName(ProcessInstance.class))
                .count())
        .isEqualTo(piCount * 2);
  }
  ...
  public void testLocalizeProcess() throws Exception {
    ...
    dynamicBpmnService.changeLocalizationName(
        "en-GB", "oneTaskProcess", "The One Task Process 'en-GB' localized name", infoNode);
    dynamicBpmnService.changeLocalizationDescription(
        "en-GB", "oneTaskProcess", "The One Task Process 'en-GB' localized description", infoNode);
    dynamicBpmnService.saveProcessDefinitionInfo(
        processInstance.getProcessDefinitionId(), infoNode);

    dynamicBpmnService.changeLocalizationName(
        "en", "oneTaskProcess", "The One Task Process 'en' localized name", infoNode);
    dynamicBpmnService.changeLocalizationDescription(
        "en", "oneTaskProcess", "The One Task Process 'en' localized description", infoNode);
    dynamicBpmnService.saveProcessDefinitionInfo(
        processInstance.getProcessDefinitionId(), infoNode);
    ...
    assertThat(processes.get(0).getDescription())
        .isEqualTo("The One Task Process 'en-GB' localized description");
    ...
    assertThat(processInstance.getDescription())
        .isEqualTo("The One Task Process 'en-GB' localized description");
    ...
    assertThat(processInstance.getDescription())
        .isEqualTo("The One Task Process 'en' localized description");
  ...
  public void testQueryStartedBefore() throws Exception {
    ...
    List<ProcessInstance> processInstances =
        runtimeService.createProcessInstanceQuery().startedBefore(hourLater).list();
  ...
  public void testQueryStartedAfter() throws Exception {
    ...
    List<ProcessInstance> processInstances =
        runtimeService.createProcessInstanceQuery().startedAfter(hourEarlier).list();
  ...
  public void testQueryStartedBy() throws Exception {
    ...
    List<ProcessInstance> processInstances =
        runtimeService.createProcessInstanceQuery().startedBy(authenticatedUser).list();
