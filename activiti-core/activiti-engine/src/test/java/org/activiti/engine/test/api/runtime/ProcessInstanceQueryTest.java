...
public class ProcessInstanceQueryTest extends PluggableActivitiTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        for (int i = 0; i < PROCESS_DEFINITION_KEY_DEPLOY_COUNT; i++) {
            processInstanceIds.add(
                    runtimeService
                            .startProcessInstanceByKey(PROCESS_DEFINITION_KEY, i + "")
                            .getId());
        }
        processInstanceIds.add(
    ...
    public void testQueryWithExcludeSubprocesses() {
        ...
        instanceList =
                runtimeService.createProcessInstanceQuery().excludeSubprocesses(false).list();
    ...
    public void testNativeQuery() {
        ...
        // TaskQueryTest
        assertThat(managementService.getTableName(ProcessInstance.class))
                .isEqualTo("ACT_RU_EXECUTION");
    ...
    public void testLocalizeProcess() throws Exception {
        ...
        assertThat(processes.get(0).getName())
                .isEqualTo("The One Task Process 'en-GB' localized name");
