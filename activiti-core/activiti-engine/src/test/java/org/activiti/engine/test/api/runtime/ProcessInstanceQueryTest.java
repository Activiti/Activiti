...
public class ProcessInstanceQueryTest extends PluggableActivitiTestCase {
    ...
    private static final String PROCESS_DEFINITION_NAME_2 =
        "oneTaskProcess2Name";
    ...
    protected void setUp() throws Exception {
        ...
        processInstanceIds.add(
            runtimeService
                .startProcessInstanceByKey(PROCESS_DEFINITION_KEY_2, "1")
                .getId()
        );
    }
    ...
    public void testQueryByProcessDefinitionId() {
        ...
        assertThat(query2.count())
            .isEqualTo(PROCESS_DEFINITION_KEY_2_DEPLOY_COUNT);
        assertThat(query2.list())
            .hasSize(PROCESS_DEFINITION_KEY_2_DEPLOY_COUNT);
    ...
    public void testQueryByDeploymentId() {
        ...
        assertThat(processInstance.getProcessDefinitionVersion())
    ...
    public void testQueryWithExcludeSubprocesses() {
        ...
        for (ProcessInstance processInstance : instanceList) {
            if (processInstance.getId().equals(superProcessInstance.getId())) {
                ...
                processInstance.getId().equals(subProcessInstance.getId())
            ) {
                subProcessFound = true;
            } else if (
                processInstance.getId().equals(nestedSubProcessInstance.getId())
            ) {
    ...
    public void testQueryLongVariable() {
        ...
        List<String> expectedIds = asList(
            processInstance1.getId(),
            processInstance2.getId()
        );
        List<String> ids = new ArrayList(
    ...
    public void testQueryDoubleVariable() {
        ...
        processInstances =
            runtimeService
                .createProcessInstanceQuery()
                .variableValueEquals(12345.6789)
                .list();
        assertThat(processInstances).hasSize(2);
        expectedIds =
            asList(processInstance1.getId(), processInstance2.getId());
    ...
    public void testQueryDateVariable() throws Exception {
        ...
        // Query with unexisting variable value
        Date unexistingDate = new SimpleDateFormat("dd/MM/yyyy hh:mm:ss")
            .parse("01/01/1989 12:00:00");
        resultInstance =
            runtimeService
                .createProcessInstanceQuery()
    ...
    public void testBooleanVariable() throws Exception {
        ...
        assertThat(instances.get(0).getId())
    ...
    public void testQueryNullVariable() throws Exception {
        ...
        assertThat(processInstances.get(0).getId())
            .isEqualTo(processInstance1.getId());
    ...
    public void testClashingValues() throws Exception {
        ...
        assertThat(foundInstances.get(0).getId())
            .isEqualTo(processInstance.getId());
    ...
    public void testIncludeBinaryVariables() throws Exception {
        ...
        byte[] bytes = (byte[]) processInstance
            .getProcessVariables()
            .get("binaryVariable");
    ...
    public void testLocalizeProcess() throws Exception {
        ...
        assertThat(processes.get(0).getDescription())
            .isEqualTo("Descripción del proceso");
        ...
        processInstance =
            runtimeService
                ...
                .singleResult();
        assertThat(processInstance.getName())
            .isEqualTo("The One Task Process 'en' localized name");
        assertThat(processInstance.getDescription())
