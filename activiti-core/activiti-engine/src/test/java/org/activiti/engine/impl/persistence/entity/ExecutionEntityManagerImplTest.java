...
public class ExecutionEntityManagerImplTest {
    ...
    @InjectMocks private ExecutionEntityManagerImpl executionEntityManager;
    ...
    @Mock private ActivitiEventDispatcher eventDispatcher;
    ...
    public void should_createProcessInstanceExecution_when_initialVariableNameIsNull() {
        ...
        ExecutionEntity processInstanceResult =
    ...
    public void should_createSubProcess() {
        ...
        ExecutionEntity subProcessResult =
                executionEntityManager.createSubprocessInstance(
    ...
    public void should_updateStartDateOfProcessInstance() {
        ...
        ExecutionEntity processInstanceUpdated =
                executionEntityManager.updateProcessInstanceStartDate(processInstanceResult);
