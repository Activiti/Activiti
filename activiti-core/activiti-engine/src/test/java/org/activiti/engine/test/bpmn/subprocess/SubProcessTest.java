...
public class SubProcessTest extends PluggableActivitiTestCase {
    ...
    public void testSimpleSubProcessWithTimer() {
        ...
        Task escalationTask = taskService.createTaskQuery().processInstanceId(pi.getId())
            .singleResult();
        ...
        if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.ACTIVITY)) {
            HistoricTaskInstance historicTaskInstance = historyService.createHistoricTaskInstanceQuery()
                .taskName("Task in subprocess").singleResult();
            assertThat(historicTaskInstance.getEndTime()).isNotNull();

            HistoricActivityInstance historicActivityInstance = historyService.createHistoricActivityInstanceQuery()
                .activityId("subProcessTask").singleResult();
    ...
    public void testNestedSimpleSubProcess() {
        ...
        taskService.complete(subProcessTask.getId());
        Task taskAfterSubProcesses = taskService.createTaskQuery().processInstanceId(pi.getId())
            .singleResult();
    ...
    public void testNestedSimpleSubprocessWithTimerOnInnerSubProcess() {
        ...
        Task taskAfterSubProcess = taskService.createTaskQuery().processInstanceId(pi.getId())
            .singleResult();
    ...
    public void testSimpleParallelSubProcess() {
        ...
        List<Task> subProcessTasks = taskService.createTaskQuery().processInstanceId(pi.getId())
    ...
    public void testSimpleParallelSubProcessWithTimer() {
        ...
        List<Task> subProcessTasks = taskService.createTaskQuery()
        ...
        Task taskAfterTimer = taskService.createTaskQuery()
    ...
    public void testDataObjectScope() {
        ...
        Task currentTask = taskService.createTaskQuery().processInstanceId(pi.getId())
            .singleResult();
