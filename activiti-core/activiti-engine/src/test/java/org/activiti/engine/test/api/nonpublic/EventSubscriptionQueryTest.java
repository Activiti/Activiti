...
public class EventSubscriptionQueryTest extends PluggableActivitiTestCase {
  ...
  public void testQueryByEventName() {
        ...
        .execute(
            new Command<Void>() {
              public Void execute(CommandContext commandContext) {
                ...
                MessageEventSubscriptionEntity messageEventSubscriptionEntity2 =
                    commandContext
                        .getEventSubscriptionEntityManager()
                        .createMessageEventSubscription();
                ...
                MessageEventSubscriptionEntity messageEventSubscriptionEntity3 =
                    commandContext
                        .getEventSubscriptionEntityManager()
                        .createMessageEventSubscription();
    ...
    List<EventSubscriptionEntity> list =
        newEventSubscriptionQuery().eventName("messageName").list();
        ...
        .execute(
            new Command<Void>() {
              public Void execute(CommandContext commandContext) {
                ...
                SignalEventSubscriptionEntity signalEventSubscriptionEntity3 =
                    commandContext
                        .getEventSubscriptionEntityManager()
  ...
  public void testQueryByActivityId() {
    ...
    List<EventSubscriptionEntity> list =
        newEventSubscriptionQuery().activityId("someOtherActivity").list();
    assertThat(list).hasSize(1);
  ...
  public void testQueryByExecutionId() {
    ...
    EventSubscriptionEntity subscription =
        newEventSubscriptionQuery().processInstanceId(processInstance.getId()).singleResult();
    assertThat(subscription).isNotNull();

    Execution executionWaitingForSignal =
        runtimeService
    ...
    EventSubscriptionEntity signalSubscription =
        newEventSubscriptionQuery().executionId(executionWaitingForSignal.getId()).singleResult();
  ...
  protected void cleanDb() {
    processEngineConfiguration
        ...
        .execute(
            new Command<Void>() {
              public Void execute(CommandContext commandContext) {
                final List<EventSubscriptionEntity> subscriptions =
                    new EventSubscriptionQueryImpl(commandContext).list();
