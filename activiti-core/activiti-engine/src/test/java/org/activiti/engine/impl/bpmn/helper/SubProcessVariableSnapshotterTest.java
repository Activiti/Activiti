...
public class SubProcessVariableSnapshotterTest {
  ...
  @Test
  public void
      setVariablesSnapshots_should_set_parent_variables_in_the_snapshot_holder_when_parent_is_multi_instance()
          throws Exception {
    // given
  ...
  private ExecutionEntity buildExecutionEntity(
      ExecutionEntity parentExecution, Map<String, Object> localVariables) {
  ...
  @Test
  public void
      setVariablesSnapshots_should_not_set_parent_variables_in_the_snapshot_holder_when_parent_is_not_multi_instance()
          throws Exception {
    // given
    Map<String, Object> parentVariables = singletonMap("parentCount", 1L);
    ExecutionEntity parentExecution = buildExecutionEntity(parentVariables);
