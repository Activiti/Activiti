...
public class TenancyTest extends PluggableActivitiTestCase {
    ...
    public void testDeploymentTenancy() {
        ...
        assertThat(
                        repositoryService
                                .createDeploymentQuery()
                                .deploymentTenantIdLike("%TenantId")
                                .list())
                .hasSize(1);
        assertThat(
                        repositoryService
                                .createDeploymentQuery()
                                .deploymentTenantIdLike("m%Ten%")
                                .list())
                .hasSize(1);
        assertThat(
                        repositoryService
                                .createDeploymentQuery()
                                .deploymentTenantIdLike("noexisting%")
                                .list())
                .hasSize(0);
    ...
    public void testExecutionTenancy() {
        ...
        assertThat(
                        runtimeService
                                .createExecutionQuery()
                                .executionTenantId(TEST_TENANT_ID)
                                .list()
                                .size())
    ...
    public void testTaskTenancy() {
        ...
        assertThat(taskService.createTaskQuery().taskTenantId(TEST_TENANT_ID).list().size())
                .isEqualTo(10);
        assertThat(taskService.createTaskQuery().taskTenantId("Another").list().size())
                .isEqualTo(0);
        assertThat(taskService.createTaskQuery().taskTenantIdLike("my%").list().size())
                .isEqualTo(10);
    ...
    public void testModelTenancy() {
        ...
        assertThat(repositoryService.createModelQuery().modelTenantIdLike("my%").list().size())
                .isEqualTo(nrOfModelsWithTenant);
        assertThat(repositoryService.createModelQuery().modelTenantId("a%").list().size())
                .isEqualTo(0);
    ...
    public void testChangeDeploymentTenantId() {
        ...
        assertThat(
                        runtimeService
                                .createProcessInstanceQuery()
                                .processInstanceTenantId(newTenantId)
                                .list())
    ...
    public void testChangeDeploymentIdWithClash() {
        ...
        assertThatExceptionOfType(Exception.class)
                .isThrownBy(
                        () ->
                                repositoryService.changeDeploymentTenantId(
    ...
    public void testSignalFromProcessTenancy() {
        ...
        // Now, start 1 process instance that fires a signal event (not in tenant context), it
        // should
    ...
    public void testStartProcessInstanceBySignalTenancy() {
        ...
        runtimeService.startProcessInstanceByKeyAndTenantId(
                "processWithSignalCatch", TEST_TENANT_ID);
