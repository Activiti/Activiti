...
public class RuntimeVariablesTest extends PluggableActivitiTestCase {
  ...
  public void testGetSerializableTypeVariable() {
    ...
    Map<String, VariableInstance> variableInstances =
        taskService.getVariableInstances(task1.getId());
    ...
    variableInstance =
        runtimeService.getVariableInstance(processInstance1.getId(), "executionVar1");
    assertThat(variableInstance.getValue()).isEqualTo(serializableTypeVar);
  ...
  private void checkVariable(
      String executionId, String name, String value, List<VariableInstance> variables) {
  ...
  public void testGetVariablesByExecutionIdsForScope() {
    ...
    List<VariableInstance> executionVariableInstances =
        runtimeService.getVariableInstancesByExecutionIds(executionIds);
