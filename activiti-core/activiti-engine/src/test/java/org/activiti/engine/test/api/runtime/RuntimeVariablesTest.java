...
public class RuntimeVariablesTest extends PluggableActivitiTestCase {
    ...
    public void testGetVariablesByExecutionIds() {
        ...
        ProcessInstance processInstance2 = runtimeService.startProcessInstanceByKey(
            "oneTaskProcess");
        Task task1 = taskService.createTaskQuery().processInstanceId(processInstance1.getId())
            .singleResult();
        Task task2 = taskService.createTaskQuery().processInstanceId(processInstance2.getId())
            .singleResult();
    ...
    public void testGetSerializableTypeVariable() {
        ...
        VariableInstance variableInstance = taskService.getVariableInstance(task1.getId(),
            "taskVar1");
        ...
        variableInstance = runtimeService.getVariableInstance(processInstance1.getId(),
            "executionVar1");
        assertThat(variableInstance.getValue()).isEqualTo(serializableTypeVar);

        variableInstances = runtimeService.getVariableInstances(processInstance1.getId());
        assertThat(variableInstances.get("executionVar1").getValue()).isEqualTo(
            serializableTypeVar);
    }

    private void checkVariable(String executionId, String name, String value,
    ...
    public void testGetVariablesByExecutionIdsForScope() {
        ...
        List<VariableInstance> executionVariableInstances = runtimeService.getVariableInstancesByExecutionIds(
            executionIds);
        ...
        executionVariableInstances = runtimeService.getVariableInstancesByExecutionIds(
            executionIds);
