...
public class HistoricVariableInstanceTest extends PluggableActivitiTestCase {
    ...
    public void testOrderProcessWithCallActivity() {
        if (
            ...
            assertThat(prepareAndShipTask.getName())
                .isEqualTo("Prepare and Ship");
        }
    }
    ...
    public void testSimple() {
        if (
            ...
            assertThat(
                historyService.createHistoricActivityInstanceQuery().count()
            )
                .isEqualTo(5);
            assertThat(historyService.createHistoricDetailQuery().count())
                .isEqualTo(3);
        }
    }
    ...
    public void testHistoricVariableQuery2() {
        ...
        String processInstanceId = runtimeService
            .startProcessInstanceByKey("twoTasksProcess", startVars)
            .getId();
    ...
    public void testHistoricVariableQueryByExecutionIdsForScope() {
        ...
        assertThat("processVar")
            .isEqualTo(historicVariableInstances.get(0).getVariableName());
        assertThat("processVar")
            .isEqualTo(historicVariableInstances.get(0).getValue());
        ...
        assertThat("executionVar")
            .isEqualTo(historicVariableInstances.get(0).getValue());
        assertThat("executionVar")
            .isEqualTo(historicVariableInstances.get(1).getVariableName());
        assertThat("executionVar")
            .isEqualTo(historicVariableInstances.get(1).getValue());
    }
    ...
    public void testHistoricVariableQueryByTaskIds() {
        ...
        // Generate data
        String processInstanceId = runtimeService
            .startProcessInstanceByKey("twoTasksProcess")
            .getId();
        List<Task> tasks = taskService
            .createTaskQuery()
            .processInstanceId(processInstanceId)
        ...
        assertThat(historicVariableInstances.get(0).getVariableName())
            .isEqualTo("taskVar1");
        assertThat(historicVariableInstances.get(0).getValue())
            .isEqualTo("hello1");
        assertThat(historicVariableInstances.get(1).getVariableName())
            .isEqualTo("taskVar2");
        assertThat(historicVariableInstances.get(1).getValue())
            .isEqualTo("hello2");
    ...
    public void testVariableUpdatesLinkedToActivity() throws Exception {
        if (
            ...
            HistoricVariableUpdate update = (HistoricVariableUpdate) updates.get(
                0
            );
    ...
    @Deployment(
        resources = "org/activiti/engine/test/history/HistoricVariableInstanceTest.testSimple.bpmn20.xml"
    )
    ...
    public void testNativeHistoricDetailQuery() {
        if (
            ...
            assertThat(managementService.getTableName(HistoricDetail.class))
                .isEqualTo("ACT_HI_DETAIL");
            assertThat(
                managementService.getTableName(HistoricVariableUpdate.class)
            )
                .isEqualTo("ACT_HI_DETAIL");

            String tableName = managementService.getTableName(
                HistoricDetail.class
            );
            String baseQuerySql = "SELECT * FROM " + tableName;
            ...
            String sqlWithConditions =
                baseQuerySql + " where NAME_ = #{name} and TYPE_ = #{type}";
            assertThat(
                historyService
                    .createNativeHistoricDetailQuery()
                    .sql(sqlWithConditions)
    ...
    public void testChangeType() {
        if (
            ...
            assertThat(getHistoricVariable("firstVar").getValue())
                .isEqualTo("123");
            runtimeService.setVariable(
                processInstance.getId(),
                "firstVar",
            ...
            assertThat(getHistoricVariable("secondVar").getValue())
                .isEqualTo("123");
            runtimeService.setVariable(
                processInstance.getId(),
                "secondVar",
