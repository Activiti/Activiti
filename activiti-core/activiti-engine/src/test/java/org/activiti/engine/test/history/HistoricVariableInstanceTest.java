...
public class HistoricVariableInstanceTest extends PluggableActivitiTestCase {
    ...
    public void testSimple() {
        if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.FULL)) {
            ...
            HistoricVariableInstanceEntity historicVariable = (HistoricVariableInstanceEntity) variables.get(
                0);
    ...
    public void testParallel() {
        if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.FULL)) {
            ...
            HistoricVariableInstanceEntity historicVariable1 = (HistoricVariableInstanceEntity) variables.get(
                1);
    ...
    public void testHistoricVariableInstanceQuery() {
        if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.FULL)) {
            ...
            assertThat(
                historyService.createHistoricVariableInstanceQuery().orderByProcessInstanceId()
                    .asc().count()).isEqualTo(4);
            assertThat(
                historyService.createHistoricVariableInstanceQuery().orderByProcessInstanceId()
                    .asc().list()).hasSize(4);
            assertThat(
            ...
            assertThat(historyService.createHistoricVariableInstanceQuery()
                .processInstanceId(processInstance.getId()).list()).hasSize(2);
            assertThat(historyService.createHistoricVariableInstanceQuery().variableName("myVar")
                .count()).isEqualTo(2);
            assertThat(historyService.createHistoricVariableInstanceQuery().variableName("myVar")
                .list()).hasSize(2);
            assertThat(
                historyService.createHistoricVariableInstanceQuery().variableNameLike("myVar1")
                    .count()).isEqualTo(2);
            assertThat(
                historyService.createHistoricVariableInstanceQuery().variableNameLike("myVar1")
                    .list()).hasSize(2);
            ...
            assertThat(historyService.createHistoricVariableInstanceQuery()
                .variableValueEquals("myVar", "test123").count()).isEqualTo(1);
            assertThat(historyService.createHistoricVariableInstanceQuery()
                .variableValueEquals("myVar", "test123").list()).hasSize(1);
            assertThat(historyService.createHistoricVariableInstanceQuery()
                .variableValueEquals("myVar1", "test456").count()).isEqualTo(1);
            assertThat(historyService.createHistoricVariableInstanceQuery()
                .variableValueEquals("myVar1", "test456").list()).hasSize(1);
            assertThat(historyService.createHistoricVariableInstanceQuery()
                .variableValueEquals("myVar", "test666").count()).isEqualTo(1);
            assertThat(historyService.createHistoricVariableInstanceQuery()
                .variableValueEquals("myVar", "test666").list()).hasSize(1);
            assertThat(historyService.createHistoricVariableInstanceQuery()
                .variableValueEquals("myVar1", "test666").count()).isEqualTo(1);
            assertThat(historyService.createHistoricVariableInstanceQuery()
                .variableValueEquals("myVar1", "test666").list()).hasSize(1);
    ...
    public void testHistoricVariableQuery2() {
        ...
        String processInstanceId = runtimeService.startProcessInstanceByKey("twoTasksProcess",
            startVars).getId();
        ...
        List<String> expectedVariableNames = asList("executionVar0", "executionVar1", "startVar",
            "taskVar0", "taskVar1");
        for (int i = 0; i < expectedVariableNames.size(); i++) {
            assertThat(historicVariableInstances.get(i).getVariableName()).isEqualTo(
                expectedVariableNames.get(i));
        }
        ...
        historicVariableInstances = historyService.createHistoricVariableInstanceQuery()
            .processInstanceId(processInstanceId).executionId(tasks.get(0).getExecutionId())
            .orderByVariableName().asc().list();
        assertThat(historicVariableInstances).hasSize(2);
        assertThat(historicVariableInstances.get(0).getVariableName()).isEqualTo("executionVar0");
        assertThat(historicVariableInstances.get(1).getVariableName()).isEqualTo("taskVar0");
        historicVariableInstances = historyService.createHistoricVariableInstanceQuery()
            .processInstanceId(processInstanceId).executionId(tasks.get(1).getExecutionId())
            .orderByVariableName().asc().list();
        assertThat(historicVariableInstances).hasSize(2);
        assertThat(historicVariableInstances.get(0).getVariableName()).isEqualTo("executionVar1");
        assertThat(historicVariableInstances.get(1).getVariableName()).isEqualTo("taskVar1");
    ...
    public void testHistoricVariableQueryByExecutionIds() {
        ...
        assertThat(historyService.createHistoricVariableInstanceQuery()
            .executionIds(testProcessInstanceIds).list().size())
            .isEqualTo((int) historyService.createHistoricVariableInstanceQuery()
                .executionIds(testProcessInstanceIds).count())
            .isEqualTo(2);

        List<HistoricVariableInstance> historicVariableInstances = historyService.createHistoricVariableInstanceQuery()
            .executionIds(testProcessInstanceIds).list();
        assertThat(historicVariableInstances).hasSize(2)
        ...
        historicVariableInstances = historyService.createHistoricVariableInstanceQuery()
            .executionIds(processInstanceIds).list();
    ...
    public void testHistoricVariableQueryByExecutionIdsForScope() {
        ...
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey(
            "variableScopeProcess", processVars);
        ...
        historicVariableInstances = historyService.createHistoricVariableInstanceQuery()
            .executionIds(executionIds).excludeTaskVariables().list();
    ...
    public void testHistoricVariableQueryByTaskIds() {
        ...
        assertThat(historyService.createHistoricVariableInstanceQuery().taskIds(taskIds)
            .count()).isEqualTo(2);
        assertThat(historicVariableInstances).hasSize(2);
        assertThat(historicVariableInstances.get(0).getVariableName()).isEqualTo("taskVar1");
    ...
    public void testHistoricProcessVariableOnDeletion() {
        if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.FULL)) {
            ...
            assertThat(historyService.createHistoricVariableInstanceQuery()
                ...
                .variableValueEquals("testVar", "Hallo Christian").count()).isEqualTo(1);
        }
    }
    ...
    public void testVariableUpdatesLinkedToActivity() throws Exception {
        if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.FULL)) {
             ...
             */
            assertThat(historicActivityInstance2.getExecutionId()
                .equals(update2.getExecutionId())).isFalse();
        }
    }
    ...
    public void testHistoricProcessInstanceDeleteCascadesCorrectly() {
        ...
        if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.FULL)) {
            ...
            ProcessInstance processInstance2 = runtimeService.startProcessInstanceByKey("myProcess",
                variables);
    ...
    public void testNativeHistoricVariableInstanceQuery() {
        ...
        if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.FULL)) {
            ...
            assertThat(managementService.getTableName(HistoricVariableInstance.class)).isEqualTo(
                "ACT_HI_VARINST");
            assertThat(
                managementService.getTableName(HistoricVariableInstanceEntity.class)).isEqualTo(
                "ACT_HI_VARINST");
            ...
            assertThat(historyService.createNativeHistoricVariableInstanceQuery().sql(baseQuerySql)
                .list()).hasSize(3);

            String sqlWithConditions = baseQuerySql + " where NAME_ = #{name}";
            assertThat(
                historyService.createNativeHistoricVariableInstanceQuery().sql(sqlWithConditions)
                    .parameter("name", "myVar").singleResult().getValue()).isEqualTo("test123");

            sqlWithConditions = baseQuerySql + " where NAME_ like #{name}";
            assertThat(
                historyService.createNativeHistoricVariableInstanceQuery().sql(sqlWithConditions)
                    .parameter("name", "var%").list()).hasSize(2);

            // paging
            assertThat(historyService.createNativeHistoricVariableInstanceQuery().sql(baseQuerySql)
                .listPage(0, 3)).hasSize(3);
            assertThat(historyService.createNativeHistoricVariableInstanceQuery().sql(baseQuerySql)
                .listPage(1, 3)).hasSize(2);
            assertThat(
                historyService.createNativeHistoricVariableInstanceQuery().sql(sqlWithConditions)
                    .parameter("name", "var%").listPage(0, 2)).hasSize(2);
        }
    ...
    public void testNativeHistoricDetailQuery() {
        if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.FULL)) {
            assertThat(managementService.getTableName(HistoricDetail.class)).isEqualTo(
                "ACT_HI_DETAIL");
            assertThat(managementService.getTableName(HistoricVariableUpdate.class)).isEqualTo(
                "ACT_HI_DETAIL");
            ...
            assertThat(
                historyService.createNativeHistoricDetailQuery().sql(baseQuerySql).list()).hasSize(
                3);

            String sqlWithConditions = baseQuerySql + " where NAME_ = #{name} and TYPE_ = #{type}";
            assertThat(historyService.createNativeHistoricDetailQuery().sql(sqlWithConditions)
                .parameter("name", "myVar").parameter("type", "VariableUpdate")
            ...
            // paging
            assertThat(historyService.createNativeHistoricDetailQuery().sql(baseQuerySql)
                .listPage(0, 3)).hasSize(3);
            assertThat(historyService.createNativeHistoricDetailQuery().sql(baseQuerySql)
                .listPage(1, 3)).hasSize(2);
        }
    ...
    private HistoricVariableInstance getHistoricVariable(String variableName) {
        return historyService.createHistoricVariableInstanceQuery().variableName(variableName)
            .singleResult();
    }
    ...
    public void testRestrictByExecutionId() {
        if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.FULL)) {
            ...
            List<HistoricVariableInstance> variables = historyService.createHistoricVariableInstanceQuery()
                .executionId(processInstance.getId()).list();
            assertThat(variables).hasSize(1);
