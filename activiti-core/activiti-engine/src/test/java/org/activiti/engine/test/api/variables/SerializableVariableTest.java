...
public class SerializableVariableTest extends PluggableActivitiTestCase {
    ...
    public void testUpdateSerializableInServiceTask() {
        ...
        ProcessInstance processInstance =
                runtimeService.startProcessInstanceByKey(
                        "testUpdateSerializableInServiceTask", vars);
        ...
        TestSerializableVariable testSerializableVariable =
                (TestSerializableVariable)
                        runtimeService.getVariable(processInstance.getId(), "myVar");
    ...
    public static class TestUpdateSerializableVariableDelegate implements JavaDelegate {
        ...
        public void execute(DelegateExecution execution) {
            TestSerializableVariable var =
                    (TestSerializableVariable) execution.getVariable("myVar");
            var.setNumber(2);
        }
    }
