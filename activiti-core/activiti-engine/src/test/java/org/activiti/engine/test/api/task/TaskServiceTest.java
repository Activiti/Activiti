...
public class TaskServiceTest extends PluggableActivitiTestCase {
    ...
    public void testTaskComments() {
        if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.ACTIVITY)) {
            ...
            taskService.addComment(
                    ...
                    null,
                    "look at this \n"
                        + "       isn't this great? slkdjf sldkfjs ldkfjs ldkfjs ldkfj sldkfj"
                        + " sldkfj sldkjg laksfg sdfgsd;flgkj ksajdhf skjdfh ksjdhf skjdhf kalskjgh"
                        + " lskh dfialurhg kajsh dfuieqpgkja rzvkfnjviuqerhogiuvysbegkjz lkhf ais"
                        + " liasduh flaisduh ajiasudh vaisudhv nsfd");
            ...
            assertThat(((Event) comment).getMessage())
                    .isEqualTo(
                            "look at this isn't this great? slkdjf sldkfjs ldkfjs ldkfjs ldkfj"
                                + " sldkfj sldkfj sldkjg laksfg sdfgsd;flgkj ksajdhf skjdfh ksjdhf"
                                + " skjdhf kalskjgh lskh dfialurhg ...");
            assertThat(comment.getFullMessage())
                    .isEqualTo(
                            "look at this \n"
                                + "       isn't this great? slkdjf sldkfjs ldkfjs ldkfjs ldkfj"
                                + " sldkfj sldkfj sldkjg laksfg sdfgsd;flgkj ksajdhf skjdfh ksjdhf"
                                + " skjdhf kalskjgh lskh dfialurhg kajsh dfuieqpgkja"
                                + " rzvkfnjviuqerhogiuvysbegkjz lkhf ais liasduh flaisduh ajiasudh"
                                + " vaisudhv nsfd");
    ...
    public void testCustomTaskComments() {
        if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.ACTIVITY)) {
            ...
            Comment customComment1 =
                    taskService.addComment(
                            taskId, null, customType1, "This is a custom comment of type Type1");
            Comment customComment2 =
                    taskService.addComment(
                            taskId, null, customType1, "This is another Type1 comment");
            Comment customComment3 =
                    taskService.addComment(
                            taskId,
                            null,
                            customType2,
    ...
    public void testTaskAttachments() {
        if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.ACTIVITY)) {
            ...
            assertThat(historyService.createHistoricTaskInstanceQuery().taskId(taskId).list())
                    .hasSize(1);
    ...
    public void testTaskAttachmentWithProcessInstanceId() {
        if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.ACTIVITY)) {
            ...
            Attachment attachment =
                    taskService.getProcessInstanceAttachments(processInstanceId).get(0);
            assertThat(attachment.getName()).isEqualTo("weatherforcast");
            assertThat(attachment.getDescription()).isEqualTo("temperatures and more");
            assertThat(attachment.getType()).isEqualTo("web page");
    ...
    public void testDeleteTasksTaskIdsUnexistingTaskId() {
        ...
        // The unexisting taskId's should be silently ignored. Existing task should have been
        // deleted.
    ...
    public void testDeleteTaskIdentityLink() {
        ...
        try {
            ...
            assertThat(taskService.createTaskQuery().taskCandidateGroup("sales").singleResult())
                    .isNotNull();
            assertThat(taskService.createTaskQuery().taskCandidateUser("kermit").singleResult())
                    .isNotNull();
    ...
    public void testClaimAlreadyClaimedTaskByOtherUser() {
        ...
        assertThatExceptionOfType(ActivitiTaskAlreadyClaimedException.class)
                ...
                .withMessageContaining(
                        "Task '" + task.getId() + "' is already claimed by someone else.");
    ...
    public void testCompleteTaskWithFormKey() {
        ProcessInstance processInstance =
                runtimeService.startProcessInstanceByKey("oneTaskWithFormProcess");
                ...
                .isThrownBy(
                        () ->
                                taskService.addGroupIdentityLink(
                                        null, "groupId", IdentityLinkType.CANDIDATE))
                .withMessageContaining("taskId is null");
    }
    ...
    public void testAddGroupIdentityLinkNullUserId() {
        assertThatExceptionOfType(ActivitiIllegalArgumentException.class)
                .isThrownBy(
                        () ->
                                taskService.addGroupIdentityLink(
                                        "taskId", null, IdentityLinkType.CANDIDATE))
                .withMessageContaining("identityId is null");
    }
    ...
    public void testAddGroupIdentityLinkUnexistingTask() {
        assertThatExceptionOfType(ActivitiObjectNotFoundException.class)
                .isThrownBy(
                        () ->
                                taskService.addGroupIdentityLink(
                                        "unexistingTaskId", "user", IdentityLinkType.CANDIDATE))
                .withMessageContaining("Cannot find task with id unexistingTaskId")
                .satisfies(ae -> assertThat(ae.getObjectClass()).isEqualTo(Task.class));
    }
                ...
                .isThrownBy(
                        () ->
                                taskService.addUserIdentityLink(
                                        null, "userId", IdentityLinkType.CANDIDATE))
                .withMessageContaining("taskId is null");
    }
    ...
    /**
     * @see <a
     *     href="https://activiti.atlassian.net/browse/ACT-1059">https://activiti.atlassian.net/browse/ACT-1059</a>
     */
    ...
    public void testGetVariableByHistoricActivityInstance() {
        if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.FULL)) {
            ...
            HistoricActivityInstance historicActivitiInstance =
                    historyService
    ...
    public void testRemoveVariableLocal() {
        ...
        assertThat(taskService.getVariable(currentTask.getId(), "variable1")).isEqualTo("value1");
        assertThat(taskService.getVariableLocal(currentTask.getId(), "variable1"))
                .isEqualTo("value1");
    ...
    public void testRemoveVariablesLocal() {
        ...
        assertThat(taskService.getVariableLocal(currentTask.getId(), "variable1"))
                .isEqualTo("value1");
        assertThat(taskService.getVariableLocal(currentTask.getId(), "variable2"))
                .isEqualTo("value2");
        assertThat(taskService.getVariableLocal(currentTask.getId(), "variable3"))
                .isEqualTo("value3");
    ...
    public void testFormKeyExpression() {
        runtimeService.startProcessInstanceByKey("testFormExpression", singletonMap("var", "abc"));
    ...
    public void testGetVariableLocalWithCast() {
        ...
        String variable =
                taskService.getVariableLocal(currentTask.getId(), "variable1", String.class);
                ...
                .isThrownBy(
                        () ->
                                taskService.getVariableLocal(
                                        currentTask.getId(), "variable1", Boolean.class));
    }
