...
public class TaskServiceTest extends PluggableActivitiTestCase {
  ...
  public void testTaskComments() {
    if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.ACTIVITY)) {
      ...
      taskService.addComment(
          ...
          null,
          "look at this \n"
              + "       isn't this great? slkdjf sldkfjs ldkfjs ldkfjs ldkfj sldkfj sldkfj sldkjg"
              + " laksfg sdfgsd;flgkj ksajdhf skjdfh ksjdhf skjdhf kalskjgh lskh dfialurhg kajsh"
              + " dfuieqpgkja rzvkfnjviuqerhogiuvysbegkjz lkhf ais liasduh flaisduh ajiasudh"
              + " vaisudhv nsfd");
      ...
      assertThat(((Event) comment).getMessage())
          .isEqualTo(
              "look at this isn't this great? slkdjf sldkfjs ldkfjs ldkfjs ldkfj sldkfj sldkfj"
                  + " sldkjg laksfg sdfgsd;flgkj ksajdhf skjdfh ksjdhf skjdhf kalskjgh lskh"
                  + " dfialurhg ...");
      assertThat(comment.getFullMessage())
          .isEqualTo(
              "look at this \n"
                  + "       isn't this great? slkdjf sldkfjs ldkfjs ldkfjs ldkfj sldkfj sldkfj"
                  + " sldkjg laksfg sdfgsd;flgkj ksajdhf skjdfh ksjdhf skjdhf kalskjgh lskh"
                  + " dfialurhg kajsh dfuieqpgkja rzvkfnjviuqerhogiuvysbegkjz lkhf ais liasduh"
                  + " flaisduh ajiasudh vaisudhv nsfd");
  ...
  public void testCustomTaskComments() {
    if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.ACTIVITY)) {
      ...
      Comment customComment3 =
          taskService.addComment(
              taskId, null, customType2, "This is another custom comment. Type2 this time!");
  ...
  public void testResolveWithParametersTask() {
    ...
    task =
        taskService.createTaskQuery().taskDelegationState(DelegationState.RESOLVED).singleResult();
    assertThat(task.getName()).isEqualTo("First task");
