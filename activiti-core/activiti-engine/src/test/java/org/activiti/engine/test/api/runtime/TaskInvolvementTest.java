...
public class TaskInvolvementTest extends PluggableActivitiTestCase {
    ...
    public void testQueryByInvolvedGroupOrUser2() {
        try {
            ...
            taskService.addGroupIdentityLink(
                    taskUser1WithGroups.getId(), "group1", IdentityLinkType.PARTICIPANT);
            ...
            taskService.addCandidateUser(
                    taskUser1WithGroupsCandidateUser.getId(), "candidateUser1");
    ...
    public void testQueryMultipleAndAndSingleOr() {
        try {
            ...
            taskService.addGroupIdentityLink(
                    taskUser1Group1.getId(), "group1", IdentityLinkType.PARTICIPANT);
            ...
            taskService.addGroupIdentityLink(
                    taskUser1Group2.getId(), "group2", IdentityLinkType.PARTICIPANT);
            ...
            taskService.addGroupIdentityLink(
                    taskUser1Group2.getId(), "group1", IdentityLinkType.PARTICIPANT);
            taskService.addGroupIdentityLink(
                    taskUser1Group2.getId(), "group2", IdentityLinkType.PARTICIPANT);
            ...
            taskService.addGroupIdentityLink(
                    taskUser1Group1and3.getId(), "group1", IdentityLinkType.PARTICIPANT);
            taskService.addGroupIdentityLink(
                    taskUser1Group1and3.getId(), "group3", IdentityLinkType.PARTICIPANT);
            ...
            taskService.addGroupIdentityLink(
                    taskUser1Group1and4.getId(), "group1", IdentityLinkType.PARTICIPANT);
            taskService.addGroupIdentityLink(
                    taskUser1Group1and4.getId(), "group4", IdentityLinkType.PARTICIPANT);
    ...
    public void testQueryMultipleAndAndMultipleOr() {
        try {
            ...
            taskService.addGroupIdentityLink(
                    taskUser1Group1andUser2.getId(), "group1", IdentityLinkType.PARTICIPANT);
            taskService.addUserIdentityLink(
                    taskUser1Group1andUser2.getId(), "user2", IdentityLinkType.PARTICIPANT);
            ...
            taskService.addGroupIdentityLink(
                    taskUser1Group1andUser2Group4.getId(), "group1", IdentityLinkType.PARTICIPANT);
            taskService.addGroupIdentityLink(
                    taskUser1Group1andUser2Group4.getId(), "group4", IdentityLinkType.PARTICIPANT);
            taskService.addUserIdentityLink(
                    taskUser1Group1andUser2Group4.getId(), "user2", IdentityLinkType.PARTICIPANT);
            ...
            taskService.addGroupIdentityLink(
                    taskUser1Group5andUser2Group4.getId(), "group5", IdentityLinkType.PARTICIPANT);
            taskService.addGroupIdentityLink(
                    taskUser1Group5andUser2Group4.getId(), "group4", IdentityLinkType.PARTICIPANT);
            taskService.addUserIdentityLink(
                    taskUser1Group5andUser2Group4.getId(), "user2", IdentityLinkType.PARTICIPANT);
            ...
            taskService.addGroupIdentityLink(
                    taskUser2Group1andUser2Group4.getId(), "group1", IdentityLinkType.PARTICIPANT);
            taskService.addGroupIdentityLink(
                    taskUser2Group1andUser2Group4.getId(), "group4", IdentityLinkType.PARTICIPANT);
            taskService.addUserIdentityLink(
                    taskUser2Group1andUser2Group4.getId(), "user2", IdentityLinkType.PARTICIPANT);
