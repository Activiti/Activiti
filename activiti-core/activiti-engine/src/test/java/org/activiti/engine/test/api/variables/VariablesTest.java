...
public class VariablesTest extends PluggableActivitiTestCase {
    ...
    public void testGetVariablesWithCollectionThroughRuntimeService() {
        ...
        Map<String, Object> vars = runtimeService.getVariables(processInstanceId,
            asList("intVar1", "intVar3", "intVar5", "intVar9"));
        ...
        assertThat(runtimeService.getVariablesLocal(processInstanceId,
            asList("intVar1", "intVar3", "intVar5", "intVar9"))).hasSize(4);
        ...
        assertThat(runtimeService.getVariablesLocal(executionId,
            asList("intVar1", "intVar3", "intVar5", "intVar9"))).hasSize(0);
    ...
    public void testGetVariableAllVariableFetchingDefault() {
        ...
        String processInstanceId = runtimeService.startProcessInstanceByKey(
            "variablesFetchingTestProcess", vars).getId();

        taskService.complete(
            taskService.createTaskQuery().taskName("Task A").singleResult().getId());
        taskService.complete(taskService.createTaskQuery().taskName("Task B").singleResult()
    ...
    public void testGetVariableInDelegateMixed() {
        ...
        assertThat((String) runtimeService.getVariable(processInstanceId, "testVar")).isEqualTo(
            "test 1 2 3");
        assertThat((String) runtimeService.getVariable(processInstanceId, "testVar2")).isEqualTo(
            "Hiya");
    }
    ...
    public void testGetVariableInDelegateMixed3() {
        ...
        assertThat((String) runtimeService.getVariable(processInstanceId, "testVar1")).isEqualTo(
            "one-CHANGED");
        assertThat((String) runtimeService.getVariable(processInstanceId, "testVar2")).isEqualTo(
            "two-CHANGED");
    ...
    public void testTaskGetVariables() {
        ...
        assertThat(
            taskService.getVariablesLocal(task.getId(), asList("intVar2", "intVar5"))).hasSize(0);

        // Get Variable
        assertThat(taskService.getVariable(task.getId(), "stringVar3")).isEqualTo(
            "stringVarValue-3");
        ...
        assertThat(
            taskService.getVariablesLocal(task.getId(), asList("intVar2", "intVar5"))).hasSize(0);
        assertThat(taskService.getVariable(task.getId(), "localTaskVar")).isEqualTo(
            "localTaskVarValue");
        assertThat(taskService.getVariableLocal(task.getId(), "localTaskVar")).isEqualTo(
            "localTaskVarValue");

        // Override process variable
        Collection<String> varNames = new ArrayList<String>();
        varNames.add("stringVar1");
        assertThat(taskService.getVariable(task.getId(), "stringVar1")).isEqualTo(
            "stringVarValue-1");
        assertThat(taskService.getVariable(task.getId(), "stringVar1")).isEqualTo(
            "stringVarValue-1");
        assertThat(taskService.getVariables(task.getId(), varNames).get("stringVar1")).isEqualTo(
            "stringVarValue-1");
    ...
    public void testLocalDateVariable() {
        ...
        // Regular getVariables after process instance start
        LocalDate date1 = (LocalDate) runtimeService.getVariable(processInstanceId,
            "localdateVar1");
        ...
        ProcessInstance processInstance = runtimeService.createProcessInstanceQuery()
            .variableValueGreaterThan("localdateVar1", queryDate).singleResult();
        ...
        processInstance = runtimeService.createProcessInstanceQuery()
            .variableValueGreaterThanOrEqual("localdateVar1", queryDate).singleResult();
        assertThat(processInstance).isNotNull();
        assertThat(processInstance.getId()).isEqualTo(processInstanceId);
    }
    ...
    public void testLocalDateTimeVariable() {
        ...
        ProcessInstance processInstance = runtimeService.createProcessInstanceQuery()
            .variableValueGreaterThan("datetimeVar1", queryDate).singleResult();
        assertThat(processInstance).isNotNull();
        assertThat(processInstance.getId()).isEqualTo(processInstanceId);
        ...
        processInstance = runtimeService.createProcessInstanceQuery()
            .variableValueGreaterThanOrEqual("datetimeVar1", queryDate).singleResult();
        assertThat(processInstance).isNotNull();
        assertThat(processInstance.getId()).isEqualTo(processInstanceId);
    }
    ...
    public static class TestJavaDelegate13 implements JavaDelegate {
        ...
        public void execute(DelegateExecution execution) {
            Map<String, Object> vars = execution.getVariables(
                asList("testVar1", "testVar2", "testVar3"), false);
