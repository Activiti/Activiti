...
public class TerminateEndEventTest extends PluggableActivitiTestCase {
    ...
    public void testProcessTerminate() throws Exception {
        ...
        assertHistoricProcessInstanceDeleteReason(
            pi,
    ...
    public void testTerminateInExclusiveGatewayWithCallActivity()
        throws Exception {
        ProcessInstance pi = runtimeService.startProcessInstanceByKey(
    ...
    @Deployment
    public void testTerminateInExclusiveGatewayWithMultiInstanceSubProcess()
        throws Exception {
        ProcessInstance pi = runtimeService.startProcessInstanceByKey(
            "terminateEndEventExample-terminateAfterExclusiveGateway"
        );
    ...
    @Deployment
    public void testTerminateInSubProcessWithBoundaryTerminateAll()
        throws Exception {
        // Test terminating subprocess
    ...
    @Deployment
    public void testTerminateInSubProcessConcurrentTerminateAll()
        throws Exception {
        ProcessInstance pi = runtimeService.startProcessInstanceByKey(
            "terminateEndEventExample"
        );
    ...
    @Deployment
    public void testTerminateInSubProcessConcurrentTerminateAll2()
        throws Exception {
        ProcessInstance pi = runtimeService.startProcessInstanceByKey(
            "terminateEndEventExample"
        );
    ...
    public void testTerminateInSubProcessConcurrentMultiInstance()
        ...
        long executionEntitiesCount = runtimeService
            .createExecutionQuery()
            .count();
    ...
    @Deployment
    public void testTerminateInSubProcessConcurrentMultiInstance2()
        throws Exception {
        ProcessInstance pi = runtimeService.startProcessInstanceByKey(
            "terminateEndEventExample"
        );
    ...
    @Deployment
    public void testTerminateInSubProcessConcurrentMultiInstanceTerminateAll()
        throws Exception {
        ProcessInstance pi = runtimeService.startProcessInstanceByKey(
            "terminateEndEventExample"
        );
    ...
    public void testTerminateInCallActivityConcurrentCallActivity()
        throws Exception {
    ...
    public void testTerminateInSubProcessSequentialConcurrentMultiInstance()
        ...
        long remainingExecutions = runtimeService
            .createExecutionQuery()
            .count();
    ...
    public void testTerminateInCallActivityMultiInstanceTerminateAll()
        throws Exception {
        ProcessInstance pi = runtimeService.startProcessInstanceByKey(
            "terminateEndEventExample"
        );
    ...
    public void testTerminateInCallActivityConcurrentTerminateAll()
        throws Exception {
        ProcessInstance pi = runtimeService.startProcessInstanceByKey(
            "terminateEndEventExample"
        );
    ...
    public void testTerminateInCallActivityConcurrentMulitInstanceTerminateALl()
        throws Exception {
        ProcessInstance pi = runtimeService.startProcessInstanceByKey(
            "terminateEndEventExample"
        );
    ...
    public void testNestedCallActivities() {
        ...
        // Verify the tasks
        List<Task> tasks = assertTaskNames(
            processInstance,
            asList(
                "B",
                "B",
    ...
    private List<Task> assertTaskNames(
        ...
        for (int i = 0; i < taskNames.size(); i++) {
            assertThat(tasks.get(i).getName())
                .as("Task name at index " + i + " does not match")
    ...
    public void testParseTerminateEndEventDefinitionWithExtensions() {
        org.activiti.engine.repository.Deployment deployment = repositoryService
            ...
            .deploy();
        ProcessDefinition processDefinitionQuery = repositoryService
            .createProcessDefinitionQuery()
            .deploymentId(deployment.getId())
            .singleResult();
        BpmnModel bpmnModel =
            this.processEngineConfiguration.getProcessDefinitionCache()
            ...
            for (Execution execution : executionList) {
                ...
                if (
                    ...
                    activityId.equalsIgnoreCase(
                        "quality_control_passed_gateway"
                    ) ||
    ...
    protected void assertHistoricProcessInstanceDetails(
        ...
        if (
            ...
            assertThat(historicProcessInstance.getDurationInMillis())
                .isNotNull();
            assertThat(historicProcessInstance.getEndActivityId()).isNotNull();
        }
    }

    protected void assertHistoricProcessInstanceDeleteReason(
        ProcessInstance processInstance,
    ...
    protected void assertHistoricTasksDeleteReason(
        ProcessInstance processInstance,
        String expectedDeleteReason,
        String... taskNames
    ) {
    ...
    protected void assertHistoricActivitiesDeleteReason(
        ProcessInstance processInstance,
        String expectedDeleteReason,
        String... activityIds
    ) {
        if (
            ...
            for (String activityId : activityIds) {
                List<HistoricActivityInstance> historicActiviyInstances = historyService
                ...
                for (HistoricActivityInstance historicActiviyInstance : historicActiviyInstances) {
                    assertThat(historicActiviyInstance.getEndTime())
                        .isNotNull();
                    if (expectedDeleteReason == null) {
