...
public class MessageEventSubprocessTest extends PluggableActivitiTestCase {
    ...
    private void testInterruptingUnderProcessDefinition(int expectedNumberOfEventSubscriptions,
        ...
        Execution execution = runtimeService.createExecutionQuery()
            .messageEventSubscriptionName("newMessage").singleResult();
        assertThat(execution).isNotNull();
        assertThat(createEventSubscriptionQuery().count()).isEqualTo(
            expectedNumberOfEventSubscriptions);
        ...
        execution = runtimeService.createExecutionQuery().messageEventSubscriptionName("newMessage")
            .singleResult();
        assertThat(execution).isNotNull();
    ...
    public void testNonInterruptingUnderProcessDefinition() {
        ...
        task = taskService.createTaskQuery().taskDefinitionKey("eventSubProcessTask")
            .singleResult();
        taskService.complete(task.getId());
        // done!
        assertThat(runtimeService.createExecutionQuery().count()).isEqualTo(0);
