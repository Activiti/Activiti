...
public class DatabaseEventLoggerTest extends PluggableActivitiTestCase {
    ...
    public void testDatabaseEvents() throws IOException {
        ...
        while (iterator.hasNext()) {
            ...
            if (entry.getProcessDefinitionId() != null && !entry.getProcessDefinitionId()
        ...
        for (int i = 0; i < eventLogEntries.size(); i++) {
            ...
            if (i == 0) {
                ...
                Map<String, Object> data = objectMapper.readValue(entry.getData(),
    ...
    public void testDatabaseEventsNoTenant() throws IOException {
        ...
        String deploymentId = repositoryService.createDeployment().addClasspathResource(
                "org/activiti/engine/test/api/event/DatabaseEventLoggerProcess.bpmn20.xml").deploy()
            .getId();

        // Run process to gather data
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey(
            "DatabaseEventLoggerProcess", singletonMap("testVar", "helloWorld"));
    ...
    public void testStandaloneTaskEvents()
        ...
        for (EventLogEntry eventLogEntry : events) {
            Map<String, Object> data = objectMapper.readValue(eventLogEntry.getData(),
                new TypeReference<HashMap<String, Object>>() {
                });
