...
public class ActivityEventsTest extends PluggableActivitiTestCase {
    ...
    public void testActivityEvents() throws Exception {
        ...
        ActivitiActivityEvent activityEvent = (ActivitiActivityEvent) listener.getEventsReceived()
            .get(0);
        ...
        assertThat(activityEvent.getProcessInstanceId()).isEqualTo(
            processInstance.getProcessInstanceId());
        assertThat(activityEvent.getProcessDefinitionId()).isEqualTo(
        ...
        Execution execution = runtimeService.createExecutionQuery()
            .parentId(processInstance.getId()).singleResult();
    ...
    public void testActivitySignalEvents() throws Exception {
        ...
        assertThat(signalEvent.getProcessInstanceId()).isEqualTo(
            executionWithSignal.getProcessInstanceId());
        assertThat(signalEvent.getProcessDefinitionId()).isEqualTo(
            processInstance.getProcessDefinitionId());
    ...
    public void testActivityMessageEvents() throws Exception {
        ...
        ActivitiMessageEvent messageEvent = (ActivitiMessageEvent) listener.getEventsReceived()
            .get(0);
        ...
        assertThat(messageEvent.getProcessInstanceId()).isEqualTo(
            executionWithMessage.getProcessInstanceId());
        assertThat(messageEvent.getProcessDefinitionId()).isEqualTo(
            processInstance.getProcessDefinitionId());
    ...
    public void testActivityMessageEventsInEventSubprocess() throws Exception {
        ...
        assertThat(listener.getEventsReceived().get(2)).isInstanceOf(
            ActivitiActivityCancelledEvent.class);
        ActivitiActivityEvent activityEvent = (ActivitiActivityEvent) listener.getEventsReceived()
            .get(2);
    ...
    public void testActivityErrorEvents() throws Exception {
        ...
        ProcessInstance afterErrorInstance = runtimeService.createProcessInstanceQuery()
            .processInstanceId(processInstance.getId()).singleResult();
        ...
        assertThat(errorEvent.getProcessDefinitionId()).isEqualTo(
            processInstance.getProcessDefinitionId());
        assertThat(errorEvent.getExecutionId()).isNotEqualTo(processInstance.getId());
    }

    /**
     * Test events related to error-events, thrown from within process-execution (eg.
     * service-task).
     */
    @Deployment
    ...
    public void testActivityTimeOutEvent() {
        ...
        Job theJob = managementService.createTimerJobQuery()
            .processInstanceId(processInstance.getId()).singleResult();
        ...
        assertThat(((ActivitiActivityCancelledEvent) activitiEvent).getCause()).isEqualTo(
    ...
    public void testActivityTimeOutEventInSubProcess() {
        ...
        for (ActivitiEvent event : listener.getEventsReceived()) {
            ...
            assertThat(((ActivitiActivityCancelledEvent) event).getCause()).isEqualTo(
    ...
    public void testActivityMessageBoundaryEventsOnUserTask() throws Exception {
        ...
        Execution executionWithMessage = runtimeService.createExecutionQuery()
            .messageEventSubscriptionName("message_1").singleResult();
        assertThat(executionWithMessage).isNotNull();
        Execution taskExecution = runtimeService.createExecutionQuery().activityId("cloudformtask1")
            .processInstanceId(processInstance.getId()).singleResult();
        ...
        assertThat(listener.getEventsReceived().get(2)).isInstanceOf(
            ActivitiActivityCancelledEvent.class);
        ActivitiActivityCancelledEvent cancelledEvent = (ActivitiActivityCancelledEvent) listener.getEventsReceived()
            .get(2);
        ...
        assertThat(cancelledEvent.getProcessInstanceId()).isEqualTo(
            executionWithMessage.getProcessInstanceId());
        assertThat(cancelledEvent.getProcessDefinitionId()).isEqualTo(
            processInstance.getProcessDefinitionId());
        assertThat(cancelledEvent.getCause()).isEqualTo(
            "boundary event (boundaryMessageEventCatching)");
    ...
    public void testActivityMessageBoundaryEventsOnSubProcess() throws Exception {
        ...
        Execution executionWithMessage = runtimeService.createExecutionQuery()
            .activityId("boundaryMessageEventCatching").singleResult();
        assertThat(executionWithMessage).isNotNull();
        ...
        assertThat(listener.getEventsReceived().get(3)).isInstanceOf(
            ActivitiActivityCancelledEvent.class);
    ...
    public void testActivitySignalBoundaryEventsOnSubProcess() throws Exception {
        ...
        Execution executionWithSignal = runtimeService.createExecutionQuery()
            .activityId("userTaskInsideProcess").singleResult();
        assertThat(executionWithSignal).isNotNull();
        ...
        ActivitiSignalEventImpl signalEvent = (ActivitiSignalEventImpl) listener.getEventsReceived()
            .get(0);
        assertThat(signalEvent.getType()).isEqualTo(ActivitiEventType.ACTIVITY_SIGNALED);
        ...
        assertThat(listener.getEventsReceived().get(2)).isInstanceOf(
            ActivitiActivityCancelledEvent.class);
        ActivitiActivityCancelledEvent cancelEvent = (ActivitiActivityCancelledEvent) listener.getEventsReceived()
            .get(2);
        ...
        assertThat(cancelEvent.getProcessInstanceId()).isEqualTo(
            executionWithSignal.getProcessInstanceId());
        assertThat(cancelEvent.getProcessDefinitionId()).isEqualTo(
            processInstance.getProcessDefinitionId());
        assertThat(cancelEvent.getCause()).isEqualTo(
            "boundary event (boundarySignalEventCatching)");

        assertThat(listener.getEventsReceived().get(1)).isInstanceOf(
            ActivitiActivityCancelledEvent.class);
    ...
    public void testActivitySignalBoundaryEventsOnUserTask() throws Exception {
        ...
        Execution executionWithSignal = runtimeService.createExecutionQuery().activityId("userTask")
            .singleResult();
        assertThat(executionWithSignal).isNotNull();
