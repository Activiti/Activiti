...
public class AsyncExecutorTest {
  ...
  public void testRegularAsyncExecution() {
    ...
    try {
      ...
      assertThat(processEngine.getTaskService().createTaskQuery().taskName("The Task").count())
          .isEqualTo(1);
      assertThat(
              processEngine.getTaskService().createTaskQuery().taskName("Task after timer").count())
          .isEqualTo(0);
  ...
  public void testAsyncExecutorDisabledOnOneEngine() {
    ...
    try {
      ...
      assertThat(firstProcessEngine.getTaskService().createTaskQuery().taskName("The Task").count())
          .isEqualTo(1);
      assertThat(
              firstProcessEngine
                  .getTaskService()
                  ...
                  .count())
          .isEqualTo(0);
      assertThat(firstProcessEngine.getManagementService().createTimerJobQuery().count())
          .isEqualTo(1);
  ...
  public void testAsyncFailingScript() {
    ...
    try {
      ...
      JobTestHelper.waitForJobExecutorOnCondition(
          ...
          new Callable<Boolean>() {
            ...
            public Boolean call() throws Exception {
              long timerJobCount =
                  processEngineCopy.getManagementService().createTimerJobQuery().count();
              if (timerJobCount == 0) {
      ...
      assertThat(
          ...
          .isEqualTo(0);
      assertThat(processEngine.getManagementService().createJobQuery().count()).isEqualTo(0);
      assertThat(processEngine.getManagementService().createDeadLetterJobQuery().count())
          .isEqualTo(1);
