...
public class AsyncExecutorTest {
    ...
    public void testRegularAsyncExecution() {
        ...
        try {
            ...
            assertThat(processEngine.getTaskService().createTaskQuery().taskName("Task after timer").count()).isEqualTo(
                0
            );
    ...
    public void testAsyncExecutorDisabledOnOneEngine() {
        ...
        try {
            ...
            assertThat(
                firstProcessEngine.getTaskService().createTaskQuery().taskName("Task after timer").count()
            ).isEqualTo(0);
    ...
    public void testAsyncScriptExecution() {
        ...
        try {
            ...
            assertThat(
                processEngine.getTaskService().createTaskQuery().taskName("Task after script").count()
            ).isEqualTo(1);
    ...
    public void testAsyncScriptExecutionOnTwoEngines() {
        ...
        try {
            ...
            assertThat(
                firstProcessEngine.getTaskService().createTaskQuery().taskName("Task after script").count()
            ).isEqualTo(0);
    ...
    private void cleanup(ProcessEngine processEngine) {
        if (processEngine != null) {
            for (org.activiti.engine.repository.Deployment deployment : processEngine
