...
public class TaskVariablesTest extends PluggableActivitiTestCase {
    ...
    public void testGetVariablesLocalByTaskIds() {
        ProcessInstance processInstance1 =
                runtimeService.startProcessInstanceByKey("twoTaskProcess");
    ...
    public void testGetVariablesCopiedIntoTasks() {
        ...
        ProcessInstance processInstance1 =
                runtimeService.startProcessInstanceByKey("twoTaskProcess", startVariables);
        Task userTask1 =
                taskService.createTaskQuery().taskDefinitionKey("usertask1").singleResult();
        Task userTask2 =
                taskService.createTaskQuery().taskDefinitionKey("usertask2").singleResult();
        ...
        // after completion the process variable should be updated but only that one and not task2's
        // local variable
        assertThat(runtimeService.getVariable(processInstance1.getId(), "start1"))
                .isEqualTo("modifiedstart1");
        assertThat(runtimeService.getVariable(processInstance1.getId(), "start2"))
                .isEqualTo("start2");
        assertThat(taskService.getVariablesLocal(userTask2.getId())).isEqualTo(startVariables);
    ...
    private void checkVariable(
            String taskId, String name, String value, List<VariableInstance> variables) {
