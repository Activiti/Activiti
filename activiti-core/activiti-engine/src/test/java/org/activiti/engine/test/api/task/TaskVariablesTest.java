...
public class TaskVariablesTest extends PluggableActivitiTestCase {
    ...
    public void testTaskExecutionVariables() {
        ...
        assertThat(runtimeService.getVariablesLocal(processInstanceId)).isEqualTo(
            expectedVariables);
    ...
    public void testGetVariablesLocalByTaskIds() {
        ...
        List<Task> taskList1 = taskService.createTaskQuery()
            .processInstanceId(processInstance1.getId()).list();
    ...
    public void testGetVariablesCopiedIntoTasks() {
        ...
        ProcessInstance processInstance1 = runtimeService.startProcessInstanceByKey(
            "twoTaskProcess", startVariables);
        Task userTask1 = taskService.createTaskQuery().taskDefinitionKey("usertask1")
            .singleResult();
        Task userTask2 = taskService.createTaskQuery().taskDefinitionKey("usertask2")
            .singleResult();
        ...
        assertThat(runtimeService.getVariable(processInstance1.getId(), "start1")).isEqualTo(
            "modifiedstart1");
        assertThat(runtimeService.getVariable(processInstance1.getId(), "start2")).isEqualTo(
            "start2");
        assertThat(taskService.getVariablesLocal(userTask2.getId())).isEqualTo(startVariables);
    ...
    private void checkVariable(String taskId, String name, String value,
