...
public class TaskVariablesTest extends PluggableActivitiTestCase {
    ...
    public void testStandaloneTaskVariables() {
        ...
        assertThat(taskService.getVariable(taskId, "instrument"))
            .isEqualTo("trumpet");
    ...
    public void testSerializableTaskVariable() {
        ...
        // Fetch variable
        MyVariable variable = (MyVariable) taskService.getVariable(
            task.getId(),
            "theVar"
        );
    ...
    public void testGetVariablesLocalByTaskIds() {
        ...
        List<VariableInstance> variables = taskService.getVariableInstancesLocalByTaskIds(
            taskIds
        );
        assertThat(variables).hasSize(2);
        checkVariable(
            taskList1.get(0).getId(),
            "taskVar1",
            "sayHello1",
            variables
        );
        checkVariable(
            taskList1.get(1).getId(),
            "taskVar2",
            "sayHello2",
            variables
        );
        ...
        checkVariable(
            taskList2.get(0).getId(),
            "taskVar3",
            "sayHello3",
            variables
        );
        checkVariable(
            taskList2.get(1).getId(),
            "taskVar4",
            "sayHello4",
            variables
        );
    ...
    public void testGetVariablesCopiedIntoTasks() {
        ...
        assertThat(taskService.getVariablesLocal(userTask1.getId()))
            .isEqualTo(startVariables);
        assertThat(taskService.getVariablesLocal(userTask2.getId()))
            .isEqualTo(startVariables);
        ...
        assertThat(startVariables)
            .isEqualTo(taskService.getVariablesLocal(userTask2.getId()));
        ...
        assertThat(
            runtimeService.getVariable(processInstance1.getId(), "start1")
        )
            .isEqualTo("modifiedstart1");
        assertThat(
            runtimeService.getVariable(processInstance1.getId(), "start2")
        )
            .isEqualTo("start2");
        assertThat(taskService.getVariablesLocal(userTask2.getId()))
            .isEqualTo(startVariables);
    ...
    public void testGetVariablesLocalByTaskIdsForScope() {
        ...
        List<VariableInstance> variableInstances = taskService.getVariableInstancesLocalByTaskIds(
            taskIds
        );
