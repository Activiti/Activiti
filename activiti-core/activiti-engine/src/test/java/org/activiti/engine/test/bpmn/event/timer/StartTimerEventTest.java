...
public class StartTimerEventTest extends PluggableActivitiTestCase {
    ...
    public void testDurationStartTimerEvent() throws Exception {
        ...
        processEngineConfiguration
            .getClock()
            .setCurrentTime(
                new Date(startTime.getTime() + ((50 * 60 * 1000) + 5000))
            );
    ...
    public void testVersionUpgradeShouldCancelJobs() throws Exception {
        ...
        .replaceAll("beforeChange", "changed");
                ...
                public Boolean call() throws Exception {
                    ...
                    if (processInstance != null) {
                        ...
                        if (activityExecution != null) {
                            return "changed".equals(
                                    activityExecution.getActivityId()
                                );
                        } else {
                            return false;
                        }
    ...
    public void testTimerShouldNotBeRemovedWhenUndeployingOldVersion()
        ...
        //we deploy new process version, with some small change
        String processChanged = processXml.replaceAll(
            "beforeChange",
            "changed"
        );
        String secondDeploymentId = repositoryService
            .createDeployment()
            .addInputStream(
                "StartTimerEventTest.testVersionUpgradeShouldCancelJobs.bpmn20.xml",
    ...
    public void testTimersRecreatedOnDeploymentDelete() {
        ...
        String deployment2 = repositoryService
            .createDeployment()
            .addClasspathResource(
        ...
        // Deploy v3: no timer
        String deployment3 = repositoryService
            .createDeployment()
            .addClasspathResource(
        ...
        // Deploy v4: no timer
        String deployment4 = repositoryService
            .createDeployment()
            .addClasspathResource(
        ...
        assertThat(repositoryService.createProcessDefinitionQuery().count())
            .isEqualTo(2);
        assertThat(managementService.createTimerJobQuery().count())
            .isEqualTo(0); // v3 is still active
    ...
    public void testTimersRecreatedOnDeploymentDeleteWithTenantId() {
        ...
        assertThat(
            repositoryService
                .createProcessDefinitionQuery()
                .processDefinitionTenantId(testTenant)
                .count()
        )
            .isEqualTo(1);
        assertThat(
    ...
    public void testMultipleStartEvents() {
        ...
        assertThat(managementService.createTimerJobQuery().count())
            .isEqualTo(4);
        assertThat(managementService.createTimerJobQuery().executable().count())
            .isEqualTo(0);
        ...
        List<Job> executableTimers = managementService
            .createTimerJobQuery()
            .executable()
            .list();
    ...
    private void validateTaskCounts(
        long taskACount,
        long taskBCount,
        long taskCCount,
        long taskDCount
    ) {
        assertThat(taskService.createTaskQuery().taskName("Task A").count())
            .as("task A counts are incorrect")
            .isEqualTo(taskACount);
        assertThat(taskService.createTaskQuery().taskName("Task B").count())
            .as("task B counts are incorrect")
            .isEqualTo(taskBCount);
        assertThat(taskService.createTaskQuery().taskName("Task C").count())
            .as("task C counts are incorrect")
            .isEqualTo(taskCCount);
        assertThat(taskService.createTaskQuery().taskName("Task D").count())
            .as("task D counts are incorrect")
            .isEqualTo(taskDCount);
    }
