...
public class StartTimerEventTest extends PluggableActivitiTestCase {
  ...
  public void testCycleDateStartTimerEvent() throws Exception {
    ...
    final ProcessInstanceQuery piq =
        runtimeService.createProcessInstanceQuery().processDefinitionKey("startTimerEventExample");
          ...
          public Boolean call() throws Exception {
            ...
            if (processInstance != null) {
              ...
              List<Execution> executions =
                  runtimeService.createExecutionQuery().processInstanceId(pi).list();
  ...
  public void testTimersRecreatedOnDeploymentDeleteWithTenantId() {
    ...
    assertThat(repositoryService.createDeploymentQuery().deploymentTenantId(testTenant).count())
        .isEqualTo(1);
    assertThat(
            repositoryService
                .createProcessDefinitionQuery()
                ...
                .count())
        .isEqualTo(1);
    assertThat(managementService.createTimerJobQuery().jobTenantId(testTenant).count())
        .isEqualTo(1);
  ...
  public void testMultipleStartEvents() {
    ...
    // Moving 7 seconds (18:50:08) should trigger one timer (the second start timer in the process
    // diagram)
  ...
  private void validateTaskCounts(
      long taskACount, long taskBCount, long taskCCount, long taskDCount) {
