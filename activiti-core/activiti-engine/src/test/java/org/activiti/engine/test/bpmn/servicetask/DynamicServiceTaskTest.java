...
public class DynamicServiceTaskTest extends PluggableActivitiTestCase {
    ...
    public void testChangeClassName() {
        ...
        ObjectNode infoNode = dynamicBpmnService.changeServiceTaskClassName("service",
    ...
    public void testChangeExpression() {
        ...
        String processDefinitionId = processInstance.getProcessDefinitionId();
        ObjectNode infoNode = dynamicBpmnService.changeServiceTaskExpression("service",
            "${bean2.test(execution)}");
        dynamicBpmnService.saveProcessDefinitionInfo(processDefinitionId, infoNode);
    ...
    public void testChangeDelegateExpression() {
        ...
        String processDefinitionId = processInstance.getProcessDefinitionId();
        ObjectNode infoNode = dynamicBpmnService.changeServiceTaskDelegateExpression("service",
            "${bean2}");
        dynamicBpmnService.saveProcessDefinitionInfo(processDefinitionId, infoNode);
