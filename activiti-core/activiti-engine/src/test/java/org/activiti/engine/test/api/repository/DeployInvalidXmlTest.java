...
public class DeployInvalidXmlTest extends PluggableActivitiTestCase {
    ...
    private static final String UNSAFE_XML = "<?xml version='1.0' encoding='UTF-8'?>"
        ...
        + " <endEvent id='theEnd' />" + "</process>" + "</definitions>";
        ...
        public void run() {
            try {
                String deploymentId = repositoryService.createDeployment()
                    .addString("test.bpmn20.xml", UNSAFE_XML).deploy().getId();
                assertThat(
                    repositoryService.createProcessDefinitionQuery().singleResult()).isEqualTo(1);
