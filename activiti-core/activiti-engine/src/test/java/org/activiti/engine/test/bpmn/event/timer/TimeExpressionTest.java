...
public class TimeExpressionTest extends PluggableActivitiTestCase {
    ...
    public void testTimeExpressionComplete() throws Exception {
        ...
        Date dueDate = testExpression(
            new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss").format(dt)
        );
        assertThat(
            new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss").format(dueDate)
        )
            .isEqualTo(
                new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss").format(dt)
            );
    ...
    public void testTimeExpressionWithoutMinutes() throws Exception {
        ...
        Date dueDate = testExpression(
            new SimpleDateFormat("yyyy-MM-dd'T'HH").format(new Date())
        );
    ...
    public void testTimeExpressionWithoutDay() throws Exception {
        ...
        assertThat(new SimpleDateFormat("yyyy-MM").format(dueDate))
            .isEqualTo(new SimpleDateFormat("yyyy-MM").format(dt));
    }
    ...
    public void testTimeExpressionWithoutMonth() throws Exception {
        ...
        assertThat(new SimpleDateFormat("yyyy").format(dueDate))
            .isEqualTo(new SimpleDateFormat("yyyy").format(dt));
    }
}
