...
public class TimeExpressionTest extends PluggableActivitiTestCase {
    ...
    private Date testExpression(String timeExpression) {
        ...
        ProcessInstance pi1 = runtimeService.startProcessInstanceByKey(
            "intermediateTimerEventExample", variables1);
        assertThat(managementService.createTimerJobQuery().processInstanceId(pi1.getId())
            .count()).isEqualTo(1);
    ...
    @Deployment(resources = {
        "org/activiti/engine/test/bpmn/event/timer/IntermediateTimerEventTest.testExpression.bpmn20.xml"})
    public void testTimeExpressionComplete() throws Exception {
        ...
        assertThat(new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss").format(dueDate)).isEqualTo(
    ...
    public void testTimeExpressionWithoutSeconds() throws Exception {
        ...
        assertThat(new SimpleDateFormat("yyyy-MM-dd'T'HH:mm").format(dueDate)).isEqualTo(
            new SimpleDateFormat("yyyy-MM-dd'T'HH:mm").format(dt));
    }
    ...
    public void testTimeExpressionWithoutMinutes() throws Exception {
        ...
        assertThat(new SimpleDateFormat("yyyy-MM-dd'T'HH").format(dueDate)).isEqualTo(
            new SimpleDateFormat("yyyy-MM-dd'T'HH").format(dt));
    }
    ...
    public void testTimeExpressionWithoutTime() throws Exception {
        ...
        assertThat(new SimpleDateFormat("yyyy-MM-dd").format(dueDate)).isEqualTo(
    ...
    public void testTimeExpressionWithoutDay() throws Exception {
        ...
        assertThat(new SimpleDateFormat("yyyy-MM").format(dueDate)).isEqualTo(
            new SimpleDateFormat("yyyy-MM").format(dt));
    }
    ...
    public void testTimeExpressionWithoutMonth() throws Exception {
        ...
        assertThat(new SimpleDateFormat("yyyy").format(dueDate)).isEqualTo(
