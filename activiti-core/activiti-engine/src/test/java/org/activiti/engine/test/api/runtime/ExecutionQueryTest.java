...
public class ExecutionQueryTest extends PluggableActivitiTestCase {
    ...
    public void testQueryByProcessDefinitionKey() {
        ...
        assertThat(runtimeService.createExecutionQuery().processDefinitionKey(CONCURRENT_PROCESS_KEY).list()).hasSize(
            12
        );
        assertThat(runtimeService.createExecutionQuery().processDefinitionKey(SEQUENTIAL_PROCESS_KEY).list()).hasSize(
            2
        );
    }
    ...
    public void testQueryByProcessDefinitionCategory() {
        // Concurrent process with 3 executions for each process instance
        assertThat(
            runtimeService.createExecutionQuery().processDefinitionCategory(CONCURRENT_PROCESS_CATEGORY).list()
        ).hasSize(12);
        assertThat(
            runtimeService.createExecutionQuery().processDefinitionCategory(SEQUENTIAL_PROCESS_CATEGORY).list()
        ).hasSize(2);
    }
    ...
    public void testQueryByProcessDefinitionName() {
        // Concurrent process with 3 executions for each process instance
        assertThat(runtimeService.createExecutionQuery().processDefinitionName(CONCURRENT_PROCESS_NAME).list()).hasSize(
            12
        );
        assertThat(runtimeService.createExecutionQuery().processDefinitionName(SEQUENTIAL_PROCESS_NAME).list()).hasSize(
            2
        );
    }
    ...
    public void testQueryByProcessInstanceId() {
        ...
        assertThat(
            runtimeService.createExecutionQuery().processInstanceId(sequentialProcessInstanceIds.getFirst()).list()
        ).hasSize(2);
    }
    ...
    public void testQueryByRootProcessInstanceId() {
        ...
        assertThat(
            runtimeService.createExecutionQuery().rootProcessInstanceId(sequentialProcessInstanceIds.getFirst()).list()
        ).hasSize(2);
    }
    ...
    public void testQueryPaging() {
        ...
        assertThat(
            runtimeService.createExecutionQuery().processDefinitionKey(CONCURRENT_PROCESS_KEY).listPage(0, 4)
        ).hasSize(4);
        assertThat(
            runtimeService.createExecutionQuery().processDefinitionKey(CONCURRENT_PROCESS_KEY).listPage(2, 1)
        ).hasSize(1);
        assertThat(
            runtimeService.createExecutionQuery().processDefinitionKey(CONCURRENT_PROCESS_KEY).listPage(1, 10)
        ).hasSize(10);
        assertThat(
            runtimeService.createExecutionQuery().processDefinitionKey(CONCURRENT_PROCESS_KEY).listPage(0, 20)
        ).hasSize(12);
    }
    ...
    public void testQueryStringVariable() {
        ...
        assertThat(
            runtimeService.createExecutionQuery().variableValueGreaterThanOrEqual("stringVar", "abcdef").count()
        ).isEqualTo(3);
        assertThat(
            runtimeService.createExecutionQuery().variableValueGreaterThanOrEqual("stringVar", "z").count()
        ).isEqualTo(0);
        ...
        List<String> ids = new ArrayList<String>(asList(executions.getFirst().getId(), executions.get(1).getId()));
        ids.removeAll(expectedIds);
        assertThat(ids.isEmpty()).isTrue();

        assertThat(
            runtimeService.createExecutionQuery().variableValueLessThan("stringVar", "abcdef").count()
        ).isEqualTo(0);
        assertThat(
            runtimeService.createExecutionQuery().variableValueLessThanOrEqual("stringVar", "z").count()
        ).isEqualTo(3);
        ...
        assertThat(
            runtimeService.createExecutionQuery().variableValueLessThanOrEqual("stringVar", "aa").count()
        ).isEqualTo(0);
    ...
    public void testQueryLongVariable() {
        ...
        assertThat(runtimeService.createExecutionQuery().variableValueGreaterThan("longVar", 55555L).count()).isEqualTo(
            0
        );
        ...
        assertThat(
            runtimeService.createExecutionQuery().variableValueGreaterThanOrEqual("longVar", 1L).count()
        ).isEqualTo(3);
        ...
        assertThat(
            runtimeService.createExecutionQuery().variableValueLessThanOrEqual("longVar", 12344L).count()
        ).isEqualTo(0);
    ...
    public void testQueryDoubleVariable() {
        ...
        assertThat(
            runtimeService.createExecutionQuery().variableValueGreaterThan("doubleVar", 55555.5555).count()
        ).isEqualTo(0);
        assertThat(
            runtimeService.createExecutionQuery().variableValueGreaterThan("doubleVar", 1.234).count()
        ).isEqualTo(3);
        ...
        assertThat(
            runtimeService.createExecutionQuery().variableValueGreaterThanOrEqual("doubleVar", 1.234).count()
        ).isEqualTo(3);
        ...
        assertThat(
            runtimeService.createExecutionQuery().variableValueLessThan("doubleVar", 12345.6789).count()
        ).isEqualTo(0);
        assertThat(
            runtimeService.createExecutionQuery().variableValueLessThan("doubleVar", 66666.6666).count()
        ).isEqualTo(3);
        ...
        assertThat(
            runtimeService.createExecutionQuery().variableValueLessThanOrEqual("doubleVar", 12344.6789).count()
        ).isEqualTo(0);
    ...
    public void testQueryIntegerVariable() {
        ...
        assertThat(
            runtimeService.createExecutionQuery().variableValueGreaterThan("integerVar", 55555).count()
        ).isEqualTo(0);
        assertThat(runtimeService.createExecutionQuery().variableValueGreaterThan("integerVar", 1).count()).isEqualTo(
            3
        );
        ...
        assertThat(
            runtimeService.createExecutionQuery().variableValueGreaterThanOrEqual("integerVar", 1).count()
        ).isEqualTo(3);
        ...
        assertThat(runtimeService.createExecutionQuery().variableValueLessThan("integerVar", 12345).count()).isEqualTo(
            0
        );
        assertThat(runtimeService.createExecutionQuery().variableValueLessThan("integerVar", 66666).count()).isEqualTo(
            3
        );
        ...
        assertThat(
            runtimeService.createExecutionQuery().variableValueLessThanOrEqual("integerVar", 12344).count()
        ).isEqualTo(0);
    ...
    public void testQueryNullVariable() throws Exception {
        ...
        assertThat(executions.getFirst().getId()).isEqualTo(processInstance1.getId());

        // Test NOT_EQUALS null
        assertThat(runtimeService.createExecutionQuery().variableValueNotEquals("nullVar", null).count()).isEqualTo(1);
        assertThat(runtimeService.createExecutionQuery().variableValueNotEquals("nullVarLong", null).count()).isEqualTo(
            1
        );
        assertThat(
            runtimeService.createExecutionQuery().variableValueNotEquals("nullVarDouble", null).count()
        ).isEqualTo(1);
        // When a byte-array reference is present, the variable is not considered
        // null
        assertThat(runtimeService.createExecutionQuery().variableValueNotEquals("nullVarByte", null).count()).isEqualTo(
            1
        );
    ...
    public void testQueryAllVariableTypes() throws Exception {
        ...
        assertThat(executions).isNotNull();
        assertThat(executions).hasSize(1);
        assertThat(executions.getFirst().getId()).isEqualTo(processInstance.getId());
    ...
    public void testQueryBySignalSubscriptionNameBoundary() {
        ...
        // it finds more than one
        runtimeService.startProcessInstanceByKey("signalProces");
        assertThat(runtimeService.createExecutionQuery().signalEventSubscriptionName("Test signal").count()).isEqualTo(
            2
        );
    }
