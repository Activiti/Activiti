...
public class ExecutionQueryTest extends PluggableActivitiTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        repositoryService
                ...
                .addClasspathResource(
                        "org/activiti/engine/test/api/runtime/concurrentExecution.bpmn20.xml")
                .deploy();
    ...
    public void testQueryByInvalidProcessDefinitionKey() {
        ExecutionQuery query =
                runtimeService.createExecutionQuery().processDefinitionKey("invalid");
    ...
    public void testQueryByInvalidProcessDefinitionName() {
        ExecutionQuery query =
                runtimeService.createExecutionQuery().processDefinitionName("invalid");
        assertThat(query.singleResult()).isNull();
        assertThat(query.list()).hasSize(0);
        assertThat(query.count()).isEqualTo(0);
    }
    ...
    public void testQueryByParentId() {
        ...
        for (String processInstanceId : concurrentProcessInstanceIds) {
            ExecutionQuery query =
                    runtimeService.createExecutionQuery().parentId(processInstanceId);
    ...
    public void testQueryStringVariable() {
        ...
        execution =
                runtimeService.createExecutionQuery().variableValueEquals("azerty").singleResult();
        assertThat(execution).isNotNull();
        assertThat(execution.getId()).isEqualTo(processInstance3.getId());
    ...
    public void testQueryLongVariable() {
        ...
        // Test value-only matching
        execution =
                runtimeService.createExecutionQuery().variableValueEquals(55555L).singleResult();
        assertThat(execution).isNotNull();
        assertThat(execution.getId()).isEqualTo(processInstance3.getId());
        ...
        execution =
                runtimeService.createExecutionQuery().variableValueEquals(99999L).singleResult();
        assertThat(execution).isNull();
    ...
    public void testQueryDoubleVariable() {
        ...
        execution =
                runtimeService
                        .createExecutionQuery()
                        .variableValueEquals(55555.5555)
                        .singleResult();
        assertThat(execution).isNotNull();
        assertThat(execution.getId()).isEqualTo(processInstance3.getId());
        ...
        execution =
                runtimeService.createExecutionQuery().variableValueEquals(9999.9999).singleResult();
        assertThat(execution).isNull();
                ...
                .isThrownBy(
                        () ->
                                runtimeService
                                        .createExecutionQuery()
                                        .variableValueEquals(
                                                "serializableVar", new DummySerializable())
                                        .list())
                .withMessageContaining("Variables of type ByteArray cannot be used to query");
    ...
    @Deployment(
            resources = {"org/activiti/engine/test/api/runtime/executionLocalization.bpmn20.xml"})
    public void testLocalizeExecution() throws Exception {
        ...
        dynamicBpmnService.changeLocalizationName(
                "en", "subProcess", "SubProcess Name 'en'", infoNode);
        dynamicBpmnService.changeLocalizationDescription(
