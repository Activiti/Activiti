...
public class ExecutionQueryTest extends PluggableActivitiTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        sequentialProcessInstanceIds.add(
            runtimeService
                .startProcessInstanceByKey(SEQUENTIAL_PROCESS_KEY)
                .getId()
        );
    }
    ...
    public void testQueryByProcessDefinitionKeyIn() {
        ...
        assertThat(
            runtimeService
                .createExecutionQuery()
                .processDefinitionKeys(includeIds)
                .list()
        )
            .hasSize(14);
    ...
    public void testQueryNullVariable() throws Exception {
        ...
        assertThat(executions.get(0).getId())
            .isEqualTo(processInstance1.getId());
    ...
    public void testNativeQuery() {
        ...
        assertThat(managementService.getTableName(Execution.class))
    ...
    public void testLocalizeExecution() throws Exception {
        ...
        for (Execution execution : executions) {
            if (execution.getParentId() == null) {
                ...
                assertThat(execution.getDescription())
                ...
                assertThat(execution.getDescription())
                    .isEqualTo("Subproceso Descripción");
            }
        }
        ...
        for (Execution execution : executions) {
            if (execution.getParentId() == null) {
                assertThat(execution.getName())
                    .isEqualTo("Process Name 'en-GB'");
                assertThat(execution.getDescription())
                    .isEqualTo("Process Description 'en-GB'");
            } else if (
                execution.getParentId().equals(execution.getProcessInstanceId())
            ) {
                assertThat(execution.getName())
                    .isEqualTo("SubProcess Name 'en-GB'");
                assertThat(execution.getDescription())
                    .isEqualTo("SubProcess Description 'en-GB'");
            }
        }
        ...
        assertThat(execution.getDescription())
            .isEqualTo("Process Description 'en'");
        ...
        assertThat(execution.getDescription())
            .isEqualTo("SubProcess Description 'en'");
        ...
        assertThat(execution.getDescription())
            .isEqualTo("Process Description 'en-US'");
        ...
        assertThat(execution.getDescription())
            .isEqualTo("SubProcess Description 'en-US'");
    }
        ...
        for (Execution execution : executions) {
            if (execution.getParentId() == null) {
                assertThat(processInstance.getId())
                    .isNotEqualTo(execution.getProcessInstanceId());
            } else if (
                execution.getParentId().equals(execution.getProcessInstanceId())
            ) {
                assertThat(execution.getActivityId())
                    .isEqualTo("embeddedSubprocess");
            } else {
                fail();
            }
        }
    ...
    public void testExecutionQueryParentProcessInstanceIdResultMapping()
        throws Exception {
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey(
            "subProcessQueryTest"
        );
        ...
        for (Execution execution : executions) {
            ...
            assertThat(execution.getParentProcessInstanceId())
                .isEqualTo(processInstance.getId());
        }
    }
}
