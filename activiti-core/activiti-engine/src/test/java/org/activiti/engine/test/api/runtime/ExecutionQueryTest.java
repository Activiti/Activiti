...
public class ExecutionQueryTest extends PluggableActivitiTestCase {
  ...
  private static String CONCURRENT_PROCESS_CATEGORY =
      "org.activiti.enginge.test.api.runtime.concurrent.Category";
  private static String SEQUENTIAL_PROCESS_CATEGORY =
  ...
  protected void setUp() throws Exception {
    ...
    for (int i = 0; i < 4; i++) {
      concurrentProcessInstanceIds.add(
          runtimeService
              .startProcessInstanceByKey(CONCURRENT_PROCESS_KEY, "BUSINESS-KEY-" + i)
              .getId());
    }
  ...
  public void testQueryByProcessDefinitionKeyIn() {
    ...
    assertThat(runtimeService.createExecutionQuery().processDefinitionKeys(includeIds).list())
        .hasSize(14);
  ...
  public void testQueryByProcessDefinitionCategory() {
    ...
    assertThat(
            runtimeService
                .createExecutionQuery()
                .processDefinitionCategory(CONCURRENT_PROCESS_CATEGORY)
                .list())
        .hasSize(12);
    assertThat(
            runtimeService
                .createExecutionQuery()
                .processDefinitionCategory(SEQUENTIAL_PROCESS_CATEGORY)
                .list())
        .hasSize(2);
  }
  ...
  public void testQueryByInvalidProcessDefinitionCategory() {
    ExecutionQuery query =
        runtimeService.createExecutionQuery().processDefinitionCategory("invalid");
    assertThat(query.singleResult()).isNull();
    assertThat(query.list()).hasSize(0);
    assertThat(query.count()).isEqualTo(0);
  }
  ...
  public void testQueryByProcessDefinitionName() {
    ...
    assertThat(
            runtimeService
                .createExecutionQuery()
                .processDefinitionName(CONCURRENT_PROCESS_NAME)
                .list())
        .hasSize(12);
    assertThat(
            runtimeService
                .createExecutionQuery()
                .processDefinitionName(SEQUENTIAL_PROCESS_NAME)
                .list())
        .hasSize(2);
  }
  ...
  public void testQueryByProcessInstanceId() {
    ...
    assertThat(
            runtimeService
                .createExecutionQuery()
                .processInstanceId(sequentialProcessInstanceIds.get(0))
                .list())
        .hasSize(2);
  }
  ...
  public void testQueryByRootProcessInstanceId() {
    for (String processInstanceId : concurrentProcessInstanceIds) {
      ExecutionQuery query =
          runtimeService.createExecutionQuery().rootProcessInstanceId(processInstanceId);
      assertThat(query.list()).hasSize(3);
      assertThat(query.count()).isEqualTo(3);
    }
    assertThat(
            runtimeService
                .createExecutionQuery()
                .rootProcessInstanceId(sequentialProcessInstanceIds.get(0))
                .list())
        .hasSize(2);
  }
  ...
  public void testQueryExecutionId() {
    List<Execution> executions =
        runtimeService.createExecutionQuery().processDefinitionKey(SEQUENTIAL_PROCESS_KEY).list();
  ...
  public void testQuerySorting() {
    ...
    assertThat(runtimeService.createExecutionQuery().orderByProcessInstanceId().asc().list())
        .hasSize(14);
    assertThat(runtimeService.createExecutionQuery().orderByProcessDefinitionId().asc().list())
        .hasSize(14);
    assertThat(runtimeService.createExecutionQuery().orderByProcessDefinitionKey().asc().list())
        .hasSize(14);

    assertThat(runtimeService.createExecutionQuery().orderByProcessInstanceId().desc().list())
        .hasSize(14);
    assertThat(runtimeService.createExecutionQuery().orderByProcessDefinitionId().desc().list())
        .hasSize(14);
    assertThat(runtimeService.createExecutionQuery().orderByProcessDefinitionKey().desc().list())
        .hasSize(14);
  ...
  public void testQueryStringVariable() {
    ...
    ExecutionQuery query =
        runtimeService.createExecutionQuery().variableValueEquals("stringVar", "abcdef");
    ...
    executions =
        runtimeService.createExecutionQuery().variableValueLessThan("stringVar", "abcdeg").list();
    assertThat(executions).hasSize(2);
    List<String> expectedIds = asList(processInstance1.getId(), processInstance2.getId());
    List<String> ids =
        new ArrayList<String>(asList(executions.get(0).getId(), executions.get(1).getId()));
    ...
    execution =
        runtimeService.createExecutionQuery().variableValueLike("stringVar", "%y").singleResult();
    assertThat(execution).isNotNull();
    assertThat(execution.getId()).isEqualTo(processInstance3.getId());
    ...
    assertThat(runtimeService.createExecutionQuery().variableValueLike("stringVar", "a%").count())
        .isEqualTo(3);
    assertThat(runtimeService.createExecutionQuery().variableValueLike("stringVar", "%x%").count())
        .isEqualTo(0);
  ...
  public void testQueryLike() {
    ...
    Execution execution =
        runtimeService.createExecutionQuery().variableValueLike("var1", "aa%").singleResult();
    assertThat(execution).isNotNull();
    assertThat(execution.getId()).isEqualTo(processInstance1.getId());

    execution =
        runtimeService.createExecutionQuery().variableValueLike("var2", "bb%").singleResult();
    assertThat(execution).isNotNull();
    assertThat(execution.getId()).isEqualTo(processInstance1.getId());
    ...
    assertThatExceptionOfType(ActivitiIllegalArgumentException.class)
        .isThrownBy(
            () ->
                runtimeService
                    .createExecutionQuery()
                    .variableValueLike(null, "abcdefg")
                    .singleResult())
        .withMessageContaining("name is null");
  }
  ...
  public void testQueryLikeIgnoreCase() {
    ...
    execution =
        runtimeService
            .createExecutionQuery()
            .variableValueLikeIgnoreCase("lower", "abcd%")
            .singleResult();
    assertThat(execution).isNotNull();
    assertThat(execution.getId()).isEqualTo(processInstance1.getId());
  ...
  public void testQueryLongVariable() {
    ...
    ExecutionQuery query =
        runtimeService.createExecutionQuery().variableValueEquals("longVar", 12345L);
    List<Execution> executions = query.list();
    assertThat(executions).isNotNull();
    assertThat(executions).hasSize(2);
    ...
    execution =
        runtimeService.createExecutionQuery().variableValueEquals("longVar", 999L).singleResult();
    assertThat(execution).isNull();
    ...
    assertThat(
        ...
        .isEqualTo(0);
    assertThat(
            runtimeService.createExecutionQuery().variableValueGreaterThan("longVar", 1L).count())
        .isEqualTo(3);
    ...
    // Test LESS_THAN
    executions =
        runtimeService.createExecutionQuery().variableValueLessThan("longVar", 55555L).list();
    assertThat(executions).hasSize(2);
    ...
    assertThat(
            runtimeService.createExecutionQuery().variableValueLessThan("longVar", 12345L).count())
        .isEqualTo(0);
    assertThat(
            runtimeService.createExecutionQuery().variableValueLessThan("longVar", 66666L).count())
        .isEqualTo(3);
  ...
  public void testQueryDoubleVariable() {
    ...
    ExecutionQuery query =
        runtimeService.createExecutionQuery().variableValueEquals("doubleVar", 12345.6789);
    List<Execution> executions = query.list();
    assertThat(executions).isNotNull();
    assertThat(executions).hasSize(2);
    ...
    // Test LESS_THAN
    executions =
        runtimeService.createExecutionQuery().variableValueLessThan("doubleVar", 55555.5555).list();
    assertThat(executions).hasSize(2);
    ...
    // Test value-only matching
    execution =
        runtimeService.createExecutionQuery().variableValueEquals(55555.5555).singleResult();
    assertThat(execution).isNotNull();
    assertThat(execution.getId()).isEqualTo(processInstance3.getId());
  ...
  public void testQueryIntegerVariable() {
    ...
    ExecutionQuery query =
        runtimeService.createExecutionQuery().variableValueEquals("integerVar", 12345);
    List<Execution> executions = query.list();
    assertThat(executions).isNotNull();
    assertThat(executions).hasSize(2);
    ...
    assertThat(
        ...
        .isEqualTo(0);
    assertThat(
            runtimeService.createExecutionQuery().variableValueGreaterThan("integerVar", 1).count())
        .isEqualTo(3);
    ...
    // Test LESS_THAN
    executions =
        runtimeService.createExecutionQuery().variableValueLessThan("integerVar", 55555).list();
    assertThat(executions).hasSize(2);
  ...
  public void testQueryShortVariable() {
    ...
    ExecutionQuery query =
        runtimeService.createExecutionQuery().variableValueEquals("shortVar", shortVar);
    List<Execution> executions = query.list();
    assertThat(executions).isNotNull();
    assertThat(executions).hasSize(2);
    ...
    // Test value-only matching
    execution =
        runtimeService.createExecutionQuery().variableValueEquals((short) 5555).singleResult();
    assertThat(execution).isNotNull();
    assertThat(execution.getId()).isEqualTo(processInstance3.getId());
    ...
    execution =
        runtimeService.createExecutionQuery().variableValueEquals((short) 999).singleResult();
    assertThat(execution).isNull();
  ...
  public void testQueryDateVariable() throws Exception {
    ...
    // Query on single short variable, should result in 2 matches
    ExecutionQuery query =
        runtimeService.createExecutionQuery().variableValueEquals("dateVar", date1);
    List<Execution> executions = query.list();
    assertThat(executions).isNotNull();
    assertThat(executions).hasSize(2);
    ...
    assertThat(
            runtimeService.createExecutionQuery().variableValueLessThan("dateVar", date1).count())
        .isEqualTo(0);
    assertThat(
            runtimeService
                .createExecutionQuery()
  ...
  public void testBooleanVariable() throws Exception {
    ...
    // Test value-only matching
    Execution execution =
        runtimeService.createExecutionQuery().variableValueEquals(true).singleResult();
    assertThat(execution).isNotNull();
    assertThat(execution.getId()).isEqualTo(processInstance1.getId());
  ...
  public void testQueryNullVariable() throws Exception {
    ...
    ExecutionQuery query =
        runtimeService.createExecutionQuery().variableValueEquals("nullVar", null);
    List<Execution> executions = query.list();
    assertThat(executions).isNotNull();
    ...
    assertThat(
            runtimeService.createExecutionQuery().variableValueNotEquals("nullVar", null).count())
        .isEqualTo(1);
    assertThat(
            runtimeService
                .createExecutionQuery()
    ...
    // Test value-only matching
    Execution execution =
        runtimeService.createExecutionQuery().variableValueEquals(null).singleResult();
    assertThat(execution).isNotNull();
    assertThat(execution.getId()).isEqualTo(processInstance1.getId());
  ...
  public void testQueryBySignalSubscriptionName() {
    ...
    Execution execution =
        runtimeService.createExecutionQuery().signalEventSubscriptionName("alert").singleResult();
    assertThat(execution).isNotNull();
    ...
    runtimeService.startProcessInstanceByKey("catchSignal");
    assertThat(runtimeService.createExecutionQuery().signalEventSubscriptionName("alert").count())
        .isEqualTo(2);
  }
  ...
  public void testExecutionQueryWithProcessVariable() {
    ...
    List<Execution> concurrentExecutions =
  ...
  public void testLocalizeExecution() throws Exception {
    ProcessInstance processInstance =
        runtimeService.startProcessInstanceByKey("executionLocalization");
    ...
    dynamicBpmnService.changeLocalizationName(
        "en-GB", "executionLocalization", "Process Name 'en-GB'", infoNode);
    dynamicBpmnService.changeLocalizationDescription(
        "en-GB", "executionLocalization", "Process Description 'en-GB'", infoNode);
    dynamicBpmnService.saveProcessDefinitionInfo(
        processInstance.getProcessDefinitionId(), infoNode);

    dynamicBpmnService.changeLocalizationName(
        "en", "executionLocalization", "Process Name 'en'", infoNode);
    dynamicBpmnService.changeLocalizationDescription(
        "en", "executionLocalization", "Process Description 'en'", infoNode);

    dynamicBpmnService.changeLocalizationName(
        "en-GB", "subProcess", "SubProcess Name 'en-GB'", infoNode);
    dynamicBpmnService.changeLocalizationDescription(
        "en-GB", "subProcess", "SubProcess Description 'en-GB'", infoNode);

    dynamicBpmnService.changeLocalizationName("en", "subProcess", "SubProcess Name 'en'", infoNode);
    dynamicBpmnService.changeLocalizationDescription(
        "en", "subProcess", "SubProcess Description 'en'", infoNode);
    ...
    Execution execution =
        runtimeService.createExecutionQuery().executionId(processInstance.getId()).singleResult();
    assertThat(execution.getName()).isNull();
    assertThat(execution.getDescription()).isNull();
    ...
    execution =
        runtimeService.createExecutionQuery().executionId(subProcessId).locale("es").singleResult();
    assertThat(execution.getName()).isEqualTo("Nombre Subproceso");
    assertThat(execution.getDescription()).isEqualTo("Subproceso Descripción");
    ...
    dynamicBpmnService.changeLocalizationName(
        "en-US", "executionLocalization", "Process Name 'en-US'", infoNode);
    dynamicBpmnService.changeLocalizationDescription(
        "en-US", "executionLocalization", "Process Description 'en-US'", infoNode);
    dynamicBpmnService.saveProcessDefinitionInfo(
        processInstance.getProcessDefinitionId(), infoNode);

    dynamicBpmnService.changeLocalizationName(
        "en-US", "subProcess", "SubProcess Name 'en-US'", infoNode);
    dynamicBpmnService.changeLocalizationDescription(
        "en-US", "subProcess", "SubProcess Description 'en-US'", infoNode);
  ...
  public void testQueryStartedBefore() throws Exception {
    ...
    List<Execution> executions =
        runtimeService.createExecutionQuery().startedBefore(hourLater).list();
  ...
  public void testQueryStartedAfter() throws Exception {
    ...
    List<Execution> executions =
        runtimeService.createExecutionQuery().startedAfter(hourEarlier).list();
  ...
  public void testQueryStartedBy() throws Exception {
    ...
    List<Execution> executions =
        runtimeService.createExecutionQuery().startedBy(authenticatedUser).list();
  ...
  public void testOnlySubProcessExecutions() throws Exception {
    ProcessInstance processInstance =
        runtimeService.startProcessInstanceByKey("multipleSubProcessTest");

    List<Execution> executions =
        runtimeService.createExecutionQuery().onlySubProcessExecutions().list();
    assertThat(executions).hasSize(2);
    for (Execution execution : executions) {
      if (execution.getParentId() == null) {
