...
public class HistoricTaskInstanceTest extends PluggableActivitiTestCase {
    ...
    public void testHistoricTaskInstanceQuery() throws Exception {
        ...
        assertThat(historyService.createHistoricTaskInstanceQuery().taskNameLike("%unexistingname%").count()).isEqualTo(
            0
        );
        ...
        assertThat(historyService.createHistoricTaskInstanceQuery().taskDueDate(anHourAgo.getTime()).count()).isEqualTo(
            0
        );
        assertThat(
        ...
        // Start date
        assertThat(historyService.createHistoricTaskInstanceQuery().taskCreatedOn(start.getTime()).count()).isEqualTo(
            1
        );
        assertThat(
    ...
    public void testHistoricTaskInstanceOrQuery() throws Exception {
        ...
        // Task priority
        assertThat(historyService.createHistoricTaskInstanceQuery().or().taskPriority(1234).endOr().count()).isEqualTo(
            1
        );
        assertThat(historyService.createHistoricTaskInstanceQuery().or().taskPriority(5678).endOr().count()).isEqualTo(
            0
        );
    ...
    public void testHistoricTaskInstanceQuerySorting() {
        ...
        assertThat(historyService.createHistoricTaskInstanceQuery().orderByProcessInstanceId().asc().count()).isEqualTo(
            1
        );
        assertThat(historyService.createHistoricTaskInstanceQuery().orderByTaskDescription().asc().count()).isEqualTo(
            1
        );
        assertThat(historyService.createHistoricTaskInstanceQuery().orderByTaskName().asc().count()).isEqualTo(1);
        assertThat(historyService.createHistoricTaskInstanceQuery().orderByTaskDefinitionKey().asc().count()).isEqualTo(
            1
        );
        ...
        assertThat(historyService.createHistoricTaskInstanceQuery().orderByTaskCreateTime().desc().count()).isEqualTo(
            1
        );
        assertThat(
        ...
        assertThat(historyService.createHistoricTaskInstanceQuery().orderByTaskDescription().desc().count()).isEqualTo(
            1
        );
