...
public class HistoricTaskInstanceTest extends PluggableActivitiTestCase {
    ...
    public void testHistoricTaskInstance() throws Exception {
        ...
        String processInstanceId =
                runtimeService
                        .startProcessInstanceByKey("HistoricTaskInstanceTest", varMap)
                        .getId();
    ...
    public void testHistoricTaskInstanceQuery() throws Exception {
        ...
        assertThat(
                        historyService
                                .createHistoricTaskInstanceQuery()
                                .taskAssigneeLike("kermi%")
                                .count())
                .isEqualTo(1);
        assertThat(
                        historyService
                                .createHistoricTaskInstanceQuery()
                                .taskAssigneeLike("%ermi%")
                                .count())
                .isEqualTo(1);
        assertThat(
                        historyService
        ...
        assertThat(historyService.createHistoricTaskInstanceQuery().finished().count())
                .isEqualTo(1);
        assertThat(historyService.createHistoricTaskInstanceQuery().unfinished().count())
                .isEqualTo(1);
    }
                ...
                .satisfies(
                        ae ->
                                assertThat(ae.getObjectClass())
                                        .isEqualTo(HistoricTaskInstance.class));
    }
