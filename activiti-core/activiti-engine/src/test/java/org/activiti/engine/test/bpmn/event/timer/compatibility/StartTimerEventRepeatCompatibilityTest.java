...
public class StartTimerEventRepeatCompatibilityTest extends TimerEventCompatibilityTest {
    ...
    public void testCycleDateStartTimerEvent() throws Exception {
        ...
        // AFTER DEPLOYMENT
        // when the process is deployed there will be created a timerStartEvent job which will wait
        // to
        // be executed.
        ...
        try {
            ...
            fail(
                    "Because the maximum number of repeats is reached it will not be executed other"
                            + " jobs");
        }
        ...
        // let's complete the userTasks where the process is hanging in order to complete the
        // processes.
