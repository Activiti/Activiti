...
public class StartTimerEventRepeatCompatibilityTest extends TimerEventCompatibilityTest {
    ...
    public void testCycleDateStartTimerEvent() throws Exception {
        ...
        try {
            ...
            fail(
                "Because the maximum number of repeats is reached it will not be executed other jobs");
        }
        ...
        assertThat(eventCreatedCount).isEqualTo(
            20); // 20 job entities created, 2 per job (timer and executable job)
        assertThat(eventDeletedCount).isEqualTo(
            20); // 20 jobs entities deleted, 2 per job (timer and executable job)
