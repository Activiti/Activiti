...
public class AsyncExclusiveJobsTest extends PluggableActivitiTestCase {
    ...
    public void testExclusiveJobs() {
        ...
        if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.AUDIT)) {
            ...
            HistoricActivityInstance scriptTaskAInstance = historyService.createHistoricActivityInstanceQuery()
                .activityId("scriptTaskA").singleResult();
            HistoricActivityInstance scriptTaskBInstance = historyService.createHistoricActivityInstanceQuery()
                .activityId("scriptTaskB").singleResult();
            ...
            assertThat(
                endTimeDifference > 6000).isTrue(); // > 6000 -> jobs were executed in parallel
        }
