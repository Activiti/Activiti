...
public class AsyncExclusiveJobsTest extends PluggableActivitiTestCase {
    ...
    public void testExclusiveJobs() {
        ...
        if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.AUDIT)) {
            ...
            // They should be executed with at least 6 seconds in between (as they both sleep for 6
            // seconds)
            runtimeService.startProcessInstanceByKey("testExclusiveJobs");
            waitForJobExecutorToProcessAllJobs(20000L, 500L);

            HistoricActivityInstance scriptTaskAInstance =
                    historyService
                            .createHistoricActivityInstanceQuery()
                            .activityId("scriptTaskA")
                            .singleResult();
            HistoricActivityInstance scriptTaskBInstance =
                    historyService
                            .createHistoricActivityInstanceQuery()
            ...
            assertThat(endTimeDifference > 6000)
                    .isTrue(); // > 6000 -> jobs were executed in parallel
        }
    }
}
