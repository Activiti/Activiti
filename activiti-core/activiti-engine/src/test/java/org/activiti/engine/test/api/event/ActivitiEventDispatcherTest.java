...
public abstract class ActivitiEventDispatcherTest extends PluggableActivitiTestCase {
    ...
    public void addAndRemoveEventListenerAllEvents() throws Exception {
        ...
        ActivitiEntityEventImpl event2 = new ActivitiEntityEventImpl(
            processEngineConfiguration.getTaskEntityManager().create(),
            ActivitiEventType.ENTITY_CREATED);
    ...
    /**
     * Test adding a listener and check if events are sent to it, for the types it was registered
     * for. Also checks that after removal, no events are received.
     */
    public void addAndRemoveEventListenerTyped() throws Exception {
        ...
        // Add event-listener to dispatcher
        dispatcher.addEventListener(newListener, ActivitiEventType.ENTITY_CREATED,
        ...
        ActivitiEntityEventImpl event2 = new ActivitiEntityEventImpl(
            processEngineConfiguration.getTaskEntityManager().create(),
            ActivitiEventType.ENTITY_DELETED);
        ActivitiEntityEventImpl event3 = new ActivitiEntityEventImpl(
            processEngineConfiguration.getTaskEntityManager().create(),
    ...
    public void baseEntityEventListener() throws Exception {
        ...
        ActivitiEntityEventImpl createEvent = new ActivitiEntityEventImpl(
            processEngineConfiguration.getTaskEntityManager().create(),
            ActivitiEventType.ENTITY_CREATED);
        ActivitiEntityEventImpl deleteEvent = new ActivitiEntityEventImpl(
            processEngineConfiguration.getTaskEntityManager().create(),
            ActivitiEventType.ENTITY_DELETED);
        ActivitiEntityEventImpl updateEvent = new ActivitiEntityEventImpl(
            processEngineConfiguration.getTaskEntityManager().create(),
            ActivitiEventType.ENTITY_UPDATED);
        ActivitiEntityEventImpl otherEvent = new ActivitiEntityEventImpl(
        ...
        ActivitiEntityEventImpl createEventForExecution = new ActivitiEntityEventImpl(
            new ExecutionEntityImpl(), ActivitiEventType.ENTITY_CREATED);
     ...
     * configuration of process-engine {@link ProcessEngineConfigurationImpl#setTypedEventListeners(java.util.Map)}
     * .
     */
