...
public class ExecutionListenerOnTransactionTest extends PluggableActivitiTestCase {
    ...
    public void testOnClosedExecutionListenersWithRollback() {
        ...
        assertThat(currentActivities.get(0).getProcessInstanceId()).isEqualTo(
    ...
    public void testOnClosedExecutionListenersWithExecutionVariables() {
        ...
        assertThat(currentActivities.get(1).getExecutionVariables()
            .get("injectedExecutionVariable")).isEqualTo("test1");
        ...
        assertThat(currentActivities.get(2).getExecutionVariables()
            .get("injectedExecutionVariable")).isEqualTo("test2");
    }
    ...
    public void testOnClosedExecutionListenersWithCustomPropertiesResolver() {
        ...
        assertThat(currentActivities.get(0).getCustomPropertiesMap().get("customProp1")).isEqualTo(
            "serviceTask1");
    }
