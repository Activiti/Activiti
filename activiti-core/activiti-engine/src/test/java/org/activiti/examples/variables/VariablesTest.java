...
public class VariablesTest extends PluggableActivitiTestCase {
    ...
    public void testBasicVariableOperations() {
        ...
        assertThat(variables.get("longString2000chars")).isEqualTo(
            long2000StringBuilder.toString());
        ...
        runtimeService.setVariable(processInstance.getId(), "longString2000chars",
            long2001StringBuilder.toString());
        runtimeService.setVariable(processInstance.getId(), "longString4000chars",
            long4001StringBuilder.toString());
        ...
        assertThat(variables.get("longString2000chars")).isEqualTo(
            long2001StringBuilder.toString());
        assertThat(variables.get("longString4000chars")).isEqualTo(
            long4001StringBuilder.toString());
        assertThat(variables.get("dateVar")).isEqualTo(now);
        assertThat(variables.get("nullVar")).isEqualTo(null);
        assertThat(variables.get("serializableVar")).isEqualTo(serializable);
        ...
        Map<String, Object> filteredVariables = runtimeService.getVariables(processInstance.getId(),
            varFilter);
    ...
    public void testLocalizeVariables() {
        ...
        variableInstances = runtimeService.getVariableInstances(processInstance.getId(),
            variableNames);
        assertThat(variableInstances).hasSize(1);
        assertThat(variableInstances.get("stringVar").getName()).isEqualTo("stringVar");
        assertThat(variableInstances.get("stringVar").getValue()).isEqualTo("coca-cola");
        ...
        variableInstances = runtimeService.getVariableInstancesLocal(processInstance.getId(),
            variableNames);
        assertThat(variableInstances).hasSize(1);
        assertThat(variableInstances.get("stringVar").getName()).isEqualTo("stringVar");
        assertThat(variableInstances.get("stringVar").getValue()).isEqualTo("coca-cola");
        ...
        // getVariableInstance
        VariableInstance variableInstance = runtimeService.getVariableInstance(
            processInstance.getId(), "stringVar");
        ...
        variableInstance = runtimeService.getVariableInstanceLocal(processInstance.getId(),
            "stringVar");
        assertThat(variableInstance).isNotNull();
        assertThat(variableInstance.getName()).isEqualTo("stringVar");
        assertThat(variableInstance.getValue()).isEqualTo("coca-cola");
    ...
    public void testLocalizeDataObjects() {
        ...
        dynamicBpmnService.changeLocalizationName("en-US", "stringVarId", "stringVar 'en-US' Name",
            infoNode);
        dynamicBpmnService.changeLocalizationDescription("en-US", "stringVarId",
            "stringVar 'en-US' Description", infoNode);
        dynamicBpmnService.changeLocalizationName("en-AU", "stringVarId", "stringVar 'en-AU' Name",
            infoNode);
        dynamicBpmnService.changeLocalizationDescription("en-AU", "stringVarId",
            "stringVar 'en-AU' Description", infoNode);
        dynamicBpmnService.changeLocalizationName("en", "stringVarId", "stringVar 'en' Name",
            infoNode);
        dynamicBpmnService.changeLocalizationDescription("en", "stringVarId",
            "stringVar 'en' Description", infoNode);

        dynamicBpmnService.changeLocalizationName("en-US", "intVarId", "intVar 'en-US' Name",
            infoNode);
        dynamicBpmnService.changeLocalizationDescription("en-US", "intVarId",
            "intVar 'en-US' Description", infoNode);
        dynamicBpmnService.changeLocalizationName("en-AU", "intVarId", "intVar 'en-AU' Name",
            infoNode);
        dynamicBpmnService.changeLocalizationDescription("en-AU", "intVarId",
            "intVar 'en-AU' Description", infoNode);
        dynamicBpmnService.changeLocalizationName("en", "intVarId", "intVar 'en' Name", infoNode);
        dynamicBpmnService.changeLocalizationDescription("en", "intVarId",
            "intVar 'en' Description", infoNode);
        ...
        assertThat(dataObjects.get("stringVar").getLocalizedName()).isEqualTo(
            "stringVar 'es' Name");
        assertThat(dataObjects.get("stringVar").getDescription()).isEqualTo(
            "stringVar 'es' Description");
        assertThat(dataObjects.get("stringVar").getDataObjectDefinitionKey()).isEqualTo(
            "stringVarId");
        ...
        assertThat(dataObjects.get("stringVar").getValue()).isEqualTo("coca-cola");
        assertThat(dataObjects.get("stringVar").getLocalizedName()).isEqualTo(
            "stringVar 'en-US' Name");
        assertThat(dataObjects.get("stringVar").getDescription()).isEqualTo(
            "stringVar 'en-US' Description");
        assertThat(dataObjects.get("stringVar").getDataObjectDefinitionKey()).isEqualTo(
            "stringVarId");
        assertThat(dataObjects.get("stringVar").getType()).isEqualTo("string");
        ...
        assertThat(dataObjects.get("stringVar").getValue()).isEqualTo("coca-cola");
        assertThat(dataObjects.get("stringVar").getLocalizedName()).isEqualTo(
            "stringVar 'en-AU' Name");
        assertThat(dataObjects.get("stringVar").getDescription()).isEqualTo(
            "stringVar 'en-AU' Description");
        assertThat(dataObjects.get("stringVar").getDataObjectDefinitionKey()).isEqualTo(
            "stringVarId");
        assertThat(dataObjects.get("stringVar").getType()).isEqualTo("string");
        ...
        dataObjects = runtimeService.getDataObjects(processInstance.getId(), variableNames, "en-US",
            false);
        assertThat(dataObjects).hasSize(1);
        assertThat(dataObjects.get("stringVar").getName()).isEqualTo("stringVar");
        assertThat(dataObjects.get("stringVar").getValue()).isEqualTo("coca-cola");
        ...
        dataObjects = runtimeService.getDataObjects(processInstance.getId(), variableNames, "en-AU",
            false);
        assertThat(dataObjects).hasSize(1);
        assertThat(dataObjects.get("stringVar").getName()).isEqualTo("stringVar");
        assertThat(dataObjects.get("stringVar").getValue()).isEqualTo("coca-cola");
        ...
        dataObjects = runtimeService.getDataObjects(processInstance.getId(), variableNames, "en-GB",
            true);
        assertThat(dataObjects).hasSize(1);
        assertThat(dataObjects.get("stringVar").getName()).isEqualTo("stringVar");
        assertThat(dataObjects.get("stringVar").getValue()).isEqualTo("coca-cola");
        ...
        // getDataObject
        DataObject dataObject = runtimeService.getDataObject(processInstance.getId(), "stringVar",
            "en-GB", false);
        ...
        dataObject = runtimeService.getDataObject(processInstance.getId(), "stringVar", "en-US",
            false);
        assertThat(dataObject).isNotNull();
        assertThat(dataObject.getName()).isEqualTo("stringVar");
        assertThat(dataObject.getValue()).isEqualTo("coca-cola");
        ...
        dataObject = runtimeService.getDataObject(processInstance.getId(), "stringVar", "en-AU",
            false);
        assertThat(dataObject).isNotNull();
        assertThat(dataObject.getName()).isEqualTo("stringVar");
        assertThat(dataObject.getValue()).isEqualTo("coca-cola");
        ...
        dataObject = runtimeService.getDataObject(processInstance.getId(), "stringVar", "en-GB",
            true);
        assertThat(dataObject).isNotNull();
        assertThat(dataObject.getName()).isEqualTo("stringVar");
        assertThat(dataObject.getValue()).isEqualTo("coca-cola");
        ...
        // getDataObjectLocal
        dataObject = runtimeService.getDataObjectLocal(processInstance.getId(), "stringVar",
            "en-US", false);
        assertThat(dataObject).isNotNull();
        assertThat(dataObject.getName()).isEqualTo("stringVar");
        assertThat(dataObject.getValue()).isEqualTo("coca-cola");
        ...
        assertThat(dataObjects.get("intVar").getDescription()).isEqualTo(
            "intVar 'en-US' Description");
        assertThat(dataObjects.get("stringVar").getDataObjectDefinitionKey()).isEqualTo(
            "stringVarId");
        ...
        dataObjects = runtimeService.getDataObjects(subprocess.getId(), variableNames, "en-US",
            false);
        assertThat(dataObjects).hasSize(2);
        assertThat(dataObjects.get("stringVar").getName()).isEqualTo("stringVar");
        assertThat(dataObjects.get("stringVar").getValue()).isEqualTo("coca-cola");
        ...
        dataObjects = runtimeService.getDataObjects(subprocess.getId(), variableNames, "en-AU",
            false);
        assertThat(dataObjects).hasSize(2);
        assertThat(dataObjects.get("stringVar").getName()).isEqualTo("stringVar");
        assertThat(dataObjects.get("stringVar").getValue()).isEqualTo("coca-cola");
        ...
        dataObjects = runtimeService.getDataObjects(subprocess.getId(), variableNames, "en-GB",
            true);
        assertThat(dataObjects).hasSize(2);
        assertThat(dataObjects.get("stringVar").getName()).isEqualTo("stringVar");
        assertThat(dataObjects.get("stringVar").getValue()).isEqualTo("coca-cola");
        ...
        // getDataObjectsLocal via names
        dataObjects = runtimeService.getDataObjectsLocal(subprocess.getId(), variableNames, "en-US",
            false);
        assertThat(dataObjects).hasSize(1);
        assertThat(dataObjects.get("intVar").getName()).isEqualTo("intVar");
        assertThat(dataObjects.get("intVar").getValue()).isEqualTo(null);
        ...
        dataObjects = runtimeService.getDataObjectsLocal(subprocess.getId(), variableNames, "en-AU",
            false);
        assertThat(dataObjects).hasSize(1);
        assertThat(dataObjects.get("intVar").getName()).isEqualTo("intVar");
        assertThat(dataObjects.get("intVar").getValue()).isEqualTo(null);
        ...
        dataObjects = runtimeService.getDataObjectsLocal(subprocess.getId(), variableNames, "en-GB",
            true);
        assertThat(dataObjects).hasSize(1);
        assertThat(dataObjects.get("intVar").getName()).isEqualTo("intVar");
        assertThat(dataObjects.get("intVar").getValue()).isEqualTo(null);
        ...
        dataObject = runtimeService.getDataObjectLocal(subprocess.getId(), "intVar", "en-US",
            false);
        assertThat(dataObject).isNotNull();
        assertThat(dataObject.getName()).isEqualTo("intVar");
        assertThat(dataObject.getValue()).isEqualTo(null);
        ...
        dataObject = runtimeService.getDataObjectLocal(subprocess.getId(), "intVar", "en-AU",
            false);
        assertThat(dataObject).isNotNull();
        assertThat(dataObject.getName()).isEqualTo("intVar");
        assertThat(dataObject.getValue()).isEqualTo(null);
        ...
        dataObject = runtimeService.getDataObjectLocal(subprocess.getId(), "intVar", "en-GB",
            false);
        assertThat(dataObject).isNotNull();
        assertThat(dataObject.getName()).isEqualTo("intVar");
        assertThat(dataObject.getValue()).isEqualTo(null);
    ...
    public void testChangeTypeSerializable() {
        ...
        SomeSerializable myVar = (SomeSerializable) runtimeService.getVariable(
            processInstance.getId(), "myVar");
    ...
    public String getVariableInstanceId(String executionId, String name) {
        HistoricVariableInstance variable = historyService.createHistoricVariableInstanceQuery()
            .processInstanceId(executionId).variableName(name).singleResult();
    ...
    public void testChangeVariableType() {
        ...
        if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.AUDIT)) {
            String oldSerializableVarId = getVariableInstanceId(processInstance.getId(),
                "serializableVar");
            ...
            String newSerializableVarId = getVariableInstanceId(processInstance.getId(),
                "serializableVar");
    ...
    public void testNullVariable() {
        ...
        String resultVar = (String) runtimeService.getVariable(processInstance.getId(),
            "testProperty");
        ...
        runtimeService.deleteProcessInstance(processInstance.getId(),
            "intentional exception in script task");
    ...
    public void testUUIDVariableAndQuery() {
        ...
        Task resultingTask = taskService.createTaskQuery()
            .taskVariableValueEquals("conversationId", randomUUID).singleResult();
