...
public class BoundaryErrorEventTest extends PluggableActivitiTestCase {
    ...
    public void testReviewSalesLeadProcess() {
        ...
        String procId = runtimeService.startProcessInstanceByKey("reviewSaledLead", variables)
            .getId();
        ...
        Task provideDetailsTask = taskService.createTaskQuery().taskAssignee("kermit")
            .singleResult();
