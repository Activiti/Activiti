...
public class TaskCandidateTest extends PluggableActivitiTestCase {
  ...
  public void testSingleCandidateGroup() {
    ...
    ProcessInstance processInstance =
        runtimeService.startProcessInstanceByKey("singleCandidateGroup");
  ...
  public void testMultipleCandidateGroups() {
    ...
    // Deploy and start process
    ProcessInstance processInstance =
        runtimeService.startProcessInstanceByKey("multipleCandidatesGroup");
    ...
    assertThat(
            taskService.createTaskQuery().taskCandidateUser(KERMIT, KERMITSGROUPS).list().isEmpty())
        .isTrue();
    assertThat(
            taskService.createTaskQuery().taskCandidateUser(GONZO, GONZOSGROUPS).list().isEmpty())
        .isTrue();
  ...
  public void testMultipleCandidateUsers() {
    runtimeService.startProcessInstanceByKey(
        "multipleCandidateUsersExample", singletonMap("Variable", (Object) "var"));
  ...
  public void testCandidateExpressionTwoParams() {
    ...
    runtimeService.startProcessInstanceByKey("candidateWithExpression", params);
    assertThat(taskService.createTaskQuery().taskCandidateUser(KERMIT, KERMITSGROUPS).count())
        .isEqualTo(1);
