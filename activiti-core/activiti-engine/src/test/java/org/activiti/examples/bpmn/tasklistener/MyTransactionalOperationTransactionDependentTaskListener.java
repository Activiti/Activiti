 ...
 *
 */
public class MyTransactionalOperationTransactionDependentTaskListener extends
    CurrentTaskTransactionDependentTaskListener {
    ...
    public void notify(String processInstanceId, String executionId, Task task,
        ...
        if (Context.getCommandContext().getProcessEngineConfiguration().getHistoryLevel()
            .isAtLeast(HistoryLevel.ACTIVITY)) {
            HistoryService historyService = Context.getCommandContext()
