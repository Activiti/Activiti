 ...
 * custom properties.
 */
public class CurrentTaskTransactionDependentTaskListener implements
    ...
    public void notify(String processInstanceId, String executionId, Task task,
        ...
        currentTasks.add(
            new CurrentTask(processInstanceId, executionId, task.getId(), task.getName(),
    ...
    public static class CurrentTask {
        ...
        public CurrentTask(String processInstanceId, String executionId, String taskId,
            String taskName, Map<String, Object> executionVariables,
