...
public class JavaServiceTaskTest extends PluggableActivitiTestCase {
    ...
    public void testJavaServiceDelegation() {
        ProcessInstance pi =
                runtimeService.startProcessInstanceByKey(
                        "javaServiceDelegation", singletonMap("input", "Activiti BPM Engine"));
        Execution execution =
                runtimeService
    ...
    public void testExpressionFieldInjection() {
        ...
        ProcessInstance pi =
                runtimeService.startProcessInstanceByKey("expressionFieldInjection", vars);
        Execution execution =
                runtimeService
                        .createExecutionQuery()
                        .processInstanceId(pi.getId())
    ...
    public void testGetBusinessKeyFromDelegateExecution() {
        ProcessInstance processInstance =
                runtimeService.startProcessInstanceByKey("businessKeyProcess", "1234567890");
        assertThat(
                        runtimeService
        ...
        String key =
                (String)
                        runtimeService.getVariable(
                                processInstance.getId(), "businessKeySetOnExecution");
