...
public class ExecutionListenerTest extends PluggableActivitiTestCase {
    ...
    public void testExecutionListenersOnAllPossibleElements() {
        ...
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey(
            "executionListenersProcess", "businessKey123");

        String varSetInExecutionListener = (String) runtimeService.getVariable(
            processInstance.getId(), "variableSetInExecutionListener");
    ...
    public void testExecutionListenersOnStartEndEvents() {
        ...
        assertThat(recordedEvents.get(1).getParameter()).isEqualTo(
            "Intermediate Catch Event Listener");
        ...
        assertThat(recordedEvents.get(2).getParameter()).isEqualTo(
            "Intermediate Throw Event Listener");
