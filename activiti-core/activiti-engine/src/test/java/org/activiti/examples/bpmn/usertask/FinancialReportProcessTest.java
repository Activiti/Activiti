...
public class FinancialReportProcessTest extends PluggableActivitiTestCase {
    ...
    @Deployment(
            resources = {"org/activiti/examples/bpmn/usertask/FinancialReportProcess.bpmn20.xml"})
    public void testProcess() {
        ...
        List<Task> tasks =
                taskService.createTaskQuery().taskCandidateUser("fozzie", FOZZIESGROUPS).list();
