 ...
 * custom properties.
 */
public class CurrentActivityTransactionDependentExecutionListener implements
    ...
    public void notify(String processInstanceId, String executionId, FlowElement currentFlowElement,
        ...
        currentActivities.add(
            new CurrentActivity(processInstanceId, executionId, currentFlowElement.getId(),
                currentFlowElement.getName(), executionVariables, customPropertiesMap));
    }
    ...
    public static class CurrentActivity {
        ...
        public CurrentActivity(String processInstanceId, String executionId, String activityId,
            String activityName, Map<String, Object> executionVariables,
