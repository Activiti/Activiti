...
public class ManagementServiceTest extends PluggableActivitiTestCase {
    ...
    public void testGetTableMetaData() {
        ...
        assertThat(tableMetaData.getColumnTypes().get(assigneeIndex)).isIn("VARCHAR", "NVARCHAR2",
            "nvarchar", "NVARCHAR");
        assertThat(tableMetaData.getColumnTypes().get(createTimeIndex)).isIn("TIMESTAMP",
