...
public class MockSupportWithActivitiRuleTest {
    ...
    public ActivitiRule activitiRule = new ActivitiRule() {
        ...
        protected void configureProcessEngine() {
            ...
            activitiRule.mockSupport().mockServiceTaskWithClassDelegate("com.yourcompany.delegate",
                ServiceTaskTestMock.class);
            activitiRule.mockSupport()
                .mockServiceTaskWithClassDelegate("com.yourcompany.anotherDelegate",
    ...
    public void testNoOpServiceTasksAnnotation() {
        ...
        for (int i = 1; i <= 5; i++) {
            assertThat(activitiRule.mockSupport().getExecutedNoOpServiceTaskDelegateClassNames()
                .get(i - 1)).isEqualTo("com.yourcompany.delegate" + i);
        }
    }
    ...
    @NoOpServiceTasks(ids = {"serviceTask1", "serviceTask3", "serviceTask5"}, classNames = {
    ...
    public void testNoOpServiceTasksWithIdsAnnotation() {
        ...
        for (int i = 1; i <= 5; i++) {
            assertThat(
                mockSupport.getExecutedNoOpServiceTaskDelegateClassNames().get(i - 1)).isEqualTo(
