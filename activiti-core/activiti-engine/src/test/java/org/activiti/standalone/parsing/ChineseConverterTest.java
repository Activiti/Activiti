...
public class ChineseConverterTest extends ResourceActivitiTestCase {
    ...
    protected BpmnModel readXMLFile() throws Exception {
        ...
        BpmnModel bpmnModel = new BpmnXMLConverter().convertToBpmnModel(xmlSource, false, false,
    ...
    protected BpmnModel exportAndReadXMLFile(BpmnModel bpmnModel) throws Exception {
        ...
        BpmnModel parsedModel = new BpmnXMLConverter().convertToBpmnModel(xmlSource, false, false,
            processEngineConfiguration.getXmlEncoding());
        return parsedModel;
    }
    ...
    protected void deployProcess(BpmnModel bpmnModel) {
        ...
        try {
            Deployment deployment = processEngine.getRepositoryService().createDeployment()
                .name("test").addString("test.bpmn20.xml", new String(xml)).deploy();
