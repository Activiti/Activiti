...
public class HistoricTaskQueryEscapeClauseTest extends AbstractEscapeClauseTestCase {
  ...
  public void testQueryByProcessDefinitionKeyLike() {
    if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.ACTIVITY)) {
      ...
      List<HistoricTaskInstance> list =
          historyService.createHistoricTaskInstanceQuery().processDefinitionKeyLike("%\\%%").list();
      assertThat(list).hasSize(0);

      list =
          historyService.createHistoricTaskInstanceQuery().processDefinitionKeyLike("%\\_%").list();
      assertThat(list).hasSize(0);
  ...
  public void testQueryByTaskDefinitionKeyLike() {
    if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.ACTIVITY)) {
      ...
      List<HistoricTaskInstance> list =
          historyService.createHistoricTaskInstanceQuery().taskDefinitionKeyLike("%\\%%").list();
      assertThat(list).hasSize(0);
