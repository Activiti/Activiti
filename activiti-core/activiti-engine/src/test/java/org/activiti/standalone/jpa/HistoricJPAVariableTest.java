...
public class HistoricJPAVariableTest extends AbstractActivitiTestCase {
    ...
    public void testGetJPAEntityAsHistoricVariable() {
        ...
        this.processInstanceId =
                runtimeService.startProcessInstanceByKey("JPAVariableProcess", variables).getId();
        ...
        HistoricVariableInstance historicVariableInstance =
                historyService
                        ...
                        .variableName("simpleEntityFieldAccess")
                        .singleResult();

        Object value = historicVariableInstance.getValue();
        assertThat(value).isInstanceOf(FieldAccessJPAEntity.class);
        assertThat(simpleEntityFieldAccess.getValue())
                .isEqualTo(((FieldAccessJPAEntity) value).getValue());
    }
    ...
    public void testGetJPAUpdateEntityAsHistoricLog() {
        ...
        for (Task task : taskService.createTaskQuery().includeProcessVariables().list()) {
            taskService.setVariable(
                    task.getId(), "simpleEntityFieldAccess", simpleEntityFieldAccess);
            taskService.complete(task.getId());
        }
