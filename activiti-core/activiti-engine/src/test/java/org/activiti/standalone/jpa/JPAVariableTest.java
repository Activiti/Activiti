...
public class JPAVariableTest extends AbstractActivitiTestCase {
    ...
    public void testStoreJPAEntityAsVariable() {
        ...
        assertThat(((PropertyAccessJPAEntity) propertyAccessResult).getId().longValue()).isEqualTo(
            1L);
        ...
        assertThat(
            ((SubclassFieldAccessJPAEntity) subclassFieldResult).getId().longValue()).isEqualTo(1L);
        assertThat(((SubclassFieldAccessJPAEntity) subclassFieldResult).getValue()).isEqualTo(
            "value3");
        ...
        assertThat(((SubclassPropertyAccessJPAEntity) subclassPropertyResult).getId()
            .longValue()).isEqualTo(1L);
        assertThat(((SubclassPropertyAccessJPAEntity) subclassPropertyResult).getValue()).isEqualTo(
            "value4");
        ...
        currentValue = runtimeService.getVariable(processInstance.getId(),
            "simpleEntityFieldAccess");
    ...
    public void testStoreJPAEntityAsVariableAllAllowedIdTypes() {
        ...
        assertThat(((ByteIdJPAEntity) byteIdResult).getByteId()).isEqualTo(
            byteIdJPAEntity.getByteId());
        ...
        assertThat(((ShortIdJPAEntity) shortIdResult).getShortId()).isEqualTo(
            shortIdJPAEntity.getShortId());
        ...
        assertThat(((IntegerIdJPAEntity) integerIdResult).getIntId()).isEqualTo(
            integerIdJPAEntity.getIntId());
        ...
        assertThat(((LongIdJPAEntity) longIdResult).getLongId()).isEqualTo(
            longIdJPAEntity.getLongId());
        ...
        assertThat(((FloatIdJPAEntity) floatIdResult).getFloatId()).isEqualTo(
            floatIdJPAEntity.getFloatId());
        ...
        assertThat(((DoubleIdJPAEntity) doubleIdResult).getDoubleId()).isEqualTo(
            doubleIdJPAEntity.getDoubleId());
        ...
        assertThat(((CharIdJPAEntity) charIdResult).getCharId()).isEqualTo(
            charIdJPAEntity.getCharId());
        ...
        assertThat(((StringIdJPAEntity) stringIdResult).getStringId()).isEqualTo(
            stringIdJPAEntity.getStringId());
        ...
        assertThat(((DateIdJPAEntity) dateIdResult).getDateId()).isEqualTo(
            dateIdJPAEntity.getDateId());
        ...
        assertThat(((SQLDateIdJPAEntity) sqlDateIdResult).getDateId()).isEqualTo(
            sqlDateIdJPAEntity.getDateId());
    ...
    public void testStoreJPAEntityListAsVariable() {
        ...
        // -----------------------------------------------------------------------------
        Map<String, Object> variables = new HashMap<String, Object>();
        variables.put("simpleEntityFieldAccess",
            asList(simpleEntityFieldAccess, simpleEntityFieldAccess, simpleEntityFieldAccess));
        variables.put("simpleEntityPropertyAccess",
            asList(simpleEntityPropertyAccess, simpleEntityPropertyAccess,
                simpleEntityPropertyAccess));
        variables.put("subclassFieldAccess",
            asList(subclassFieldAccess, subclassFieldAccess, subclassFieldAccess));
        variables.put("subclassPropertyAccess",
        ...
        assertThat(simpleEntityFieldAccess.getId()).isEqualTo(
            ((FieldAccessJPAEntity) list.get(0)).getId());
        ...
        assertThat(simpleEntityPropertyAccess.getId()).isEqualTo(
            ((PropertyAccessJPAEntity) list.get(0)).getId());
        ...
        assertThat(simpleEntityPropertyAccess.getId()).isEqualTo(
            ((SubclassFieldAccessJPAEntity) list.get(0)).getId());
    ...
    public void testStoreJPAEntityListAsVariableEdgeCases() {
        ...
        variablesForException.put("simpleEntityFieldAccess",
            asList(simpleEntityFieldAccess, simpleEntityPropertyAccess));

        assertThatExceptionOfType(ActivitiException.class)
            .isThrownBy(() -> runtimeService.startProcessInstanceByKey("JPAVariableProcess",
        ...
        assertThat(((List<?>) runtimeService.getVariable(processInstance.getId(), "list"))).hasSize(
            0);

        runtimeService.setVariable(processInstance.getId(), "list",
            asList(simpleEntityFieldAccess, simpleEntityFieldAccess));
        assertThat(((List<?>) runtimeService.getVariable(processInstance.getId(), "list"))).hasSize(
            2);
        assertThat(((List<?>) runtimeService.getVariable(processInstance.getId(), "list")).get(
            0)).isInstanceOf(FieldAccessJPAEntity.class);
