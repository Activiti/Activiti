...
public class JPAVariableTest extends AbstractActivitiTestCase {
    ...
    public void testStoreJPAEntityAsVariable() {
        ...
        Object fieldAccessResult =
                runtimeService.getVariable(processInstance.getId(), "simpleEntityFieldAccess");
        ...
        Object propertyAccessResult =
                runtimeService.getVariable(processInstance.getId(), "simpleEntityPropertyAccess");
        assertThat(propertyAccessResult).isInstanceOf(PropertyAccessJPAEntity.class);
        assertThat(((PropertyAccessJPAEntity) propertyAccessResult).getId().longValue())
                .isEqualTo(1L);
        ...
        Object subclassFieldResult =
                runtimeService.getVariable(processInstance.getId(), "subclassFieldAccess");
        assertThat(subclassFieldResult).isInstanceOf(SubclassFieldAccessJPAEntity.class);
        assertThat(((SubclassFieldAccessJPAEntity) subclassFieldResult).getId().longValue())
                .isEqualTo(1L);
        assertThat(((SubclassFieldAccessJPAEntity) subclassFieldResult).getValue())
                .isEqualTo("value3");

        // Read entity with @Id on property of mapped superclass
        Object subclassPropertyResult =
                runtimeService.getVariable(processInstance.getId(), "subclassPropertyAccess");
        assertThat(subclassPropertyResult).isInstanceOf(SubclassPropertyAccessJPAEntity.class);
        assertThat(((SubclassPropertyAccessJPAEntity) subclassPropertyResult).getId().longValue())
                .isEqualTo(1L);
        assertThat(((SubclassPropertyAccessJPAEntity) subclassPropertyResult).getValue())
                .isEqualTo("value4");
        ...
        runtimeService.setVariable(
                processInstance.getId(), "simpleEntityFieldAccess", simpleEntityFieldAccess);
        currentValue =
                runtimeService.getVariable(processInstance.getId(), "simpleEntityFieldAccess");
        assertThat(currentValue).isNotNull();
    ...
    public void testStoreJPAEntityAsVariableAllAllowedIdTypes() {
        ...
        // stored in the DB.
        ProcessInstance processInstanceAllTypes =
                runtimeService.startProcessInstanceByKey("JPAVariableProcess", variables);
        Object byteIdResult =
                runtimeService.getVariable(processInstanceAllTypes.getId(), "byteIdJPAEntity");
        assertThat(byteIdResult).isInstanceOf(ByteIdJPAEntity.class);
        assertThat(((ByteIdJPAEntity) byteIdResult).getByteId())
                .isEqualTo(byteIdJPAEntity.getByteId());

        Object shortIdResult =
                runtimeService.getVariable(processInstanceAllTypes.getId(), "shortIdJPAEntity");
        assertThat(shortIdResult).isInstanceOf(ShortIdJPAEntity.class);
        assertThat(((ShortIdJPAEntity) shortIdResult).getShortId())
                .isEqualTo(shortIdJPAEntity.getShortId());

        Object integerIdResult =
                runtimeService.getVariable(processInstanceAllTypes.getId(), "integerIdJPAEntity");
        assertThat(integerIdResult).isInstanceOf(IntegerIdJPAEntity.class);
        assertThat(((IntegerIdJPAEntity) integerIdResult).getIntId())
                .isEqualTo(integerIdJPAEntity.getIntId());

        Object longIdResult =
                runtimeService.getVariable(processInstanceAllTypes.getId(), "longIdJPAEntity");
        assertThat(longIdResult).isInstanceOf(LongIdJPAEntity.class);
        assertThat(((LongIdJPAEntity) longIdResult).getLongId())
                .isEqualTo(longIdJPAEntity.getLongId());

        Object floatIdResult =
                runtimeService.getVariable(processInstanceAllTypes.getId(), "floatIdJPAEntity");
        assertThat(floatIdResult).isInstanceOf(FloatIdJPAEntity.class);
        assertThat(((FloatIdJPAEntity) floatIdResult).getFloatId())
                .isEqualTo(floatIdJPAEntity.getFloatId());

        Object doubleIdResult =
                runtimeService.getVariable(processInstanceAllTypes.getId(), "doubleIdJPAEntity");
        assertThat(doubleIdResult).isInstanceOf(DoubleIdJPAEntity.class);
        assertThat(((DoubleIdJPAEntity) doubleIdResult).getDoubleId())
                .isEqualTo(doubleIdJPAEntity.getDoubleId());

        Object charIdResult =
                runtimeService.getVariable(processInstanceAllTypes.getId(), "charIdJPAEntity");
        assertThat(charIdResult).isInstanceOf(CharIdJPAEntity.class);
        assertThat(((CharIdJPAEntity) charIdResult).getCharId())
                .isEqualTo(charIdJPAEntity.getCharId());

        Object stringIdResult =
                runtimeService.getVariable(processInstanceAllTypes.getId(), "stringIdJPAEntity");
        assertThat(stringIdResult).isInstanceOf(StringIdJPAEntity.class);
        assertThat(((StringIdJPAEntity) stringIdResult).getStringId())
                .isEqualTo(stringIdJPAEntity.getStringId());

        Object dateIdResult =
                runtimeService.getVariable(processInstanceAllTypes.getId(), "dateIdJPAEntity");
        assertThat(dateIdResult).isInstanceOf(DateIdJPAEntity.class);
        assertThat(((DateIdJPAEntity) dateIdResult).getDateId())
                .isEqualTo(dateIdJPAEntity.getDateId());

        Object sqlDateIdResult =
                runtimeService.getVariable(processInstanceAllTypes.getId(), "sqlDateIdJPAEntity");
        assertThat(sqlDateIdResult).isInstanceOf(SQLDateIdJPAEntity.class);
        assertThat(((SQLDateIdJPAEntity) sqlDateIdResult).getDateId())
                .isEqualTo(sqlDateIdJPAEntity.getDateId());

        Object bigDecimalIdResult =
                runtimeService.getVariable(
                        processInstanceAllTypes.getId(), "bigDecimalIdJPAEntity");
        assertThat(bigDecimalIdResult).isInstanceOf(BigDecimalIdJPAEntity.class);
        assertThat(((BigDecimalIdJPAEntity) bigDecimalIdResult).getBigDecimalId())
                .isEqualTo(bigDecimalIdJPAEntity.getBigDecimalId());

        Object bigIntegerIdResult =
                runtimeService.getVariable(
                        processInstanceAllTypes.getId(), "bigIntegerIdJPAEntity");
        assertThat(bigIntegerIdResult).isInstanceOf(BigIntegerIdJPAEntity.class);
        assertThat(((BigIntegerIdJPAEntity) bigIntegerIdResult).getBigIntegerId())
                .isEqualTo(bigIntegerIdJPAEntity.getBigIntegerId());
    }
    ...
    public void testStoreJPAEntityListAsVariable() {
        ...
        variables.put(
                "subclassFieldAccess",
                asList(subclassFieldAccess, subclassFieldAccess, subclassFieldAccess));
        variables.put(
        ...
        assertThat(simpleEntityFieldAccess.getId())
                .isEqualTo(((FieldAccessJPAEntity) list.get(0)).getId());
        ...
        assertThat(simpleEntityPropertyAccess.getId())
                .isEqualTo(((PropertyAccessJPAEntity) list.get(0)).getId());
        ...
        assertThat(simpleEntityPropertyAccess.getId())
                .isEqualTo(((SubclassFieldAccessJPAEntity) list.get(0)).getId());
        ...
        assertThat(simpleEntityPropertyAccess.getId())
                .isEqualTo(((SubclassPropertyAccessJPAEntity) list.get(0)).getId());
    }
    ...
    public void testStoreJPAEntityListAsVariableEdgeCases() {
                ...
                .isThrownBy(
                        () ->
                                runtimeService.startProcessInstanceByKey(
                                        "JPAVariableProcess", variablesForException));
        ...
        assertThat(((List<?>) runtimeService.getVariable(processInstance.getId(), "list")))
                .hasSize(0);
        ...
        assertThat(((List<?>) runtimeService.getVariable(processInstance.getId(), "list")))
                .hasSize(2);
        assertThat(((List<?>) runtimeService.getVariable(processInstance.getId(), "list")).get(0))
                .isInstanceOf(FieldAccessJPAEntity.class);
    ...
    public void testReplaceExistingJPAEntityWithAnotherOfSameType() {
        ...
        ProcessInstance processInstance =
                runtimeService.startProcessInstanceByKey("JPAVariableProcess");
    ...
    public void testIllegalEntities() {
                ...
                .isThrownBy(
                        () ->
                                runtimeService.startProcessInstanceByKey(
                                        "JPAVariableProcessExceptions",
                                        singletonMap(
                                                "nullValueEntity", new FieldAccessJPAEntity())))
        ...
        assertThatExceptionOfType(ActivitiException.class)
                .isThrownBy(
                        () ->
                                runtimeService.getVariable(
                                        processInstance.getId(), "nonPersistentEntity"))
                .withMessageContaining(
                        "Entity does not exist: "
                                + FieldAccessJPAEntity.class.getName()
                                + " - 9999");
    }
    ...
    public void testQueryJPAVariable() {
        ...
        ProcessInstance processInstance =
                runtimeService.startProcessInstanceByKey(
                        "JPAVariableProcess", singletonMap("entityToQuery", entityToQuery));
    ...
    public void testUpdateJPAEntityValues() {
        ...
        Object updatedEntity =
                runtimeService.getVariable(processInstance.getId(), "entityToUpdate");
