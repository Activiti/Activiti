...
public class JPAVariableTest extends AbstractActivitiTestCase {
  ...
  public void testStoreJPAEntityAsVariableAllAllowedIdTypes() {
    ...
    Object bigDecimalIdResult =
        runtimeService.getVariable(processInstanceAllTypes.getId(), "bigDecimalIdJPAEntity");
    ...
    Object bigIntegerIdResult =
        runtimeService.getVariable(processInstanceAllTypes.getId(), "bigIntegerIdJPAEntity");
  ...
  public void testStoreJPAEntityListAsVariableEdgeCases() {
    ...
    variablesForException.put(
        "simpleEntityFieldAccess", asList(simpleEntityFieldAccess, simpleEntityPropertyAccess));
    ...
    runtimeService.setVariable(
        processInstance.getId(), "list", asList(simpleEntityFieldAccess, simpleEntityFieldAccess));
