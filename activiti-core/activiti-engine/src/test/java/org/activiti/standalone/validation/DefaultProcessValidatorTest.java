...
public class DefaultProcessValidatorTest {
    ...
    public void verifyValidation() throws Exception {
        BpmnModel bpmnModel = readModel("org/activiti/engine/test/validation/invalidProcess.bpmn20.xml");
        ...
        // Exclusive gateway
        problems =
            findErrors(allErrors, setName, Problems.EXCLUSIVE_GATEWAY_CONDITION_NOT_ALLOWED_ON_SINGLE_SEQ_FLOW, 1);
        assertCommonProblemFieldForActivity(problems.get(0));
    ...
    public void testValidMessageFlow() throws Exception {
        BpmnModel bpmnModel = readModel("org/activiti/engine/test/validation/validMessageProcess.bpmn20.xml");
        assertThat(bpmnModel).isNotNull();
    ...
    public void testInvalidMessageFlow() throws Exception {
        BpmnModel bpmnModel = readModel("org/activiti/engine/test/validation/invalidMessageProcess.bpmn20.xml");
        assertThat(bpmnModel).isNotNull();
    ...
    private List<ValidationError> findErrors(List<ValidationError> errors, String validatorSetName, String problemKey) {
