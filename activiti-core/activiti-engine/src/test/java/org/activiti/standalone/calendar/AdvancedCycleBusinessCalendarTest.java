...
public class AdvancedCycleBusinessCalendarTest extends AbstractTestCase {
    ...
    public void testDaylightSavingFallIso() throws Exception {
        ...
        assertThat(businessCalendar.resolveDuedate("R2/2013-11-03T00:00:00-04:00/P1D DSTZONE:US/Eastern")).isEqualTo(
            parseCalendar("20131104-05:00:00", TimeZone.getTimeZone("UTC")).getTime()
        );
    }
    ...
    public void testDaylightSavingSpringIso() throws Exception {
        ...
        assertThat(businessCalendar.resolveDuedate("R2/2014-03-09T00:00:00-05:00/P1D DSTZONE:US/Eastern")).isEqualTo(
            parseCalendar("20140310-04:00:00", TimeZone.getTimeZone("UTC")).getTime()
        );
    }
    ...
    public void testIsoString() throws Exception {
        ...
        assertThat(businessCalendar.resolveDuedate("R2/2014-03-10T04:00:00/P1D DSTZONE:US/Eastern")).isEqualTo(
            parseCalendar("20140311-04:00:00", TimeZone.getTimeZone("UTC")).getTime()
        );
    }
    ...
    public void testLegacyIsoString() throws Exception {
        ...
        assertThat(businessCalendar.resolveDuedate("R2/2014-03-10T00:00:00/P1D")).isEqualTo(
            parseCalendar("20140311-00:00:00", TimeZone.getDefault()).getTime()
        );
    }
    ...
    public void testDaylightSavingFallCron() throws Exception {
        ...
        assertThat(businessCalendar.resolveDuedate("0 0 12 1/1 * ? * DSTZONE:US/Eastern")).isEqualTo(
            parseCalendar("20131103-17:00:00", TimeZone.getTimeZone("UTC")).getTime()
        );
    }
    ...
    public void testDaylightSavingSpringCron() throws Exception {
        ...
        assertThat(businessCalendar.resolveDuedate("0 0 12 1/1 * ? * DSTZONE:US/Eastern")).isEqualTo(
            parseCalendar("20140309-16:00:00", TimeZone.getTimeZone("UTC")).getTime()
        );
    }
    ...
    public void testCronString() throws Exception {
        ...
        assertThat(businessCalendar.resolveDuedate("0 0 12 1/1 * ? * DSTZONE:US/Eastern")).isEqualTo(
            parseCalendar("20140310-16:00:00", TimeZone.getTimeZone("UTC")).getTime()
        );
    }
    ...
    public void testLegacyCronString() throws Exception {
        ...
        assertThat(businessCalendar.resolveDuedate("0 0 12 1/1 * ? *")).isEqualTo(
            parseCalendar("20140310-12:00:00", TimeZone.getTimeZone("UTC")).getTime()
        );
    }
