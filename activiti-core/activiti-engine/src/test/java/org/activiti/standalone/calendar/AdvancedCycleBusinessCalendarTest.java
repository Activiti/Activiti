...
public class AdvancedCycleBusinessCalendarTest extends AbstractTestCase {
    ...
    public void testDaylightSavingFallIso() throws Exception {
        ...
        assertThat(businessCalendar.resolveDuedate(
            "R2/2013-11-03T00:00:00-04:00/P1D DSTZONE:US/Eastern")).isEqualTo(
    ...
    public void testDaylightSavingSpringIso() throws Exception {
        ...
        assertThat(businessCalendar.resolveDuedate(
            "R2/2014-03-09T00:00:00-05:00/P1D DSTZONE:US/Eastern")).isEqualTo(
    ...
    public void testIsoString() throws Exception {
        ...
        assertThat(businessCalendar.resolveDuedate(
            "R2/2014-03-10T04:00:00/P1D DSTZONE:US/Eastern")).isEqualTo(
    ...
    public void testDaylightSavingFallCron() throws Exception {
        ...
        assertThat(
            businessCalendar.resolveDuedate("0 0 12 1/1 * ? * DSTZONE:US/Eastern")).isEqualTo(
