...
public class BaseEntityEventListener implements ActivitiEventListener {
    ...
    /**
     * Create a new BaseEntityEventListener, notified when an event that targets any type of entity
     * is received. Returning true when {@link #isFailOnException()} is called.
     */
    ...
    protected boolean isValidEvent(ActivitiEvent event) {
        ...
        if (event instanceof ActivitiEntityEvent) {
            if (entityClass == null) {
                ...
                valid = entityClass.isAssignableFrom(
