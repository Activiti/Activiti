 ...
 */
@Internal
public interface HistoricProcessInstanceQuery extends
    Query<HistoricProcessInstanceQuery, HistoricProcessInstance> {

    /**
     * Only select historic process instances with the given process instance. {@link
     * ProcessInstance) ids and {@link HistoricProcessInstance} ids match.
     */
    HistoricProcessInstanceQuery processInstanceId(String processInstanceId);

    /**
     * Only select historic process instances whose id is in the given set of ids. {@link
     * ProcessInstance) ids and {@link HistoricProcessInstance} ids match.
     */
    ...
    /**
     * Only select historic process instances that are defined by a process definition with the
     * given key.
     */
    HistoricProcessInstanceQuery processDefinitionKey(String processDefinitionKey);

    /**
     * Only select historic process instances that are defined by a process definition with one of
     * the given process definition keys.
     */
    HistoricProcessInstanceQuery processDefinitionKeyIn(List<String> processDefinitionKeys);

    /**
     * Only select historic process instances that don't have a process-definition of which the key
     * is present in the given list
     */
    HistoricProcessInstanceQuery processDefinitionKeyNotIn(List<String> processDefinitionKeys);

    /**
     * Only select historic process instances whose process definition category is
    ...
    /**
     * Only select historic process instances with a certain process definition version. Particulary
     * useful when used in combination with {@link #processDefinitionKey(String)}
     */
    ...
    /**
     * Only select the historic process instances with which the user with the given id is
     * involved.
     */
    HistoricProcessInstanceQuery involvedUser(String userId);

    /**
     * Only select process instances which had a global variable with the given value when they
     * ended. The type only applies to already ended process instances, otherwise use a {@link
     * ProcessInstanceQuery} instead! of variable is determined based on the value, using types
     * configured in {@link ProcessEngineConfiguration#getVariableTypes()}. Byte-arrays and {@link
     * Serializable} objects (which are not primitive type wrappers) are not supported.
     *
     ...
     * when they ended. The type only applies to already ended process instances, otherwise use a
     * {@link ProcessInstanceQuery} instead! of variable is determined based on the value, using
     * types configured in {@link ProcessEngineConfiguration#getVariableTypes()}. Byte-arrays and
    ...
    /**
     * Only select historic process instances which have a local string variable with the given
    ...
    /**
     * Only select process instances which had a global variable with the given name, but with a
     * different value than the passed value when they ended. Only select process instances which
     * have a variable value greater than the passed value. Byte-arrays and {@link Serializable}
    ...
    /**
     * Only select process instances which had a global variable value greater than the passed value
     * when they ended. Booleans, Byte-arrays and {@link Serializable} objects (which are not
     * primitive type wrappers) are not supported. Only select process instances which have a
     * variable value greater than the passed value.
     *
    ...
    /**
     * Only select process instances which had a global variable value greater than or equal to the
     * passed value when they ended. Booleans, Byte-arrays and {@link Serializable} objects (which
     * are not primitive type wrappers) are not supported. Only applies to already ended process
     * instances, otherwise use a {@link ProcessInstanceQuery} instead!
     *
     * @param name  cannot be null.
     * @param value cannot be null.
     */
    ...
    /**
     * Only select process instances which had a global variable value less than the passed value
     * when the ended. Only applies to already ended process instances, otherwise use a {@link
     * ProcessInstanceQuery} instead! Booleans, Byte-arrays and {@link Serializable} objects (which
    ...
    /**
     * Only select process instances which has a global variable value less than or equal to the
     * passed value when they ended. Only applies to already ended process instances, otherwise use
     * a {@link ProcessInstanceQuery} instead! Booleans, Byte-arrays and {@link Serializable}
     * objects (which are not primitive type wrappers) are not supported.
     *
     * @param name  cannot be null.
     * @param value cannot be null.
    ...
    /**
     * Only select process instances which had global variable value like the given value when they
     * ended. Only applies to already ended process instances, otherwise use a {@link
     * ProcessInstanceQuery} instead! This can be used on string variables only.
     *
     * @param name  cannot be null.
    ...
    /**
     * Only select process instances which had global variable value like (case insensitive) the
     * given value when they ended. Only applies to already ended process instances, otherwise use a
     ...
     * Only one OR statement is allowed, for the second call to this method an exception will be
     * thrown.
     */
    HistoricProcessInstanceQuery or();

    /**
     * End an OR statement. Only one OR statement is allowed, for the second call to this method an
     * exception will be thrown.
     */
    HistoricProcessInstanceQuery endOr();

    /**
     * Order by the process instance id (needs to be followed by {@link #asc()} or {@link
     * #desc()}).
     */
    HistoricProcessInstanceQuery orderByProcessInstanceId();

    /**
     * Order by the process definition id (needs to be followed by {@link #asc()} or {@link
     * #desc()}).
     */
    ...
    /**
     * Order by the duration of the process instance (needs to be followed by {@link #asc()} or
     * {@link #desc()}).
     */
    ...
    /**
     * Only select historic process instances started by the given process instance. {@link
     * ProcessInstance) ids and {@link HistoricProcessInstance} ids match.
     */
    ...
    /**
     * Only select process instances that failed due to an exception happening during a job
     * execution.
     */
