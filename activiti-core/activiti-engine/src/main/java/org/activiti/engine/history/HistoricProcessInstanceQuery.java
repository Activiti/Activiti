...
public interface HistoricProcessInstanceQuery
  ...
  /**
   * Only select historic process instances that are defined by a process definition with the given
   * key.
   */
  HistoricProcessInstanceQuery processDefinitionKey(String processDefinitionKey);

  /**
   * Only select historic process instances that are defined by a process definition with one of the
   * given process definition keys.
   */
  HistoricProcessInstanceQuery processDefinitionKeyIn(List<String> processDefinitionKeys);

  /**
   * Only select historic process instances that don't have a process-definition of which the key is
   ...
   * The type only applies to already ended process instances, otherwise use a {@link
  ...
  /**
   * Only select process instances which had at least one global variable with the given value when
   * they ended. The type only applies to already ended process instances, otherwise use a {@link
   * ProcessInstanceQuery} instead! of variable is determined based on the value, using types
   * configured in {@link ProcessEngineConfiguration#getVariableTypes()}. Byte-arrays and {@link
   * Serializable} objects (which are not primitive type wrappers) are not supported.
   */
  ...
  /**
   * Only select historic process instances which have a local string variable with the given value,
   * case insensitive.
   *
   ...
   * different value than the passed value when they ended. Only select process instances which have
   * a variable value greater than the passed value. Byte-arrays and {@link Serializable} objects
   ...
   * primitive type wrappers) are not supported. Only select process instances which have a variable
   * value greater than the passed value.
   *
   ...
   * passed value when they ended. Booleans, Byte-arrays and {@link Serializable} objects (which are
   * not primitive type wrappers) are not supported. Only applies to already ended process
  ...
  /**
   * Only select process instances which had a global variable value less than the passed value when
   * the ended. Only applies to already ended process instances, otherwise use a {@link
   ...
   * passed value when they ended. Only applies to already ended process instances, otherwise use a
   * {@link ProcessInstanceQuery} instead! Booleans, Byte-arrays and {@link Serializable} objects
   * (which are not primitive type wrappers) are not supported.
   *
   * @param name cannot be null.
   * @param value cannot be null.
  ...
  /**
   * Only select process instances which had global variable value like (case insensitive) the given
   * value when they ended. Only applies to already ended process instances, otherwise use a {@link
   * ProcessInstanceQuery} instead! This can be used on string variables only.
   *
   * @param name cannot be null.
   * @param value cannot be null. The string can include the wildcard character '%' to express
  ...
  /**
   * Order by the duration of the process instance (needs to be followed by {@link #asc()} or {@link
   * #desc()}).
   */
