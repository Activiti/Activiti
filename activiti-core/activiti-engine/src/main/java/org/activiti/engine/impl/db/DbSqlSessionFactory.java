...
public class DbSqlSessionFactory implements SessionFactory {
     ...
     * database metadata doesn't return that correctly, see https://activiti.atlassian.net/browse/ACT-1220,
    ...
    private String getStatement(Class<?> entityClass, Map<Class<?>, String> cachedStatements,
        String prefix) {
