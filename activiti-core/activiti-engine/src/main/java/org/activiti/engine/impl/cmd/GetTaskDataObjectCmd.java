...
public class GetTaskDataObjectCmd implements Command<DataObject>, Serializable {
    ...
    public GetTaskDataObjectCmd(String taskId, String variableName, String locale,
    ...
    public DataObject execute(CommandContext commandContext) {
        ...
        if (variableEntity != null) {
            ...
            if (executionEntity.getParentId() == null) {
                for (ValuedDataObject dataObjectDefinition : bpmnModel.getMainProcess()
                    .getDataObjects()) {
            ...
            if (foundDataObject != null) {
                dataObject = new DataObjectImpl(variableEntity.getName(), variableEntity.getValue(),
