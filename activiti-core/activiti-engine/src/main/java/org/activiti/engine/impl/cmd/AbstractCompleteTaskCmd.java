...
public abstract class AbstractCompleteTaskCmd extends NeedsActiveTaskCmd<Void> {
  ...
  protected void executeTaskComplete(
    ...
    if (Authentication.getAuthenticatedUserId() != null
      ...
      ExecutionEntity processInstanceEntity =
          commandContext.getExecutionEntityManager().findById(taskEntity.getProcessInstanceId());
      commandContext
    ...
    if (taskEntity.getExecutionId() != null) {
      ExecutionEntity executionEntity =
          commandContext.getExecutionEntityManager().findById(taskEntity.getExecutionId());
