...
public interface Job {
    ...
    /**
     * Returns the number of retries this job has left. Whenever the jobexecutor fails to execute
     * the job, this value is decremented. When it hits zero, the job is supposed to be dead and not
     ...
     *
     * <p>To get the full exception stacktrace, use {@link
