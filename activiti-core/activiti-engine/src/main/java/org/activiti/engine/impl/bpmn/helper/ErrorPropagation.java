...
public class ErrorPropagation {
                    ...
                    if (eventMap.size() > 0) {
                        ...
                        if (superExecution != null) {
                            parentExecution = superExecution;
                                ...
                                .equals(
                                        parentExecution
                                                .getRootProcessInstanceId())) { // stop at the root
    ...
    protected static void executeCatch(
        ...
        if (eventMap.containsKey(currentExecution.getActivityId())) {
            ...
            // Traverse parents until one is found that is a scope and matches the activity the
            // boundary
            // event is defined on
                ...
                if (flowElement instanceof StartEvent) {
                    ...
                    if (CollectionUtil.isNotEmpty(startEvent.getEventDefinitions())
                        ...
                        String eventErrorCode =
                                retrieveErrorCode(bpmnModel, errorEventDef.getErrorRef());
