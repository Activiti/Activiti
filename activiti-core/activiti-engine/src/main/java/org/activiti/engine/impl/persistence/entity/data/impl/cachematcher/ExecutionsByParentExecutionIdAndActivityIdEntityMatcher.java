 ...
 *
 */
public class ExecutionsByParentExecutionIdAndActivityIdEntityMatcher extends
    CachedEntityMatcherAdapter<ExecutionEntity> {
    ...
    public boolean isRetained(ExecutionEntity executionEntity, Object parameter) {
        ...
        return executionEntity.getParentId() != null && executionEntity.getParentId()
            .equals(parentExecutionId)
            && executionEntity.getActivityId() != null && activityIds.contains(
