...
public class DeploymentManager {
    ...
    public ProcessDefinition findDeployedLatestProcessDefinitionByKeyAndTenantId(
        ...
        ProcessDefinition processDefinition =
            processDefinitionEntityManager.findLatestProcessDefinitionByKeyAndTenantId(processDefinitionKey, tenantId);
        if (processDefinition == null) {
            throw new ActivitiObjectNotFoundException(
    ...
    public ProcessDefinition findDeployedProcessDefinitionByKeyAndVersionAndTenantId(
        ...
        ProcessDefinition processDefinition =
            (ProcessDefinitionEntity) processDefinitionEntityManager.findProcessDefinitionByKeyAndVersionAndTenantId(
                processDefinitionKey,
    ...
    public ProcessDefinitionCacheEntry resolveProcessDefinition(ProcessDefinition processDefinition) {
        ...
        if (cachedProcessDefinition == null) {
            ...
            cachedProcessDefinition = resolveProcessDefinitionInternal(
                commandContext,
                processDefinition,
                deploymentId,
                processDefinitionId
