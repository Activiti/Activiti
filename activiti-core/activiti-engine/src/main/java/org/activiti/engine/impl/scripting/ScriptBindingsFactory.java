...
public class ScriptBindingsFactory {
    ...
    public ScriptBindingsFactory(ProcessEngineConfigurationImpl processEngineConfiguration,
    ...
    protected List<Resolver> createResolvers(VariableScope variableScope) {
        ...
        for (ResolverFactory scriptResolverFactory : resolverFactories) {
            Resolver resolver = scriptResolverFactory.createResolver(processEngineConfiguration,
                variableScope);
            if (resolver != null) {
