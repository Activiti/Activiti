...
public class ContinueMultiInstanceOperation extends AbstractOperation {
    ...
    public ContinueMultiInstanceOperation(CommandContext commandContext,
    ...
    protected void executeSynchronous(FlowNode flowNode) {
        ...
        if (activityBehavior != null) {
            ...
            if (Context.getProcessEngineConfiguration() != null
                ...
                Context.getProcessEngineConfiguration().getEventDispatcher().dispatchEvent(
                    ActivitiEventBuilder.createActivityEvent(ActivitiEventType.ACTIVITY_STARTED,
                        flowNode.getId(), flowNode.getName(), execution.getId(),
            ...
            logger.debug("No activityBehavior on activity '{}' with execution {}", flowNode.getId(),
                execution.getId());
        }
    }

    protected void executeAsynchronous(FlowNode flowNode) {
        JobEntity job = commandContext.getJobManager()
