 ...
 * <p>
 * To retrieve the actual bytes of a deployment resource use the operations on the {@link
 * RepositoryService#getDeploymentResourceNames(String)} and {@link RepositoryService#getResourceAsStream(String,
 * String)}
 */
@Internal
