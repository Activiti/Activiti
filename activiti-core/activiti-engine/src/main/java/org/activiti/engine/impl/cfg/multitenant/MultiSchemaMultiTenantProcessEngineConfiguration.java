...
public class MultiSchemaMultiTenantProcessEngineConfiguration
    ...
    public MultiSchemaMultiTenantProcessEngineConfiguration(TenantInfoHolder tenantInfoHolder) {
        ...
        // Using the UUID generator, as otherwise the ids are pulled from a global pool of ids,
        // backed
        // by
     ...
     *
     * <p>Note that the tenant identifier must have been added to the {@link TenantInfoHolder}
            ...
            for (String tenantId : tenantInfoHolder.getAllTenants()) {
                ((TenantAwareAsyncExecutor) asyncExecutor)
                        .addTenantAsyncExecutor(
                                tenantId,
                                false); // false -> will be started later with all the other
                // executors
            }
        }
    }
