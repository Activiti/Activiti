...
public class AddIdentityLinkForProcessInstanceCmd implements Command<Void>, Serializable {
    ...
    public AddIdentityLinkForProcessInstanceCmd(String processInstanceId, String userId,
    ...
    protected void validateParams(String processInstanceId, String userId, String groupId,
        String type) {
