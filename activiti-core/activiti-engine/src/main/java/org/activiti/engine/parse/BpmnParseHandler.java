 ...
 *
 * <p>Instances of this class can be injected into the {@link ProcessEngineConfigurationImpl}. The
 * handler will then be called whenever a BPMN 2.0 element is parsed that matches the types returned
 * by the {@link #getHandledTypes()} method.
 *
