 ...
 *
 */
public abstract class VariableScopeImpl extends AbstractEntity implements Serializable,
    VariableScope {
    ...
    public Map<String, Object> getVariables(Collection<String> variableNames,
        ...
        for (String variableName : variableNames) {
            if (transientVariabes != null && transientVariabes.containsKey(variableName)) {
                requestedVariables.put(variableName,
     ...
     * <p>
     * Note that the default Activiti way (because of backwards compatibility) is to fetch all the
     * variables when doing a get/set of variables. So this means 'true' is the default value for
     * this method, and in fact it will simply delegate to {@link #getVariable(String)}. This can
     * also be the most performant, if you're doing a lot of variable gets in the same transaction
     * (eg in service tasks).
     * <p>
     ...
     * <p>
     * Setting the fetchAllVariables parameter to true is the default behaviour (ie fetching all
     ...
     *
     * @param sourceExecution   The execution where the variable was originally set, used for
     *                          history data.
     * @param fetchAllVariables If true, all existing variables will be fetched when setting the
     *                          variable.
     */
    protected void setVariable(String variableName, Object value, ExecutionEntity sourceExecution,
        boolean fetchAllVariables) {
                ...
                if (variable != null) {
                    ...
                    if (parent != null) {
                        if (sourceExecution == null) {
                            ...
                            parent.setVariable(variableName, value, sourceExecution,
                                fetchAllVariables);
                        }
    ...
    protected void deleteVariableInstanceForExplicitUserCall(
        ...
        Context.getCommandContext().getHistoryManager()
            .recordHistoricDetailVariableCreate(variableInstance, sourceActivityExecution,
    ...
    public void setTransientVariableLocal(String variableName, Object variableValue) {
        ...
        transientVariabes.put(variableName,
