...
public class DefaultActivityBehaviorFactory extends AbstractBehaviorFactory
    ...
    public ActivityBehavior createDefaultServiceTaskBehavior(ServiceTask serviceTask) {
        // this is covering the case where only the field `implementation` was defined in the
        // process
        // definition. I.e.
    ...
    protected ActivityBehavior createMuleActivityBehavior(
        ...
        try {
            ...
            throw new ActivitiException(
                    "Could not find org.activiti.mule.MuleSendActivitiBehavior: ", e);
        }
    }
    ...
    public IntermediateThrowMessageEventActivityBehavior createThrowMessageEventActivityBehavior(
        ...
        ThrowMessageDelegate throwMessageDelegate =
    ...
    protected ThrowMessageDelegate createThrowMessageDelegate(
        ...
        return checkClassDelegate(attributes)
                ...
                .orElseGet(
                        () ->
                                checkDelegateExpression(attributes)
    ...
    protected Optional<String> checkClassDelegate(
