...
public class DefaultJobManager implements JobManager {
    ...
    public TimerJobEntity createTimerJob(TimerEventDefinition timerEventDefinition,
        ...
        TimerJobEntity timerEntity = TimerUtil.createTimerEntityForTimerEventDefinition(
            timerEventDefinition, interrupting,
    ...
    public void scheduleTimerJob(TimerJobEntity timerJob) {
        ...
        if (eventDispatcher.isEnabled()) {
            eventDispatcher.dispatchEvent(
                ActivitiEventBuilder.createEntityEvent(ActivitiEventType.TIMER_SCHEDULED,
                    timerJob));
        }
    }
    ...
    public JobEntity moveTimerJobToExecutableJob(TimerJobEntity timerJob) {
        ...
        boolean insertSuccesful = processEngineConfiguration.getJobEntityManager()
    ...
    public TimerJobEntity moveJobToTimerJob(AbstractJobEntity job) {
        ...
        boolean insertSuccesful = processEngineConfiguration.getTimerJobEntityManager()
    ...
    @Override
    public JobEntity moveDeadLetterJobToExecutableJob(DeadLetterJobEntity deadLetterJobEntity,
        int retries) {
    ...
    protected void executeJobHandler(JobEntity jobEntity) {
        ...
        jobHandler.execute(jobEntity, jobEntity.getJobHandlerConfiguration(), execution,
            getCommandContext());
    }
    ...
    protected void restoreExtraData(JobEntity timerEntity, VariableScope variableScope) {
        ...
        if (timerEntity.getJobHandlerType().equalsIgnoreCase(TimerStartEventJobHandler.TYPE) ||
            ...
            activityId = TimerEventHandler.getActivityIdFromConfiguration(
            ...
            if (endDateExpressionString != null) {
                Expression endDateExpression = processEngineConfiguration.getExpressionManager()
                ...
                BusinessCalendar businessCalendar = processEngineConfiguration.getBusinessCalendarManager()
                    .getBusinessCalendar(
                        getBusinessCalendarName(TimerEventHandler.geCalendarNameFromConfiguration(
                            timerEntity.getJobHandlerConfiguration()), variableScope));
                ...
                if (endDateExpression != null) {
                    ...
                    if (endDateValue instanceof String) {
                        ...
                        throw new ActivitiException(
                            "Timer '" + ((ExecutionEntity) variableScope).getActivityId()
    ...
    protected boolean isValidTime(JobEntity timerEntity, Date newTimerDate,
        ...
        return businessCalendar.validateDuedate(timerEntity.getRepeat(),
            timerEntity.getMaxIterations(), timerEntity.getEndDate(), newTimerDate);
    }
    ...
    protected void hintAsyncExecutor(JobEntity job) {
        AsyncJobAddedNotification jobAddedNotification = new AsyncJobAddedNotification(job,
            getAsyncExecutor());
    ...
    protected void fillDefaultAsyncJobInfo(JobEntity jobEntity, ExecutionEntity execution,
        boolean exclusive) {
    ...
    protected SuspendedJobEntity createSuspendedJobFromOtherJob(AbstractJobEntity otherJob) {
        SuspendedJobEntity suspendedJob = processEngineConfiguration.getSuspendedJobEntityManager()
            .create();
    ...
    protected DeadLetterJobEntity createDeadLetterJobFromOtherJob(AbstractJobEntity otherJob) {
        DeadLetterJobEntity deadLetterJob = processEngineConfiguration.getDeadLetterJobEntityManager()
            .create();
        copyJobInfo(deadLetterJob, otherJob);
        return deadLetterJob;
    }

    protected AbstractJobEntity copyJobInfo(AbstractJobEntity copyToJob,
