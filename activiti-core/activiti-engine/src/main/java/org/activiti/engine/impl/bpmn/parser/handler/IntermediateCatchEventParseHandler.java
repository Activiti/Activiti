 ...
 *
 */
public class IntermediateCatchEventParseHandler extends
    AbstractFlowNodeBpmnParseHandler<IntermediateCatchEvent> {

    private static final Logger logger = LoggerFactory.getLogger(
        IntermediateCatchEventParseHandler.class);
    ...
    protected void executeParse(BpmnParse bpmnParse, IntermediateCatchEvent event) {
        ...
        if (eventDefinition == null) {
            event.setBehavior(bpmnParse.getActivityBehaviorFactory()
