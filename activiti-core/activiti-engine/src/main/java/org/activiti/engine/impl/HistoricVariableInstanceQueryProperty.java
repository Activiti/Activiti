...
public class HistoricVariableInstanceQueryProperty implements QueryProperty {
    ...
    private static final Map<String, HistoricVariableInstanceQueryProperty> properties =
            new HashMap<String, HistoricVariableInstanceQueryProperty>();
    ...
    public static final HistoricVariableInstanceQueryProperty VARIABLE_NAME =
            new HistoricVariableInstanceQueryProperty("NAME_");
