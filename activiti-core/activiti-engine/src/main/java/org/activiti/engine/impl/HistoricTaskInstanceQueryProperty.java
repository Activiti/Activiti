...
public class HistoricTaskInstanceQueryProperty implements QueryProperty {
    ...
    private static final Map<String, HistoricTaskInstanceQueryProperty> properties =
            new HashMap<String, HistoricTaskInstanceQueryProperty>();
