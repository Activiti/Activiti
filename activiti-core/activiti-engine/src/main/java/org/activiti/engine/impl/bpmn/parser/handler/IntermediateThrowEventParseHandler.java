 ...
 *
 */
public class IntermediateThrowEventParseHandler extends
    AbstractActivityBpmnParseHandler<ThrowEvent> {
    ...
    protected void executeParse(BpmnParse bpmnParse, ThrowEvent intermediateEvent) {
        ...
        if (eventDefinition instanceof SignalEventDefinition) {
            ...
            intermediateEvent.setBehavior(bpmnParse.getActivityBehaviorFactory()
                .createIntermediateThrowSignalEventActivityBehavior(intermediateEvent,
            ...
            intermediateEvent.setBehavior(bpmnParse.getActivityBehaviorFactory()
                .createIntermediateThrowCompensationEventActivityBehavior(intermediateEvent,
            ...
            logger.warn("Unsupported intermediate throw event type for throw event "
