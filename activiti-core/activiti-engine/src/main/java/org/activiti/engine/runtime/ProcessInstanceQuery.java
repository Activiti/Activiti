...
public interface ProcessInstanceQuery extends Query<ProcessInstanceQuery, ProcessInstance> {
    ...
    ProcessInstanceQuery processInstanceBusinessKey(
            String processInstanceBusinessKey, String processDefinitionKey);
    ...
    /**
     * Only select process instances with a certain process definition version. Particulary useful
    ...
    /**
     * Select the process instances which are a sub process instance of the given super process
     * instance.
     */
     ...
     * Note that there will always be maximum only <b>one</b> such process instance that can be the
    ...
    /**
     * Only select process instances which have a global variable with the given value. The type of
     ...
     * The type of variable is determined based on the value, using types configured in {@link
     * ProcessEngineConfiguration#getVariableTypes()}. Byte-arrays and {@link Serializable} objects
     * (which are not primitive type wrappers) are not supported.
     */
    ...
    /**
     * Only select process instances which have a local string variable with the given value, case
     * insensitive.
     *
    ...
    /**
     * Only select process instances which have a global variable with the given name, but with a
     * different value than the passed value. Byte-arrays and {@link Serializable} objects (which
    ...
    /**
     * Only select process instances which have a local string variable which is not the given
    ...
    /**
     * Only select process instances which have a global variable value greater than or equal to the
     * passed value. Booleans, Byte-arrays and {@link Serializable} objects (which are not primitive
    ...
    /**
     * Only select process instances which have a global variable value less than or equal to the
     * passed value. Booleans, Byte-arrays and {@link Serializable} objects (which are not primitive
     * type wrappers) are not supported.
     *
     * @param name variable name, cannot be null.
    ...
    /**
     * Only select process instances which have a global variable value like the given value. This
    ...
    /**
     * Only select process instances which have a global variable value like the given value (case
    ...
    /**
     * Only select process instances which are suspended, either because the process instance itself
     * is suspended or because the corresponding process definition is suspended
     */
    ProcessInstanceQuery suspended();

    /**
     * Only select process instances which are active, which means that neither the process instance
     * nor the corresponding process definition are suspended.
     */
