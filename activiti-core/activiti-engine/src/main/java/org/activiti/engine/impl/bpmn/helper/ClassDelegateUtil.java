    ...
    public static void applyFieldDeclaration(FieldDeclaration declaration, Object target) {
        ...
        if (setterMethod != null) {
            try {
                ...
                throw new ActivitiException(
                    "Illegal access when calling '" + declaration.getName() + "' on class "
                        + target.getClass().getName(), e);
            ...
            if (field == null) {
                throw new ActivitiIllegalArgumentException(
                    "Field definition uses non-existing field '" + declaration.getName()
            ...
            if (!fieldTypeCompatible(declaration, field)) {
                throw new ActivitiIllegalArgumentException(
                    "Incompatible type set on field declaration '" + declaration.getName()
                        ...
                        + declaration.getValue().getClass().getName() + ", while expecting "
