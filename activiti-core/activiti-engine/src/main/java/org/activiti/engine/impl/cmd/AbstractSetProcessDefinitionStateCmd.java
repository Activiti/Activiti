...
public abstract class AbstractSetProcessDefinitionStateCmd implements Command<Void> {
    ...
    protected List<ProcessDefinitionEntity> findProcessDefinition(CommandContext commandContext) {
        ...
        // If process definition is already provided (eg. when command is called through the
        // DeployCmd)
        // we don't need to do an extra database fetch and we can simply return it, wrapped in a
        // list
        ...
        if (processDefinitionId != null) {
            ...
            ProcessDefinitionEntity processDefinitionEntity =
                    processDefinitionManager.findById(processDefinitionId);
            if (processDefinitionEntity == null) {
            ...
            ProcessDefinitionQueryImpl query =
            ...
            if (includeProcessInstances) {
                ...
                List<ProcessInstance> processInstances =
                        fetchProcessInstancesPage(
                                commandContext, processDefinition, currentStartIndex);
