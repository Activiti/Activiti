...
public interface DelegateExecution extends VariableScope {
    ...
    /**
     * The 'root' process instance. When using call activity for example, the processInstance set
     * will not always be the root. This method returns the topmost process instance.
     */
    String getRootProcessInstanceId();

    /**
     * Will contain the event name in case this execution is passed in for an {@link
     * ExecutionListener}.
     */
    String getEventName();
    ...
    /**
     * Returns the {@link ActivitiListener} instance matching an {@link ExecutionListener} if
     * currently an execution listener is being execution. Returns null otherwise.
     */
