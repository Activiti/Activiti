 ...
 *
 */
public class MybatisJobDataManager extends AbstractDataManager<JobEntity> implements
    JobDataManager {
    ...
    @Override
    public List<JobEntity> findJobsByTypeAndProcessDefinitionId(final String jobHandlerType,
