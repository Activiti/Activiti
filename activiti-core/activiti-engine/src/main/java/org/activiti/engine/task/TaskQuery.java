...
public interface TaskQuery extends TaskInfoQuery<TaskQuery, Task> {
     ...
     * be claimed by a user in the given groups while set property <strong>dbIdentityUsed</strong>
     * to <strong>false</strong> in process engine configuration or using custom session factory of
