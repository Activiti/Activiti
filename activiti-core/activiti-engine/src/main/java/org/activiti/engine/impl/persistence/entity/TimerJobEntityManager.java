...
public interface TimerJobEntityManager extends EntityManager<TimerJobEntity> {
    ...
    /**
     * Returns the {@link TimerJobEntity} instances that are elegible to execute, meaning the due
     * date of the timer has been passed.
     */
     ...
     * <p>
     * This is for example used when deleting a process definition: it finds the {@link
     * TimerJobEntity} representing the timer start events.
     */
    List<TimerJobEntity> findJobsByTypeAndProcessDefinitionId(String type,
        String processDefinitionId);

    /**
     * The same as {@link #findJobsByTypeAndProcessDefinitionId(String, String)}, but by key and for
     * a specific tenantId.
     */
    List<TimerJobEntity> findJobsByTypeAndProcessDefinitionKeyAndTenantId(String type,
     ...
     */
    List<TimerJobEntity> findJobsByTypeAndProcessDefinitionKeyNoTenantId(String type,
