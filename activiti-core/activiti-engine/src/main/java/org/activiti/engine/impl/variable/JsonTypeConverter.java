...
public class JsonTypeConverter {
    ...
    public Object convertToValue(JsonNode jsonValue, ValueFields valueFields) {
        ...
        if (jsonValue != null && StringUtils.isNotBlank(javaClassFieldForJackson)) {
            // can find type so long as JsonTypeInfo annotation on the class - see
            // https://stackoverflow.com/a/28384407/9705485
            ...
            try {
                ...
                LOGGER.warn(
                        "Unable to obtain type for json variable object " + valueFields.getName(),
                        e);
            }
        }
