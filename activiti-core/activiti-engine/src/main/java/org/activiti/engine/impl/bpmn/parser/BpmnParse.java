...
public class BpmnParse implements BpmnXMLConstants {
     ...
     * <p>
     * All the map's elements are defined outside the process definition(s), which means that this
        ...
        if (!bpmnModel.getLocationMap().isEmpty()) {
            ...
            for (String bpmnReference : bpmnModel.getLocationMap().keySet()) {
                if (bpmnModel.getFlowElement(bpmnReference) == null) {
                    ...
                    LOGGER.warn(
                        "Invalid reference in diagram interchange definition: " + bpmnReference
