 ...
 *
 */
public class TimerEventDefinitionParseHandler extends
    AbstractBpmnParseHandler<TimerEventDefinition> {
    ...
    protected void executeParse(BpmnParse bpmnParse, TimerEventDefinition timerEventDefinition) {
        ...
        if (bpmnParse.getCurrentFlowElement() instanceof IntermediateCatchEvent) {
            ...
            boundaryEvent.setBehavior(bpmnParse.getActivityBehaviorFactory()
                .createBoundaryTimerEventActivityBehavior(boundaryEvent, timerEventDefinition,
