 ...
 *
 */
public class MybatisExecutionDataManager extends AbstractDataManager<ExecutionEntity> implements
    ...
    protected ExecutionEntity findByIdAndFetchExecutionTree(final String executionId) {
        ...
        ExecutionEntity cachedEntity = getEntityCache().findInCache(getManagedEntityClass(),
            executionId);
        ...
        List<ExecutionEntity> executionEntities = getList(
            "selectExecutionsWithSameRootProcessInstanceId", executionId,
    ...
    public List<ExecutionEntity> findChildExecutionsByParentExecutionId(
        ...
        if (performanceSettings.isEnableEagerExecutionTreeFetching()) {
            ...
            return getList("selectExecutionsByParentExecutionId", parentExecutionId,
                executionsByParentIdMatcher, true);
        }
    }
    ...
    public List<ExecutionEntity> findChildExecutionsByProcessInstanceId(
        ...
        if (performanceSettings.isEnableEagerExecutionTreeFetching()) {
            ...
            return getList("selectChildExecutionsByProcessInstanceId", processInstanceId,
                executionsByProcessInstanceIdMatcher, true);
        }
    }
    ...
    public List<ExecutionEntity> findExecutionsByParentExecutionAndActivityIds(
        ...
        if (performanceSettings.isEnableEagerExecutionTreeFetching()) {
            findByIdAndFetchExecutionTree(parentExecutionId);
            return getListFromCache(executionsByParentExecutionIdAndActivityIdEntityMatcher,
                parameters);
        } else {
    ...
    @Override
    public List<ExecutionEntity> findExecutionsByRootProcessInstanceId(
        ...
        if (performanceSettings.isEnableEagerExecutionTreeFetching()) {
            ...
            return getList("selectExecutionsByRootProcessInstanceId", rootProcessInstanceId,
                executionsByRootProcessInstanceMatcher, true);
        }
    }
    ...
    public List<ExecutionEntity> findExecutionsByProcessInstanceId(final String processInstanceId) {
        if (performanceSettings.isEnableEagerExecutionTreeFetching()) {
            ...
            return getList("selectExecutionsByProcessInstanceId", processInstanceId,
                executionByProcessInstanceMatcher, true);
        }
    }
    ...
    public Collection<ExecutionEntity> findInactiveExecutionsByProcessInstanceId(
        ...
        if (performanceSettings.isEnableEagerExecutionTreeFetching()) {
            ...
            return getList("selectInactiveExecutionsForProcessInstance", params,
                inactiveExecutionsByProcInstMatcher, true);
        }
    }
    ...
    public Collection<ExecutionEntity> findInactiveExecutionsByActivityIdAndProcessInstanceId(
        ...
        if (performanceSettings.isEnableEagerExecutionTreeFetching()) {
            ...
            return getList("selectInactiveExecutionsInActivityAndProcessInstance", params,
    ...
    public List<String> findProcessInstanceIdsByProcessDefinitionId(String processDefinitionId) {
        return getDbSqlSession().selectList("selectProcessInstanceIdsByProcessDefinitionId",
            processDefinitionId, false);
    }

    @Override
    public long findExecutionCountByQueryCriteria(ExecutionQueryImpl executionQuery) {
        return (Long) getDbSqlSession().selectOne("selectExecutionCountByQueryCriteria",
            executionQuery);
    }
    ...
    public List<ExecutionEntity> findExecutionsByQueryCriteria(ExecutionQueryImpl executionQuery,
        ...
        return getDbSqlSession().selectList("selectExecutionsByQueryCriteria", executionQuery, page,
            !performanceSettings.isEnableEagerExecutionTreeFetching()); // False -> executions should not be cached if using executionTreeFetching
    }

    @Override
    public long findProcessInstanceCountByQueryCriteria(ProcessInstanceQueryImpl executionQuery) {
        return (Long) getDbSqlSession().selectOne("selectProcessInstanceCountByQueryCriteria",
            executionQuery);
    }
    ...
    public List<ProcessInstance> findProcessInstanceAndVariablesByQueryCriteria(
        ...
        List<ProcessInstance> instanceList = getDbSqlSession().selectListWithRawParameterWithoutFilter(
            "selectProcessInstanceWithVariablesByQueryCriteria", executionQuery,
        ...
        if (instanceList != null && !instanceList.isEmpty()) {
            if (firstResult > 0) {
                if (firstResult <= instanceList.size()) {
                    int toIndex =
                        firstResult + Math.min(maxResults, instanceList.size() - firstResult);
    ...
    public List<Execution> findExecutionsByNativeQuery(Map<String, Object> parameterMap,
        ...
        return getDbSqlSession().selectListWithRawParameter("selectExecutionByNativeQuery",
    ...
    public long findExecutionCountByNativeQuery(Map<String, Object> parameterMap) {
        return (Long) getDbSqlSession().selectOne("selectExecutionCountByNativeQuery",
            parameterMap);
    }
    ...
    @Override
    public void updateProcessInstanceLockTime(String processInstanceId, Date lockDate,
        Date expirationTime) {
        HashMap<String, Object> params = new HashMap<String, Object>();
