...
public interface ExecutionQuery extends Query<ExecutionQuery, Execution> {
     ...
     * <p>
     * Note that only process instances have a business key and as such, child executions will NOT
     * be returned. If you want to return child executions of the process instance with the given
     * business key too, use the {@link #processInstanceBusinessKey(String, boolean)} method with a
     * boolean value of <i>true</i> instead.
     */
    ExecutionQuery processInstanceBusinessKey(String processInstanceBusinessKey);

    /**
     * Only executions with the given business key. Similar to {@link #processInstanceBusinessKey(String)},
    ...
    /**
     * Only select executions which are a direct child-execution of the execution with the given
     * id.
     **/
     ...
     *              '%' to express like-strategy: starts with (string%), ends with (%string) or
     *              contains (%string%).
     */
     ...
     * <p>
     * (The messageName is specified using the 'name' attribute of the message element in the BPMN
     * 2.0 XML.)
     *
