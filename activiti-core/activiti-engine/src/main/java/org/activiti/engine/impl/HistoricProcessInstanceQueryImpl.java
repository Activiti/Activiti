 ...
 *
 */
public class HistoricProcessInstanceQueryImpl extends
    AbstractVariableQueryImpl<HistoricProcessInstanceQuery, HistoricProcessInstance> implements
    ...
    @Override
    public HistoricProcessInstanceQuery variableValueEquals(String variableName,
    ...
    @Override
    public HistoricProcessInstanceQuery variableValueNotEquals(String variableName,
        Object variableValue) {
        if (inOrStatement) {
    ...
    @Override
    public HistoricProcessInstanceQuery variableValueNotEqualsIgnoreCase(String name,
        String value) {
        if (inOrStatement) {
    ...
    public List<HistoricProcessInstance> executeList(CommandContext commandContext, Page page) {
        ...
        if (includeProcessVariables) {
            results = commandContext.getHistoricProcessInstanceEntityManager()
        ...
        if (Context.getProcessEngineConfiguration().getPerformanceSettings()
    ...
    protected void localize(HistoricProcessInstance processInstance,
        ...
        if (locale != null && processInstance.getProcessDefinitionId() != null) {
            ProcessDefinition processDefinition = commandContext.getProcessEngineConfiguration()
                ...
                .findDeployedProcessDefinitionById(processInstanceEntity.getProcessDefinitionId());
