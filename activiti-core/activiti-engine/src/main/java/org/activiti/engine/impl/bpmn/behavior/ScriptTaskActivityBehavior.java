...
public class ScriptTaskActivityBehavior extends TaskActivityBehavior {
    ...
    public ScriptTaskActivityBehavior(String scriptTaskId, String script, String language,
    ...
    public void execute(DelegateExecution execution) {
        ...
        ScriptingEngines scriptingEngines = Context.getProcessEngineConfiguration()
            .getScriptingEngines();
        ...
        if (Context.getProcessEngineConfiguration().isEnableProcessDefinitionInfoCache()) {
            ...
            if (taskElementProperties != null && taskElementProperties.has(
                ...
                String overrideScript = taskElementProperties.get(
                    DynamicBpmnConstants.SCRIPT_TASK_SCRIPT).asText();
        ...
        try {
            ...
            LOGGER.warn(
                "Exception while executing " + execution.getCurrentFlowElement().getId() + " : "
                    + e.getMessage());
