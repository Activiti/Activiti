...
public interface ExecutionEntityManager extends EntityManager<ExecutionEntity> {
    ...
    ExecutionEntity createSubprocessInstance(ProcessDefinition processDefinition,
        ExecutionEntity superExecutionEntity, String businessKey);

    /**
     * Finds the {@link ExecutionEntity} for the given root process instance id. All children will
     * have been fetched and initialized.
     */
    ...
    List<ExecutionEntity> findExecutionsByParentExecutionAndActivityIds(String parentExecutionId,
    ...
    List<Execution> findExecutionsByNativeQuery(Map<String, Object> parameterMap, int firstResult,
        int maxResults);
    ...
    /**
     * Returns all child executions of a given {@link ExecutionEntity}. In the list, child
     * executions will be behind parent executions.
     */
    ...
    void deleteProcessInstancesByProcessDefinition(String processDefinitionId, String deleteReason,
        boolean cascade);
