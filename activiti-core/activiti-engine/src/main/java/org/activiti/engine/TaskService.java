...
public interface TaskService {
     ...
     *
     * <p>The returned task is transient and must be saved with {@link #saveTask(Task)} 'manually'.
     */
    Task newTask();
     ...
     * @throws ActivitiException when an error occurs while deleting the tasks or in case one of the
     ...
     *
     * <p>Authorization: actual owner / business admin
     *
     * @param taskId id of the task, cannot be null.
    ...
    Map<String, VariableInstance> getVariableInstances(
            String taskId, Collection<String> variableNames);
    ...
    Map<String, DataObject> getDataObjects(
            String taskId, String locale, boolean withLocalizationFallback);
    ...
    DataObject getDataObject(
            String taskId, String dataObjectName, String locale, boolean withLocalizationFallback);
