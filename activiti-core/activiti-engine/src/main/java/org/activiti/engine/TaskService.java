...
public interface TaskService {
   ...
   * with {@link #setAssignee(String, String)} is that here a check is done if the task already has
   * a user assigned to it. No check is done whether the user is known by the identity component.
   *
   ...
   * returns, the {@link Task#getDelegationState() delegationState} is set to {@link
   ...
   * most outer scope. This means the process instance in case this task is related to an execution.
   */
