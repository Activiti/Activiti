...
public class ExecutionEntityManagerImpl
    ...
    public ExecutionEntity createSubprocessInstance(
        ...
        String authenticatedUserId = Optional.ofNullable(Authentication.getAuthenticatedUserId()).orElseGet(() ->
            getStartUserId(superExecutionEntity)
        );
    ...
    private void deleteExecutionEntity(ExecutionEntity executionEntity, String deleteReason) {
        ...
        if (
            ...
            Collection<IdentityLinkEntity> identityLinks =
                identityLinkEntityManager.findIdentityLinksByProcessInstanceId(executionEntity.getProcessInstanceId());
