...
public class ModelQueryProperty implements QueryProperty {
    ...
    private static final Map<String, ModelQueryProperty> properties =
            new HashMap<String, ModelQueryProperty>();
    ...
    public static final ModelQueryProperty MODEL_CREATE_TIME =
            new ModelQueryProperty("RES.CREATE_TIME_");
    public static final ModelQueryProperty MODEL_LAST_UPDATE_TIME =
            new ModelQueryProperty("RES.LAST_UPDATE_TIME_");
    ...
    public static final ModelQueryProperty MODEL_TENANT_ID =
            new ModelQueryProperty("RES.TENANT_ID_");
