        ...
        if (isValidEvent(event)) {
            ...
            if (event.getProcessInstanceId() == null && processInstanceScope) {
                throw new ActivitiIllegalArgumentException(
                        "Cannot throw process-instance scoped signal, since the dispatched event is"
                                + " not part of an ongoing process instance");
            }
            ...
            for (SignalEventSubscriptionEntity signalEventSubscriptionEntity :
                    subscriptionEntities) {
