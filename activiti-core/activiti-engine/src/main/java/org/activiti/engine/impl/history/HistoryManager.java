...
public interface HistoryManager {
    ...
    HistoricActivityInstanceEntity findActivityInstance(ExecutionEntity execution,
        boolean createOnNotFound, boolean validateEndTimeNull);
     ...
     * enabled.
     */
    void recordTaskProcessDefinitionChange(String taskId,
     ...
     * history is enabled.
     */
    void createIdentityLinkComment(String taskId, String userId, String groupId, String type,
        boolean create);
     ...
     * history is enabled.
     */
    void createProcessInstanceIdentityLinkComment(String processInstanceId, String userId,
     ...
     * enabled.
     */
    void createAttachmentComment(String taskId, String processInstanceId, String attachmentName,
        boolean create);
