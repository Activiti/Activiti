...
public interface HistoryManager {
    ...
    /**
     * @return true, if the configured history-level is equal to OR set to a higher value than the
     *     given level.
     */
    ...
    /**
     * Record a process-instance ended. Updates the historic process instance if activity history is
     * enabled.
     */
    ...
    /**
     * Record a sub-process-instance started and alters the calledProcessinstanceId on the current
     * active activity's historic counterpart. Only effective when activity history is enabled.
     */
    void recordSubProcessInstanceStart(
    ...
    HistoricActivityInstanceEntity findActivityInstance(
            ExecutionEntity execution, boolean createOnNotFound, boolean validateEndTimeNull);

    /**
     * Record a change of the process-definition id of a process instance, if activity history is
     * enabled.
     */
    ...
    /**
     * Record the id of a the task associated with a historic activity, if activity history is
     * enabled.
     */
    ...
    /**
     * Record a change of the process-definition id of a task instance, if activity history is
     * enabled.
     */
    ...
    /**
     * Creates a new comment to indicate a new {@link IdentityLink} has been created or deleted, if
     * history is enabled.
     */
    ...
    /**
     * Creates a new comment to indicate a new user {@link IdentityLink} has been created or
     * deleted, if history is enabled.
     */
    void createUserIdentityLinkComment(String taskId, String userId, String type, boolean create);

    /**
     * Creates a new comment to indicate a new group {@link IdentityLink} has been created or
     * deleted, if history is enabled.
     */
    ...
    /**
     * Creates a new comment to indicate a new attachment has been created or deleted, if history is
     * enabled.
     */
