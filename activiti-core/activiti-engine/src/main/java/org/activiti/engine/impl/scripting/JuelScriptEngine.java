 ...
 * <p>
 * Uses EL 1.1 if available, to resolve expressions. Otherwise it reverts to EL 1.0, using {@link
...
public class JuelScriptEngine extends AbstractScriptEngine implements Compilable {
    ...
    private ELResolver createElResolver() {
        ...
        compositeResolver.add(new DynamicBeanPropertyELResolver(ItemInstance.class, "getFieldValue",
            "setFieldValue"));
    ...
    private static Method getImportMethod() {
        try {
            return JuelScriptEngine.class.getMethod("importFunctions",
                ScriptContext.class, String.class, Object.class);
        } catch (Exception exp) {
            // Will never occur
            return null;
        }
