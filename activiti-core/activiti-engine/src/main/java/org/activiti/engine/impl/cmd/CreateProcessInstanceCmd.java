...
public class CreateProcessInstanceCmd implements Command<ProcessInstance> {
    ...
    public CreateProcessInstanceCmd(String processDefinitionKey, String processDefinitionId,
    ...
    public ProcessInstance execute(CommandContext commandContext) {
        ...
        ProcessDefinitionRetriever processRetriever = new ProcessDefinitionRetriever(this.tenantId,
            deploymentCache);
        ...
        return processInstanceHelper.createProcessInstance(processDefinition, businessKey,
