 ...
 *
 */
public class MybatisModelDataManager extends AbstractDataManager<ModelEntity> implements
    ModelDataManager {
    ...
    @Override
    @SuppressWarnings("unchecked")
    public List<Model> findModelsByNativeQuery(Map<String, Object> parameterMap, int firstResult,
        int maxResults) {
        return getDbSqlSession().selectListWithRawParameter("selectModelByNativeQuery",
