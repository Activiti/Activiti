...
public class DeserializedObject {
    ...
    public DeserializedObject(SerializableType type, Object deserializedObject,
        byte[] serializedBytes, VariableInstanceEntity variableInstanceEntity) {
        this.type = type;
    ...
    public void verifyIfBytesOfSerializedObjectChanged() {
        ...
        if (deserializedObject == variableInstanceEntity.getCachedValue()
            ...
            if (!Arrays.equals(originalBytes, bytes)) {
                ...
                byte[] refreshedOriginalBytes = type.serialize(originalObject,
