...
public interface Query<T extends Query<?, ?>, U> {
    ...
    /**
     * Order the results ascending on the given property as defined in this class (needs to come
    ...
    /**
     * Order the results by the given {@link QueryProperty} (needs to be followed by {@link #asc()}
     * or {@link #desc()})
     *
