 ...
 * <p>
 * Currently, only 8-bits are supported, but can be extended to use all 31 bits in the integer (1st
 * of 32 bits is used for sign).
 */
public class BitMaskUtil {
    ...
    private static final int[] MASKS = {FLAG_BIT_1, FLAG_BIT_2, FLAG_BIT_3, FLAG_BIT_4, FLAG_BIT_5,
        FLAG_BIT_6, FLAG_BIT_7, FLAG_BIT_8};
