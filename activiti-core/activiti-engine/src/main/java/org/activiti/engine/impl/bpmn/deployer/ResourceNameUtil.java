...
public class ResourceNameUtil {
    ...
    public static String getProcessDiagramResourceName(String bpmnFileResource, String processKey,
     ...
     * that if abc.a.png, abc.b.png and abc.c.png don't exist, all processes will have the same
     * image: abc.png.
     *
