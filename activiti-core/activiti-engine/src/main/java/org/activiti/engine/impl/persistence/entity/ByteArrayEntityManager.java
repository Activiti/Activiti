...
public interface ByteArrayEntityManager extends EntityManager<ByteArrayEntity> {
     ...
     * operation will NOT do any optimistic locking, to avoid loading the bytes in memory. So use
     * this method only in conjunction with an entity that has optimistic locking!.
     */
