...
public interface SuspendedJobEntityManager extends EntityManager<SuspendedJobEntity> {
    ...
    /**
     * Executes a {@link JobQueryImpl} and returns the matching {@link SuspendedJobEntity}
     * instances.
     */
    List<Job> findJobsByQueryCriteria(SuspendedJobQueryImpl jobQuery, Page page);

    /**
     * Same as {@link #findJobsByQueryCriteria(SuspendedJobQueryImpl, Page)}, but only returns a
