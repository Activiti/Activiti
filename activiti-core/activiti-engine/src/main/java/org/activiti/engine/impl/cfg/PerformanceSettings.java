...
public class PerformanceSettings {
     ...
     * <p>
     * Less roundtrips to the database outweighs doing many, smaller fetches and often multiple
     ...
     * <p>
     * This makes the delete more performant as a query is not needed anymore to check if there is
