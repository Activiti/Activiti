...
public class PerformanceSettings {
  ...
  /**
   * Experimental setting: if true, whenever an execution is fetched from the data store, the whole
   * execution tree is fetched in the same roundtrip.
   *
   ...
   *
   * <p>This makes the delete more performant as a query is not needed anymore to check if there is
   * related data. However, maintaining the count does mean more updates to the execution and
   * potentially more optimistic locking opportunities. Typically keeping the counts lead to better
   * performance as deletes are a large part of the execution tree maintenance.
   */
