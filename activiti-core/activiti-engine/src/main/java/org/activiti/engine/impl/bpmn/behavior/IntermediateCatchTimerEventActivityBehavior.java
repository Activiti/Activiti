...
public class IntermediateCatchTimerEventActivityBehavior extends
    ...
    public void execute(DelegateExecution execution) {
        ...
        TimerJobEntity timerJob = jobManager.createTimerJob(timerEventDefinition, false,
            (ExecutionEntity) execution, TriggerTimerEventJobHandler.TYPE,
            TimerEventHandler.createConfiguration(execution.getCurrentActivityId(), null,
