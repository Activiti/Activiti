...
public class ExecuteAsyncRunnable implements Runnable {
    ...
    public ExecuteAsyncRunnable(String jobId,
        ProcessEngineConfigurationImpl processEngineConfiguration) {
        this.jobId = jobId;
        this.processEngineConfiguration = processEngineConfiguration;
    }

    public ExecuteAsyncRunnable(Job job,
        ProcessEngineConfigurationImpl processEngineConfiguration) {
        this.job = job;
    ...
    protected void handleFailedJob(final Throwable exception) {
        processEngineConfiguration.getCommandExecutor().execute(new Command<Void>() {
            ...
            public Void execute(CommandContext commandContext) {
                ...
                CommandConfig commandConfig = processEngineConfiguration.getCommandExecutor()
                ...
                log.trace("Using FailedJobCommandFactory '" + failedJobCommandFactory.getClass()
                    + "' and command of type '" + cmd.getClass() + "'");
