...
public class SequentialMultiInstanceBehavior extends MultiInstanceActivityBehavior {
    ...
    public void leave(DelegateExecution childExecution) {
        DelegateExecution multiInstanceRootExecution =
                getMultiInstanceRootExecution(childExecution);
        ...
        int nrOfActiveInstances =
                getLoopVariable(multiInstanceRootExecution, NUMBER_OF_ACTIVE_INSTANCES);

        setLoopVariable(
                multiInstanceRootExecution, NUMBER_OF_COMPLETED_INSTANCES, nrOfCompletedInstances);
        ...
        if (loopCounter >= nrOfInstances
            ...
            try {
                ...
                if (childExecution.getCurrentFlowElement() instanceof SubProcess) {
                    ...
                    setLoopVariable(
                            executionToContinue, getCollectionElementIndexVariable(), loopCounter);
