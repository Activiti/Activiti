...
public class CollectionUtil {
     ...
     * <p>
     * Alternative for singletonMap()), since that method returns a generic typed map <K,T>
    ...
    /**
     * Helper method to easily create a map with keys of type String and values of a given Class.
    ...
    public static <T> Map<String, T> mapOfClass(Class<T> clazz, Object... objects) {
        ...
        for (int i = 0; i < objects.length; i += 2) {
            ...
            if (value != null && !clazz.isInstance(value)) {
                throw new ActivitiIllegalArgumentException(
                    "value at index " + valueIndex + " should be a " + clazz + " but is a "
                        + value.getClass());
            }
