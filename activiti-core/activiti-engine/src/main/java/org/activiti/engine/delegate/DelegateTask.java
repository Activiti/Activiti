...
public interface DelegateTask extends VariableScope {
    ...
    /**
     * The category of the task. This is an optional field and allows to 'tag' tasks as belonging to
     * a certain category.
     */
    String getCategory();
    ...
    /**
     * Convenience shorthand for {@link #deleteUserIdentityLink(String, String)} ; with type {@link
