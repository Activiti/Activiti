    ...
    public EventLogEntryEntity generateEventLogEntry(CommandContext commandContext) {
        ...
        if (event instanceof ActivitiEntityWithVariablesEvent) {
            ...
            if (activitiEntityWithVariablesEvent.getVariables() != null
                ...
                for (Object variableName : activitiEntityWithVariablesEvent.getVariables()
                    .keySet()) {
        ...
        return createEventLogEntry(task.getProcessDefinitionId(), task.getProcessInstanceId(),
            task.getExecutionId(), task.getId(), data);
    }
