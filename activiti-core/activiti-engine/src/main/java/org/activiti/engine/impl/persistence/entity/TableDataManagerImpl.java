...
public class TableDataManagerImpl extends AbstractManager implements TableDataManager {
        ...
        try {
            ...
            try {
                ...
                if ("oracle".equals(getDbSqlSession().getDbSqlSessionFactory().getDatabaseType())) {
                    tableNameFilter =
                        databaseTablePrefix + "ACT" + databaseMetaData.getSearchStringEscape()
                            + "_%";
                }
                ...
                tables = databaseMetaData.getTables(catalog, schema, tableNameFilter,
    ...
    public TableMetaData getTableMetaData(String tableName) {
        ...
        try {
            ...
            DatabaseMetaData metaData = getDbSqlSession().getSqlSession().getConnection()
                .getMetaData();
                ...
                if (schema != null && schema.length() > 0) {
                    for (int i = 0; i < resultSet.getMetaData().getColumnCount(); i++) {
                        ...
                        if ("TABLE_SCHEM".equalsIgnoreCase(columnName)
                            ...
                            if (!schema.equalsIgnoreCase(resultSet.getString(
