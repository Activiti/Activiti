 ...
 *
 * <p>
 * To create a process engine programmatic, without a configuration file, the first option is {@link
 ...
 * case
 * <code>create-drop</code>. Standalone mode means that Activiti will manage the transactions on the
 * JDBC connections that it creates. One transaction per service method.
 * </p>
 *
 * <p>
...
public abstract class ProcessEngineConfiguration {
     ...
     * <p>
     * This will be added at then end of queries that include for example a LIKE clause. For
    ...
    public static ProcessEngineConfiguration createProcessEngineConfigurationFromResource(
        ...
        return BeansConfigurationHelper.parseProcessEngineConfigurationFromResource(resource,
            beanName);
    }
