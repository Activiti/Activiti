...
public class IntermediateCatchEventActivityBehavior extends AbstractBpmnActivityBehavior {
    ...
    public void eventCancelledByEventGateway(DelegateExecution execution) {
        Context.getCommandContext().getExecutionEntityManager()
            .deleteExecutionAndRelatedData((ExecutionEntity) execution,
    ...
    protected void deleteOtherEventsRelatedToEventBasedGateway(DelegateExecution execution,
        ...
        Set<String> eventActivityIds = new HashSet<String>(outgoingSequenceFlows.size()
        ...
        List<ExecutionEntity> executionEntities = executionEntityManager
            .findExecutionsByParentExecutionAndActivityIds(execution.getParentId(),
                eventActivityIds);
            ...
            if (eventActivityIds.contains(executionEntity.getActivityId())
                ...
                if (intermediateCatchEvent.getBehavior() instanceof IntermediateCatchEventActivityBehavior) {
                    ...
                    eventActivityIds.remove(
                        executionEntity.getActivityId()); // We only need to delete ONE execution at the event.
                }
            }
        }
    }
