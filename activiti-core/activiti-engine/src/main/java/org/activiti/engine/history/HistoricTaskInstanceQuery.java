 ...
 */
@Internal
public interface HistoricTaskInstanceQuery extends
    TaskInfoQuery<HistoricTaskInstanceQuery, HistoricTaskInstance> {
    ...
    /**
     * Only select historic task instances which are part of a process instance which is not
     * finished yet.
     */
