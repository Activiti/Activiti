...
public interface HistoricProcessInstance {
     ...
     * can have multiple end events, in this case it might not be deterministic which activity id
     * will be referenced here. Use a {@link HistoricActivityInstanceQuery} instead to query for end
     * events of the process instance (use the activityTYpe attribute)
     */
