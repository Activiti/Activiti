...
@Internal
@Deprecated
public class CommentEntityManagerImpl extends AbstractEntityManager<CommentEntity> implements
    ...
    public void insert(CommentEntity commentEntity) {
        ...
        if (getEventDispatcher().isEnabled()) {
            ...
            if (comment.getProcessInstanceId() != null) {
                ExecutionEntity process = getExecutionEntityManager().findById(
                    comment.getProcessInstanceId());
                if (process != null) {
