...
public class ListenerNotificationHelper {
    ...
    public void executeExecutionListeners(HasExecutionListeners elementWithExecutionListeners,
        ...
        if (listeners != null && listeners.size() > 0) {
            ListenerFactory listenerFactory = Context.getProcessEngineConfiguration()
                .getListenerFactory();
            for (ActivitiListener activitiListener : listeners) {
                ...
                if (eventType.equals(activitiListener.getEvent())) {
                    ...
                    if (ImplementationType.IMPLEMENTATION_TYPE_CLASS.equalsIgnoreCase(
                        ...
                        activitiListener.getImplementationType())) {
                        executionListener = listenerFactory.createExpressionExecutionListener(
                            activitiListener);
    ...
    protected void planTransactionDependentExecutionListener(ListenerFactory listenerFactory,
        ...
        CustomPropertiesResolver customPropertiesResolver = createCustomPropertiesResolver(
            activitiListener);
        Map<String, Object> customPropertiesMapToUse = invokeCustomPropertiesResolver(execution,
    ...
    protected BaseTaskListener createTaskListener(ActivitiListener activitiListener) {
        ...
        if (ImplementationType.IMPLEMENTATION_TYPE_CLASS.equalsIgnoreCase(
            ...
            if (activitiListener.getOnTransaction() != null) {
                ...
                taskListener = listenerFactory.createDelegateExpressionTaskListener(
                    activitiListener);
            }
        } else if (ImplementationType.IMPLEMENTATION_TYPE_INSTANCE.equalsIgnoreCase(
            activitiListener.getImplementationType())) {
    ...
    protected void planTransactionDependentTaskListener(DelegateExecution execution,
        ...
        TransactionDependentTaskListenerExecutionScope scope = new TransactionDependentTaskListenerExecutionScope(
            ...
            (Task) execution.getCurrentFlowElement(), executionVariablesToUse,
