                ...
                if (eventType.equals(activitiListener.getEvent())) {
                    ...
                    if (ImplementationType.IMPLEMENTATION_TYPE_CLASS.equalsIgnoreCase(
                        ...
                        executionListener =
                            ...
                            activitiListener.getImplementationType())) {
                        executionListener =
                                listenerFactory.createExpressionExecutionListener(activitiListener);
                    ...
                    if (executionListener != null) {
                        if (activitiListener.getOnTransaction() != null) {
                            ...
                            execution.setEventName(
                                    eventType); // eventName is used to differentiate the event when
                            // reusing an
    ...
    public void executeTaskListeners(TaskEntity taskEntity, String eventType) {
        if (taskEntity.getProcessDefinitionId() != null) {
            ...
            FlowElement flowElement =
                    process.getFlowElement(taskEntity.getTaskDefinitionKey(), true);
                        ...
                        Context.getProcessEngineConfiguration()
                                ...
                                .handleInvocation(
                                        new TaskListenerInvocation(
                                                (TaskListener) taskListener, taskEntity));
                    } catch (Exception e) {
    ...
    protected BaseTaskListener createTaskListener(ActivitiListener activitiListener) {
        ...
        if (ImplementationType.IMPLEMENTATION_TYPE_CLASS.equalsIgnoreCase(
            ...
            if (activitiListener.getOnTransaction() != null) {
                ...
                taskListener =
                        listenerFactory.createDelegateExpressionTaskListener(activitiListener);
            }
        } else if (ImplementationType.IMPLEMENTATION_TYPE_INSTANCE.equalsIgnoreCase(
                activitiListener.getImplementationType())) {
    ...
    protected void addTransactionListener(
        ...
        if (TransactionDependentExecutionListener.ON_TRANSACTION_BEFORE_COMMIT.equals(
            ...
            transactionContext.addTransactionListener(
                    TransactionState.COMMITTING, transactionListener);
            ...
            transactionContext.addTransactionListener(
                ...
                activitiListener.getOnTransaction())) {
            transactionContext.addTransactionListener(
                    TransactionState.ROLLED_BACK, transactionListener);
        }
    }
}
