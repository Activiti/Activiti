...
public class EventSubscriptionManager {
    ...
    protected void insertMessageEvent(
        ...
        for (EventSubscriptionEntity eventSubscriptionEntity : subscriptionsForSameMessageName) {
            ...
            if (eventSubscriptionEntity.getProcessInstanceId() == null
                    || eventSubscriptionEntity
                            .getProcessInstanceId()
                            .isEmpty()) { // processInstanceId != null or not empty -> it's a
                // message related to
                // an execution
                ...
                throw new ActivitiException(
                        "Cannot deploy process definition '"
                                ...
                                + "': there already is a message event subscription for the message"
                                + " with name '"
                                + messageEventDefinition.getMessageRef()
                                + "'.");
            }
                ...
                if (element instanceof StartEvent) {
                    ...
                    if (CollectionUtil.isNotEmpty(startEvent.getEventDefinitions())) {
                        ...
                        if (eventDefinition instanceof SignalEventDefinition) {
                            ...
                            Signal signal =
                                    bpmnModel.getSignal(signalEventDefinition.getSignalRef());
                            if (signal != null) {
