...
public interface SyncWebServiceClient {
     ...
     * @param overridenEndpointAddresses a not null map of overriden enpoint addresses. The key is
     *                                   the endpoint qualified name.
     * @return the result of invoking the method of the web service
     */
    Object[] send(String methodName, Object[] arguments,
