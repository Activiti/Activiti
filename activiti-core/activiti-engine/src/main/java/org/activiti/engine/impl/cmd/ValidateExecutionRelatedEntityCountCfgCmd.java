...
public class ValidateExecutionRelatedEntityCountCfgCmd implements Command<Void> {
    ...
    public Void execute(CommandContext commandContext) {
        ...
        boolean configProperty = commandContext.getProcessEngineConfiguration()
            .getPerformanceSettings().isEnableExecutionRelationshipCounts();
        ...
        if (propertyEntity == null) {
            ...
            boolean propertyValue = Boolean.valueOf(
                propertyEntity.getValue().toLowerCase());
            if (!configProperty && propertyValue) {
                ...
                commandContext.getProcessEngineConfiguration().getExecutionDataManager()
