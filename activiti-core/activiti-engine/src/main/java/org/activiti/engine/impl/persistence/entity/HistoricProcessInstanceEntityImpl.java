 ...
 *
 */
public class HistoricProcessInstanceEntityImpl extends HistoricScopeInstanceEntityImpl implements
    HistoricProcessInstanceEntity, BulkDeleteable {
    ...
    public HistoricProcessInstanceEntityImpl(ExecutionEntity processInstance) {
        ...
        superProcessInstanceId =
            processInstance.getSuperExecution() != null ? processInstance.getSuperExecution()
