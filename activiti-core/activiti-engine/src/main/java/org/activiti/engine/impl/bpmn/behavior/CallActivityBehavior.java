...
public class CallActivityBehavior
    ...
    public void execute(DelegateExecution execution) {
        String finalProcessDefinitionKey = resolveProcessDefinitionKey(
            execution
        );
        ProcessDefinition processDefinition = findProcessDefinition(
            finalProcessDefinitionKey,
            execution.getTenantId()
        );

        // Get model from cache
        Process subProcess = ProcessDefinitionUtil.getProcess(
        ...
        Map<String, Object> variables = processDataObjects(
        ...
        Map<String, Object> variablesFromExtensionFile = calculateInboundVariables(
            execution,
            processDefinition
        );
    ...
    private String resolveProcessDefinitionKey(DelegateExecution execution) {
        ...
        if (processDefinitionExpression != null) {
            finalProcessDefinitionKey =
                (String) processDefinitionExpression.getValue(execution);
        } else {
