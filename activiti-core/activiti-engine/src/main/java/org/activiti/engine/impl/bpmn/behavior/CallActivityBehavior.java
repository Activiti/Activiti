 ...
 * (yet) a global task).
 */
public class CallActivityBehavior extends AbstractBpmnActivityBehavior implements
    ...
    public CallActivityBehavior(String processDefinitionKey,
        ...
        this(processDefinitionKey, mapExceptions,
            new VariablesPropagator(new NoneVariablesCalculator()));
    }
    ...
    public CallActivityBehavior(Expression processDefinitionExpression,
        List<MapExceptionEntry> mapExceptions) {
        this(processDefinitionExpression, mapExceptions,
            new VariablesPropagator(new NoneVariablesCalculator()));
    }
    ...
    public void execute(DelegateExecution execution) {
        ...
        ProcessDefinition processDefinition = findProcessDefinition(finalProcessDefinitionKey,
        ...
        if (subProcess == null) {
            throw new ActivitiException(
                "Cannot start a sub process instance. Process model " + processDefinition.getName()
        ...
        Map<String, Object> variablesFromExtensionFile = calculateInboundVariables(execution,
            processDefinition);
        ...
        ExecutionEntity subProcessInitialExecution = executionEntityManager.createChildExecution(
            subProcessInstance);
        ...
        Context.getProcessEngineConfiguration().getEventDispatcher()
            .dispatchEvent(
                ActivitiEventBuilder.createProcessStartedEvent(subProcessInitialExecution,
                    variables, false));
    }
    ...
    protected ProcessDefinition findProcessDefinition(String processDefinitionKey,
        ...
        if (tenantId == null || ProcessEngineConfiguration.NO_TENANT_ID.equals(tenantId)) {
            ...
            return Context.getProcessEngineConfiguration().getDeploymentManager()
                .findDeployedLatestProcessDefinitionByKeyAndTenantId(processDefinitionKey,
                    tenantId);
        }
    }
    ...
    protected void initializeVariables(ExecutionEntity subProcessInstance,
    ...
    protected Map<String, Object> copyProcessVariables(DelegateExecution execution,
    ...
    protected DelegateExecution copyOutParameters(DelegateExecution execution,
