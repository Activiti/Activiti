...
public class ProcessDefinitionInfoCache {
        ...
        this.cache =
                synchronizedMap(
                        new LinkedHashMap<String, ProcessDefinitionInfoCacheObject>(
                            ...
                            // true will keep the 'access-order', which is needed to have a real LRU
                            // cache
                ...
                new Command<ProcessDefinitionInfoCacheObject>() {
                    ...
                    public ProcessDefinitionInfoCacheObject execute(CommandContext commandContext) {
                        return retrieveProcessDefinitionInfoCacheObject(
                                processDefinitionId, commandContext);
                    }
                };
    ...
    protected ProcessDefinitionInfoCacheObject retrieveProcessDefinitionInfoCacheObject(
        ...
        ProcessDefinitionInfoEntity infoEntity =
                infoEntityManager.findProcessDefinitionInfoByProcessDefinitionId(
                        processDefinitionId);
