...
public class ConsoleLogger {
    ...
    public void log() {
        for (ProfileSession profileSession : profiler.getProfileSessions()) {
            ...
            System.out.println(
                "Total time: " + profileSession.getTotalTime() + " ms"
            );
            System.out.println();
            ...
            for (String classFqn : allStats.keySet()) {
                ...
                System.out.println(
                    "Number of times invoked: " + stats.getCount()
                );
                double commandPercentage = (double) stats.getTotalCommandTime /
                (double) profileSession.getTotalTime();
                System.out.println(
                ...
                for (String select : stats.getDbSelects().keySet()) {
                    System.out.println(
                        select + " : " + stats.getDbSelects().get(select)
                    );
                }
                ...
                for (String insert : stats.getDbInserts().keySet()) {
                    System.out.println(
                        insert + " : " + stats.getDbInserts().get(insert)
                    );
                }
                ...
                for (String update : stats.getDbUpdates().keySet()) {
                    System.out.println(
                        update + " : " + stats.getDbSelects().get(update)
                    );
                }
                ...
                for (String delete : stats.getDbDeletes().keySet()) {
                    System.out.println(
                        delete + " : " + stats.getDbDeletes().get(delete)
                    );
                }
