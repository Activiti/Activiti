 ...
 */
@Internal
public interface TaskInfoQuery<T extends TaskInfoQuery<?, ?>, V extends TaskInfo> extends
    Query<T, V> {
     ...
     * Only select tasks with a name that is in the given list
     * <p>
     * This method, unlike the {@link #taskNameIn(List)} method will not take in account the
     ...
     * usage: nameLike(%activiti%)
     * <p>
     * This method, unlike the {@link #taskNameLike(String)} method will not take in account the
     ...
     * example usage: descriptionLike(%activiti%)
     * <p>
     * This method, unlike the {@link #taskDescriptionLike(String)} method will not take in account
     ...
     * that should be used is the same as in SQL, eg. %activiti%.
     * <p>
     * This method, unlike the {@link #taskAssigneeLike(String)} method will not take in account the
     * upper/lower case: both the input parameter as the column value are lowercased when the query
     * is executed.
     */
     ...
     * should be used is the same as in SQL, eg. %activiti%.
     * <p>
     * This method, unlike the {@link #taskOwnerLike(String)} method will not take in account the
     * upper/lower case: both the input parameter as the column value are lowercased when the query
     * is executed.
     */
     ...
     *
     * @throws ActivitiIllegalArgumentException When query is executed and {@link #taskCandidateGroup(String)}
     *                                          or {@link #taskCandidateUser(String)} has been
     *                                          executed on the query instance. When passed group
     *                                          list is empty or
     *                                          <code>null</code>.
     */
     ...
     * example usage: processInstanceBusinessKeyLike("%activiti%").
     * <p>
     * This method, unlike the {@link #processInstanceBusinessKeyLike(String)} method will not take
     ...
     * like the given value. The syntax that should be used is the same as in SQL, eg. %activiti%.
     * <p>
     * This method, unlike the {@link #processDefinitionKeyLike(String)} method will not take in
     ...
     * @throws ActivitiIllegalArgumentException When passed category list is empty or
     *                                          <code>null</code> or contains <code>null
     *                                          String</code>.
     */
     ...
     * case-sensitive Collations available (<a href="http://msdn.microsoft.com/en-us/library/ms144250(v=sql.105).aspx"
     * >MSDN Server Collation Reference</a>).
     * </p>
     */
     ...
     * <p>
     * Calling endOr() will add all clauses to the regular query again. Calling or() after endOr()
