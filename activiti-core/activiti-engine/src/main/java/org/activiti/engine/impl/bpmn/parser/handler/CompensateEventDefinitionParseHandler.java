 ...
 *
 */
public class CompensateEventDefinitionParseHandler extends
    AbstractBpmnParseHandler<CompensateEventDefinition> {
    ...
    protected void executeParse(BpmnParse bpmnParse, CompensateEventDefinition eventDefinition) {
        ...
        if (bpmnParse.getCurrentFlowElement() instanceof ThrowEvent) {
            ...
            boundaryEvent.setBehavior(bpmnParse.getActivityBehaviorFactory()
                .createBoundaryCompensateEventActivityBehavior(boundaryEvent,
