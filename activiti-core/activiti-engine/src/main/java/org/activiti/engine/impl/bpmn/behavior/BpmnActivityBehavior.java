...
public class BpmnActivityBehavior implements Serializable {
    ...
    /**
     * Performs the default outgoing BPMN 2.0 behavior (@see {@link #performDefaultOutgoingBehavior(ExecutionEntity)}),
     ...
     * @param checkConditions                Whether or not to check conditions before determining
     *                                       whether or not to take a transition.
     * @param throwExceptionIfExecutionStuck If true, an {@link ActivitiException} will be thrown in
     *                                       case no transition could be found to leave the
     *                                       activity.
     */
