...
public class BpmnActivityBehavior implements Serializable {
     ...
     * #performDefaultOutgoingBehavior(ExecutionEntity)}), but without checking the conditions on
     * the outgoing sequence flow.
     *
     * <p>This means that every outgoing sequence flow is selected for continuing the process
     * instance, regardless of having a condition or not. In case of multiple outgoing sequence
     ...
     * @param checkConditions Whether or not to check conditions before determining whether or not
