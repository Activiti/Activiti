...
public class ActivitiEntityWithVariablesEventImpl extends ActivitiEntityEventImpl implements
    ActivitiEntityWithVariablesEvent {

    protected Map variables;
    protected boolean localScope;

    public ActivitiEntityWithVariablesEventImpl(Object entity, Map variables, boolean localScope,
