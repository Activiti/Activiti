...
public class ProcessInstanceHelper {
            ...
            if (flowElement instanceof StartEvent) {
                ...
                if (CollectionUtil.isNotEmpty(startEvent.getEventDefinitions())
                    ...
                    if (messageRef.equals(messageName)) {
                        ...
                        break;
                    } // FIXME: We should not need to reset eventDefinition messageRef to message
                    // name
    ...
    public void startProcessInstance(
            ...
            Map<String, Object> transientVariables) {
        Process process =
                ProcessDefinitionUtil.getProcess(processInstance.getProcessDefinitionId());
        ...
        if (Context.getProcessEngineConfiguration().getEventDispatcher().isEnabled()) {
            ...
            for (MessageEventSubscriptionEntity messageEventSubscription :
        ...
        if (Context.getProcessEngineConfiguration().getEventDispatcher().isEnabled()) {
            ...
            eventDispatcher.dispatchEvent(
                    ActivitiEventBuilder.createMessageReceivedEvent(
                            execution, messageName, null, variables));
        }
    }
}
