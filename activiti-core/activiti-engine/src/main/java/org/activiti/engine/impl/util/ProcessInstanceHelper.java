...
public class ProcessInstanceHelper {
  ...
  public ProcessInstance createAndStartProcessInstance(
    ...
    return createAndStartProcessInstance(
        processDefinition, businessKey, processInstanceName, variables, transientVariables, true);
  }
  ...
  public ProcessInstance createProcessInstance(
    ...
    ExecutionEntity processInstance =
        createProcessInstanceWithInitialFlowElement(
            processDefinition, businessKey, processInstanceName, initialFlowElement, process);
  ...
  public ProcessInstance createAndStartProcessInstanceByMessage(
      ...
      if (flowElement instanceof StartEvent) {
        ...
        if (CollectionUtil.isNotEmpty(startEvent.getEventDefinitions())
          ...
          MessageEventDefinition messageEventDefinition =
              (MessageEventDefinition) startEvent.getEventDefinitions().get(0);
    ...
    // Create process instance with executions but defer to start process after dispatching
    // ACTIVITY_MESSAGE_RECEIVED
    ExecutionEntity processInstance =
        createProcessInstanceWithInitialFlowElement(
            processDefinition, businessKey, null, initialFlowElement, process);
    ...
    startProcessInstance(
        processInstance, commandContext, processVariables, initialFlowElement, transientVariables);
  ...
  public ProcessInstance createAndStartProcessInstanceWithInitialFlowElement(
    ...
    if (startProcessInstance) {
      CommandContext commandContext = Context.getCommandContext();
      startProcessInstance(
          processInstance, commandContext, variables, initialFlowElement, transientVariables);
    }
      ...
      Context.getProcessEngineConfiguration()
          ...
          .dispatchEvent(
              ActivitiEventBuilder.createEntityWithVariablesEvent(
                  ActivitiEventType.ENTITY_INITIALIZED, processInstance, variables, false));
    }
  }
  ...
  public void startProcessInstance(
          ...
          if (subElement instanceof StartEvent) {
            ...
            if (CollectionUtil.isNotEmpty(startEvent.getEventDefinitions())) {
              ...
              if (eventDefinition instanceof MessageEventDefinition) {
                ...
                String messageName =
                    getMessageName(commandContext, messageEventDefinition, messageExecution);
                ...
                Optional<String> correlationKey =
                    getCorrelationKey(commandContext, messageEventDefinition, messageExecution);
    ...
    ExecutionEntity execution =
        processInstance.getExecutions().get(0); // There will always be one child execution created
        ...
        .map(
            correlationKey -> {
              Expression expression =
                  expressionManager.createExpression(messageEventDefinition.getCorrelationKey());
  ...
  protected String getMessageName(
    ...
    String messageName =
        Optional.ofNullable(messageEventDefinition.getMessageRef())
  ...
  public ExecutionEntity createProcessInstanceWithInitialFlowElement(
    ...
    ExecutionEntity execution =
        commandContext.getExecutionEntityManager().createChildExecution(processInstance);
  ...
  private void setProcessInstanceName(
      CommandContext commandContext, ExecutionEntity processInstance, String processInstanceName) {
  ...
  protected void dispatchStartMessageReceivedEvent(
      ExecutionEntity processInstance, String messageName, Map<String, Object> variables) {
    // Dispatch message received event
    if (Context.getProcessEngineConfiguration().getEventDispatcher().isEnabled()) {
