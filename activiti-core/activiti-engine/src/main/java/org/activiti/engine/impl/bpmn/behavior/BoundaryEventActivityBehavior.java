...
public class BoundaryEventActivityBehavior extends FlowNodeActivityBehavior {
    ...
    protected void executeInterruptingBehavior(ExecutionEntity executionEntity,
    ...
    protected void executeNonInterruptingBehavior(ExecutionEntity executionEntity,
        CommandContext commandContext) {
        ...
        ExecutionEntity currentlyExaminedExecution = executionEntityManager.findById(
            parentExecutionEntity.getParentId());
    ...
    protected void deleteChildExecutions(ExecutionEntity parentExecution,
        ExecutionEntity notToDeleteExecution, CommandContext commandContext) {
        ...
        String deleteReason = DeleteReason.BOUNDARY_EVENT_INTERRUPTING + " ("
