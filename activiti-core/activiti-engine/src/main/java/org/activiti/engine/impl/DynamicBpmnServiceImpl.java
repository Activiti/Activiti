...
public class DynamicBpmnServiceImpl
    ...
    public ObjectNode getProcessDefinitionInfo(String processDefinitionId) {
        return commandExecutor.execute(
            new GetProcessDefinitionInfoCmd(processDefinitionId)
        );
    }

    public void saveProcessDefinitionInfo(
        String processDefinitionId,
        ObjectNode infoNode
    ) {
        commandExecutor.execute(
            new SaveProcessDefinitionInfoCmd(processDefinitionId, infoNode)
        );
    }

    public ObjectNode changeServiceTaskClassName(String id, String className) {
        ObjectNode infoNode = processEngineConfiguration
            .getObjectMapper()
            .createObjectNode();
    ...
    public void changeServiceTaskClassName(
        String id,
        String className,
        ObjectNode infoNode
    ) {
    ...
    public ObjectNode changeServiceTaskExpression(
        String id,
        String expression
    ) {
        ObjectNode infoNode = processEngineConfiguration
    ...
    public void changeServiceTaskExpression(
        String id,
        String expression,
        ObjectNode infoNode
    ) {
    ...
    public ObjectNode changeServiceTaskDelegateExpression(
        String id,
        String expression
    ) {
        ObjectNode infoNode = processEngineConfiguration
    ...
    public void changeServiceTaskDelegateExpression(
        ...
        setElementProperty(
            id,
            SERVICE_TASK_DELEGATE_EXPRESSION,
            expression,
            infoNode
        );
    }
    ...
    public void changeScriptTaskScript(
        String id,
        String script,
        ObjectNode infoNode
    ) {
    ...
    public void changeUserTaskName(
        String id,
        String name,
        ObjectNode infoNode
    ) {
    ...
    public void changeUserTaskDescription(
        String id,
        String description,
        ObjectNode infoNode
    ) {
    ...
    public void changeUserTaskDueDate(
        String id,
        String dueDate,
        ObjectNode infoNode
    ) {
    ...
    public void changeUserTaskPriority(
        String id,
        String priority,
        ObjectNode infoNode
    ) {
    ...
    public void changeUserTaskCategory(
        String id,
        String category,
        ObjectNode infoNode
    ) {
    ...
    public void changeUserTaskFormKey(
        String id,
        String formKey,
        ObjectNode infoNode
    ) {
    ...
    public void changeUserTaskAssignee(
        String id,
        String assignee,
        ObjectNode infoNode
    ) {
    ...
    public void changeUserTaskOwner(
        String id,
        String owner,
        ObjectNode infoNode
    ) {
    ...
    public void changeUserTaskCandidateUser(
        ...
        if (overwriteOtherChangedEntries) {
            valuesNode =
                processEngineConfiguration.getObjectMapper().createArrayNode();
        } else {
            if (
                doesElementPropertyExist(
                    id,
                    USER_TASK_CANDIDATE_USERS,
                    infoNode
                )
            ) {
                valuesNode =
    ...
    public ObjectNode changeDmnTaskDecisionTableKey(
        String id,
    ...
    public void changeSequenceFlowCondition(
        String id,
        String condition,
        ObjectNode infoNode
    ) {
    ...
    public ObjectNode changeLocalizationName(
        String language,
        String id,
        String value
    ) {
    ...
    public ObjectNode changeLocalizationDescription(
        String language,
        String id,
        String value
    ) {
    ...
    protected boolean doesElementPropertyExist(
        String id,
        String propertyName,
        ObjectNode infoNode
    ) {
