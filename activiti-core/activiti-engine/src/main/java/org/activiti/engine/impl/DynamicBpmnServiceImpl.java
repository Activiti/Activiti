...
public class DynamicBpmnServiceImpl extends ServiceImpl
    ...
    public void changeUserTaskCandidateUser(
        ...
        if (overwriteOtherChangedEntries) {
            ...
            if (doesElementPropertyExist(id, USER_TASK_CANDIDATE_USERS, infoNode)) {
                valuesNode =
                        (ArrayNode) infoNode.get(BPMN_NODE).get(id).get(USER_TASK_CANDIDATE_USERS);
            }
    ...
    public void changeUserTaskCandidateGroup(
        ...
        if (overwriteOtherChangedEntries) {
            ...
            if (doesElementPropertyExist(id, USER_TASK_CANDIDATE_GROUPS, infoNode)) {
                valuesNode =
                        (ArrayNode) infoNode.get(BPMN_NODE).get(id).get(USER_TASK_CANDIDATE_GROUPS);
            }
    ...
    protected boolean doesElementPropertyExist(
            String id, String propertyName, ObjectNode infoNode) {
