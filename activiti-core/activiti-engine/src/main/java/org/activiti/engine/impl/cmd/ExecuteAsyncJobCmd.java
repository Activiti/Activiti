...
public class ExecuteAsyncJobCmd implements Command<Object>, Serializable {
    ...
    public Object execute(CommandContext commandContext) {
        ...
        // For exampel: an embedded subprocess with a couple of async tasks and a timer on the
        // boundary
        // of the subprocess
        // when the timer fires, all executions and thus also the jobs inside of the embedded
        // subprocess
        // are destroyed.
        // However, the async task jobs could already have been fetched and put in the queue....
        // while
        ...
        if (job == null) {
            log.debug(
                    "Job does not exist anymore and will not be executed. It has most likely been"
                        + " deleted as part of another concurrent part of the process instance.");
            return null;
        }
