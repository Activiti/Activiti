 ...
 */
public class SharedExecutorServiceAsyncExecutor extends DefaultAsyncJobExecutor implements
    ...
    public SharedExecutorServiceAsyncExecutor(TenantInfoHolder tenantInfoHolder) {
        ...
        setExecuteAsyncRunnableFactory(new ExecuteAsyncRunnableFactory() {
            ...
            @Override
            public Runnable createExecuteAsyncRunnable(Job job,
    ...
    public void addTenantAsyncExecutor(String tenantId, boolean startExecutor) {
        ...
        TenantAwareAcquireTimerJobsRunnable timerRunnable = new TenantAwareAcquireTimerJobsRunnable(
            this, tenantInfoHolder, tenantId);
        timerJobAcquisitionRunnables.put(tenantId, timerRunnable);
        timerJobAcquisitionThreads.put(tenantId, new Thread(timerRunnable));

        TenantAwareAcquireAsyncJobsDueRunnable asyncJobsRunnable = new TenantAwareAcquireAsyncJobsDueRunnable(
            this, tenantInfoHolder, tenantId);
        ...
        TenantAwareResetExpiredJobsRunnable resetExpiredJobsRunnable = new TenantAwareResetExpiredJobsRunnable(
            this, tenantInfoHolder, tenantId);
    ...
    protected void stopThreadsForTenant(String tenantId) {
        ...
        try {
            ...
            logger.warn(
                "Interrupted while waiting for the timer job acquisition thread to terminate", e);
        }
        ...
        try {
            ...
            logger.warn("Interrupted while waiting for the reset expired jobs thread to terminate",
                e);
        }
    }
