...
public class TaskActivityBehavior extends AbstractBpmnActivityBehavior {
    ...
    protected String getActiveValue(String originalValue, String propertyName,
    ...
    protected List<String> getActiveValueList(List<String> originalValues, String propertyName,
        ObjectNode taskElementProperties) {
        ...
        if (taskElementProperties != null) {
            ...
            if (overrideValuesNode != null) {
                if (overrideValuesNode.isNull() || !overrideValuesNode.isArray()
