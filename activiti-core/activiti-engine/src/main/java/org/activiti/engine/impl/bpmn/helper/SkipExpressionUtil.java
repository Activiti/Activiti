...
public class SkipExpressionUtil {
    ...
    public static boolean isSkipExpressionEnabled(DelegateExecution execution,
    ...
    private static boolean checkSkipExpressionVariable(DelegateExecution execution) {
        ...
        if (isSkipExpressionEnabled == null) {
            ...
            throw new ActivitiIllegalArgumentException(
                skipExpressionEnabledVariable + " variable does not resolve to a boolean. "
                    + isSkipExpressionEnabled);
        }
    }

    public static boolean shouldSkipFlowElement(CommandContext commandContext,
        DelegateExecution execution, String skipExpressionString) {
        Expression skipExpression = commandContext.getProcessEngineConfiguration()
            .getExpressionManager().createExpression(skipExpressionString);
    ...
    public static boolean shouldSkipFlowElement(DelegateExecution execution,
        Expression skipExpression) {
        Object value = skipExpression.getValue(execution);
