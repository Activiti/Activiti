...
public class TimerUtil {
     ...
     *
     * <p>Takes in an optional execution, if missing the {@link NoExecutionVariableScope} will be
     * used (eg Timer start event)
     */
    public static TimerJobEntity createTimerEntityForTimerEventDefinition(
        ...
        if (StringUtils.isNotEmpty(timerEventDefinition.getCalendarName())) {
            ...
            businessCalendarRef =
                    businessCalendarExpression.getValue(scopeForExpression).toString();
        }
