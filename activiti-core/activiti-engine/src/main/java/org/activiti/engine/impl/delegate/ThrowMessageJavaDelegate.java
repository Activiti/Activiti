...
public class ThrowMessageJavaDelegate implements ThrowMessageDelegate {
  ...
  public ThrowMessageJavaDelegate(
      Class<? extends ThrowMessageDelegate> clazz, List<FieldDeclaration> fieldDeclarations) {
    this.clazz = clazz;
  ...
  public boolean send(DelegateExecution execution, ThrowMessage message) {
    ...
    Object delegate =
        (ThrowMessageDelegate) ClassDelegate.defaultInstantiateDelegate(clazz, fieldDeclarations);
