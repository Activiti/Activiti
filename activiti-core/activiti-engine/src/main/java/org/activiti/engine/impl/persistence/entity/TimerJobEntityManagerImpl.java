...
public class TimerJobEntityManagerImpl
    ...
    public TimerJobEntity createAndCalculateNextTimer(
        ...
        if (repeatValue != 0) {
            ...
            if (
                newTimer != null &&
                isValidTime(timerEntity, newTimer, variableScope)
            ) {
    ...
    public void delete(TimerJobEntity jobEntity) {
        ...
        if (
            ...
            if (isExecutionRelatedEntityCountEnabled(executionEntity)) {
                executionEntity.setTimerJobCount(
                    executionEntity.getTimerJobCount() - 1
                );
            }
        }
    ...
    protected TimerJobEntity createTimer(JobEntity te) {
        ...
        newTimerEntity.setJobHandlerConfiguration(
            te.getJobHandlerConfiguration()
        );
