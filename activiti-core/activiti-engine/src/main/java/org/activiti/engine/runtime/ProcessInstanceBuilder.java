 ...
 * <p>
 * processDefinitionId or processDefinitionKey should be set before calling {@link #start()} to
...
public interface ProcessInstanceBuilder {
    ...
    /**
     * Set the key of the process definition, latest version of the process definition with the
     * given key. If processDefinitionId was set this will be ignored
     **/
    ProcessInstanceBuilder processDefinitionKey(String processDefinitionKey);

    /**
     * Set the message name that needs to be used to look up the process definition that needs to be
     * used to start the process instance.
     */
     ...
     *
     * @throws ActivitiIllegalArgumentException if processDefinitionKey and processDefinitionId are
     *                                          null
     * @throws ActivitiObjectNotFoundException  when no process definition is deployed with the
     *                                          given processDefinitionKey or processDefinitionId
     **/
