 ...
 *
 * <p>An instance can be obtained through {@link
 * org.activiti.engine.RuntimeService#createProcessInstanceBuilder()}.
 *
 * <p>processDefinitionId or processDefinitionKey should be set before calling {@link #start()} to
...
public interface ProcessInstanceBuilder {
  ...
  /**
   * Set the key of the process definition, latest version of the process definition with the given
   * key. If processDefinitionId was set this will be ignored
   */
