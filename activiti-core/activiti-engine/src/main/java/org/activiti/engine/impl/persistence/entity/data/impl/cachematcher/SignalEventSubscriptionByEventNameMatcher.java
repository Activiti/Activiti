 ...
 *
 */
public class SignalEventSubscriptionByEventNameMatcher extends
    ...
    public boolean isRetained(EventSubscriptionEntity eventSubscriptionEntity, Object parameter) {
        ...
        return eventSubscriptionEntity.getEventType() != null
            ...
            && ((params.containsKey("tenantId") && tenantId.equals(
            eventSubscriptionEntity.getTenantId())) || (!params.containsKey("tenantId")
