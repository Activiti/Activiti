...
public class TimerManager {
    ...
    protected void removeObsoleteTimers(ProcessDefinitionEntity processDefinition) {
        ...
        if (processDefinition.getTenantId() != null
            ...
            jobsToDelete = Context.getCommandContext().getTimerJobEntityManager()
                .findJobsByTypeAndProcessDefinitionKeyNoTenantId(TimerStartEventJobHandler.TYPE,
    ...
    protected List<TimerJobEntity> getTimerDeclarations(ProcessDefinitionEntity processDefinition,
        Process process) {
        JobManager jobManager = Context.getCommandContext().getJobManager();
                    ...
                    if (CollectionUtil.isNotEmpty(startEvent.getEventDefinitions())) {
                        ...
                        if (eventDefinition instanceof TimerEventDefinition) {
                            ...
                            TimerJobEntity timerJob = jobManager.createTimerJob(
                                timerEventDefinition, false, null, TimerStartEventJobHandler.TYPE,
