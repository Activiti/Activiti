...
public class ContinueProcessOperation extends AbstractOperation {
  ...
  protected void continueThroughFlowNode(FlowNode flowNode) {
    ...
    // Check if it's the initial flow element. If so, we must fire the execution listeners for the
    // process too
  ...
  protected void createChildExecutionForSubProcess(SubProcess subProcess) {
    ...
    ExecutionEntity subProcessExecution =
        commandContext.getExecutionEntityManager().createChildExecution(parentScopeExecution);
  ...
  protected void executeSynchronous(FlowNode flowNode) {
    ...
    // Execute any boundary events, sub process boundary events will be executed from the activity
    // behavior
    if (!inCompensation
  ...
  protected void continueThroughSequenceFlow(SequenceFlow sequenceFlow) {
    ...
    // Execution listener. Sequenceflow only 'take' makes sense ... but we've supported all three
    // since the beginning
  ...
  protected void executeBoundaryEvents(
    ...
    for (BoundaryEvent boundaryEvent : boundaryEvents) {
      ...
      // A Child execution of the current execution is created to represent the boundary event being
      // active
