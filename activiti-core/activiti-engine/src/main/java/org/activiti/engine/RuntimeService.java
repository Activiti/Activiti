...
public interface RuntimeService {
    ...
    /**
     * Create a {@link ProcessInstanceBuilder}, that allows to set various options for starting a
     * process instance, as an alternative to the various startProcessInstanceByXX methods.
     */
     ...
     * @throws ActivitiObjectNotFoundException when user does not have permission to start the
     *     process instance
     * @throws NotFoundException when no process instance with the given id is found
     */
    ProcessInstance startCreatedProcessInstance(
            ProcessInstance createdProcessInstance, Map<String, Object> variables);

    /**
     * Starts a new process instance in the latest version of the process definition with the given
     * key.
     *
     ...
     * key.
     *
     * <p>A business key can be provided to associate the process instance with a certain identifier
     * that has a clear business meaning. For example in an order process, the business key could be
     * an order id. This business key can then be used to easily look up that process instance , see
     ...
     * key is definitely a best practice.
     *
     * <p>The combination of processdefinitionKey-businessKey must be unique.
     *
     * @param processDefinitionKey key of process definition, cannot be null.
     * @param variables the variables to pass, can be null.
     * @param businessKey a key that uniquely identifies the process instance in the context or the
    ...
    /**
     * Similar to {@link #startProcessInstanceByKey(String)}, but using a specific tenant
     * identifier.
     */
    ...
    /**
     * Similar to {@link #startProcessInstanceByKey(String, String)}, but using a specific tenant
     * identifier.
     */
    ProcessInstance startProcessInstanceByKeyAndTenantId(
            String processDefinitionKey, String businessKey, String tenantId);

    /**
     * Similar to {@link #startProcessInstanceByKey(String, Map)}, but using a specific tenant
     * identifier.
     */
    ProcessInstance startProcessInstanceByKeyAndTenantId(
            String processDefinitionKey, Map<String, Object> variables, String tenantId);

    /**
     * Similar to {@link #startProcessInstanceByKey(String, String, Map)}, but using a specific
     * tenant identifier.
     */
    ProcessInstance startProcessInstanceByKeyAndTenantId(
    ...
    /**
     * Starts a new process instance in the exactly specified version of the process definition with
     * the given id.
     *
    ...
    /**
     * Signals the process engine that a message is received and starts a new {@link
     * ProcessInstance}.
     *
     * <p>Calling this method can have two different outcomes:
     *
     * <ul>
     *   <li>If the message name is associated with a message start event, a new process instance is
     *       started.
     *   <li>If no subscription to a message with the given name exists, {@link ActivitiException}
     *       is thrown
     * </ul>
     *
     * @param messageName the 'name' of the message as specified as an attribute on the bpmn20
     *     {@code <message name="messageName" />} element.
     * @return the {@link ProcessInstance} object representing the started process instance
     * @throws ActivitiException if no subscription to a message with the given name exists
     * @since 5.9
     */
    ProcessInstance startProcessInstanceByMessage(String messageName);

    /**
     * Similar to {@link RuntimeService#startProcessInstanceByMessage(String)}, but with tenant
     * context.
     */
    ...
    /**
     * Signals the process engine that a message is received and starts a new {@link
     * ProcessInstance}. See {@link #startProcessInstanceByMessage(String, Map)}. This method allows
     * specifying a business key.
     *
     * @param messageName the 'name' of the message as specified as an attribute on the bpmn20
     *     {@code <message name="messageName" />} element.
     * @param businessKey the business key which is added to the started process instance
     * @throws ActivitiException if no subscription to a message with the given name exists
     * @since 5.10
     */
    ...
    /**
     * Similar to {@link RuntimeService#startProcessInstanceByMessage(String, String)}, but with
     * tenant context.
     */
    ProcessInstance startProcessInstanceByMessageAndTenantId(
            String messageName, String businessKey, String tenantId);

    /**
     * Signals the process engine that a message is received and starts a new {@link
     * ProcessInstance}. See {@link #startProcessInstanceByMessage(String)}. In addition, this
     * method allows specifying a the payload of the message as a map of process variables.
     *
     * @param messageName the 'name' of the message as specified as an attribute on the bpmn20
     *     {@code <message name="messageName" />} element.
     * @param processVariables the 'payload' of the message. The variables are added as processes
    ...
    /**
     * Similar to {@link RuntimeService#startProcessInstanceByMessage(String, Map<String, Object>)},
     * but with tenant context.
     */
    ProcessInstance startProcessInstanceByMessageAndTenantId(
            String messageName, Map<String, Object> processVariables, String tenantId);

    /**
     * Signals the process engine that a message is received and starts a new {@link
     * ProcessInstance}. See {@link #startProcessInstanceByMessage(String, Map)}. In addition, this
     ...
     */
    ProcessInstance startProcessInstanceByMessage(
            String messageName, String businessKey, Map<String, Object> processVariables);

    /**
     * Similar to {@link RuntimeService#startProcessInstanceByMessage(String, String, Map<String,
     * Object>)}, but with tenant context.
     */
    ProcessInstance startProcessInstanceByMessageAndTenantId(
            String messageName,
            String businessKey,
    ...
    /**
     * Finds the activity ids for all executions that are waiting in activities. This is a list
     * because a single activity can be active multiple times.
     *
    ...
    /**
     * Involves a user with a process instance. The type of identity link is defined by the given
     * identityLinkType.
     *
    ...
    /**
     * Involves a group with a process instance. The type of identityLink is defined by the given
     * identityLink.
     *
     * @param processInstanceId id of the process instance, cannot be null.
    ...
    /**
     * Removes the association between a group and a process instance for the given
     * identityLinkType.
     *
     * @param processInstanceId id of the process instance, cannot be null.
     * @param groupId id of the group to involve, cannot be null.
    ...
    /**
     * Retrieves the {@link IdentityLink}s associated with the given process instance. Such an
     * {@link IdentityLink} informs how a certain user is involved with a process instance.
     */
     ...
     * All variables visible from the given execution scope (including parent scopes).
     *
     * @param executionIds ids of execution, cannot be null.
     * @return the variables.
     */
    List<VariableInstance> getVariableInstancesByExecutionIds(Set<String> executionIds);

    /**
     * All variable values that are defined in the execution scope, without taking outer scopes into
     * account. If you have many task local variables and you only need a few, consider using {@link
     * #getVariablesLocal(String, Collection)} for better performance.
     *
     * @param executionId id of execution, cannot be null.
     * @return the variables or an empty map if no such variables are found.
     * @throws ActivitiObjectNotFoundException when no execution is found for the given executionId.
     ...
     * visible from the given execution scope (including parent scopes).
     *
     * @param executionId id of execution, cannot be null.
    ...
    /**
     * The variable values for the given variableNames only taking the given execution scope into
     * account, not looking in outer scopes.
     *
     * @param executionId id of execution, cannot be null.
     * @param variableNames the collection of variable names that should be retrieved.
     * @return the variables or an empty map if no such variables are found.
    ...
    /**
     * The variable value. Searching for the variable is done in all scopes that are visible to the
     * given execution (including parent scopes). Returns null when no variable value is found with
     * the given name or when the value is set to null.
     *
     * @param executionId id of execution, cannot be null.
    ...
    /**
     * The variable. Searching for the variable is done in all scopes that are visible to the given
     * execution (including parent scopes). Returns null when no variable value is found with the
     ...
     * The variable value. Searching for the variable is done in all scopes that are visible to the
     * given execution (including parent scopes). Returns null when no variable value is found with
     * the given name or when the value is set to null. Throws ClassCastException when cannot cast
     * variable to given class
     *
     * @param executionId id of execution, cannot be null.
     * @param variableName name of variable, cannot be null.
     * @param variableClass name of variable, cannot be null.
     * @return the variable value or null if the variable is undefined or the value of the variable
     *     is null.
     * @throws ActivitiObjectNotFoundException when no execution is found for the given executionId.
     */
    ...
    /**
     * Check whether or not this execution has variable set with the given name, Searching for the
     * variable is done in all scopes that are visible to the given execution (including parent
     * scopes).
     */
    boolean hasVariable(String executionId, String variableName);

    /**
     * The variable value for an execution. Returns the value when the variable is set for the
     * execution (and not searching parent scopes). Returns null when no variable value is found
     * with the given name or when the value is set to null.
     */
    Object getVariableLocal(String executionId, String variableName);

    /**
     * The variable for an execution. Returns the variable when it is set for the execution (and not
     * searching parent scopes). Returns null when no variable is found with the given name or when
    ...
    /**
     * The variable value for an execution. Returns the value casted to given class when the
     * variable is set for the execution (and not searching parent scopes). Returns null when no
     * variable value is found with the given name or when the value is set to null.
     */
     ...
     *
     * <p>The variable is set according to the algorithm as documented for {@link
     * VariableScope#setVariable(String, Object)}.
     *
     * @see VariableScope#setVariable(String, Object) {@link VariableScope#setVariable(String,
     *     Object)}
    ...
    /**
     * Update or create a variable for an execution (not considering parent scopes). If the variable
     * is not already existing, it will be created in the given execution.
     *
     * @param executionId id of execution to set variable in, cannot be null.
     * @param variableName name of variable to set, cannot be null.
     * @param value value to set. When null is passed, the variable is not removed, only it's value
     ...
     *
     * <p>Variables are set according to the algorithm as documented for {@link
     * VariableScope#setVariables(Map)}, applied separately to each variable.
     *
    ...
    /**
     * Update or create given variables for an execution (not considering parent scopes). If the
     * variables are not already existing, it will be created in the given execution.
     *
     * @param executionId id of the execution, cannot be null.
     * @param variables map containing name (key) and value of variables, can be null.
     * @throws ActivitiObjectNotFoundException when no execution is found for the given executionId.
     ...
     *
     * @param executionId id of execution, cannot be null.
     * @param locale locale the DataObject name and description should be returned in (if
     *     available).
     * @param withLocalizationFallback When true localization will fallback to more general locales
     *     if the specified locale is not found.
     * @return the DataObjects or an empty map if no DataObjects are found.
     * @throws ActivitiObjectNotFoundException when no execution is found for the given executionId.
     */
    Map<String, DataObject> getDataObjects(
            String executionId, String locale, boolean withLocalizationFallback);

    /**
     * All DataObject values that are defined in the execution scope, without taking outer scopes
     * into account. If you have many local DataObjects and you only need a few, consider using
    ...
    /**
     * The DataObjects for the given dataObjectNames only taking the given execution scope into
     * account, not looking in outer scopes.
     *
     * @param executionId id of execution, cannot be null.
     * @param dataObjectNames the collection of DataObject names that should be retrieved.
    ...
    /**
     * The DataObject. Searching for the DataObject is done in all scopes that are visible to the
     * given execution (including parent scopes). Returns null when no DataObject value is found
     * with the given name or when the value is set to null.
     *
     * @param executionId id of execution, cannot be null.
    ...
    /**
     * The DataObject for an execution. Returns the DataObject when it is set for the execution (and
     * not searching parent scopes). Returns null when no DataObject is found with the given name.
     *
     * @param executionId id of execution, cannot be null.
     * @param dataObjectName name of DataObject, cannot be null.
     * @return the DataObject or null if the DataObject is undefined.
    ...
    /**
     * Creates a new {@link ExecutionQuery} instance, that can be used to query the executions and
     * process instances.
     */
    ...
    /**
     * Creates a new {@link ProcessInstanceQuery} instance, that can be used to query process
     * instances.
     */
    ProcessInstanceQuery createProcessInstanceQuery();

    /**
     * creates a new {@link NativeProcessInstanceQuery} to query {@link ProcessInstance}s by SQL
     * directly
     */
     ...
     *
     * <p>If a process instance is in state suspended, activiti will not execute jobs (timers,
     * messages) associated with this instance.
     *
     * <p>If you have a process instance hierarchy, suspending one process instance form the
     * hierarchy will not suspend other process instances form that hierarchy.
     *
     ...
     *
     * <p><strong>NOTE:</strong> The waiting executions are notified synchronously.
     *
     ...
     *
     * @param signalName the name of the signal event
     * @param processVariables a map of variables added to the execution(s)
     */
    void signalEventReceived(String signalName, Map<String, Object> processVariables);

    /**
     * Similar to {@link #signalEventReceived(String, Map<String, Object>)}, but within the context
     * of one tenant.
     */
    void signalEventReceivedWithTenantId(
            String signalName, Map<String, Object> processVariables, String tenantId);
    ...
    void signalEventReceived(
            String signalName, String executionId, Map<String, Object> processVariables);

    /**
     * Notifies the process engine that a signal event of name 'signalName' has been received. This
     * method delivers the signal to a single execution, being the execution referenced by
     * 'executionId'. The waiting execution is notified <strong>asynchronously</strong>.
     *
     * @param signalName the name of the signal event
     * @param executionId the id of the execution to deliver the signal to
     * @throws ActivitiObjectNotFoundException if no such execution exists.
    ...
    /**
     * Notifies the process engine that a message event with name 'messageName' has been received
     * and has been correlated to an execution with id 'executionId'.
     *
     * <p>The waiting execution is notified synchronously.
     *
     * @param messageName the name of the message event
     * @param executionId the id of the execution to deliver the message to
     * @throws ActivitiObjectNotFoundException if no such execution exists.
     * @throws ActivitiException if the execution has not subscribed to the signal
     */
    ...
    /**
     * Notifies the process engine that a message event with the name 'messageName' has been
     * received and has been correlated to an execution with id 'executionId'.
     *
     * <p>The waiting execution is notified synchronously.
     *
     * <p>Variables are set for the scope of the execution of the message event subscribed to the
     * message name. For example:
     *
     * <p>
     * <li>The scope for an intermediate message event in the main process is that of the process
     *     instance
     * <li>The scope for an intermediate message event in a subprocess is that of the subprocess
     * <li>The scope for a boundary message event is that of the execution for the Activity the
     ...
     * received and has been correlated to an execution with id 'executionId'.
     *
     * <p>The waiting execution is notified <strong>asynchronously</strong>.
     *
     * @param messageName the name of the message event
     * @param executionId the id of the execution to deliver the message to
     * @throws ActivitiObjectNotFoundException if no such execution exists.
     ...
     * @throws ActivitiException if an exception occurs when dispatching the event or when the
     *     {@link ActivitiEventDispatcher} is disabled.
     * @throws ActivitiIllegalArgumentException when the given event is not suitable for
     *     dispatching.
     */
     ...
     * @throws ActivitiObjectNotFoundException when the given process instance does not exist.
     */
     ...
     *
     * @param executionId id of the execution that has an ad-hoc sub process as current flow element
     ...
     *
     * @param executionId id of the execution that has an ad-hoc sub process as current flow element
     * @param activityId id of the activity id to enable
