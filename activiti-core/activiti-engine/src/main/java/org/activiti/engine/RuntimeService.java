...
public interface RuntimeService {
     ...
     * key.
     * <p>
     * A business key can be provided to associate the process instance with a certain identifier
     ...
     *
     * @param processDefinitionKey key of process definition, cannot be null.
     * @param businessKey          a key that uniquely identifies the process instance in the
     ...
     * identifier.
     */
    ProcessInstance startProcessInstanceByKeyAndTenantId(String processDefinitionKey,
        String tenantId);
     ...
     */
    ProcessInstance startProcessInstanceByMessageAndTenantId(String messageName,
    ...
    /**
     * Sends an external trigger to an activity instance that is waiting inside the given
     * execution.
     *
     * @param executionId id of execution to signal, cannot be null.
     * @throws ActivitiObjectNotFoundException when no execution is found for the given
     *                                         executionId.
     */
     ...
     * @param identityLinkType  type of identityLink, cannot be null (@see {@link
     *                          IdentityLinkType}).
    ...
    /**
     * Removes the association between a user and a process instance for the given
     * identityLinkType.
     *
     * @param processInstanceId id of the process instance, cannot be null.
     * @param userId            id of the user involve, cannot be null.
     ...
     *
     * <p>
     * The variable is set according to the algorithm as documented for {@link
     ...
     * @param value        value to set. When null is passed, the variable is not removed, only it's
     ...
     * <p>
     * Variables are set according to the algorithm as documented for {@link
     ...
     *
     * @param executionId              id of execution, cannot be null.
     * @param locale                   locale the DataObject name and description should be returned
     *                                 in (if available).
     ...
     */
    Map<String, DataObject> getDataObjectsLocal(String executionId,
        Collection<String> dataObjectNames, String locale, boolean withLocalizationFallback);
     ...
     *                                 in (if available).
     * @param withLocalizationFallback When true localization will fallback to more general locales
     *                                 including the default locale of the JVM if the specified
     *                                 locale is not found.
     ...
     *                                         executionId.
     */
    DataObject getDataObjectLocal(String executionId, String dataObjectName, String locale,
        boolean withLocalizationFallback);
     ...
     * <p>
     * If a process instance is in state suspended, activiti will not execute jobs (timers,
     * messages) associated with this instance.
     * <p>
     * If you have a process instance hierarchy, suspending one process instance form the hierarchy
     ...
     * of one tenant.
     */
    void signalEventReceivedWithTenantId(String signalName, Map<String, Object> processVariables,
        String tenantId);
     ...
     *
     * <p>
     * Variables are set for the scope of the execution of the message event subscribed to the
     ...
     * @throws ActivitiException                if an exception occurs when dispatching the event or
     *                                          when the {@link ActivitiEventDispatcher} is
     *                                          disabled.
     ...
     *
     * @param executionId id of the execution that has an ad-hoc sub process as current flow
     *                    element
