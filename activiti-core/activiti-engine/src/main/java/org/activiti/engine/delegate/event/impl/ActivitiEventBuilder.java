...
public class ActivitiEventBuilder {
     ...
     * @return an {@link ActivitiEvent} that doesn't have it's execution context-fields filled, as
     * the event is a global event, independent of any running execution.
     */
    ...
    public static ActivitiEvent createEvent(ActivitiEventType type, String executionId,
     ...
     * execution related event fields will be populated. If not, execution details will be retrieved
     * from the {@link Object} if possible.
     */
     ...
     * @return an {@link ActivitiEntityEvent}. In case an {@link ExecutionContext} is active, the
     * execution related event fields will be populated. If not, execution details will be reteived
     * from the {@link Object} if possible.
     */
    ...
    public static ActivitiProcessStartedEvent createProcessStartedEvent(final Object entity,
        ...
        final ActivitiProcessStartedEventImpl newEvent = new ActivitiProcessStartedEventImpl(entity,
    ...
    public static ActivitiEntityWithVariablesEvent createEntityWithVariablesEvent(
        ...
        ActivitiEntityWithVariablesEventImpl newEvent = new ActivitiEntityWithVariablesEventImpl(
            entity, variables, localScope, type);
    ...
    public static ActivitiSequenceFlowTakenEvent createSequenceFlowTakenEvent(
        ExecutionEntity executionEntity, ActivitiEventType type,
        String sequenceFlowId, String sourceActivityId, String sourceActivityName,
        String sourceActivityType, Object sourceActivityBehavior,
        String targetActivityId, String targetActivityName, String targetActivityType,
        ...
        newEvent.setSourceActivityBehaviorClass(
            sourceActivityBehavior != null ? sourceActivityBehavior.getClass().getCanonicalName()
                : null);
        ...
        newEvent.setTargetActivityBehaviorClass(
            targetActivityBehavior != null ? targetActivityBehavior.getClass().getCanonicalName()
                : null);
     ...
     * @return an {@link ActivitiEntityEvent} that is also instance of {@link
     * ActivitiExceptionEvent}. In case an {@link ExecutionContext} is active, the execution related
     * event fields will be populated.
     */
    public static ActivitiEntityEvent createEntityExceptionEvent(ActivitiEventType type,
        Object entity, Throwable cause) {
        ActivitiEntityExceptionEventImpl newEvent = new ActivitiEntityExceptionEventImpl(entity,
            type, cause);
     ...
     */
    public static ActivitiEntityEvent createEntityExceptionEvent(ActivitiEventType type,
        Object entity, Throwable cause, String executionId, String processInstanceId,
    ...
    public static ActivitiActivityCancelledEvent createActivityCancelledEvent(String activityId,
        String activityName, String executionId,
    ...
    public static ActivitiErrorEvent createErrorEvent(ActivitiEventType type, String activityId,
        String errorId, String errorCode,
        String executionId, String processInstanceId, String processDefinitionId) {
    ...
    public static ActivitiVariableEvent createVariableEvent(ActivitiEventType type,
        String variableName, Object variableValue, VariableType variableType, String taskId,
        String executionId,
        String processInstanceId, String processDefinitionId) {
    ...
    public static ActivitiVariableUpdatedEventImpl createVariableUpdateEvent(
        VariableInstanceEntity variableInstance, Object previousValue,
        String processInstanceId, String processDefinitionId) {
    ...
    public static ActivitiMembershipEvent createMembershipEvent(ActivitiEventType type,
