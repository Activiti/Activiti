...
public class ActivitiEventBuilder {
    ...
    public static ActivitiProcessStartedEvent createProcessStartedEvent(
        ...
        // In case an execution-context is active, populate the event fields related to the
        // execution
        populateEventWithCurrentContext(newEvent);
        return newEvent;
    }
     ...
     *     ActivitiExceptionEvent}. In case an {@link ExecutionContext} is active, the execution
     *     related event fields will be populated.
     */
    ...
    public static ActivitiSignalEvent createActivitiySignalledEvent(
        ...
        return createSignalEvent(
                ActivitiEventType.ACTIVITY_SIGNALED, execution, signalName, payload);
    }
