...
public class DelegateHelper {
     ...
     */
    public static void leaveDelegate(
        ...
        if (flowElement instanceof SequenceFlow) {
            ...
            throw new ActivitiException(
                sequenceFlowId + " does not match a sequence flow"
            );
        }
    }
    ...
    public static BpmnModel getBpmnModel(DelegateExecution execution) {
        ...
        return ProcessDefinitionUtil.getBpmnModel(
     ...
     */
    public static boolean isExecutingExecutionListener(
    ...
    public static List<FieldExtension> getFlowElementFields(
        DelegateExecution execution
    ) {
    ...
    public static List<FieldExtension> getListenerFields(
        DelegateExecution execution
    ) {
     ...
     */
    public static FieldExtension getField(
        DelegateExecution execution,
        String fieldName
    ) {
        if (isExecutingExecutionListener(execution)) {
    ...
    public static FieldExtension getFlowElementField(
        ...
        for (FieldExtension fieldExtension : fieldExtensions) {
            if (
                fieldExtension.getFieldName() != null &&
    ...
    public static FieldExtension getListenerField(
        DelegateExecution execution,
        String fieldName
    ) {
     ...
     */
    public static Expression createExpressionForField(
     ...
     */
    public static Expression getFieldExpression(
        DelegateExecution execution,
        String fieldName
    ) {
        if (isExecutingExecutionListener(execution)) {
    ...
    public static Expression getFieldExpression(
        ...
        if (task.getCurrentActivitiListener() != null) {
            List<FieldExtension> fieldExtensions = task
    ...
    public static Expression getFlowElementFieldExpression(
        ...
        FieldExtension fieldExtension = getFlowElementField(
            execution,
            fieldName
        );
