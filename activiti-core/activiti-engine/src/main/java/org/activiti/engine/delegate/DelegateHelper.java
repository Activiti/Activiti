...
public class DelegateHelper {
   ...
   * default BPMN 2.0 rules: all sequenceflow with a condition that evaluates to true are followed.
   */
  ...
  /**
   * To be used in an {@link ActivityBehavior} or {@link JavaDelegate}: leaves the current activity
   * via one specific sequenceflow.
   */
   ...
   * ExtensionElement} instances. These represent the extension elements defined in the BPMN 2.0 XML
   * as part of that particular activity.
   *
   ...
   * or {@link #getListenerFields(DelegateExecution)} if needing the flow element of listener fields
   * specifically.
   */
   ...
   *
   * <p>If the execution is currently being used for executing an {@link ExecutionListener}, it will
   * return the field expression for the listener. Use {@link
  ...
  /**
   * Similar to {@link #getFieldExpression(DelegateExecution, String)}, but for use within a {@link
   * TaskListener}.
   */
