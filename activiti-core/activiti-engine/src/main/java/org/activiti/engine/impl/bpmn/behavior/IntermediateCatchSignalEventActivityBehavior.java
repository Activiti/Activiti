...
public class IntermediateCatchSignalEventActivityBehavior extends
    ...
    public IntermediateCatchSignalEventActivityBehavior(SignalEventDefinition signalEventDefinition,
        Signal signal) {
    ...
    public void execute(DelegateExecution execution) {
        ...
        if (StringUtils.isNotEmpty(signalEventDefinition.getSignalRef())) {
            ...
            Expression signalExpression = commandContext.getProcessEngineConfiguration()
