...
insert into ACT_HI_DETAIL_TMP (ID_, TYPE_, PROC_INST_ID_, EXECUTION_ID_, TASK_ID_, ACT_INST_ID_,
                               NAME_, VAR_TYPE_, REV_, TIME_, BYTEARRAY_ID_, DOUBLE_, LONG_, TEXT_,
                               TEXT2_)
select ID_,
       TYPE_,
       PROC_INST_ID_,
...
insert into ACT_HI_DETAIL (ID_, TYPE_, PROC_INST_ID_, EXECUTION_ID_, TASK_ID_, ACT_INST_ID_, NAME_,
                           VAR_TYPE_, REV_, TIME_, BYTEARRAY_ID_, DOUBLE_, LONG_, TEXT_, TEXT2_)
select ID_,
       TYPE_,
       PROC_INST_ID_,
       EXECUTION_ID_,
