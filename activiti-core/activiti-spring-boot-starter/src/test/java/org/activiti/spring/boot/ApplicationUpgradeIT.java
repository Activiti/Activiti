...
public class ApplicationUpgradeIT {
    ...
    public void should_getLatestProcessDefinitionByKey_when_multipleVersions() {
        ...
        ProcessDefinition result =
                processRuntime.processDefinition(SINGLE_TASK_PROCESS_DEFINITION_KEY);
    ...
    public void should_adminApiGetLatestProcessDefinitionByKey_when_multipleVersions() {
        ...
        ProcessDefinition result =
                processAdminRuntime.processDefinition(SINGLE_TASK_PROCESS_DEFINITION_KEY);
    ...
    public void processDefinitions_should_returnOnlyTheLatestVersion_when_multipleVersions() {
        ...
        projectManifest.setVersion("34");
        Deployment latestDeployment =
                deployProcesses(projectManifest, MULTI_INSTANCE_PROCESS_DEFINITION_PATH);
    ...
    public void
        ...
        deployProcessesWithoutProjectManifest(
                "customDeployment", "custom-deployment/ProcessFromCustomDeployment.bpmn20.xml");
    ...
    public void
        ...
        deployProcessesWithoutProjectManifest(
                deploymentName, "custom-deployment/ProcessFromCustomDeployment.bpmn20.xml");
        Deployment latestCustomDeployment =
                deployProcesses(
                        deploymentName,
                        projectManifest,
    ...
    @Test
    public void
            should_noUpgradeTakePlace_when_enforcedAppVersionAndProjectManifestVersionAreNotSet() {
    ...
    private Deployment deployProcesses(
            String deploymentName, ProjectManifest projectManifest, String... processPaths) {
    ...
    private Deployment deployProcessesWithoutProjectManifest(
            String deploymentName, String... processPaths) {
