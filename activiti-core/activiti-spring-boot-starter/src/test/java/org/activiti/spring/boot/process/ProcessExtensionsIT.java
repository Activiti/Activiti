...
public class ProcessExtensionsIT {
  ...
  public void processInstanceFailsWithoutRequiredVariables() {
    ...
    assertThatExceptionOfType(ActivitiException.class)
        ...
        .withMessage(
            "Can't start process '" + INITIAL_VARS_PROCESS + "' without required variables - age");
  }
  ...
  private List<VariableInstance> retrieveVariablesForFirstTaskOfProcess(
    ...
    Page<Task> tasks =
        taskRuntime.tasks(
            Pageable.of(0, 1), TaskPayloadBuilder.tasksForProcess(processInstance).build());
  ...
  public void should_mapProcessVariables_when_createAndStartProcessAreCalled() {
    // given
    ProcessInstance createdProcess =
    ...
    ProcessInstance startedProcess =
