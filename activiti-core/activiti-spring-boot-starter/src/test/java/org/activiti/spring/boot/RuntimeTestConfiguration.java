...
public class RuntimeTestConfiguration {
    ...
    public static Set<TaskCandidateUserRemovedEvent> taskCandidateUserRemovedEvents =
            new HashSet<>();

    public static Set<TaskCandidateGroupAddedEvent> taskCandidateGroupAddedEvents = new HashSet<>();

    public static Set<TaskCandidateGroupRemovedEvent> taskCandidateGroupRemovedEvents =
            new HashSet<>();
    ...
    public Connector processImageActionName() {
        return integrationContext -> {
            Map<String, Object> inBoundVariables = integrationContext.getInBoundVariables();
            LOGGER.info(
                    "processImageActionName inbound variables keys: " + inBoundVariables.keySet());
            LOGGER.info(
    ...
    public Connector variableMappingActionName() {
        return integrationContext -> {
            ...
            integrationContext.addOutBoundVariable(
                    "out_variable_name_2", currentAge + offSet + integerConstantValue);
            integrationContext.addOutBoundVariable(
                    "out_unmapped_variable_matching_name", "outTest");
            integrationContext.addOutBoundVariable(
                    "out_unmapped_variable_non_matching_name", "outTest");
            return integrationContext;
        };
    }
        ...
        return integrationContext -> {
            ...
            assertThat(inBoundVariables.entrySet())
                    ...
                    .containsOnly(
                            ...
                            tuple(
                                    variableThree,
                                    "Hello John Doe, today is your 20th birthday! It means 7305.0"
                                            + " days of life"),
            ...
            integrationContext.addOutBoundVariable(
                    "out-variable-name-2", currentAge + integerConstantValue);
            integrationContext.addOutBoundVariable(
                    "out-unmapped-variable-matching-name", "outTest");
            integrationContext.addOutBoundVariable(
                    "out-unmapped-variable-non-matching-name", "outTest");
    ...
    public Connector outputMappingVariableExpressionActionName() {
        return integrationContext -> {
            integrationContext.addOutBoundVariable("out-variable-name-1", "${name}");
            return integrationContext;
        };
    }
