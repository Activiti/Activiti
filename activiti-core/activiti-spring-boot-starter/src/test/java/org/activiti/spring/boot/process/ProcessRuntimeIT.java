...
public class ProcessRuntimeIT {
    ...
    public void getProcessInstances() {
        ...
        processInstancePage =
                processRuntime.processInstances(
                        PAGEABLE, ProcessPayloadBuilder.processInstances().build());
        ...
        // I need to clean up the Process Instances that I started because @WithMockUser cannot be
        // used
    ...
    public void signalAdmin() {
        ...
        Page<ProcessInstance> processInstancePage =
                processAdminRuntimeMock.processInstances(PAGEABLE);
