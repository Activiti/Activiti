...
public class TaskRuntimeVariableMappingIT {
    ...
    public void should_mapTaskVariables_when_thereIsMapping() {
        ...
        assertThat(procVariables)
            .isNotNull()
            .extracting(VariableInstance::getName, VariableInstance::getType, VariableInstance::getValue)
            .containsOnly(
                tuple("process_variable_unmapped_1", "string", "unmapped1Value"),
                tuple("process_variable_inputmap_1", "string", "inputmap1Value"),
                tuple("process_variable_outputmap_1", "string", "outputmap1Value"),
                tuple("process-variable-date", "date", date),
                tuple("process-variable-datetime", "date", datetime)
            );
        ...
        assertThat(taskVariables)
            ...
            .extracting(VariableInstance::getName, VariableInstance::getType, VariableInstance::getValue)
            .containsOnly(
                tuple("task_input_variable_name_1", "string", "inputmap1Value"),
                tuple("task-variable-date", "date", date),
                tuple("task-variable-datetime", "date", datetime)
            );
        ...
        assertThat(procVariables)
            ...
            .containsOnly(
                tuple("process_variable_unmapped_1", "unmapped1Value"),
                tuple("process_variable_inputmap_1", "inputmap1Value"),
                tuple("process_variable_outputmap_1", "outputTaskValue"),
                tuple("process-variable-date", date),
                tuple("process-variable-datetime", datetime)
            );
    ...
    public void should_notMapTaskVariables_when_thereIsNoMapping() {
        ...
        assertThat(procVariables)
            ...
            .containsOnly(
                tuple("process_variable_unmapped_1", "unmapped1Value"),
                tuple("process_variable_inputmap_1", "inputmap1Value"),
                tuple("process_variable_outputmap_1", "outputmap1Value")
            );
    ...
    public void should_sendAllTaskVariables_when_thereIsMappingTypeMAP_ALL() {
        ...
        assertThat(procVariables)
            ...
            .containsExactlyInAnyOrder(
                ...
                tuple("process_variable_inputmap_1", "inputmap1Value"),
                tuple("process_variable_outputmap_1", "outputmap1Value"),
                tuple("task_input_variable_name_1", "outputValue"),
                tuple("task_output_variable_name_1", "outputTaskValue"),
                tuple(ASSIGNEE_VARIABLE_NAME, "user")
    ...
    public void should_sendAllInputTasksVariablesAndOnlySelectedOuputs_when_thereIsMappingTypeMAP_ALL_INPUTS() {
        ...
        Map<String, Object> variables = new HashMap<>();
        variables.put("task_input_variable_name_1", "notMappedValue");
        variables.put("task_output_variable_name_1", "outputMappedValue");
        ...
        assertThat(procVariables)
            ...
            .containsOnly(
                tuple("process_variable_unmapped_1", "unmapped1Value"),
                tuple("process_variable_inputmap_1", "inputmap1Value"),
                tuple("process_variable_outputmap_1", "outputMappedValue")
            );
    ...
    public void should_sendAllOutputTaskVariablesAndOnlySelectedInputs_when_thereIsMappingTypeMAP_ALL_OUTPUTS() {
        ...
        assertThat(taskVariables)
            .isNotNull()
            .extracting(VariableInstance::getName, VariableInstance::getType, VariableInstance::getValue)
            .containsOnly(tuple("task_input_variable_name_1", "string", "inputmap1Value"));

        Map<String, Object> variables = new HashMap<>();
        variables.put("process_variable_outputmap_1", "outputMappedValue");
        variables.put("new_task_output_variable_name", "newOutputMappedValue");
        ...
        assertThat(procVariables)
            ...
            .containsOnly(
                ...
                tuple("process_variable_inputmap_1", "inputmap1Value"),
                tuple("process_variable_outputmap_1", "outputMappedValue"),
                tuple("new_task_output_variable_name", "newOutputMappedValue"),
                tuple("task_input_variable_name_1", "inputmap1Value"),
                tuple(ASSIGNEE_VARIABLE_NAME, "user")
            );
    ...
    public void should_supportVariableMappingAfterLoopingBack() {
        //given
        final ProcessInstance processInstance = processBaseRuntime.startProcessWithProcessDefinitionKey(
            "Process_N4qkN051N"
        );
        List<Task> tasks = taskBaseRuntime.getTasksByProcessInstanceId(processInstance.getId());
        assertThat(tasks).extracting(Task::getName).containsExactly("Enter values");

        //when the task completes with a variable value causing a loop back
        taskBaseRuntime.completeTask(tasks.getFirst(), singletonMap("formInput", "provided-it1"));
        ...
        taskBaseRuntime.completeTask(tasks.getFirst(), singletonMap("formInput", "go"));
    ...
    public void mapping_should_workProperlyAfterChainingUserAndServiceTasks() {
        ...
        List<Task> tasks = taskBaseRuntime.getTasksByProcessInstanceId(processInstance.getId());
        assertThat(tasks).extracting(Task::getName).containsExactly("Input Task");

        //when
        taskBaseRuntime.completeTask(tasks.getFirst(), singletonMap("inputText", "From input task"));
        ...
        assertThat(variables)
            .extracting(VariableInstance::getName, VariableInstance::getValue)
            .containsExactly(tuple("stringVar", "From output connector"));
    ...
    public void mapping_should_workProperlyAfterChainingUserAndCallActivities() {
        ...
        assertThat(variables)
            .extracting(VariableInstance::getName, VariableInstance::getValue)
            .containsExactly(tuple("stringVar", "From child"));
    ...
    public void should_haveLastTaskAssigneeValue_when_sequentialTasks() {
        ProcessInstance processInstance = processBaseRuntime.startProcessWithProcessDefinitionKey(
            TASK_ASSIGNEE_SEQUENTIAL_MAP_ALL
        );
        ...
        assertThat(procVariables)
            .isNotNull()
            .extracting(VariableInstance::getName, VariableInstance::getValue)
            .containsOnly(tuple(ASSIGNEE_VARIABLE_NAME, "user"));
        ...
        assertThat(procVariables)
            .isNotNull()
            .extracting(VariableInstance::getName, VariableInstance::getValue)
            .containsOnly(tuple(ASSIGNEE_VARIABLE_NAME, "garth"));
    ...
    public void should_mapTaskAssignee_when_mappingToVariable_multi_instances() {
        ProcessInstance processInstance = processBaseRuntime.startProcessWithProcessDefinitionKey(
            TASK_ASSIGNEE_MULTI_INSTANCE_MAPPING
        );

        List<Task> tasks = checkMultiInstanceTasks(processInstance.getId(), 2);

        taskBaseRuntime.completeTask(tasks.getFirst().getId());
        ...
        assertThat(procVariables)
            ...
            .contains(
                tuple(
                    "miResult",
                    asList(Map.of(ASSIGNEE_VARIABLE_NAME, "user"), Map.of(ASSIGNEE_VARIABLE_NAME, "garth"))
                )
            );
        processBaseRuntime.delete(processInstance.getId());
    }
    ...
    public void should_evaluateToNull_when_expressionIsNotResolvable() {
        ...
        assertThat(taskVariables)
            .isNotNull()
            .extracting(VariableInstance::getName, VariableInstance::getValue)
            .containsOnly(tuple("inValue", "varValue"), tuple("inNull", null));
    ...
    public void should_includeConstants_when_mappingAll() {
        ...
        assertThat(taskVariables)
            .isNotNull()
            .extracting(VariableInstance::getName, VariableInstance::getValue)
            .containsOnly(tuple("name", "inName"), tuple("_constant_value_", "myConstantValue"));
    ...
    public void should_mapTaskVariables_when_inputMappingWithExpression_andExpressionHasEnvironmentVariables() {
        ...
        assertThat(taskVariables)
            .isNotNull()
            .extracting(VariableInstance::getName, VariableInstance::getValue)
            .containsOnly(tuple("inValue", "varValue"), tuple("envVar", "test-value"), tuple("inNull", null));
    }
