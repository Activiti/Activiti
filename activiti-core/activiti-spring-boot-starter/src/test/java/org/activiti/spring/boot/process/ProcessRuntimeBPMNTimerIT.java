...
public class ProcessRuntimeBPMNTimerIT {
  ...
  public void shouldGetTimerCanceledEventByProcessDelete() {
    ...
    ProcessInstance processInstance =
        processBaseRuntime.startProcessWithProcessDefinitionKey(PROCESS_TIMER_CANCELLED_EVENT);
  ...
  public void shouldGetTimerFiredScheduledEventsForProcessWithTimer() throws Exception {
    // given
    ProcessInstance processInstance =
        processBaseRuntime.startProcessWithProcessDefinitionKey(PROCESS_INTERMEDIATE_TIMER_EVENT);
        ...
        .untilAsserted(
            () -> {
              ...
              Page<ProcessInstance> processInstancePage =
                  processBaseRuntime.getProcessInstancesPage();
              // then
