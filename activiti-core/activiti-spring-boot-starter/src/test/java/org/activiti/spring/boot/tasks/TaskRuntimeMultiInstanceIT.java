...
public class TaskRuntimeMultiInstanceIT {
    ...
    @Test
    public void
            processWithSequentialMultiInstancesOnSubProcess_should_emmit_EqualStartAndEndEvent() {
        // when
        ProcessInstance processInstance =
    ...
    public void processWithParallelMultiInstancesOnUserTask_Boundary_Event() {
        ...
        assertThat(localEventSource.getTaskEvents())
                .extracting(
                        event -> ((Task) event.getEntity()).getName(), RuntimeEvent::getEventType)
                .containsExactly(
                        tuple("Escalation Task", TaskRuntimeEvent.TaskEvents.TASK_COMPLETED));
    ...
    @Test
    public void
            processWithParallelMultiInstancesOnCallActivity_should_emmit_EqualStartAndEndEvent() {
        ProcessInstance parentProcessInstance =
    ...
    @Test
    public void
            processWithSequentialMultiInstancesOnManualTask_should_emmit_EqualStartAndEndEvent() {
    ...
    @Test
    public void
            processWithParallelMultiInstancesOnServiceTask_should_emmit_EqualStartAndEndEvent() {
                        ...
                        .start(
                                ProcessPayloadBuilder.start()
                                        .withProcessDefinitionKey(
                                                "miParallelUserTasksOutputCollection")
    ...
    @Test
    public void
            parallelMultiInstance_should_collectAllOutputValuesForServiceTask_when_noDataItem() {
        // given
        ProcessInstance processInstance =
                processBaseRuntime.startProcessWithProcessDefinitionKey(
