...
public class ProcessExtensionsJsonVarsTest {
  ...
  public void processInstanceHasValidInitialVariables() throws ParseException, IOException {
    ...
    ProcessInstance initialVarsProcess =
        processRuntime.start(
            ProcessPayloadBuilder.start()
                ...
                .withVariable(
                    "var2",
                    new ObjectMapper()
                        .readValue("{ \"testvar2element\":\"testvar2element\"}", JsonNode.class))
  ...
  public void processInstanceFailsIfVariableTypeIncorrect() {
    ...
    // we don't test for bad json in the extension file because the context doesn't load for that
    // scenario as failure is during parsing
  }
  ...
  public void processInstanceFailsIfVariableCannotBeSerializedAsJson() {
    ...
    // but it still needs to be serlializable as json because serializePOJOsInVariablesToJson is
    // true, meaning java ser is not available
              ...
              processRuntime.start(
                  ProcessPayloadBuilder.start()
                      ...
                      .withVariable(
                          ...
                          new ObjectMapper()
                              .readValue(
                                  "{ \"testvar2element\":\"testvar2element\"}", JsonNode.class))
