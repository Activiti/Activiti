...
public class ProcessRuntimeVariableMappingTest {
  ...
  public void shouldMapVariables() {
    ProcessInstance processInstance =
        processBaseRuntime.startProcessWithProcessDefinitionKey(VARIABLE_MAPPING_PROCESS);
  ...
  public void should_resolveExpression_when_expressionIsInInputMappingValueOrInMappedProperty() {
    ...
    assertThat(variables)
        ...
        .containsOnly(
            ...
            tuple(
                "user-msg",
                "Hello ${name.concat(' ').concat(surname)}, today is your ${age}th birthday! It"
                    + " means ${age * 365.25} days of life"),
