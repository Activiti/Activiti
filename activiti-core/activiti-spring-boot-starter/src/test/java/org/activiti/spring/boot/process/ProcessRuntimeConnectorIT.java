...
public class ProcessRuntimeConnectorIT {
   ...
   * the first input variable is defined in the first connector action, the second input variable in
   * the second connector action.
   */
  @Test
  ...
  public void shouldSupportStaticValuesForConnectorInputsEvenWhenThereIsNoConnectorDefinition() {
    ...
    assertThat(variables)
        ...
        .containsOnly(
            ...
            tuple(
                "name",
                "Paul") // static value passed to the connector ans send back as part of integration
            // result
            );
  }
}
