...
public class ProcessRuntimeConnectorIT {
    ...
    /**
     * It tests two connector actions inside the xml against two different connector json
     * definitions: the first input variable is defined in the first connector action, the second
     * input variable in the second connector action.
     */
    @Test
    public void shouldConnectorMatchWithConnectorDefinition() {
        ...
        processRuntime.start(
                ProcessPayloadBuilder.start()
                        ...
                        .withVariable("input_variable_name_1", "input-variable-name-1")
                        .withVariable("input_variable_name_2", "input-variable-name-2")
    ...
    public void shouldSupportStaticValuesForConnectorInputsEvenWhenThereIsNoConnectorDefinition() {
        ...
        assertThat(variables)
                ...
                .containsOnly(
                        ...
                        tuple(
                                "name",
                                "Paul") // static value passed to the connector ans send back as
                        // part of integration
                        // result
                        );
    }
