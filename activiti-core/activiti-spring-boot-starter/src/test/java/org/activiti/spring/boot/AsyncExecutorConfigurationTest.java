...
public class AsyncExecutorConfigurationTest {
    ...
    public void shouldConfigureAsyncExecutorProperties() {
        assertThat(asyncExecutor.getDefaultAsyncJobAcquireWaitTimeInMillis()).isEqualTo(
            properties.getDefaultAsyncJobAcquireWaitTimeInMillis()
        );
        assertThat(asyncExecutor.getDefaultTimerJobAcquireWaitTimeInMillis()).isEqualTo(
        ...
        assertThat(asyncExecutor.getDefaultQueueSizeFullWaitTimeInMillis()).isEqualTo(
        ...
        assertThat(asyncExecutor.getMaxAsyncJobsDuePerAcquisition()).isEqualTo(
