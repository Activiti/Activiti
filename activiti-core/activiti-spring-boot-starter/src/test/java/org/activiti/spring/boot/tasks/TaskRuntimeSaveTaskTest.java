...
public class TaskRuntimeSaveTaskTest {
  ...
  public void createStandaloneTaskAndSave() {
    ...
    List<VariableInstance> variables =
        taskRuntime.variables(
            TaskPayloadBuilder.variables().withTaskId(standAloneTask.getId()).build());
  ...
  public void testSaveCompleteReviewOutcomeTasksProcessWithVariables() {
    ...
    List<VariableInstance> variables =
        taskRuntime.variables(TaskPayloadBuilder.variables().withTaskId(task1.getId()).build());
    ...
    List<VariableInstance> variables1 =
        taskRuntime.variables(TaskPayloadBuilder.variables().withTaskId(task2.getId()).build());
    ...
    List<VariableInstance> variables2 =
        taskRuntime.variables(TaskPayloadBuilder.variables().withTaskId(task4.getId()).build());
