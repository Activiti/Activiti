...
public class TaskRuntimeSaveTaskTest {
    ...
    public void createStandaloneTaskAndSave() {
        ...
        // when
        taskRuntime.save(
            new SaveTaskPayloadBuilder().withTaskId(standAloneTask.getId()).withVariable("name", "value").build()
        );
    ...
    public void testSaveCompleteReviewOutcomeTasksProcessWithVariables() {
        ...
        taskRuntime.complete(
            TaskPayloadBuilder.complete().withTaskId(task2.getId()).withVariable("approved", false).build()
        );
        ...
        taskRuntime.complete(
            TaskPayloadBuilder.complete().withTaskId(task4.getId()).withVariable("approved", true).build()
        );
