...
/**
 * Strategy interface for implementations of automatically deploying resources. A strategy may
 * perform any amount of deployments for the {@link Resource}s it is provided with.
 *
 * <p>
 *
 * <p>A strategy is capable of handling deployments corresponding to a certain indicated deployment
 * mode. This applicability is verified using the {@link #handlesMode(String)} method.
 */
@Internal
public interface AutoDeploymentStrategy {
    ...
    /**
     * Performs deployment for the provided resources, using the provided name as a hint and the
     * provided {@link RepositoryService} to perform deployment(s).
     *
