...
public class FailOnNoProcessAutoDeploymentStrategy extends AbstractAutoDeploymentStrategy {
  ...
  protected static final Logger LOGGER =
      LoggerFactory.getLogger(FailOnNoProcessAutoDeploymentStrategy.class);

  public static final String DEPLOYMENT_MODE = "fail-on-no-process";

  public FailOnNoProcessAutoDeploymentStrategy(
  ...
  public void deployResources(
      String deploymentNameHint, Resource[] resources, RepositoryService repositoryService) {
    DeploymentBuilder deploymentBuilder =
        repositoryService.createDeployment().enableDuplicateFiltering().name(deploymentNameHint);
