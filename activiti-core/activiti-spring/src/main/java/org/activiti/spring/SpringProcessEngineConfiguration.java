...
public class SpringProcessEngineConfiguration extends ProcessEngineConfigurationImpl
    ...
    public SpringProcessEngineConfiguration(
        ...
        deploymentStrategies.add(
                new NeverFailAutoDeploymentStrategy(applicationUpgradeContextService));
    }
    ...
    protected void autoDeployResources(ProcessEngine processEngine) {
        ...
        strategy.deployResources(
                deploymentName, deploymentResources, processEngine.getRepositoryService());
    }
    ...
    /**
     * Gets the {@link AutoDeploymentStrategy} for the provided mode. This method may be overridden
     * to implement custom deployment strategies if required, but implementors should take care not
