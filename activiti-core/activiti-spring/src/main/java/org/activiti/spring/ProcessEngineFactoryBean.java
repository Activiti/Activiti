...
public class ProcessEngineFactoryBean
        ...
        if (processEngineConfiguration.getExpressionManager() == null
            ...
            processEngineConfiguration.setExpressionManager(
                    new SpringExpressionManager(
                            applicationContext, processEngineConfiguration.getBeans()));
        }
    }
    ...
    protected void configureExternallyManagedTransactions() {
        if (processEngineConfiguration
                instanceof
                SpringProcessEngineConfiguration) { // remark: any config can be injected, so we
            // cannot have
            // SpringConfiguration as member
