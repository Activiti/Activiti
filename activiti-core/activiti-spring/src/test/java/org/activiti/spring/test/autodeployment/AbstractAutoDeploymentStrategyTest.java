...
public class AbstractAutoDeploymentStrategyTest {
    ...
    @Mock protected RepositoryService repositoryServiceMock;

    @Mock protected DeploymentBuilder deploymentBuilderMock;

    @Mock protected ContextResource resourceMock1;

    @Mock protected ByteArrayResource resourceMock2;

    @Mock protected Resource resourceMock3;

    @Mock protected Resource resourceMock4;

    @Mock protected Resource resourceMock5;

    @Mock protected File fileMock1;

    @Mock protected File fileMock2;

    @Mock protected File fileMock3;

    @Mock protected File fileMock4;

    @Mock protected File fileMock5;

    @Mock private InputStream inputStreamMock;

    @Mock private Deployment deploymentMock;

    @Mock protected ApplicationUpgradeContextService applicationUpgradeContextServiceMock;
