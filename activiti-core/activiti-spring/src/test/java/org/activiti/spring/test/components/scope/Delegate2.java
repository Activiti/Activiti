...
public class Delegate2 implements JavaDelegate {
  ...
  public void execute(DelegateExecution execution) {
    ...
    assertThat(this.statefulObject.getName())
        .as(
            "the 'scopedCustomer.name' property should be non-null, since it was set in a previous"
                + " delegate bound to this very thread")
        .isNotNull();
    log.info(
        "the 'uuid' value retrieved from the ScopedCustomer#name property is '{}' in {}",
