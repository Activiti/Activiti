...
public class UseActivitiServiceInServiceTaskTest extends SpringActivitiTestCase {
     ...
     * (delegateExecution.getProcessEngine().getRuntimeService()) to obtain the {@link
     * RuntimeService} to start a new process.
     */
    @Deployment
    ...
    /**
     * This test will use the dependency injection of Spring to inject the runtime service in the
     * Java delegate.
     */
    @Deployment
