...
@ContextConfiguration(
    "classpath:org/activiti/spring/test/email/jndiEmailConfiguaration-context.xml")
public class JndiEmailTest extends SpringActivitiTestCase {
  ...
  public void setUp() {
    ...
    Provider provider =
        new Provider(Type.TRANSPORT, "smtp", MockEmailTransport.class.getName(), "test", "1.0");
  ...
  public void testEmailUsingJndi() {
    ProcessInstance processInstance =
        runtimeService.startProcessInstanceByKey("EmailJndiProcess", emptyMap());
    assertThat(
            runtimeService
