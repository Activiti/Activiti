...
public class DefaultAutoDeploymentStrategyTest extends AbstractAutoDeploymentStrategyTest {
    ...
    public void before() throws Exception {
        super.before();
        deploymentStrategy =
                new DefaultAutoDeploymentStrategy(applicationUpgradeContextServiceMock);
    }

    @Test
    public void testHandlesMode() {
        assertThat(deploymentStrategy.handlesMode(DefaultAutoDeploymentStrategy.DEPLOYMENT_MODE))
                .isTrue();
    ...
    public void testDeployResources() {
        final Resource[] resources =
                new Resource[] {
                    resourceMock1, resourceMock2, resourceMock3, resourceMock4, resourceMock5
                };
