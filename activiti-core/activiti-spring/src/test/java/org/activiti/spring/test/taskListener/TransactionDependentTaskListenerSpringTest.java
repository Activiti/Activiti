...
public class TransactionDependentTaskListenerSpringTest extends SpringActivitiTestCase {
  ...
  @Autowired MyTransactionDependentTaskListener listener;
  ...
  public void testCustomPropertiesMapDelegateExpression() {
    ...
    assertThat(listener.getCurrentTasks().get(0).getCustomPropertiesMap().get("customProp1"))
        .isEqualTo("task3");
    ...
    assertThat(listener.getCurrentTasks().get(1).getCustomPropertiesMap().get("customProp1"))
        .isEqualTo("task4");
  }
}
