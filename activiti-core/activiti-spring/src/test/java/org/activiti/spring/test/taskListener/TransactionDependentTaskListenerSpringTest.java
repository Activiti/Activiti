...
public class TransactionDependentTaskListenerSpringTest extends SpringActivitiTestCase {
    ...
    public void testCustomPropertiesMapDelegateExpression() {
        ...
        // Completing first task will trigger the first closed listener (expression custom
        // properties
        // resolver)
        ...
        // Completing second task will trigger the second closed listener (delegate expression
        // custom
        // properties resolver)
