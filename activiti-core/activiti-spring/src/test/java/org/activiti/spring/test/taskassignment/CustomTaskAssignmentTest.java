...
public class CustomTaskAssignmentTest extends SpringActivitiTestCase {
    ...
    public void testSetAssigneeThroughSpringService() {
        ...
        assertThat(taskService.createTaskQuery().taskAssignee("Kermit The Frog").count())
                .isEqualTo(1);
    }
    ...
    public void testSetCandidateUsersThroughSpringService() {
        ...
        assertThat(taskService.createTaskQuery().taskCandidateUser("mispiggy").count())
                .isEqualTo(0);
    }
    ...
    public void testSetCandidateGroupsThroughSpringService() {
        ...
        assertThat(taskService.createTaskQuery().taskCandidateGroup("management").count())
                .isEqualTo(1);
        assertThat(taskService.createTaskQuery().taskCandidateGroup("directors").count())
                .isEqualTo(1);
