...
public class ExecutionListenerOnTransactionTest extends SpringActivitiTestCase {
    ...
    public void testOnClosedExecutionListenersWithRollback() {
        ...
        ProcessInstance processInstance =
                runtimeService.startProcessInstanceByKey(
                        "transactionDependentExecutionListenerProcess", variables);
        ...
        List<CurrentActivityTransactionDependentExecutionListener.CurrentActivity>
                currentActivities =
    ...
    public void testOnCloseFailureExecutionListenersWithTransactionalOperation()
        ...
        List<MyTransactionalOperationTransactionDependentExecutionListener.CurrentActivity>
                currentActivities =
                        MyTransactionalOperationTransactionDependentExecutionListener
    ...
    public void testOnClosedExecutionListenersWithCustomPropertiesResolver() {
        ...
        assertThat(currentActivities.get(0).getCustomPropertiesMap().get("customProp1"))
