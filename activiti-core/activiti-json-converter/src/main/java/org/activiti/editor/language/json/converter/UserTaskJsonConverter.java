        ...
        if (StringUtils.isNotEmpty(assignee)
            ...
            if (CollectionUtils.isNotEmpty(idmAssigneeList)
                ...
                if (StringUtils.isNotEmpty(userTask.getAssignee())) {
                    ...
                    if (userTask.getAssignee()
                            .contains("${taskAssignmentBean.assignTaskToAssignee(")) {
                        ...
                        fillProperty(
                                "externalId", "assignee-info-externalid", assigneeNode, userTask);
                        fillProperty("email", "assignee-info-email", assigneeNode, userTask);
                        fillProperty(
                                "firstName", "assignee-info-firstname", assigneeNode, userTask);
                        ...
                        for (String candidate : candidateUserArray) {
                            if (candidate.contains("field(")) {
                                candidateFieldIds.add(
                                        candidate.trim().substring(6, candidate.length() - 1));
                            } else {
                ...
                if (CollectionUtils.isNotEmpty(userTask.getCandidateGroups())) {
                    ...
                    assignmentValuesNode.set(
                            PROPERTY_USERTASK_CANDIDATE_GROUPS, candidateArrayNode);
                }
            }
                ...
                if (typeNode == null || "static".equalsIgnoreCase(typeNode.asText())) {
                    ...
                    if (idmDefNode != null && idmDefNode.has("type")) {
                        ...
                        if (idmTypeNode != null
                            ...
                            addExtensionElement(
                                    "activiti-idm-initiator", String.valueOf(true), task);
                        }
                    }
                }
            }
    ...
    protected void fillAssigneeInfo(
        ...
        if (assigneeNode != null && !assigneeNode.isNull()) {
            ...
            if (idNode != null && !idNode.isNull() && StringUtils.isNotEmpty(idNode.asText())) {
                ...
                addExtensionElement(
                        "assignee-info-externalid", assigneeNode.get("externalId"), task);
                ...
                // is replaced by a real user id, but the email information kept in this extension
                // element
            ...
            if (idNode != null && !idNode.isNull() && StringUtils.isNotEmpty(idNode.asText())) {
                ...
                addExtensionElement(
                        "assignee-field-info-name", assigneeFieldNode.get("name"), task);
            }
        }
    ...
    protected void fillCandidateUsers(
        ...
        if (candidateUsersNode != null && candidateUsersNode.isArray()) {
            ...
            for (JsonNode userNode : candidateUsersNode) {
                if (userNode != null && !userNode.isNull()) {
                    ...
                    if (idNode != null
                        ...
                        addExtensionElement(
                                "user-info-firstname-" + id, userNode.get("firstName"), task);
                        addExtensionElement(
                                "user-info-lastname-" + id, userNode.get("lastName"), task);
                        addExtensionElement(
                                "user-info-externalid-" + id, userNode.get("externalId"), task);
            ...
            if (emails.size() > 0) {
                ...
                addExtensionElement(
                        "activiti-candidate-users-emails", StringUtils.join(emails, ","), task);
            }
            ...
            for (JsonNode groupNode : candidateGroupsNode) {
                if (groupNode != null && !groupNode.isNull()) {
                    ...
                    if (idNode != null
                        ...
                        addExtensionElement(
                                "group-info-externalid-" + id, groupNode.get("externalId"), task);
                    }
                }
            }
        }
