...
public class BoundaryEventJsonConverter extends BaseBpmnJsonConverter {
    ...
    public static void fillJsonTypes(
        ...
        convertersToBpmnMap.put(
                STENCIL_EVENT_BOUNDARY_COMPENSATION, BoundaryEventJsonConverter.class);
    }
    ...
    protected void convertElementToJson(ObjectNode propertiesNode, BaseElement baseElement) {
        ...
        GraphicInfo parentGraphicInfo =
                model.getGraphicInfo(boundaryEvent.getAttachedToRef().getId());
    ...
    private String lookForAttachedRef(String boundaryEventId, JsonNode childShapesNode) {
        ...
        if (childShapesNode != null) {
            ...
            for (JsonNode childNode : childShapesNode) {
                ...
                attachedRefId =
                        lookForAttachedRef(boundaryEventId, childNode.get(EDITOR_CHILD_SHAPES));
