...
public class ServiceTaskJsonConverter extends BaseBpmnJsonConverter
    ...
    protected void convertElementToJson(ObjectNode propertiesNode, BaseElement baseElement) {
        ...
        if ("mail".equalsIgnoreCase(serviceTask.getType())) {
            ...
            setPropertyFieldValue(
                    PROPERTY_MULETASK_LANGUAGE, "language", serviceTask, propertiesNode);
            setPropertyFieldValue(
            ...
            if (ImplementationType.IMPLEMENTATION_TYPE_CLASS.equals(
                ...
                propertiesNode.put(PROPERTY_SERVICETASK_CLASS, serviceTask.getImplementation());
                    ...
                    serviceTask.getImplementationType())) {
                propertiesNode.put(
                        PROPERTY_SERVICETASK_EXPRESSION, serviceTask.getImplementation());
    ...
    protected FlowElement convertJsonToElement(
        ...
        if (StringUtils.isNotEmpty(
                getPropertyValueAsString(PROPERTY_SERVICETASK_CLASS, elementNode))) {
            ...
            task.setImplementation(
                    getPropertyValueAsString(
                            PROPERTY_SERVICETASK_DELEGATE_EXPRESSION, elementNode));
        }
            ...
            if (itemsArrayNode != null) {
                for (JsonNode itemNode : itemsArrayNode) {
                    ...
                    if (nameNode != null && StringUtils.isNotEmpty(nameNode.asText())) {
                        ...
                        if (StringUtils.isNotEmpty(
                                getValueAsString(
                                        PROPERTY_SERVICETASK_FIELD_STRING_VALUE, itemNode))) {
                            ...
                            field.setStringValue(
                                ...
                                getValueAsString(
                                        PROPERTY_SERVICETASK_FIELD_EXPRESSION, itemNode))) {
                            field.setExpression(
                                    getValueAsString(
                                            PROPERTY_SERVICETASK_FIELD_EXPRESSION, itemNode));
                        }
