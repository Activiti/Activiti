...
public class ServiceTaskJsonConverter
    ...
    public static void fillJsonTypes(
        ...
        convertersToBpmnMap.put(
            ...
            ServiceTaskJsonConverter.class
        );
    }
    ...
    protected void convertElementToJson(
        ...
        if ("mail".equalsIgnoreCase(serviceTask.getType())) {
            ...
            setPropertyFieldValue(
                PROPERTY_MAILTASK_TEXT,
                serviceTask,
                propertiesNode
            );
            setPropertyFieldValue(
                PROPERTY_MAILTASK_HTML,
                serviceTask,
                propertiesNode
            );
            setPropertyFieldValue(
            ...
            for (FieldExtension fieldExtension : serviceTask.getFieldExtensions()) {
                if (
                    PROPERTY_DECISIONTABLE_REFERENCE_KEY.equals(
                        fieldExtension.getFieldName()
                    ) &&
                    decisionTableKeyMap != null &&
                    decisionTableKeyMap.containsKey(
                    ...
                    ModelInfo modelInfo = decisionTableKeyMap.get(
                        fieldExtension.getStringValue()
                    );
            ...
            if (
                ...
                propertiesNode.put(
                    PROPERTY_SERVICETASK_DELEGATE_EXPRESSION,
                    serviceTask.getImplementation()
                );
            }
            ...
            if (StringUtils.isNotEmpty(serviceTask.getResultVariableName())) {
                propertiesNode.put(
                    PROPERTY_SERVICETASK_RESULT_VARIABLE,
        ...
        if (fieldsNode != null) {
            ...
            if (itemsArrayNode != null) {
                for (JsonNode itemNode : itemsArrayNode) {
                    JsonNode nameNode = itemNode.get(
                    ...
                    if (
                        ...
                        if (
                            ...
                            StringUtils.isNotEmpty(
                                getValueAsString(
                                    PROPERTY_SERVICETASK_FIELD_STRING,
                                    itemNode
                                )
                            )
                        ) {
