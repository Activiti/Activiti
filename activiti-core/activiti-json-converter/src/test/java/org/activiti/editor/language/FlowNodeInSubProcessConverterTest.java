...
public class FlowNodeInSubProcessConverterTest extends AbstractConverterTest {
  ...
  private void validateModel(BpmnModel model) {
    ...
    ParallelGateway gateway =
        (ParallelGateway) subProcess.getFlowElement("sid-A0E0B174-36DF-4C4F-A952-311CC3C031FC");
    assertThat(gateway).isNotNull();
    List<SequenceFlow> sequenceFlows = gateway.getOutgoingFlows();
    assertThat(sequenceFlows.size() == 2).isTrue();
    assertThat(
            sequenceFlows.get(0).getId().equals("sid-9C669980-C274-4A48-BF7F-B9C5CA577DD2")
    ...
    assertThat(
        ...
        .isTrue();
    assertThat(
            sequenceFlows.get(0).getSourceRef().equals("sid-A0E0B174-36DF-4C4F-A952-311CC3C031FC"))
        .isTrue();
    assertThat(
            sequenceFlows.get(1).getSourceRef().equals("sid-A0E0B174-36DF-4C4F-A952-311CC3C031FC"))
        .isTrue();
  }
