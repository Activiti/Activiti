...
public class ExtensionTest {
    ...
    @Mock private ProcessVariablesMapping processVariablesMapping;
    ...
    @Test
    public void
            should_bothHasMappingTypeInputsAndOutputsReturnTrue_when_thereIsMappingTypeMAP_ALL() {
    ...
    @Test
    public void
            should_onlyHasMappingTypeOutputsReturnTrue_when_thereIsMappingTypeMAP_ALL_OUTPUTS() {
    ...
    @Test
    public void findAssigneeTemplateForTask_should_returnTemplate_when_templateIsDefined()
            throws Exception {
        // given
        try (InputStream inputStream =
            ...
            ProcessExtensionModel processExtensionModel =
                    MAPPER.readValue(inputStream, ProcessExtensionModel.class);
            Extension extensions = processExtensionModel.getExtensions("processDefinitionId");

            // when
            TemplateDefinition templateDefinition =
                    extensions.findAssigneeTemplateForTask("myTaskId1").orElse(null);
    ...
    @Test
    public void findAssigneeTemplateForTask_should_returnEmpty_when_noTemplatesForTask()
            throws Exception {
        // given
        try (InputStream inputStream =
                Thread.currentThread()
            ...
            // when
            Optional<TemplateDefinition> templateDefinition =
                    extensions.findAssigneeTemplateForTask("anyTaskWithoutAssigneeTemplate");
    ...
    @Test
    public void findAssigneeTemplateForTask_should_returnEmpty_when_onlyCandidateTemplate()
            throws Exception {
        // given
        try (InputStream inputStream =
                Thread.currentThread()
            ...
            // when
            Optional<TemplateDefinition> templateDefinition =
                    extensions.findAssigneeTemplateForTask("myTaskId3");
    ...
    @Test
    public void findCandidateTemplateForTask_should_returnTemplate_when_templateIsDefined()
            throws Exception {
        // given
        try (InputStream inputStream =
                Thread.currentThread()
            ...
            // when
            TemplateDefinition templateDefinition =
                    extensions.findCandidateTemplateForTask("myTaskId1").orElse(null);
    ...
    @Test
    public void findCandidateTemplateForTask_should_returnEmpty_when_onlyAssigneeCandidate()
            throws Exception {
        // given
        try (InputStream inputStream =
                Thread.currentThread()
            ...
            // when
            Optional<TemplateDefinition> templateDefinition =
                    extensions.findCandidateTemplateForTask("myTaskId2");
    ...
    @Test
    public void findCandidateTemplateForTask_should_returnEmpty_when_noTemplatesForTask()
            throws Exception {
        // given
        try (InputStream inputStream =
                Thread.currentThread()
            ...
            // when
            Optional<TemplateDefinition> templateDefinition =
                    extensions.findCandidateTemplateForTask("anyTaskWithoutTemplates");
