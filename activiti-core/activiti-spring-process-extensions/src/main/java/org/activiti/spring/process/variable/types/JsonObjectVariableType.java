...
public class JsonObjectVariableType extends VariableType {
  ...
  public void validate(Object var, List<ActivitiException> errors) {
    ...
    // this doesn't guarantee a string body to be valid json as jackson will wrap a string to make
    // it valid
    // also doesn't guarantee it will be persisted as json
    // could be a pojo and then could be persisted as serializable if user sets
    // serializePOJOsInVariablesToJson to false - see JsonType.java
