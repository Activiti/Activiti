...
public interface ProcessDiagramGenerator {
    ...
    /**
     * Generates a diagram of the given process definition, using the diagram interchange
     * information of the process. If there is no interchange information available, an
     * ActivitiInterchangeInfoNotFoundException is thrown.
     *
    ...
    /**
     * Generates a diagram of the given process definition, using the diagram interchange
     * information of the process, or the default diagram image, if generateDefaultDiagram param is
     * true.
     *
     * @param bpmnModel bpmn model to get diagram for
     * @param highLightedActivities activities to highlight
     ...
     * @param activityFontName override the default activity font
     * @param labelFontName override the default label font
     * @param generateDefaultDiagram true if a default diagram should be generated if there is no
     *     graphic info available
     */
    InputStream generateDiagram(
            BpmnModel bpmnModel,
            List<String> highLightedActivities,
