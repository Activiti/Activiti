...
public class MessageIconType extends IconType {
    ...
    public String getDValue() {
        return " m0 1.5  l0 13  l17 0  l0 -13  z M1.5 3  L6 7.5  L1.5 12  z M3.5 3  L13.5 3  L8.5 8"
                + "  z m12 0  l0 9  l-4.5 -4.5  z M7 8.5  L8.5 10  L10 8.5  L14.5 13  L2.5 13 "
                + " z";
    }
    ...
    public void drawIcon(
        ...
        gTag.setAttributeNS(
                null, "transform", "translate(" + (imageX - 1) + "," + (imageY - 2) + ")");
