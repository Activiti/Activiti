                ...
                public void draw(
                    ...
                    if (startEvent.getEventDefinitions() != null && !startEvent.getEventDefinitions().isEmpty()) {
                        ...
                        if (eventDefinition instanceof TimerEventDefinition) {
                            processDiagramCanvas.drawTimerStartEvent(flowNode.getId(), flowNode.getName(), graphicInfo);
                        } else if (eventDefinition instanceof ErrorEventDefinition) {
                            processDiagramCanvas.drawErrorStartEvent(flowNode.getId(), flowNode.getName(), graphicInfo);
                            ...
                            processDiagramCanvas.drawNoneStartEvent(flowNode.getId(), flowNode.getName(), graphicInfo);
                        }
                    } else {
                        processDiagramCanvas.drawNoneStartEvent(flowNode.getId(), flowNode.getName(), graphicInfo);
                    }
                ...
                public void draw(
                    ...
                    if (
                        ...
                        if (intermediateCatchEvent.getEventDefinitions().getFirst() instanceof SignalEventDefinition) {
                            ...
                            intermediateCatchEvent.getEventDefinitions().getFirst() instanceof TimerEventDefinition
                        ) {
                            ...
                            intermediateCatchEvent.getEventDefinitions().getFirst() instanceof MessageEventDefinition
                        ) {
                        ...
                        } else if (intermediateCatchEvent.isLinkEvent()) {
                            processDiagramCanvas.drawCatchingLinkEvent(
                                flowNode.getId(),
                                flowNode.getName(),
                                graphicInfo,
                                true
                ...
                public void draw(
                    ...
                    if (throwEvent.getEventDefinitions() != null && !throwEvent.getEventDefinitions().isEmpty()) {
                        if (throwEvent.getEventDefinitions().getFirst() instanceof SignalEventDefinition) {
                            ...
                            processDiagramCanvas.drawThrowingLinkEvent(
                                flowNode.getId(),
                                flowNode.getName(),
                                graphicInfo
                            );
                        ...
                        processDiagramCanvas.drawThrowingNoneEvent(flowNode.getId(), flowNode.getName(), graphicInfo);
                    }
                }
            }
        );
        ...
        activityDrawInstructions.put(
            ...
            new ActivityDrawInstruction() {
                ...
                public void draw(
                    ...
                    processDiagramCanvas.drawServiceTask(flowNode.getId(), serviceTask.getName(), graphicInfo);
                }
            }
        );
            ...
            new ActivityDrawInstruction() {
                ...
                public void draw(
                    ...
                    if (boundaryEvent.getEventDefinitions() != null && !boundaryEvent.getEventDefinitions().isEmpty()) {
                        ...
                        } else if (boundaryEvent.getEventDefinitions().getFirst() instanceof ErrorEventDefinition) {
                            processDiagramCanvas.drawCatchingErrorEvent(
                                flowNode.getId(),
                                graphicInfo,
                                boundaryEvent.isCancelActivity()
                            );
                        } else if (boundaryEvent.getEventDefinitions().getFirst() instanceof SignalEventDefinition) {
                            processDiagramCanvas.drawCatchingSignalEvent(
                                flowNode.getId(),
                                flowNode.getName(),
                                graphicInfo,
                        ...
                        } else if (boundaryEvent.getEventDefinitions().getFirst() instanceof MessageEventDefinition) {
                            processDiagramCanvas.drawCatchingMessageEvent(
                                flowNode.getId(),
                                flowNode.getName(),
                                graphicInfo,
    ...
    protected void drawActivity(
        ...
        if (drawInstruction != null) {
            ...
            if (currentActivities.contains(flowNode.getId())) {
                processDiagramCanvas.drawHighLightCurrent(bpmnModel.getGraphicInfo(flowNode.getId()));
            }

            if (highLightedActivities.contains(flowNode.getId())) {
                Class flowNodeClass = flowNode.getClass();
                if (Event.class.isAssignableFrom(flowNodeClass)) {
                    processDiagramCanvas.drawEventHighLightCompleted(bpmnModel.getGraphicInfo(flowNode.getId()));
                } else if (
                    Task.class.isAssignableFrom(flowNodeClass) || CallActivity.class.isAssignableFrom(flowNodeClass)
                ) {
                    processDiagramCanvas.drawHighLightCompleted(bpmnModel.getGraphicInfo(flowNode.getId()));
                } else if (Gateway.class.isAssignableFrom(flowNodeClass)) {
                    processDiagramCanvas.drawGatewayHighLightCompleted(bpmnModel.getGraphicInfo(flowNode.getId()));
                }
            }
            ...
            if (erroredActivities.contains(flowNode.getId())) {
                Class flowNodeClass = flowNode.getClass();
                if (Event.class.isAssignableFrom(flowNodeClass)) {
                    processDiagramCanvas.drawEventHighLightErrored(bpmnModel.getGraphicInfo(flowNode.getId()));
                } else if (
                    Task.class.isAssignableFrom(flowNodeClass) || CallActivity.class.isAssignableFrom(flowNodeClass)
                ) {
                    processDiagramCanvas.drawHighLightErrored(bpmnModel.getGraphicInfo(flowNode.getId()));
                } else if (Gateway.class.isAssignableFrom(flowNodeClass)) {
                    processDiagramCanvas.drawGatewayHighLightErrored(bpmnModel.getGraphicInfo(flowNode.getId()));
                }
            }
        }
