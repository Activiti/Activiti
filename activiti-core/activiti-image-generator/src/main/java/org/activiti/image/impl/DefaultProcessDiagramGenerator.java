...
public class DefaultProcessDiagramGenerator implements ProcessDiagramGenerator {
    ...
    protected Map<Class<? extends BaseElement>, ActivityDrawInstruction> activityDrawInstructions =
            new HashMap<Class<? extends BaseElement>, ActivityDrawInstruction>();

    protected Map<Class<? extends BaseElement>, ArtifactDrawInstruction> artifactDrawInstructions =
            new HashMap<Class<? extends BaseElement>, ArtifactDrawInstruction>();
                    ...
                    public void draw(
                        ...
                        if (startEvent.getEventDefinitions() != null
                            ...
                            EventDefinition eventDefinition =
                                    startEvent.getEventDefinitions().get(0);
                            if (eventDefinition instanceof TimerEventDefinition) {
                                processDiagramCanvas.drawTimerStartEvent(
                                        flowNode.getId(), graphicInfo);
                ...
                new ActivityDrawInstruction() {
                    ...
                    public void draw(
                        ...
                        if (intermediateCatchEvent.getEventDefinitions() != null
                            ...
                            if (intermediateCatchEvent.getEventDefinitions().get(0)
                                    instanceof SignalEventDefinition) {
                                processDiagramCanvas.drawCatchingSignalEvent(
                                        flowNode.getId(), flowNode.getName(), graphicInfo, true);
                            } else if (intermediateCatchEvent.getEventDefinitions().get(0)
                                    instanceof TimerEventDefinition) {
        ...
        activityDrawInstructions.put(
                ...
                new ActivityDrawInstruction() {
                    ...
                    public void draw(
                        ...
                        if (throwEvent.getEventDefinitions() != null
                                && !throwEvent.getEventDefinitions().isEmpty()) {
                            if (throwEvent.getEventDefinitions().get(0)
                                    instanceof SignalEventDefinition) {
                                processDiagramCanvas.drawThrowingSignalEvent(
                                        flowNode.getId(), graphicInfo);
                            } else if (throwEvent.getEventDefinitions().get(0)
                ...
                new ActivityDrawInstruction() {
                    ...
                    public void draw(
                        ...
                        if (endEvent.getEventDefinitions() != null
                            ...
                            if (endEvent.getEventDefinitions().get(0)
                                    instanceof ErrorEventDefinition) {
                                processDiagramCanvas.drawErrorEndEvent(
                                        flowNode.getId(), flowNode.getName(), graphicInfo);
                            } else {
                ...
                new ActivityDrawInstruction() {
                    ...
                    public void draw(
                        ...
                        processDiagramCanvas.drawServiceTask(
                                flowNode.getId(), serviceTask.getName(), graphicInfo);
                    }
                });
                ...
                new ActivityDrawInstruction() {
                    ...
                    public void draw(
                        ...
                        if (boundaryEvent.getEventDefinitions() != null
                            ...
                            if (boundaryEvent.getEventDefinitions().get(0)
                                    instanceof TimerEventDefinition) {
                            ...
                            } else if (boundaryEvent.getEventDefinitions().get(0)
                                    instanceof ErrorEventDefinition) {
                    ...
                    public void draw(
                        ...
                        if (graphicInfo.getExpanded() != null && !graphicInfo.getExpanded()) {
                            processDiagramCanvas.drawCollapsedSubProcess(
                                    flowNode.getId(), flowNode.getName(), graphicInfo, false);
                        } else {
                ...
                new ArtifactDrawInstruction() {
                    ...
                    public void draw(
                        ...
                        processDiagramCanvas.drawTextAnnotation(
                                textAnnotation.getId(), textAnnotation.getText(), graphicInfo);
                    }
                });
                ...
                new ArtifactDrawInstruction() {
                    ...
                    public void draw(
                        ...
                        List<GraphicInfo> graphicInfoList =
                                bpmnModel.getFlowLocationGraphicInfo(artifact.getId());
                        graphicInfoList =
                        ...
                        processDiagramCanvas.drawAssociation(
                                xPoints, yPoints, associationDirection, false);
                    }
                });
    }
    ...
    protected DefaultProcessDiagramCanvas generateProcessDiagram(
        ...
        DefaultProcessDiagramCanvas processDiagramCanvas =
                initProcessDiagramCanvas(
                        bpmnModel, activityFontName, labelFontName, annotationFontName);
    ...
    public Map<Class<? extends BaseElement>, ActivityDrawInstruction>
    ...
    public Map<Class<? extends BaseElement>, ArtifactDrawInstruction>
