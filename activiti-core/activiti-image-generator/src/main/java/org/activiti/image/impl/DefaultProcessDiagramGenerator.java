...
public class DefaultProcessDiagramGenerator implements ProcessDiagramGenerator {
            ...
            if (boundaryEvent.getEventDefinitions() != null
              ...
              if (boundaryEvent.getEventDefinitions().get(0) instanceof TimerEventDefinition) {
                ...
                processDiagramCanvas.drawCatchingErrorEvent(
                    flowNode.getId(), graphicInfo, boundaryEvent.isCancelActivity());
              } else if (boundaryEvent.getEventDefinitions().get(0)
                  instanceof SignalEventDefinition) {
                processDiagramCanvas.drawCatchingSignalEvent(
                    flowNode.getId(),
          ...
          public void draw(
            ...
            if (graphicInfo.getExpanded() != null && !graphicInfo.getExpanded()) {
              ...
              processDiagramCanvas.drawExpandedSubProcess(
                  flowNode.getId(), flowNode.getName(), graphicInfo, SubProcess.class);
            }
          }
        });
    // transaction
        ...
        new ActivityDrawInstruction() {
          ...
          public void draw(
            ...
            if (graphicInfo.getExpanded() != null && !graphicInfo.getExpanded()) {
              ...
              processDiagramCanvas.drawExpandedSubProcess(
                  flowNode.getId(), flowNode.getName(), graphicInfo, Transaction.class);
            }
          }
        });
        ...
        new ActivityDrawInstruction() {
          ...
          public void draw(
            ...
            if (graphicInfo.getExpanded() != null && !graphicInfo.getExpanded()) {
              ...
              processDiagramCanvas.drawExpandedSubProcess(
                  flowNode.getId(), flowNode.getName(), graphicInfo, EventSubProcess.class);
            }
          }
        });
  ...
  public InputStream generateDiagram(
    ...
    return generateDiagram(
        bpmnModel, emptyList(), emptyList(), activityFontName, labelFontName, annotationFontName);
  }
  ...
  protected DefaultProcessDiagramCanvas generateProcessDiagram(
    ...
    DefaultProcessDiagramCanvas processDiagramCanvas =
        initProcessDiagramCanvas(bpmnModel, activityFontName, labelFontName, annotationFontName);
