            ...
            for (EventListener eventListener : eventListeners) {
                ...
                if (eventListener.getImplementationType() != null
                        && eventListener
                                ...
                                .equals(
                                        ImplementationType
                                                .IMPLEMENTATION_TYPE_INVALID_THROW_EVENT)) {
                    ...
                    addError(
                            ...
                            process,
                            eventListener,
                            "Element 'class', 'delegateExpression' or 'throwEvent' is mandatory on"
                                    + " eventListener");
                    ...
                    if (!ImplementationType.IMPLEMENTATION_TYPE_CLASS.equals(
                        ...
                        addError(
                                errors,
                                Problems.EVENT_LISTENER_INVALID_IMPLEMENTATION,
                                process,
                                eventListener,
                                "Unsupported implementation type for event listener");
                    }
                }
            }
        }
