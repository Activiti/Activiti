    ...
    protected void executeValidation(
        ...
        for (SequenceFlow sequenceFlow : sequenceFlows) {
            ...
            if (source != null && target != null) {
                FlowElementsContainer sourceContainer =
                        process.getFlowElementsContainer(source.getId());
                FlowElementsContainer targetContainer =
                        process.getFlowElementsContainer(target.getId());
                ...
                if (sourceContainer != null
                    ...
                    addError(
                            ...
                            process,
                            sequenceFlow,
                            "Invalid target for sequenceflow, the target isn't defined in the same"
                                    + " scope as the source");
                }
            }
                ...
                try {
                    new ExpressionFactoryImpl()
                            .createValueExpression(
                                    new SimpleContext(), conditionExpression.trim(), Object.class);
                } catch (Exception e) {
                    addError(
                            errors,
                            ...
                            process,
                            sequenceFlow,
                            "Conditional expression is not valid");
                }
            }
        }
    }
