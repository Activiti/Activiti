...
public interface Problems {
    ...
    String EVENT_TIMER_MISSING_CONFIGURATION =
        "activiti-event-timer-missing-configuration";

    String THROW_EVENT_INVALID_EVENTDEFINITION =
        "activiti-throw-event-invalid-eventdefinition";

    String MULTI_INSTANCE_MISSING_COLLECTION =
    ...
    String MESSAGE_EVENT_MISSING_MESSAGE_REF =
        "activiti-message-event-missing-message-ref";
    String MESSAGE_EVENT_INVALID_MESSAGE_REF =
        "activiti-message-event-invalid-message-ref";
    String MESSAGE_EVENT_MULTIPLE_ON_BOUNDARY_SAME_MESSAGE_ID =
        "activiti-message-event-multiple-on-boundary-same-message-id";

    String OPERATION_INVALID_IN_MESSAGE_REFERENCE =
        "activiti-operation-invalid-in-message-reference";

    String SIGNAL_EVENT_MISSING_SIGNAL_REF =
        "activiti-signal-event-missing-signal-ref";
    String SIGNAL_EVENT_INVALID_SIGNAL_REF =
        "activiti-signal-event-invalid-signal-ref";

    String COMPENSATE_EVENT_INVALID_ACTIVITY_REF =
        "activiti-compensate-event-invalid-activity-ref";
    String COMPENSATE_EVENT_MULTIPLE_ON_BOUNDARY =
