...
public class BpmnAutoLayout {
    ...
    protected void handleSequenceFlow() {
        ...
        for (SequenceFlow sequenceFlow : sequenceFlows.values()) {
            ...
            Object sequenceFlowEdge = graph.insertEdge(
                cellParent,
                sequenceFlow.getId(),
                "",
                sourceVertex,
    ...
    protected void handleAssociations() {
        ...
        for (Association association : associations.values()) {
            ...
            Object associationEdge = graph.insertEdge(
                cellParent,
                association.getId(),
                "",
                sourceVertex,
    ...
    protected void createEventVertex(FlowElement flowElement) {
        ...
        Object eventVertex = graph.insertVertex(
            cellParent,
            flowElement.getId(),
            "",
            0,
    ...
    protected void createGatewayVertex(FlowElement flowElement) {
        ...
        // Create gateway node
        Object gatewayVertex = graph.insertVertex(
            cellParent,
            flowElement.getId(),
            "",
            0,
