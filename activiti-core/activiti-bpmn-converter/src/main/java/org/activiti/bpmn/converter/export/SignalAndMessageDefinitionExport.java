...
public class SignalAndMessageDefinitionExport implements BpmnXMLConstants {
    ...
    public static void writeSignalsAndMessages(
        BpmnModel model,
        XMLStreamWriter xtw
    ) throws Exception {
            ...
            for (FlowElement flowElement : process.findFlowElementsOfType(
                ...
                if (!event.getEventDefinitions().isEmpty()) {
                    ...
                    if (eventDefinition instanceof SignalEventDefinition) {
                        ...
                        if (
                            StringUtils.isNotEmpty(signalEvent.getSignalRef())
                        ) {
                            if (
                                !model.containsSignalId(
                        ...
                        if (
                            StringUtils.isNotEmpty(messageEvent.getMessageRef())
                        ) {
                            if (
                                !model.containsMessageId(
        ...
        for (Message message : model.getMessages()) {
            ...
            if (
                model.getTargetNamespace() != null &&
                messageId.startsWith(model.getTargetNamespace())
            ) {
                ...
                for (String prefix : model.getNamespaces().keySet()) {
                    ...
                    if (messageId.startsWith(namespace)) {
                        messageId =
                            messageId.replace(model.getTargetNamespace(), "");
