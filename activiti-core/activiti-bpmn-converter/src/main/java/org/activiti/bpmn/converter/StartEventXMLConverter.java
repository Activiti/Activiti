    ...
    protected BaseElement convertXMLToElement(XMLStreamReader xtr, BpmnModel model)
        ...
        startEvent.setInitiator(
                xtr.getAttributeValue(
                        ACTIVITI_EXTENSIONS_NAMESPACE, ATTRIBUTE_EVENT_START_INITIATOR));
        boolean interrupting = true;
        String interruptingAttribute =
                xtr.getAttributeValue(null, ATTRIBUTE_EVENT_START_INTERRUPTING);
