    ...
    protected BaseElement convertXMLToElement(XMLStreamReader xtr, BpmnModel model)
        ...
        if (StringUtils.isNotEmpty(structureRef) && structureRef.contains(":")) {
            ...
            if (dataType.equals("string")) {
                ...
                LOGGER.error(
                        "Error converting {}, invalid data type: " + dataType,
                ...
                if (StringUtils.isNotEmpty(valueElement.getElementText())) {
                    if (dataObject instanceof DateDataObject) {
                        try {
                            ...
                            LOGGER.error(
                                    "Error converting {}", dataObject.getName(), e.getMessage());
                        }
                    } else {
    ...
    protected void writeAdditionalAttributes(
        ...
        if (dataObject.getItemSubjectRef() != null
            ...
            writeDefaultAttribute(
                    ATTRIBUTE_DATA_ITEM_REF, dataObject.getItemSubjectRef().getStructureRef(), xtw);
        }
    }
    ...
    protected boolean writeExtensionChildElements(
        ...
        if (StringUtils.isNotEmpty(dataObject.getId()) && dataObject.getValue() != null) {
            ...
            xtw.writeStartElement(
                    ACTIVITI_EXTENSIONS_PREFIX, ELEMENT_DATA_VALUE, ACTIVITI_EXTENSIONS_NAMESPACE);
