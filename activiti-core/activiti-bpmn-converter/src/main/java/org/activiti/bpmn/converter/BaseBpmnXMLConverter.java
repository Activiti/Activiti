...
public abstract class BaseBpmnXMLConverter implements BpmnXMLConstants {
    ...
    public void convertToXML(XMLStreamWriter xtw, BaseElement baseElement, BpmnModel model) throws Exception {
        ...
        didWriteExtensionStartElement =
            BpmnXMLUtil.writeExtensionElements(baseElement, didWriteExtensionStartElement, model.getNamespaces(), xtw);
        if (baseElement instanceof Activity) {
            final Activity activity = (Activity) baseElement;
    ...
    protected boolean writeListeners(BaseElement element, boolean didWriteExtensionStartElement, XMLStreamWriter xtw)
        throws Exception {
    ...
    protected void writeEventDefinitions(
        ...
        for (EventDefinition eventDefinition : eventDefinitions) {
            if (eventDefinition instanceof TimerEventDefinition) {
                ...
                linkEventDefinitionXMLConverter.writeLinkDefinition((LinkEventDefinition) eventDefinition, xtw);
