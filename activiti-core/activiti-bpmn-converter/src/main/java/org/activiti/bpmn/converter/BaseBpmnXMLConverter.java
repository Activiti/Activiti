...
public abstract class BaseBpmnXMLConverter implements BpmnXMLConstants {
    ...
    protected static final List<ExtensionAttribute> defaultElementAttributes =
            asList(new ExtensionAttribute(ATTRIBUTE_ID), new ExtensionAttribute(ATTRIBUTE_NAME));
    ...
    protected static final List<ExtensionAttribute> defaultActivityAttributes =
            asList(
                    ...
                    new ExtensionAttribute(
                            ACTIVITI_EXTENSIONS_NAMESPACE, ATTRIBUTE_ACTIVITY_ISFORCOMPENSATION));
    ...
    public void convertToXML(XMLStreamWriter xtw, BaseElement baseElement, BpmnModel model)
            ...
            if (flowNode.isAsynchronous()) {
                ...
                if (flowNode.isNotExclusive()) {
                    writeQualifiedAttribute(
                            ATTRIBUTE_ACTIVITY_EXCLUSIVE, ATTRIBUTE_VALUE_FALSE, xtw);
                }
            }
            ...
            if (baseElement instanceof Activity) {
                ...
                if (activity.isForCompensation()) {
                    writeDefaultAttribute(
                            ATTRIBUTE_ACTIVITY_ISFORCOMPENSATION, ATTRIBUTE_VALUE_TRUE, xtw);
                }
                if (StringUtils.isNotEmpty(activity.getDefaultFlow())) {
                    FlowElement defaultFlowElement =
                            model.getFlowElement(activity.getDefaultFlow());
        ...
        didWriteExtensionStartElement =
                writeListeners(baseElement, didWriteExtensionStartElement, xtw);
        didWriteExtensionStartElement =
    ...
    protected abstract void writeAdditionalAttributes(
    ...
    protected void parseChildElements(
            String elementName, BaseElement parentElement, BpmnModel model, XMLStreamReader xtr)
            throws Exception {
    ...
    protected boolean parseNotExclusive(XMLStreamReader xtr) {
        ...
        String exclusiveString =
                xtr.getAttributeValue(ACTIVITI_EXTENSIONS_NAMESPACE, ATTRIBUTE_ACTIVITY_EXCLUSIVE);
    ...
    protected boolean parseForCompensation(XMLStreamReader xtr) {
        ...
        String compensationString =
                xtr.getAttributeValue(null, ATTRIBUTE_ACTIVITY_ISFORCOMPENSATION);
        ...
        if (propertyList != null) {
            ...
            for (FormProperty property : propertyList) {
                ...
                if (StringUtils.isNotEmpty(property.getId())) {
                    ...
                    writeDefaultAttribute(
                            ATTRIBUTE_FORM_DEFAULT, property.getDefaultExpression(), xtw);
                    writeDefaultAttribute(
                            ATTRIBUTE_FORM_DATEPATTERN, property.getDatePattern(), xtw);
        ...
        for (EventDefinition eventDefinition : eventDefinitions) {
            if (eventDefinition instanceof TimerEventDefinition) {
                ...
                writeCompensateDefinition(
                        parentEvent, (CompensateEventDefinition) eventDefinition, xtw);
            }
        }
    }
    ...
    protected void writeTimerDefinition(
        ...
        if (StringUtils.isNotEmpty(timerDefinition.getCalendarName())) {
            writeQualifiedAttribute(
                    ATTRIBUTE_CALENDAR_NAME, timerDefinition.getCalendarName(), xtw);
        }
    ...
    protected void writeCancelDefinition(
            Event parentEvent, CancelEventDefinition cancelEventDefinition, XMLStreamWriter xtw)
            throws Exception {
        xtw.writeStartElement(ELEMENT_EVENT_CANCELDEFINITION);
        boolean didWriteExtensionStartElement =
                BpmnXMLUtil.writeExtensionElements(cancelEventDefinition, false, xtw);
        if (didWriteExtensionStartElement) {
            xtw.writeEndElement();
        }
        xtw.writeEndElement();
    ...
    protected void writeCompensateDefinition(
            Event parentEvent,
        ...
        writeDefaultAttribute(
                ATTRIBUTE_COMPENSATE_ACTIVITYREF, compensateEventDefinition.getActivityRef(), xtw);
        boolean didWriteExtensionStartElement =
                BpmnXMLUtil.writeExtensionElements(compensateEventDefinition, false, xtw);
        if (didWriteExtensionStartElement) {
            xtw.writeEndElement();
        }
        xtw.writeEndElement();
    ...
    protected void writeIncomingOutgoingFlowElements(
            BaseElement element, BpmnModel model, XMLStreamWriter xtw) throws Exception {
