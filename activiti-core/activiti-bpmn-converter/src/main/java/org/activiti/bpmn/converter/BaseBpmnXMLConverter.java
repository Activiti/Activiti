...
public abstract class BaseBpmnXMLConverter implements BpmnXMLConstants {
    ...
    public void convertToXML(
        ...
        if (baseElement instanceof FlowElement) {
            writeDefaultAttribute(
                ATTRIBUTE_NAME,
                ((FlowElement) baseElement).getName(),
                xtw
            );
        }
        ...
        if (baseElement instanceof FlowNode) {
            ...
            if (baseElement instanceof Activity) {
                ...
                if (StringUtils.isNotEmpty(activity.getDefaultFlow())) {
                    FlowElement defaultFlowElement = model.getFlowElement(
    ...
    protected abstract BaseElement convertXMLToElement(
        XMLStreamReader xtr,
        BpmnModel model
    ) throws Exception;
    ...
    protected ExtensionElement parseExtensionElement(XMLStreamReader xtr)
        ...
        while (!readyWithExtensionElement && xtr.hasNext()) {
            ...
            if (
                ...
                ExtensionElement childExtensionElement = parseExtensionElement(
                    xtr
                );
    ...
    protected boolean parseForCompensation(XMLStreamReader xtr) {
        ...
        String compensationString = xtr.getAttributeValue(
            null,
            ATTRIBUTE_ACTIVITY_ISFORCOMPENSATION
        );
    ...
    protected boolean writeListeners(
        ...
        return ActivitiListenerExport.writeListeners(
            element,
            didWriteExtensionStartElement,
            xtw
        );
    ...
    protected void writeTimerDefinition(
        ...
        if (StringUtils.isNotEmpty(timerDefinition.getCalendarName())) {
            writeQualifiedAttribute(
                ...
                timerDefinition.getCalendarName(),
                xtw
            );
        }
    ...
    protected void writeCompensateDefinition(
        ...
        writeDefaultAttribute(
            ATTRIBUTE_COMPENSATE_ACTIVITYREF,
            ...
            if (messageRef.startsWith(model.getTargetNamespace())) {
                ...
                for (String prefix : model.getNamespaces().keySet()) {
                    ...
                    if (messageRef.startsWith(namespace)) {
                        messageRef =
                            messageRef.replace(model.getTargetNamespace(), "");
    ...
    protected void writeDefaultAttribute(
    ...
    protected void writeQualifiedAttribute(
        String attributeName,
        String value,
        XMLStreamWriter xtw
    ) throws Exception {
