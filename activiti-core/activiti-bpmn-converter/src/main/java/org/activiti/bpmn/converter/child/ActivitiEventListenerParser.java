    ...
    public void parseChildElement(
        ...
        if (
            StringUtils.isNotEmpty(
                xtr.getAttributeValue(null, ATTRIBUTE_LISTENER_CLASS)
            )
        ) {
            ...
            StringUtils.isNotEmpty(
                xtr.getAttributeValue(null, ATTRIBUTE_LISTENER_THROW_EVENT_TYPE)
            )
        ) {
            String eventType = xtr.getAttributeValue(
                null,
            ...
            if (ATTRIBUTE_LISTENER_THROW_EVENT_TYPE_SIGNAL.equals(eventType)) {
                ...
                ATTRIBUTE_LISTENER_THROW_EVENT_TYPE_GLOBAL_SIGNAL.equals(
                    eventType
                )
            ) {
                listener.setImplementationType(
                ...
                ATTRIBUTE_LISTENER_THROW_EVENT_TYPE_MESSAGE.equals(eventType)
            ) {
                listener.setImplementationType(
                ...
                ATTRIBUTE_LISTENER_THROW_EVENT_TYPE_ERROR.equals(eventType)
            ) {
                listener.setImplementationType(
        ...
        listener.setEvents(
            xtr.getAttributeValue(null, ATTRIBUTE_LISTENER_EVENTS)
        );
        listener.setEntityType(
            xtr.getAttributeValue(null, ATTRIBUTE_LISTENER_ENTITY_TYPE)
        );
