...
public class TextAnnotationXMLConverter extends BaseBpmnXMLConverter {
    ...
    public TextAnnotationXMLConverter() {
        ...
        childParserMap.put(
            annotationTextParser.getElementName(),
            annotationTextParser
        );
    }
    ...
    protected BaseElement convertXMLToElement(
        ...
        textAnnotation.setTextFormat(
            xtr.getAttributeValue(null, ATTRIBUTE_TEXTFORMAT)
        );
        parseChildElements(
            getXMLElementName(),
            textAnnotation,
