...
public class DataAssociationParser implements BpmnXMLConstants {
    ...
    protected static final Logger LOGGER = LoggerFactory.getLogger(
        DataAssociationParser.class.getName()
    );
    ...
    public static void parseDataAssociation(
        ...
        try {
            ...
            while (!readyWithDataAssociation && xtr.hasNext()) {
                ...
                if (
                    xtr.isStartElement() &&
                    ELEMENT_SOURCE_REF.equals(xtr.getLocalName())
                ) {
                    ...
                    xtr.isStartElement() &&
                    ELEMENT_TARGET_REF.equals(xtr.getLocalName())
                ) {
                    ...
                    xtr.isStartElement() &&
                    ELEMENT_TRANSFORMATION.equals(xtr.getLocalName())
                ) {
                    ...
                    xtr.isStartElement() &&
                    ELEMENT_ASSIGNMENT.equals(xtr.getLocalName())
                ) {
                    assignment = new Assignment();
                    BpmnXMLUtil.addXMLLocation(assignment, xtr);
                } else if (
                    xtr.isStartElement() &&
                    ELEMENT_FROM.equals(xtr.getLocalName())
                ) {
                    ...
                    xtr.isStartElement() &&
                    ELEMENT_TO.equals(xtr.getLocalName())
                ) {
                    ...
                    if (
                        StringUtils.isNotEmpty(assignment.getFrom()) &&
                        StringUtils.isNotEmpty(assignment.getTo())
                    ) {
                        dataAssociation.getAssignments().add(assignment);
                    }
                } else if (
                    xtr.isEndElement() && elementName.equals(xtr.getLocalName())
                ) {
