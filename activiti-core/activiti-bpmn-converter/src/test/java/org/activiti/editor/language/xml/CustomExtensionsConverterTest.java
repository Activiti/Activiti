...
public class CustomExtensionsConverterTest extends AbstractConverterTest {
    ...
    private void validateModel(BpmnModel model) {
        ...
        List<ActivitiListener> listeners = model
            .getMainProcess()
            .getExecutionListeners();
        validateExecutionListeners(listeners);
        Map<String, List<ExtensionElement>> extensionElementMap = model
            .getMainProcess()
        ...
        extensionElementMap =
            boundaryEvent.getEventDefinitions().get(0).getExtensionElements();
        validateExtensionElements(extensionElementMap);
    }

    protected void validateExecutionListeners(
    ...
    protected void validateExtensionElements(
        ...
        assertThat(extensionElement.getNamespace())
            .isEqualTo("http://custom.org/bpmn");
        assertThat(extensionElement.getAttributes()).hasSize(2);

        List<ExtensionAttribute> attributes = extensionElement
            .getAttributes()
            .get("id");
        assertThat(attributes).hasSize(1);
        ExtensionAttribute attribute = attributes.get(0);
        ...
        List<ExtensionElement> childExtensions = extensionElement
            .getChildElements()
            .get("name");
        ...
        childExtensions =
            extensionElement.getChildElements().get("description");
        ...
        assertThat(attribute.getNamespace())
            .isEqualTo("http://custom2.org/bpmn");
