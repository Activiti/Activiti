...
public class ErrorConverterTest extends AbstractConverterTest {
    ...
    public void testConversionFromBPMNModelToXml() throws Exception {
        ...
        String convertedXml = new String(xml, "UTF-8");
        assertThat(convertedXml)
                .contains("<error id=\"Error_0v4rsz5\" name=\"ok\" errorCode=\"200\">");
        assertThat(convertedXml)
                .contains("<error id=\"Error_02htlc0\" name=\"conflict\" errorCode=\"409\">");
    }
