...
public class EventListenerConverterTest extends AbstractConverterTest {
    ...
    private void validateModel(BpmnModel model) {
        ...
        assertThat(listener.getImplementation())
                .isEqualTo("org.activiti.test.AllEventTypesListener");
        assertThat(listener.getImplementationType())
                .isEqualTo(ImplementationType.IMPLEMENTATION_TYPE_CLASS);
        ...
        assertThat(listener.getImplementationType())
                .isEqualTo(ImplementationType.IMPLEMENTATION_TYPE_THROW_SIGNAL_EVENT);
        ...
        assertThat(listener.getImplementation()).isEqualTo("theSignal");
        assertThat(listener.getImplementationType())
                .isEqualTo(ImplementationType.IMPLEMENTATION_TYPE_THROW_GLOBAL_SIGNAL_EVENT);
        ...
        assertThat(listener.getImplementationType())
                .isEqualTo(ImplementationType.IMPLEMENTATION_TYPE_THROW_MESSAGE_EVENT);
        ...
        assertThat(listener.getImplementationType())
                .isEqualTo(ImplementationType.IMPLEMENTATION_TYPE_THROW_ERROR_EVENT);
