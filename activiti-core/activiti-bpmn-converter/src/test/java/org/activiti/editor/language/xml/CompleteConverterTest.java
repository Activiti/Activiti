...
public class CompleteConverterTest extends AbstractConverterTest {
  ...
  private void validateModel(BpmnModel model) {
    var flowElement = model.getMainProcess().getFlowElement("userTask1");
    ...
    var catchEvent = (IntermediateCatchEvent) flowElement;
    ...
    var signalEvent = (SignalEventDefinition) catchEvent.getEventDefinitions()
      .getFirst();
