...
public class MapExceptionConverterTest extends AbstractConverterTest {
    ...
    public void testMapExceptionWithInvalidHasChildren() throws Exception {
        ...
        assertThatExceptionOfType(XMLException.class)
            .as(
                "No exception is thrown for mapExecution with invalid boolean for hasChildren"
            )
    ...
    public void testMapExceptionWithNoExceptionClass() throws Exception {
        ...
        FlowElement flowElement = bpmnModel
            .getMainProcess()
            .getFlowElement("servicetaskWithAndTrueAndChildren");
        assertThat(flowElement).isNotNull();
        assertThat(flowElement).isInstanceOf(ServiceTask.class);
        assertThat(flowElement.getId())
            .isEqualTo("servicetaskWithAndTrueAndChildren");
        ServiceTask serviceTask = (ServiceTask) flowElement;
        assertThat(serviceTask.getMapExceptions()).isNotNull();
        assertThat(serviceTask.getMapExceptions()).hasSize(1);
        assertThat(serviceTask.getMapExceptions().get(0).getClassName())
            .isNotNull();
        assertThat(
    ...
    private void validateModel(BpmnModel model) {
        ...
        assertThat(serviceTask.getMapExceptions().get(0).getErrorCode())
            .isEqualTo("myErrorCode1");
        assertThat(serviceTask.getMapExceptions().get(0).getClassName())
            .isEqualTo("com.activiti.Something1");
        assertThat(serviceTask.getMapExceptions().get(0).isAndChildren())
            .isTrue();

        // check a normal mapException, with hasChildren == false
        assertThat(serviceTask.getMapExceptions().get(1).getErrorCode())
            .isEqualTo("myErrorCode2");
        assertThat(serviceTask.getMapExceptions().get(1).getClassName())
            .isEqualTo("com.activiti.Something2");
        assertThat(serviceTask.getMapExceptions().get(1).isAndChildren())
            .isFalse();

        // check a normal mapException, with no hasChildren Defined, default should be false
        assertThat(serviceTask.getMapExceptions().get(2).getErrorCode())
            .isEqualTo("myErrorCode3");
        assertThat(serviceTask.getMapExceptions().get(2).getClassName())
            .isEqualTo("com.activiti.Something3");
        assertThat(serviceTask.getMapExceptions().get(2).isAndChildren())
            .isFalse();

        // if no map exception is defined, getMapException should return a not null empty list
        FlowElement flowElement1 = model
            .getMainProcess()
            .getFlowElement("servicetaskWithNoMapException");
        assertThat(flowElement1).isNotNull();
        assertThat(flowElement1).isInstanceOf(ServiceTask.class);
        assertThat(flowElement1.getId())
            .isEqualTo("servicetaskWithNoMapException");
