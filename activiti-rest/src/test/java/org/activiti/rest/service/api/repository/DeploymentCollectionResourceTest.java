...
public class DeploymentCollectionResourceTest extends BaseSpringRestTestCase {
  ...
  public void testGetDeployments() throws Exception {
    ...
    try {
      ...
      Deployment firstDeployment = repositoryService.createDeployment().name("Deployment 1").category("DEF").addClasspathResource("org/activiti/rest/service/api/repository/oneTaskProcess.bpmn20.xml")
          .deploy();
