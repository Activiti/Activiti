...
public class TaskActivatedImpl extends RuntimeEventImpl<FluentTask, TaskRuntimeEvent.TaskEvents> implements TaskActivated {

    public TaskActivatedImpl() {
    }

    public TaskActivatedImpl(FluentTask entity) {
        super(entity);
    }
