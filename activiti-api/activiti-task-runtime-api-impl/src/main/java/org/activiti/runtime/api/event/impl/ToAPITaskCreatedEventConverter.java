...
public class ToAPITaskCreatedEventConverter implements EventConverter<TaskCreated, ActivitiEntityEvent> {
    ...
    @Override
    public Optional<TaskCreated> from(ActivitiEntityEvent internalEvent) {
