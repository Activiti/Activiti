...
public interface ProcessRuntime {
    ...
    /**
     * Returns the current configuration of the ProcessRuntime, this includes - process runtime
     * events listeners - variable events listeners
     */
    ...
    /**
     * Get all process instances by pages - Notice that only in-flight or suspended processes will
     * be returned here - For already completed process instance check at the query service
     */
    ...
    List<VariableInstance> variables(
            GetVariablesPayload
                    getVariablesPayload); // I want to rename VariableInstance to Variable and it
    // needs to be
    // paged

    void removeVariables(
            RemoveProcessVariablesPayload
                    removeProcessVariablesPayload); // review if we need to return removed
    // variables// DO WE
    // NEED THIS?>

    void setVariables(
            SetProcessVariablesPayload
                    setProcessVariablesPayload); // review if we need to return set variables
