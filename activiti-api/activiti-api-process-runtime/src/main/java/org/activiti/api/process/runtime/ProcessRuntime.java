...
public interface ProcessRuntime {
  ...
  /**
   * Returns the current configuration of the ProcessRuntime, this includes - process runtime events
   * listeners - variable events listeners
   */
  ...
  List<VariableInstance> variables(
      GetVariablesPayload
          getVariablesPayload); // I want to rename VariableInstance to Variable and it needs to be
  // paged

  void removeVariables(
      RemoveProcessVariablesPayload
          removeProcessVariablesPayload); // review if we need to return removed variables// DO WE
  // NEED THIS?>
